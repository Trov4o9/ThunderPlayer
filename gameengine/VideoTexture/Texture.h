...
public:
	...
	short m_allocSize[2];
	int m_allocLevels;
	unsigned int m_allocInternalFormat;
	...
	void UploadToTexture(unsigned int *pixels, short size[2], bool mipmap, unsigned int internalFormat);
	...
	static PyObject *pyattr_get_usePBO(EXP_PyObjectPlus *self_v, const EXP_PYATTRIBUTE_DEF *attrdef);
	static int pyattr_set_usePBO(EXP_PyObjectPlus *self_v, const EXP_PYATTRIBUTE_DEF *attrdef, PyObject *value);
	static PyObject *pyattr_get_pboRingSize(EXP_PyObjectPlus *self_v, const EXP_PYATTRIBUTE_DEF *attrdef);
	static int pyattr_set_pboRingSize(EXP_PyObjectPlus *self_v, const EXP_PYATTRIBUTE_DEF *attrdef, PyObject *value);
};
...
extern ExceptionID SharedTextureStorageMismatch;
