...
public:
	enum PredefinedUniformType {
		...
		SMAA_AREA_TEX_UNIFORM,
		SMAA_SEARCH_TEX_UNIFORM,
		MAX_PREDEFINED_UNIFORM_TYPE
	};
	RAS_2DFilterManager::FILTER_MODE m_filterMode;

protected:
	std::array<int, MAX_PREDEFINED_UNIFORM_TYPE> m_predefinedUniforms;
	...
	std::array<float, TEXTURE_OFFSETS_SIZE> m_textureOffsets;
...
public:
	...
	RAS_2DFilterManager::FILTER_MODE GetFilterMode() const { return m_filterMode; }
