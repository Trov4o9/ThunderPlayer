...
extern GPUTexture *m_custom_texture;
extern GPUTexture *m_custom_texture_in;
extern GPUTexture *m_custom_texture_out;
...
protected:
	...
	int m_lastEye;
	mt::mat4 m_lastModelMatrix;
	mt::mat4 m_lastViewMatrix;

	// Caching for view matrices to avoid redundant calculations per object
	mt::mat4 m_cachedViewInverse;
	mt::mat4 m_cachedViewTranspose;
	mt::mat4 m_cachedViewInverseTranspose;
	bool m_viewInverseValid;
	bool m_viewTransposeValid;
	bool m_viewInverseTransposeValid;
	...
	bool RunTessellationShader(const char *tessCtrlSrc, const char *tessEvalSrc);
...
public:
	...
	void SetSamplerBindless(int loc, GLuint64 handle);
