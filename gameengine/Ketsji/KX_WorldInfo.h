...
class KX_WorldInfo : public EXP_Value, public mt::SimdClassAllocator
{
	...
	// Sun light tracking for sky shader
	class KX_LightObject *m_sunLight;
	mt::vec3 m_lastSunPosition;
	bool m_sunLightFound;
	bool m_sunLightSearched;
...
public:
	...
	// Sun light tracking methods
	void FindSunLight(class KX_Scene *scene);
	void UpdateSunUniform(struct GPUMaterial *gpumat);
