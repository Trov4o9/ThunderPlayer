...
void SCA_MouseManager::NextFrame()
{
    ...
    const SCA_InputEvent& eventX = m_mousedevice->GetInput(SCA_IInputDevice::MOUSEX);
    const SCA_InputEvent& eventY = m_mousedevice->GetInput(SCA_IInputDevice::MOUSEY);

    int mx = eventX.m_values.back();
    int my = eventY.m_values.back();
