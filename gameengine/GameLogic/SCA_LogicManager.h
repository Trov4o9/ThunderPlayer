...
class SCA_LogicManager
{
	...
	std::vector<SCA_EventManager*> m_eventmanagers_raw;
...
public:
	...
	void    ClearTriggeredControllers();
	void    ClearActiveActuators();
	void	ResetActuator(SCA_IActuator* actuator);
	void	SendNegativeEventToActiveActuators();
	void	ResumeActuators();
