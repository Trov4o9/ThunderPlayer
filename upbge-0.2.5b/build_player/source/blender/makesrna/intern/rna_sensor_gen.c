...
BoolPropertyRNA rna_MouseSensor_mask;
...
BoolPropertyRNA rna_RaySensor_mask;
...
EnumPropertyRNA rna_MovementSensor_axis;
BoolPropertyRNA rna_MovementSensor_use_local;
FloatPropertyRNA rna_MovementSensor_threshold;
...
EnumPropertyRNA rna_JoystickSensor_button_number;
EnumPropertyRNA rna_JoystickSensor_axis_number;
EnumPropertyRNA rna_JoystickSensor_axis_direction;
EnumPropertyRNA rna_JoystickSensor_axis_trigger_number;
EnumPropertyRNA rna_JoystickSensor_single_axis_number;
...
bool Sensor_pin_get(PointerRNA *ptr)
{
	bSensor *data = (bSensor *)(ptr->data);
	return (((data->flag) & 32) != 0);
}

void Sensor_pin_set(PointerRNA *ptr, bool value)
{
	bSensor *data = (bSensor *)(ptr->data);
...
bool Sensor_active_get(PointerRNA *ptr)
{
	bSensor *data = (bSensor *)(ptr->data);
	return !(((data->flag) & 64) != 0);
}

void Sensor_active_set(PointerRNA *ptr, bool value)
{
	bSensor *data = (bSensor *)(ptr->data);
...
bool Sensor_show_expanded_get(PointerRNA *ptr)
{
	bSensor *data = (bSensor *)(ptr->data);
	return (((data->flag) & 1) != 0);
}

void Sensor_show_expanded_set(PointerRNA *ptr, bool value)
{
	bSensor *data = (bSensor *)(ptr->data);
...
bool Sensor_invert_get(PointerRNA *ptr)
{
	bSensor *data = (bSensor *)(ptr->data);
	return (bool)(data->invert);
}

void Sensor_invert_set(PointerRNA *ptr, bool value)
{
	bSensor *data = (bSensor *)(ptr->data);
	data->invert = value;
}

bool Sensor_use_level_get(PointerRNA *ptr)
{
	bSensor *data = (bSensor *)(ptr->data);
	return (((data->level) & 1) != 0);
}

void Sensor_use_level_set(PointerRNA *ptr, bool value)
{
	rna_Sensor_level_set(ptr, value);
}

bool Sensor_use_pulse_true_level_get(PointerRNA *ptr)
{
	bSensor *data = (bSensor *)(ptr->data);
	return (((data->pulse) & 1) != 0);
}

void Sensor_use_pulse_true_level_set(PointerRNA *ptr, bool value)
{
	bSensor *data = (bSensor *)(ptr->data);
...
bool Sensor_use_pulse_false_level_get(PointerRNA *ptr)
{
	bSensor *data = (bSensor *)(ptr->data);
	return (((data->pulse) & 4) != 0);
}

void Sensor_use_pulse_false_level_set(PointerRNA *ptr, bool value)
{
	bSensor *data = (bSensor *)(ptr->data);
...
bool Sensor_use_tap_get(PointerRNA *ptr)
{
	bSensor *data = (bSensor *)(ptr->data);
	return (((data->tap) & 1) != 0);
}

void Sensor_use_tap_set(PointerRNA *ptr, bool value)
{
...
{
	return rna_Sensor_controllers_length(ptr);
}
...
bool MouseSensor_use_pulse_get(PointerRNA *ptr)
{
	bMouseSensor *data = (bMouseSensor *)(((bSensor *)ptr->data)->data);
	return (((data->flag) & 1) != 0);
}

void MouseSensor_use_pulse_set(PointerRNA *ptr, bool value)
{
	bMouseSensor *data = (bMouseSensor *)(((bSensor *)ptr->data)->data);
	if (value) data->flag |= 1;
	else data->flag &= ~1;
...
bool MouseSensor_use_x_ray_get(PointerRNA *ptr)
{
	bMouseSensor *data = (bMouseSensor *)(((bSensor *)ptr->data)->data);
	return (((data->flag) & 2) != 0);
}

void MouseSensor_use_x_ray_set(PointerRNA *ptr, bool value)
{
	bMouseSensor *data = (bMouseSensor *)(((bSensor *)ptr->data)->data);
...
void MouseSensor_mask_get(PointerRNA *ptr, bool values[16])
{
	bMouseSensor *data = (bMouseSensor *)(((bSensor *)ptr->data)->data);
	unsigned int i;
...
void MouseSensor_mask_set(PointerRNA *ptr, const bool values[16])
{
	bMouseSensor *data = (bMouseSensor *)(((bSensor *)ptr->data)->data);
	unsigned int i;

	for (i = 0; i < 16; i++) {
		if (values[i]) data->mask |= (1u << i);
		else data->mask &= ~(1u << i);
	}
}
...
bool KeyboardSensor_use_all_keys_get(PointerRNA *ptr)
{
	bKeyboardSensor *data = (bKeyboardSensor *)(((bSensor *)ptr->data)->data);
	return (((data->type) & 1) != 0);
}

void KeyboardSensor_use_all_keys_set(PointerRNA *ptr, bool value)
{
	bKeyboardSensor *data = (bKeyboardSensor *)(((bSensor *)ptr->data)->data);
...
bool DelaySensor_use_repeat_get(PointerRNA *ptr)
{
	bDelaySensor *data = (bDelaySensor *)(((bSensor *)ptr->data)->data);
	return (((data->flag) & 1) != 0);
}

void DelaySensor_use_repeat_set(PointerRNA *ptr, bool value)
{
	bDelaySensor *data = (bDelaySensor *)(((bSensor *)ptr->data)->data);
	if (value) data->flag |= 1;
	else data->flag &= ~1;
...
bool CollisionSensor_use_pulse_get(PointerRNA *ptr)
{
	bCollisionSensor *data = (bCollisionSensor *)(((bSensor *)ptr->data)->data);
	return (((data->mode) & 2) != 0);
}

void CollisionSensor_use_pulse_set(PointerRNA *ptr, bool value)
{
	bCollisionSensor *data = (bCollisionSensor *)(((bSensor *)ptr->data)->data);
...
bool CollisionSensor_use_material_get(PointerRNA *ptr)
{
	bCollisionSensor *data = (bCollisionSensor *)(((bSensor *)ptr->data)->data);
	return (((data->mode) & 1) != 0);
}

void CollisionSensor_use_material_set(PointerRNA *ptr, bool value)
{
	bCollisionSensor *data = (bCollisionSensor *)(((bSensor *)ptr->data)->data);
...
bool RaySensor_use_x_ray_get(PointerRNA *ptr)
{
	bRaySensor *data = (bRaySensor *)(((bSensor *)ptr->data)->data);
	return (((data->mode) & 2) != 0);
}

void RaySensor_use_x_ray_set(PointerRNA *ptr, bool value)
{
	bRaySensor *data = (bRaySensor *)(((bSensor *)ptr->data)->data);
	if (value) data->mode |= 2;
	else data->mode &= ~2;
...
void RaySensor_mask_get(PointerRNA *ptr, bool values[16])
{
	bRaySensor *data = (bRaySensor *)(((bSensor *)ptr->data)->data);
	unsigned int i;
...
void RaySensor_mask_set(PointerRNA *ptr, const bool values[16])
{
	bRaySensor *data = (bRaySensor *)(((bSensor *)ptr->data)->data);
	unsigned int i;
...
int MovementSensor_axis_get(PointerRNA *ptr)
{
	bMovementSensor *data = (bMovementSensor *)(((bSensor *)ptr->data)->data);
	return (int)(data->axisflag);
}

void MovementSensor_axis_set(PointerRNA *ptr, int value)
{
	bMovementSensor *data = (bMovementSensor *)(((bSensor *)ptr->data)->data);
	data->axisflag = value;
}

bool MovementSensor_use_local_get(PointerRNA *ptr)
{
	bMovementSensor *data = (bMovementSensor *)(((bSensor *)ptr->data)->data);
	return (((data->localflag) & 1) != 0);
}

void MovementSensor_use_local_set(PointerRNA *ptr, bool value)
{
	bMovementSensor *data = (bMovementSensor *)(((bSensor *)ptr->data)->data);
	if (value) data->localflag |= 1;
	else data->localflag &= ~1;
}

float MovementSensor_threshold_get(PointerRNA *ptr)
{
	bMovementSensor *data = (bMovementSensor *)(((bSensor *)ptr->data)->data);
	return (float)(data->threshold);
}

void MovementSensor_threshold_set(PointerRNA *ptr, float value)
{
	bMovementSensor *data = (bMovementSensor *)(((bSensor *)ptr->data)->data);
	data->threshold = CLAMPIS(value, 0.0010000000f, 10000.0f);
}
...
bool JoystickSensor_use_all_events_get(PointerRNA *ptr)
{
	bJoystickSensor *data = (bJoystickSensor *)(((bSensor *)ptr->data)->data);
	return (((data->flag) & 1) != 0);
}

void JoystickSensor_use_all_events_set(PointerRNA *ptr, bool value)
{
	bJoystickSensor *data = (bJoystickSensor *)(((bSensor *)ptr->data)->data);
	if (value) data->flag |= 1;
	else data->flag &= ~1;
...
int JoystickSensor_axis_trigger_number_get(PointerRNA *ptr)
{
	bJoystickSensor *data = (bJoystickSensor *)(((bSensor *)ptr->data)->data);
	return (int)(data->axis_single);
}

void JoystickSensor_axis_trigger_number_set(PointerRNA *ptr, int value)
{
	bJoystickSensor *data = (bJoystickSensor *)(((bSensor *)ptr->data)->data);
	data->axis_single = value;
}
...
static const EnumPropertyItem rna_Sensor_type_items[16] = {
...
EnumPropertyRNA rna_Sensor_type = {
	...
	NULL, 318767104, NULL, NULL,
	0, -1, NULL},
	Sensor_type_get, Sensor_type_set, rna_Sensor_type_itemf, NULL, NULL, NULL, rna_Sensor_type_items, 15, 0
};
...
BoolPropertyRNA rna_Sensor_invert = {
	...
	-1, "invert", 3, 0, 4, 0, "Invert Output",
...
BoolPropertyRNA rna_Sensor_use_pulse_true_level = {
	...
	-1, "use_pulse_true_level", 3, 0, 0, 0, "Pulse True Level",
...
BoolPropertyRNA rna_Sensor_use_pulse_false_level = {
	...
	-1, "use_pulse_false_level", 3, 0, 0, 0, "Pulse False Level",
...
CollectionPropertyRNA rna_Sensor_controllers = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Sensor_controllers_begin, Sensor_controllers_next, Sensor_controllers_end, Sensor_controllers_get, Sensor_controllers_length, Sensor_controllers_lookup_int, Sensor_controllers_lookup_string, NULL, &RNA_Controller
};
...
StructRNA RNA_Sensor = {
	...
	"Sensor", NULL, NULL, 516, NULL, "Sensor",
...
StructRNA RNA_AlwaysSensor = {
	...
	NULL,
	{NULL, NULL}},
	"AlwaysSensor", NULL, NULL, 516, NULL, "Always Sensor",
...
FloatPropertyRNA rna_NearSensor_distance = {
	...
	NULL, 318767104, NULL, NULL,
	offsetof(bNearSensor, dist), 5, NULL},
...
FloatPropertyRNA rna_NearSensor_reset_distance = {
	...
	-1, "reset_distance", 3, 0, 4, 0, "Reset Distance",
	"The distance where the sensor forgets the actor",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 318767104, NULL, NULL,
	offsetof(bNearSensor, resetdist), 5, NULL},
...
StructRNA RNA_NearSensor = {
	...
	"NearSensor", NULL, NULL, 516, NULL, "Near Sensor",
...
/* Mouse Sensor */
static const EnumPropertyItem rna_MouseSensor_mouse_event_items[9] = {
...
EnumPropertyRNA rna_MouseSensor_mouse_event = {
	...
	-1, "mouse_event", 3, 0, 0, 0, "Mouse Event",
...
static const EnumPropertyItem rna_MouseSensor_use_material_items[3] = {
...
BoolPropertyRNA rna_MouseSensor_use_x_ray = {
	{(PropertyRNA *)&rna_MouseSensor_mask, (PropertyRNA *)&rna_MouseSensor_material,
	-1, "use_x_ray", 3, 0, 0, 0, "X-Ray",
...
static bool rna_MouseSensor_mask_default[16] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_MouseSensor_mask = {
	{NULL, (PropertyRNA *)&rna_MouseSensor_use_x_ray,
	-1, "mask", 3, 0, 0, 0, "Mask",
	...
	NULL, 318767104, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, MouseSensor_mask_get, MouseSensor_mask_set, NULL, NULL, NULL, NULL, 0, rna_MouseSensor_mask_default
};

StructRNA RNA_MouseSensor = {
	{(ContainerRNA *)&RNA_KeyboardSensor, (ContainerRNA *)&RNA_NearSensor,
	NULL,
	{(PropertyRNA *)&rna_MouseSensor_mouse_event, (PropertyRNA *)&rna_MouseSensor_mask}},
	"MouseSensor", NULL, NULL, 516, NULL, "Mouse Sensor",
...
/* Keyboard Sensor */
static const EnumPropertyItem rna_KeyboardSensor_key_items[203] = {
	{0, "NONE", 0, "", ""},
...
EnumPropertyRNA rna_KeyboardSensor_key = {
	...
	NULL, 318767104, NULL, NULL,
	0, -1, NULL},
	KeyboardSensor_key_get, KeyboardSensor_key_set, NULL, NULL, NULL, NULL, rna_KeyboardSensor_key_items, 202, 0
};

static const EnumPropertyItem rna_KeyboardSensor_modifier_key_1_items[203] = {
	{0, "NONE", 0, "", ""},
	{1, "LEFTMOUSE", 0, "Left Mouse", "LMB"},
	{2, "MIDDLEMOUSE", 0, "Middle Mouse", "MMB"},
	{3, "RIGHTMOUSE", 0, "Right Mouse", "RMB"},
...
EnumPropertyRNA rna_KeyboardSensor_modifier_key_1 = {
	...
	-1, "modifier_key_1", 3, 0, 0, 0, "Modifier Key",
	"Modifier key code",
	0, "UI_Events_KeyMaps",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 318767104, NULL, NULL,
	0, -1, NULL},
	KeyboardSensor_modifier_key_1_get, KeyboardSensor_modifier_key_1_set, NULL, NULL, NULL, NULL, rna_KeyboardSensor_modifier_key_1_items, 202, 0
};

static const EnumPropertyItem rna_KeyboardSensor_modifier_key_2_items[203] = {
	{0, "NONE", 0, "", ""},
	{1, "LEFTMOUSE", 0, "Left Mouse", "LMB"},
	{2, "MIDDLEMOUSE", 0, "Middle Mouse", "MMB"},
	{3, "RIGHTMOUSE", 0, "Right Mouse", "RMB"},
...
EnumPropertyRNA rna_KeyboardSensor_modifier_key_2 = {
	...
	-1, "modifier_key_2", 3, 0, 0, 0, "Second Modifier Key",
	"Modifier key code",
	0, "UI_Events_KeyMaps",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 318767104, NULL, NULL,
	0, -1, NULL},
	KeyboardSensor_modifier_key_2_get, KeyboardSensor_modifier_key_2_set, NULL, NULL, NULL, NULL, rna_KeyboardSensor_modifier_key_2_items, 202, 0
};

StringPropertyRNA rna_KeyboardSensor_target = {
	{(PropertyRNA *)&rna_KeyboardSensor_log, (PropertyRNA *)&rna_KeyboardSensor_modifier_key_2,
	-1, "target", 262145, 0, 0, 0, "Target",
...
BoolPropertyRNA rna_KeyboardSensor_use_all_keys = {
	...
	-1, "use_all_keys", 3, 0, 0, 0, "All Keys",
...
StructRNA RNA_KeyboardSensor = {
	...
	"KeyboardSensor", NULL, NULL, 516, NULL, "Keyboard Sensor",
...
/* Property Sensor */
static const EnumPropertyItem rna_PropertySensor_evaluation_type_items[7] = {
	{0, "PROPEQUAL", 0, "Equal", ""},
...
EnumPropertyRNA rna_PropertySensor_evaluation_type = {
	...
	-1, "evaluation_type", 3, 0, 0, 0, "Evaluation Type",
...
StringPropertyRNA rna_PropertySensor_value_min = {
	...
	-1, "value_min", 262145, 0, 0, 0, "Minimum Value",
...
StringPropertyRNA rna_PropertySensor_value_max = {
	...
	-1, "value_max", 262145, 0, 0, 0, "Maximum Value",
...
StructRNA RNA_PropertySensor = {
	...
	"PropertySensor", NULL, NULL, 516, NULL, "Property Sensor",
...
/* Armature Sensor */
static const EnumPropertyItem rna_ArmatureSensor_test_type_items[6] = {
...
StringPropertyRNA rna_ArmatureSensor_constraint = {
	...
	-1, "constraint", 262145, 0, 0, 0, "Constraint Name",
...
FloatPropertyRNA rna_ArmatureSensor_value = {
	...
	-1, "value", 3, 0, 4, 0, "Compare Value",
	"Value to be used in comparison",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 318767104, NULL, NULL,
	offsetof(bArmatureSensor, value), 5, NULL},
...
StructRNA RNA_ArmatureSensor = {
	...
	"ArmatureSensor", NULL, NULL, 516, NULL, "Armature Sensor",
...
StringPropertyRNA rna_ActuatorSensor_actuator = {
	{NULL, NULL,
	-1, "actuator", 262145, 0, 0, 0, "Actuator",
...
StructRNA RNA_ActuatorSensor = {
	...
	"ActuatorSensor", NULL, NULL, 516, NULL, "Actuator Sensor",
...
StructRNA RNA_DelaySensor = {
	...
	"DelaySensor", NULL, NULL, 516, NULL, "Delay Sensor",
...
StructRNA RNA_CollisionSensor = {
	...
	"CollisionSensor", NULL, NULL, 516, NULL, "Collision Sensor",
...
static const EnumPropertyItem rna_RadarSensor_axis_items[7] = {
	{0, "XAXIS", 0, "+X axis", ""},
	{1, "YAXIS", 0, "+Y axis", ""},
	{2, "ZAXIS", 0, "+Z axis", ""},
	{3, "NEGXAXIS", 0, "-X axis", ""},
...
FloatPropertyRNA rna_RadarSensor_angle = {
	...
	NULL, 318767104, NULL, NULL,
	offsetof(bRadarSensor, angle), 5, NULL},
...
FloatPropertyRNA rna_RadarSensor_distance = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 318767104, NULL, NULL,
	offsetof(bRadarSensor, range), 5, NULL},
...
StructRNA RNA_RadarSensor = {
	...
	"RadarSensor", NULL, NULL, 516, NULL, "Radar Sensor",
...
StructRNA RNA_RandomSensor = {
	...
	"RandomSensor", NULL, NULL, 516, NULL, "Random Sensor",
...
/* Ray Sensor */
static const EnumPropertyItem rna_RaySensor_ray_type_items[3] = {
	{0, "PROPERTY", 120, "Property", "Use a property for ray intersections"},
	{1, "MATERIAL", 165, "Material", "Use a material for ray intersections"},
	{0, NULL, 0, NULL, NULL}
};
...
BoolPropertyRNA rna_RaySensor_use_x_ray = {
	...
	-1, "use_x_ray", 3, 0, 0, 0, "X-Ray Mode",
	"Toggle X-Ray option (see through objects that don\'t have the property)",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 318767104, NULL, NULL,
...
FloatPropertyRNA rna_RaySensor_range = {
	...
	-1, "range", 3, 0, 4, 0, "Range",
	"Sense objects no farther than this distance",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 318767104, NULL, NULL,
	offsetof(bRaySensor, range), 5, NULL},
...
static const EnumPropertyItem rna_RaySensor_axis_items[7] = {
	{1, "XAXIS", 0, "+X axis", ""},
	{0, "YAXIS", 0, "+Y axis", ""},
	{2, "ZAXIS", 0, "+Z axis", ""},
	{3, "NEGXAXIS", 0, "-X axis", ""},
...
EnumPropertyRNA rna_RaySensor_axis = {
	{(PropertyRNA *)&rna_RaySensor_mask, (PropertyRNA *)&rna_RaySensor_range,
	-1, "axis", 3, 0, 0, 0, "Axis",
...
static bool rna_RaySensor_mask_default[16] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_RaySensor_mask = {
	{NULL, (PropertyRNA *)&rna_RaySensor_axis,
	-1, "mask", 3, 0, 0, 0, "Mask",
	"Mask filter compared with object\'s collision group",
	0, "*",
	PROP_BOOLEAN, PROP_LAYER_MEMBER | PROP_UNIT_NONE, NULL, 1, {16, 0, 0}, 16,
	NULL, 318767104, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, RaySensor_mask_get, RaySensor_mask_set, NULL, NULL, NULL, NULL, 0, rna_RaySensor_mask_default
};

StructRNA RNA_RaySensor = {
	{(ContainerRNA *)&RNA_MovementSensor, (ContainerRNA *)&RNA_RandomSensor,
	NULL,
	{(PropertyRNA *)&rna_RaySensor_ray_type, (PropertyRNA *)&rna_RaySensor_mask}},
	"RaySensor", NULL, NULL, 516, NULL, "Ray Sensor",
...
/* Movement Sensor */
static const EnumPropertyItem rna_MovementSensor_axis_items[8] = {
	{0, "XAXIS", 0, "+X axis", ""},
	{1, "YAXIS", 0, "+Y axis", ""},
	{2, "ZAXIS", 0, "+Z axis", ""},
	{3, "NEGXAXIS", 0, "-X axis", ""},
	{4, "NEGYAXIS", 0, "-Y axis", ""},
	{5, "NEGZAXIS", 0, "-Z axis", ""},
	{6, "ALLAXIS", 0, "All axis", ""},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_MovementSensor_axis = {
	{(PropertyRNA *)&rna_MovementSensor_use_local, NULL,
	-1, "axis", 3, 0, 0, 0, "Axis",
	...
	NULL, 318767104, NULL, NULL,
	0, -1, NULL},
	MovementSensor_axis_get, MovementSensor_axis_set, NULL, NULL, NULL, NULL, rna_MovementSensor_axis_items, 7, 0
};

BoolPropertyRNA rna_MovementSensor_use_local = {
	{(PropertyRNA *)&rna_MovementSensor_threshold, (PropertyRNA *)&rna_MovementSensor_axis,
	-1, "use_local", 3, 0, 0, 0, "Local",
	"Toggle beetween local/global coordinates",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 318767104, NULL, NULL,
	0, -1, NULL},
	MovementSensor_use_local_get, MovementSensor_use_local_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

FloatPropertyRNA rna_MovementSensor_threshold = {
	{NULL, (PropertyRNA *)&rna_MovementSensor_use_local,
	-1, "threshold", 3, 0, 4, 0, "Threshold",
	"Set Threshold",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 318767104, NULL, NULL,
	offsetof(bMovementSensor, threshold), 5, NULL},
	MovementSensor_threshold_get, MovementSensor_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0010000000f, 10000.0f, 0.0010000000f, 10000.0f, 0.1000000015f, 3, 0.0099999998f, NULL
};

StructRNA RNA_MovementSensor = {
	{(ContainerRNA *)&RNA_MessageSensor, (ContainerRNA *)&RNA_RaySensor,
	NULL,
	{(PropertyRNA *)&rna_MovementSensor_axis, (PropertyRNA *)&rna_MovementSensor_threshold}},
	"MovementSensor", NULL, NULL, 516, NULL, "Movement Sensor",
...
StructRNA RNA_MessageSensor = {
	{(ContainerRNA *)&RNA_JoystickSensor, (ContainerRNA *)&RNA_MovementSensor,
	NULL,
	{(PropertyRNA *)&rna_MessageSensor_subject, (PropertyRNA *)&rna_MessageSensor_subject}},
	"MessageSensor", NULL, NULL, 516, NULL, "Message Sensor",
...
IntPropertyRNA rna_JoystickSensor_joystick_index = {
	...
	-1, "joystick_index", 3, 0, 4, 0, "Joystick Index",
...
static const EnumPropertyItem rna_JoystickSensor_event_type_items[5] = {
	{1, "STICK_DIRECTIONS", 0, "Stick Directions", ""},
	{3, "STICK_AXIS", 0, "Stick Axis", ""},
	{4, "SHOULDER_TRIGGERS", 0, "Shoulder Triggers", ""},
	{0, "BUTTONS", 0, "Buttons", ""},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_JoystickSensor_event_type = {
	...
	-1, "event_type", 3, 0, 0, 0, "Event Type",
...
BoolPropertyRNA rna_JoystickSensor_use_all_events = {
	...
	-1, "use_all_events", 3, 0, 0, 0, "All Events",
...
static const EnumPropertyItem rna_JoystickSensor_button_number_items[16] = {
	{0, "BUTTON_A", 0, "A", ""},
	{1, "BUTTON_B", 0, "B", ""},
	{2, "BUTTON_X", 0, "X", ""},
	{3, "BUTTON_Y", 0, "Y", ""},
	{4, "BUTTON_BACK", 0, "Back", ""},
	{5, "BUTTON_GUIDE", 0, "Guide", ""},
	{6, "BUTTON_START", 0, "Start", ""},
	{7, "BUTTON_STICK_LEFT", 0, "Left Stick", ""},
	{8, "BUTTON_STICK_RIGHT", 0, "Right Stick", ""},
	{9, "BUTTON_SHOULDER_LEFT", 0, "Left Shoulder", ""},
	{10, "BUTTON_SHOULDER_RIGHT", 0, "Right Shoulder", ""},
	{11, "BUTTON_DPAD_UP", 0, "Dpad Up", ""},
	{12, "BUTTON_DPAD_DOWN", 0, "Dpad Down", ""},
	{13, "BUTTON_DPAD_LEFT", 0, "Dpad Left", ""},
	{14, "BUTTON_DPAD_RIGHT", 0, "Dpad Right", ""},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_JoystickSensor_button_number = {
	{(PropertyRNA *)&rna_JoystickSensor_axis_number, (PropertyRNA *)&rna_JoystickSensor_use_all_events,
	-1, "button_number", 3, 0, 0, 0, "Button",
	"Which button to use",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 318767104, NULL, NULL,
	0, -1, NULL},
	JoystickSensor_button_number_get, JoystickSensor_button_number_set, NULL, NULL, NULL, NULL, rna_JoystickSensor_button_number_items, 15, 0
};

static const EnumPropertyItem rna_JoystickSensor_axis_number_items[3] = {
	{1, "LEFT_STICK", 0, "Left Stick", ""},
	{2, "RIGHT_STICK", 0, "Right Stick", ""},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_JoystickSensor_axis_number = {
	{(PropertyRNA *)&rna_JoystickSensor_axis_direction, (PropertyRNA *)&rna_JoystickSensor_button_number,
	-1, "axis_number", 3, 0, 0, 0, "Stick",
	"Which Stick to use",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 318767104, NULL, NULL,
	0, -1, NULL},
	JoystickSensor_axis_number_get, JoystickSensor_axis_number_set, NULL, NULL, NULL, NULL, rna_JoystickSensor_axis_number_items, 2, 1
};

static const EnumPropertyItem rna_JoystickSensor_axis_direction_items[5] = {
	{0, "RIGHTAXIS", 0, "Right", ""},
	{1, "UPAXIS", 0, "Up", ""},
	{2, "LEFTAXIS", 0, "Left", ""},
	{3, "DOWNAXIS", 0, "Down", ""},
...
EnumPropertyRNA rna_JoystickSensor_axis_direction = {
	{(PropertyRNA *)&rna_JoystickSensor_axis_trigger_number, (PropertyRNA *)&rna_JoystickSensor_axis_number,
	-1, "axis_direction", 3, 0, 0, 0, "Stick Direction",
...
static const EnumPropertyItem rna_JoystickSensor_axis_trigger_number_items[3] = {
	{1, "LEFT_SHOULDER_TRIGGER", 0, "Left Shoulder Trigger", ""},
	{2, "RIGHT_SHOULDER_TRIGGER", 0, "Right Shoulder Trigger", ""},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_JoystickSensor_axis_trigger_number = {
	{(PropertyRNA *)&rna_JoystickSensor_single_axis_number, (PropertyRNA *)&rna_JoystickSensor_axis_direction,
	-1, "axis_trigger_number", 3, 0, 0, 0, "Triggers",
	"Which trigger to detect",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 318767104, NULL, NULL,
	0, -1, NULL},
	JoystickSensor_axis_trigger_number_get, JoystickSensor_axis_trigger_number_set, NULL, NULL, NULL, NULL, rna_JoystickSensor_axis_trigger_number_items, 2, 1
};

static const EnumPropertyItem rna_JoystickSensor_single_axis_number_items[5] = {
	{1, "LEFT_STICK_HORIZONTAL", 0, "Left Stick Horizontal", ""},
	{2, "LEFT_STICK_VERTICAL", 0, "Left Stick Vertical", ""},
	{3, "RIGHT_STICK_HORIZONTAL", 0, "Right Stick Horizontal", ""},
	{4, "RIGHT_STICK_VERTICAL", 0, "Right Stick Vertical", ""},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_JoystickSensor_single_axis_number = {
	{(PropertyRNA *)&rna_JoystickSensor_axis_threshold, (PropertyRNA *)&rna_JoystickSensor_axis_trigger_number,
	-1, "single_axis_number", 3, 0, 0, 0, "Stick Axis",
	"Which stick single axis (vertical/horizontal/other) to detect",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 318767104, NULL, NULL,
	0, -1, NULL},
	JoystickSensor_single_axis_number_get, JoystickSensor_single_axis_number_set, NULL, NULL, NULL, NULL, rna_JoystickSensor_single_axis_number_items, 4, 1
};

IntPropertyRNA rna_JoystickSensor_axis_threshold = {
	{NULL, (PropertyRNA *)&rna_JoystickSensor_single_axis_number,
	-1, "axis_threshold", 3, 0, 4, 0, "Threshold",
...
StructRNA RNA_JoystickSensor = {
	...
	NULL,
	{(PropertyRNA *)&rna_JoystickSensor_joystick_index, (PropertyRNA *)&rna_JoystickSensor_axis_threshold}},
	"JoystickSensor", NULL, NULL, 516, NULL, "Joystick Sensor",
