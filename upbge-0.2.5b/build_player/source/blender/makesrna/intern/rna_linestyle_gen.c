...
bool LineStyleTextureSlot_use_tips_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->texflag) & 4096) != 0);
}

void LineStyleTextureSlot_use_tips_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
StringPropertyRNA rna_LineStyleColorModifier_AlongStroke_name = {
	...
	-1, "name", 262145, 0, 0, 0, "Modifier Name",
...
static const EnumPropertyItem rna_LineStyleColorModifier_AlongStroke_blend_items[19] = {
	{0, "MIX", 0, "Mix", ""},
	{1, "ADD", 0, "Add", ""},
...
static const EnumPropertyItem rna_LineStyleColorModifier_DistanceFromCamera_blend_items[19] = {
	{0, "MIX", 0, "Mix", ""},
	{1, "ADD", 0, "Add", ""},
	{2, "MULTIPLY", 0, "Multiply", ""},
	{3, "SUBTRACT", 0, "Subtract", ""},
...
static const EnumPropertyItem rna_LineStyleColorModifier_DistanceFromObject_blend_items[19] = {
	{0, "MIX", 0, "Mix", ""},
	{1, "ADD", 0, "Add", ""},
	{2, "MULTIPLY", 0, "Multiply", ""},
	{3, "SUBTRACT", 0, "Subtract", ""},
...
static const EnumPropertyItem rna_LineStyleColorModifier_Material_blend_items[19] = {
	{0, "MIX", 0, "Mix", ""},
	{1, "ADD", 0, "Add", ""},
	{2, "MULTIPLY", 0, "Multiply", ""},
	{3, "SUBTRACT", 0, "Subtract", ""},
...
EnumPropertyRNA rna_LineStyleColorModifier_Material_material_attribute = {
	...
	-1, "material_attribute", 3, 0, 0, 0, "Material Attribute",
...
static const EnumPropertyItem rna_LineStyleColorModifier_Tangent_blend_items[19] = {
	{0, "MIX", 0, "Mix", ""},
	{1, "ADD", 0, "Add", ""},
	{2, "MULTIPLY", 0, "Multiply", ""},
	{3, "SUBTRACT", 0, "Subtract", ""},
...
static const EnumPropertyItem rna_LineStyleColorModifier_Noise_blend_items[19] = {
	{0, "MIX", 0, "Mix", ""},
	{1, "ADD", 0, "Add", ""},
	{2, "MULTIPLY", 0, "Multiply", ""},
	{3, "SUBTRACT", 0, "Subtract", ""},
...
static const EnumPropertyItem rna_LineStyleColorModifier_CreaseAngle_blend_items[19] = {
	{0, "MIX", 0, "Mix", ""},
	{1, "ADD", 0, "Add", ""},
	{2, "MULTIPLY", 0, "Multiply", ""},
	{3, "SUBTRACT", 0, "Subtract", ""},
...
static const EnumPropertyItem rna_LineStyleColorModifier_Curvature_3D_blend_items[19] = {
	{0, "MIX", 0, "Mix", ""},
	{1, "ADD", 0, "Add", ""},
	{2, "MULTIPLY", 0, "Multiply", ""},
	{3, "SUBTRACT", 0, "Subtract", ""},
...
FloatPropertyRNA rna_LineStyleColorModifier_Curvature_3D_curvature_min = {
	...
	-1, "curvature_min", 3, 0, 4, 0, "Min Curvature",
	"Minimum Curvature",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_LineStyle_update, 385875968, NULL, NULL,
...
FloatPropertyRNA rna_LineStyleColorModifier_Curvature_3D_curvature_max = {
	...
	-1, "curvature_max", 3, 0, 4, 0, "Max Curvature",
	"Maximum Curvature",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_LineStyle_update, 385875968, NULL, NULL,
...
FloatPropertyRNA rna_LineStyleThicknessModifier_Tangent_thickness_min = {
	...
	-1, "thickness_min", 3, 0, 4, 0, "Min Thickness",
	"Minimum thickness",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_LineStyle_update, 385875968, NULL, NULL,
...
FloatPropertyRNA rna_LineStyleThicknessModifier_Tangent_thickness_max = {
	...
	-1, "thickness_max", 3, 0, 4, 0, "Max Thickness",
	"Maximum thickness",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_LineStyle_update, 385875968, NULL, NULL,
...
FloatPropertyRNA rna_LineStyleThicknessModifier_Calligraphy_orientation = {
	...
	-1, "orientation", 3, 0, 4, 0, "Orientation",
...
BoolPropertyRNA rna_LineStyleThicknessModifier_Noise_use_asymmetric = {
	...
	-1, "use_asymmetric", 3, 0, 0, 0, "Asymmetric",
...
FloatPropertyRNA rna_LineStyleGeometryModifier_SinusDisplacement_wavelength = {
	...
	-1, "wavelength", 3, 0, 4, 0, "Wavelength",
...
BoolPropertyRNA rna_LineStyleGeometryModifier_SpatialNoise_use_pure_random = {
	...
	-1, "use_pure_random", 3, 0, 0, 0, "Pure Random",
...
FloatPropertyRNA rna_LineStyleGeometryModifier_BackboneStretcher_backbone_length = {
	...
	-1, "backbone_length", 3, 0, 4, 0, "Backbone Length",
...
FloatPropertyRNA rna_LineStyleGeometryModifier_TipRemover_tip_length = {
	...
	-1, "tip_length", 3, 0, 4, 0, "Tip Length",
...
IntPropertyRNA rna_LineStyleGeometryModifier_Blueprint_random_radius = {
	...
	-1, "random_radius", 3, 0, 4, 0, "Random Radius",
...
IntPropertyRNA rna_LineStyleGeometryModifier_Blueprint_random_center = {
	...
	-1, "random_center", 3, 0, 4, 0, "Random Center",
...
IntPropertyRNA rna_LineStyleGeometryModifier_Blueprint_random_backbone = {
	...
	-1, "random_backbone", 3, 0, 4, 0, "Random Backbone",
...
FloatPropertyRNA rna_LineStyleGeometryModifier_2DTransform_scale_x = {
	...
	-1, "scale_x", 67108867, 0, 4, 0, "Scale X",
...
FloatPropertyRNA rna_LineStyleGeometryModifier_2DTransform_scale_y = {
	...
	-1, "scale_y", 67108867, 0, 4, 0, "Scale Y",
...
FloatPropertyRNA rna_LineStyleGeometryModifier_2DTransform_angle = {
	...
	-1, "angle", 3, 0, 4, 0, "Rotation Angle",
	"Rotation angle",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_LineStyle_update, 385875968, NULL, NULL,
...
FloatPropertyRNA rna_LineStyleGeometryModifier_2DTransform_pivot_u = {
	...
	-1, "pivot_u", 3, 0, 4, 0, "Stroke Point Parameter",
...
FloatPropertyRNA rna_FreestyleLineStyle_alpha = {
	...
	-1, "alpha", 3, 0, 4, 0, "Alpha Transparency",
...
EnumPropertyRNA rna_FreestyleLineStyle_thickness_position = {
	...
	-1, "thickness_position", 3, 0, 0, 0, "Thickness Position",
...
FloatPropertyRNA rna_FreestyleLineStyle_thickness_ratio = {
	...
	-1, "thickness_ratio", 3, 0, 4, 0, "Thickness Ratio",
...
CollectionPropertyRNA rna_FreestyleLineStyle_color_modifiers = {
	...
	-1, "color_modifiers", 0, 0, 0, 0, "Color Modifiers",
...
CollectionPropertyRNA rna_FreestyleLineStyle_alpha_modifiers = {
	...
	-1, "alpha_modifiers", 0, 0, 0, 0, "Alpha Modifiers",
...
CollectionPropertyRNA rna_FreestyleLineStyle_thickness_modifiers = {
	...
	-1, "thickness_modifiers", 0, 0, 0, 0, "Thickness Modifiers",
...
CollectionPropertyRNA rna_FreestyleLineStyle_geometry_modifiers = {
	...
	-1, "geometry_modifiers", 0, 0, 0, 0, "Geometry Modifiers",
...
BoolPropertyRNA rna_FreestyleLineStyle_use_chaining = {
	...
	-1, "use_chaining", 3, 0, 0, 0, "Chaining",
...
EnumPropertyRNA rna_FreestyleLineStyle_chaining = {
	...
	-1, "chaining", 3, 0, 0, 0, "Chaining Method",
...
BoolPropertyRNA rna_FreestyleLineStyle_use_same_object = {
	...
	-1, "use_same_object", 3, 0, 0, 0, "Same Object",
...
BoolPropertyRNA rna_FreestyleLineStyle_use_split_length = {
	...
	-1, "use_split_length", 3, 0, 0, 0, "Use Split Length",
...
FloatPropertyRNA rna_FreestyleLineStyle_split_length = {
	...
	-1, "split_length", 3, 0, 4, 0, "Split Length",
...
BoolPropertyRNA rna_FreestyleLineStyle_use_angle_min = {
	...
	-1, "use_angle_min", 3, 0, 0, 0, "Use Min 2D Angle",
...
FloatPropertyRNA rna_FreestyleLineStyle_angle_min = {
	...
	-1, "angle_min", 3, 0, 4, 0, "Min 2D Angle",
...
BoolPropertyRNA rna_FreestyleLineStyle_use_angle_max = {
	...
	-1, "use_angle_max", 3, 0, 0, 0, "Use Max 2D Angle",
...
FloatPropertyRNA rna_FreestyleLineStyle_angle_max = {
	...
	-1, "angle_max", 3, 0, 4, 0, "Max 2D Angle",
...
BoolPropertyRNA rna_FreestyleLineStyle_use_length_min = {
	...
	-1, "use_length_min", 3, 0, 0, 0, "Use Min 2D Length",
...
FloatPropertyRNA rna_FreestyleLineStyle_length_min = {
	...
	-1, "length_min", 3, 0, 4, 0, "Min 2D Length",
...
BoolPropertyRNA rna_FreestyleLineStyle_use_length_max = {
	...
	-1, "use_length_max", 3, 0, 0, 0, "Use Max 2D Length",
...
FloatPropertyRNA rna_FreestyleLineStyle_length_max = {
	...
	-1, "length_max", 3, 0, 4, 0, "Max 2D Length",
...
BoolPropertyRNA rna_FreestyleLineStyle_use_chain_count = {
	...
	-1, "use_chain_count", 3, 0, 0, 0, "Use Chain Count",
...
IntPropertyRNA rna_FreestyleLineStyle_chain_count = {
	...
	-1, "chain_count", 3, 0, 4, 0, "Chain Count",
...
BoolPropertyRNA rna_FreestyleLineStyle_use_split_pattern = {
	...
	-1, "use_split_pattern", 3, 0, 0, 0, "Use Split Pattern",
...
IntPropertyRNA rna_FreestyleLineStyle_split_dash1 = {
	...
	-1, "split_dash1", 3, 0, 4, 0, "Split Dash 1",
...
IntPropertyRNA rna_FreestyleLineStyle_split_gap1 = {
	...
	-1, "split_gap1", 3, 0, 4, 0, "Split Gap 1",
...
IntPropertyRNA rna_FreestyleLineStyle_split_dash2 = {
	...
	-1, "split_dash2", 3, 0, 4, 0, "Split Dash 2",
...
IntPropertyRNA rna_FreestyleLineStyle_split_gap2 = {
	...
	-1, "split_gap2", 3, 0, 4, 0, "Split Gap 2",
...
IntPropertyRNA rna_FreestyleLineStyle_split_dash3 = {
	...
	-1, "split_dash3", 3, 0, 4, 0, "Split Dash 3",
...
IntPropertyRNA rna_FreestyleLineStyle_split_gap3 = {
	...
	-1, "split_gap3", 3, 0, 4, 0, "Split Gap 3",
...
BoolPropertyRNA rna_FreestyleLineStyle_material_boundary = {
	...
	-1, "material_boundary", 3, 0, 0, 0, "Material Boundary",
...
EnumPropertyRNA rna_FreestyleLineStyle_sort_order = {
	...
	-1, "sort_order", 3, 0, 0, 0, "Sort Order",
...
EnumPropertyRNA rna_FreestyleLineStyle_integration_type = {
	...
	-1, "integration_type", 3, 0, 0, 0, "Integration Type",
...
BoolPropertyRNA rna_FreestyleLineStyle_use_dashed_line = {
	...
	-1, "use_dashed_line", 3, 0, 0, 0, "Dashed Line",
...
BoolPropertyRNA rna_FreestyleLineStyle_use_texture = {
	...
	-1, "use_texture", 3, 0, 0, 0, "Use Textures",
...
FloatPropertyRNA rna_FreestyleLineStyle_texture_spacing = {
	...
	-1, "texture_spacing", 3, 0, 4, 0, "Texture spacing",
