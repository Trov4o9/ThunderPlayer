...
StringPropertyRNA rna_Struct_identifier = {
	...
	-1, "identifier", 262144, 0, 0, 0, "Identifier",
...
StringPropertyRNA rna_Struct_description = {
	...
	-1, "description", 262144, 0, 0, 0, "Description",
...
StringPropertyRNA rna_Struct_translation_context = {
	...
	-1, "translation_context", 262144, 0, 0, 0, "Translation Context",
...
PointerPropertyRNA rna_Struct_name_property = {
	...
	-1, "name_property", 8388608, 0, 0, 0, "Name Property",
...
CollectionPropertyRNA rna_Struct_property_tags = {
	...
	-1, "property_tags", 0, 0, 8, 0, "Property Tags",
...
static const EnumPropertyItem rna_Property_icon_items[572] = {
	{0, "NONE", 0, "NONE", ""},
...
EnumPropertyRNA rna_Property_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Property_icon_get, NULL, NULL, NULL, NULL, NULL, rna_Property_icon_items, 571, 0
};

BoolPropertyRNA rna_Property_is_readonly = {
	{(PropertyRNA *)&rna_Property_is_animatable, (PropertyRNA *)&rna_Property_icon,
	-1, "is_readonly", 2, 0, 0, 0, "Read Only",
...
BoolPropertyRNA rna_Property_is_animatable = {
	...
	-1, "is_animatable", 2, 0, 0, 0, "Animatable",
...
BoolPropertyRNA rna_Property_is_required = {
	...
	-1, "is_required", 2, 0, 0, 0, "Required",
...
BoolPropertyRNA rna_Property_is_argument_optional = {
	...
	-1, "is_argument_optional", 2, 0, 0, 0, "Optional Argument",
...
BoolPropertyRNA rna_Property_is_never_none = {
	...
	-1, "is_never_none", 2, 0, 0, 0, "Never None",
...
BoolPropertyRNA rna_Property_is_skip_save = {
	...
	-1, "is_skip_save", 2, 0, 0, 0, "Skip Save",
...
BoolPropertyRNA rna_Property_is_registered = {
	...
	-1, "is_registered", 2, 0, 0, 0, "Registered",
...
BoolPropertyRNA rna_Property_is_registered_optional = {
	...
	-1, "is_registered_optional", 2, 0, 0, 0, "Registered Optionally",
...
BoolPropertyRNA rna_Property_is_enum_flag = {
	...
	-1, "is_enum_flag", 2, 0, 0, 0, "Enum Flag",
...
BoolPropertyRNA rna_Property_is_library_editable = {
	...
	-1, "is_library_editable", 2, 0, 0, 0, "Library Editable",
...
BoolPropertyRNA rna_BoolProperty_default_array = {
	...
	-1, "default_array", 131074, 0, 0, 0, "Default Array",
...
IntPropertyRNA rna_BoolProperty_array_length = {
	...
	-1, "array_length", 2, 0, 0, 0, "Array Length",
...
IntPropertyRNA rna_BoolProperty_array_dimensions = {
	...
	-1, "array_dimensions", 2, 0, 0, 0, "Array Dimensions",
...
IntPropertyRNA rna_IntProperty_hard_min = {
	...
	-1, "hard_min", 2, 0, 0, 0, "Hard Minimum",
...
IntPropertyRNA rna_IntProperty_hard_max = {
	...
	-1, "hard_max", 2, 0, 0, 0, "Hard Maximum",
...
IntPropertyRNA rna_IntProperty_soft_min = {
	...
	-1, "soft_min", 2, 0, 0, 0, "Soft Minimum",
	"Minimum value used by buttons",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_IntProperty_soft_max = {
	...
	-1, "soft_max", 2, 0, 0, 0, "Soft Maximum",
	"Maximum value used by buttons",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
StringPropertyRNA rna_StringProperty_default = {
	...
	-1, "default", 262144, 0, 0, 0, "Default",
...
IntPropertyRNA rna_StringProperty_length_max = {
	...
	-1, "length_max", 2, 0, 0, 0, "Maximum Length",
...
EnumPropertyRNA rna_EnumProperty_default_flag = {
	...
	-1, "default_flag", 2097154, 0, 0, 0, "Default",
	"Default value for this enum",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
CollectionPropertyRNA rna_EnumProperty_enum_items_static = {
	...
	-1, "enum_items_static", 0, 0, 8, 0, "Static Items",
...
static const EnumPropertyItem rna_EnumPropertyItem_icon_items[572] = {
	{0, "NONE", 0, "NONE", ""},
	{1, "QUESTION", 0, "QUESTION", ""},
	{2, "ERROR", 0, "ERROR", ""},
	{3, "CANCEL", 0, "CANCEL", ""},
...
EnumPropertyRNA rna_EnumPropertyItem_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	EnumPropertyItem_icon_get, NULL, NULL, NULL, NULL, NULL, rna_EnumPropertyItem_icon_items, 571, 0
};
...
PointerPropertyRNA rna_PointerProperty_fixed_type = {
	{NULL, NULL,
	-1, "fixed_type", 8388608, 0, 0, 0, "Pointer Type",
...
CollectionPropertyRNA rna_Function_parameters = {
	...
	-1, "parameters", 0, 0, 0, 0, "Parameters",
...
BoolPropertyRNA rna_Function_use_self_type = {
	...
	-1, "use_self_type", 2, 0, 0, 0, "Use Self Type",
