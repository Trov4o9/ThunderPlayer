...
extern BoolPropertyRNA rna_KeyConfigurations_find_item_from_operator_is_hotkey;
...
struct PointerRNA KeyConfigurations_find_item_from_operator(struct wmWindowManager *_self, bContext *C, const char * idname, int context, struct PointerRNA *properties, bool is_hotkey, struct PointerRNA *item)
{
	return rna_KeyConfig_find_item_from_operator(_self, C, idname, context, properties, is_hotkey, item);
}
...
void KeyConfigurations_find_item_from_operator_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	_data += 24;
	is_hotkey = *((bool *)_data);
	_data += 1;
	item = ((struct PointerRNA *)_data);
	_data += 24;
	_retdata = _data;
	
	keymap = rna_KeyConfig_find_item_from_operator(_self, C, idname, context, properties, is_hotkey, item);
	*((struct PointerRNA *)_retdata) = keymap;
}
...
struct PointerRNA rna_KeyConfig_find_item_from_operator(struct wmWindowManager *_self, bContext *C, const char * idname, int context, struct PointerRNA *properties, bool is_hotkey, struct PointerRNA *item);
void rna_KeyConfig_update(struct wmWindowManager *_self);


struct wmKeyMap *KeyMaps_new(struct wmKeyConfig *_self, const char * name, int space_type, int region_type, bool modal)
{
...
struct wmKeyMap *rna_keymap_new(struct wmKeyConfig *_self, const char * name, int space_type, int region_type, bool modal);
...
BoolPropertyRNA rna_Operator_has_reports = {
	...
	-1, "has_reports", 2, 0, 0, 0, "Has Reports",
...
PointerPropertyRNA rna_Operator_options = {
	...
	-1, "options", 8650752, 0, 0, 0, "Options",
	"Runtime options",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
StringPropertyRNA rna_Operator_bl_label = {
	...
	-1, "bl_label", 262161, 0, 0, 0, "bl_label",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
StringPropertyRNA rna_Operator_bl_translation_context = {
	...
	-1, "bl_translation_context", 49, 0, 0, 0, "bl_translation_context",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
StringPropertyRNA rna_Operator_bl_description = {
	...
	-1, "bl_description", 49, 0, 0, 0, "bl_description",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
StringPropertyRNA rna_Operator_bl_undo_group = {
	...
	-1, "bl_undo_group", 49, 0, 0, 0, "bl_undo_group",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
static const EnumPropertyItem rna_Operator_bl_options_items[9] = {
...
EnumPropertyRNA rna_Operator_bl_options = {
	...
	-1, "bl_options", 2097203, 0, 0, 0, "Options",
	"Options for this operator type",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Operator_bl_options_get, Operator_bl_options_set, NULL, NULL, NULL, NULL, rna_Operator_bl_options_items, 8, 1
};

CollectionPropertyRNA rna_Operator_macros = {
	{NULL, (PropertyRNA *)&rna_Operator_bl_options,
	-1, "macros", 0, 0, 0, 0, "Macros",
	"",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
StringPropertyRNA rna_Operator_report_message = {
	...
	-1, "message", 262145, 1, 0, 0, "Report Message",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_OperatorOptions_is_grab_cursor = {
	...
	-1, "is_grab_cursor", 2, 0, 0, 0, "Grab Cursor",
...
BoolPropertyRNA rna_OperatorOptions_use_cursor_region = {
	...
	-1, "use_cursor_region", 3, 0, 0, 0, "Focus Region",
...
static const EnumPropertyItem rna_Macro_bl_options_items[9] = {
	{1, "REGISTER", 0, "Register", "Display in the info window and support the redo toolbar panel"},
	{2, "UNDO", 0, "Undo", "Push an undo event (needed for operator redo)"},
	{256, "UNDO_GROUPED", 0, "Grouped Undo", "Push a single undo event for repetead instances of this operator"},
	{4, "BLOCKING", 0, "Blocking", "Block anything else from using the cursor"},
...
EnumPropertyRNA rna_Macro_bl_options = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Macro_bl_options_get, Macro_bl_options_set, NULL, NULL, NULL, NULL, rna_Macro_bl_options_items, 8, 1
};
...
StringPropertyRNA rna_Event_unicode = {
	...
	-1, "unicode", 262144, 0, 0, 0, "Unicode",
...
static const EnumPropertyItem rna_Event_type_items[203] = {
	{0, "NONE", 0, "", ""},
...
EnumPropertyRNA rna_Event_type = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Event_type_get, NULL, NULL, NULL, NULL, NULL, rna_Event_type_items, 202, 0
};

IntPropertyRNA rna_Event_mouse_x = {
	{(PropertyRNA *)&rna_Event_mouse_y, (PropertyRNA *)&rna_Event_type,
	-1, "mouse_x", 2, 0, 0, 0, "Mouse X Position",
...
IntPropertyRNA rna_Event_mouse_y = {
	...
	-1, "mouse_y", 2, 0, 0, 0, "Mouse Y Position",
...
IntPropertyRNA rna_Event_mouse_region_x = {
	...
	-1, "mouse_region_x", 2, 0, 0, 0, "Mouse X Position",
...
IntPropertyRNA rna_Event_mouse_region_y = {
	...
	-1, "mouse_region_y", 2, 0, 0, 0, "Mouse Y Position",
...
IntPropertyRNA rna_Event_mouse_prev_x = {
	...
	-1, "mouse_prev_x", 2, 0, 0, 0, "Mouse Previous X Position",
	"The window relative horizontal location of the mouse",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_Event_mouse_prev_y = {
	...
	-1, "mouse_prev_y", 2, 0, 0, 0, "Mouse Previous Y Position",
	"The window relative vertical location of the mouse",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
FloatPropertyRNA rna_Event_pressure = {
	...
	-1, "pressure", 2, 0, 0, 0, "Tablet Pressure",
...
BoolPropertyRNA rna_Event_is_mouse_absolute = {
	...
	-1, "is_mouse_absolute", 2, 0, 0, 0, "Absolute Motion",
...
PointerPropertyRNA rna_Window_screen = {
	...
	-1, "screen", 12845121, 0, 0, 0, "Screen",
...
PointerPropertyRNA rna_Window_stereo_3d_display = {
	...
	-1, "stereo_3d_display", 8650752, 0, 0, 0, "Stereo 3D Display",
...
EnumPropertyRNA rna_Stereo3dDisplay_anaglyph_type = {
	...
	-1, "anaglyph_type", 3, 0, 0, 0, "Anaglyph Type",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
EnumPropertyRNA rna_Stereo3dDisplay_interlace_type = {
	...
	-1, "interlace_type", 3, 0, 0, 0, "Interlace Type",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_Stereo3dDisplay_use_interlace_swap = {
	...
	-1, "use_interlace_swap", 3, 0, 0, 0, "Swap Left/Right",
...
BoolPropertyRNA rna_Stereo3dDisplay_use_sidebyside_crosseyed = {
	...
	-1, "use_sidebyside_crosseyed", 3, 0, 0, 0, "Cross-Eyed",
...
CollectionPropertyRNA rna_WindowManager_keyconfigs = {
	...
	-1, "keyconfigs", 0, 0, 0, 0, "Key Configurations",
...
StringPropertyRNA rna_WindowManager_clipboard = {
	...
	-1, "clipboard", 262145, 0, 0, 0, "Text Clipboard",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
static const EnumPropertyItem rna_WindowManager_popmenu_begin__internal_icon_items[572] = {
	{0, "NONE", 0, "NONE", ""},
	...
	{836, "SMALL_TRI_RIGHT_VEC", 0, "SMALL_TRI_RIGHT_VEC", ""},
	{837, "KEYTYPE_KEYFRAME_VEC", 0, "KEYTYPE_KEYFRAME_VEC", ""},
	{838, "KEYTYPE_BREAKDOWN_VEC", 0, "KEYTYPE_BREAKDOWN_VEC", ""},
	{839, "KEYTYPE_EXTREME_VEC", 0, "KEYTYPE_EXTREME_VEC", ""},
	{840, "KEYTYPE_JITTER_VEC", 0, "KEYTYPE_JITTER_VEC", ""},
	{841, "KEYTYPE_MOVING_HOLD_VEC", 0, "KEYTYPE_MOVING_HOLD_VEC", ""},
	{842, "COLORSET_01_VEC", 0, "COLORSET_01_VEC", ""},
	{843, "COLORSET_02_VEC", 0, "COLORSET_02_VEC", ""},
	{844, "COLORSET_03_VEC", 0, "COLORSET_03_VEC", ""},
	{845, "COLORSET_04_VEC", 0, "COLORSET_04_VEC", ""},
	{846, "COLORSET_05_VEC", 0, "COLORSET_05_VEC", ""},
	{847, "COLORSET_06_VEC", 0, "COLORSET_06_VEC", ""},
	{848, "COLORSET_07_VEC", 0, "COLORSET_07_VEC", ""},
	{849, "COLORSET_08_VEC", 0, "COLORSET_08_VEC", ""},
	{850, "COLORSET_09_VEC", 0, "COLORSET_09_VEC", ""},
	{851, "COLORSET_10_VEC", 0, "COLORSET_10_VEC", ""},
	{852, "COLORSET_11_VEC", 0, "COLORSET_11_VEC", ""},
	{853, "COLORSET_12_VEC", 0, "COLORSET_12_VEC", ""},
	{854, "COLORSET_13_VEC", 0, "COLORSET_13_VEC", ""},
	{855, "COLORSET_14_VEC", 0, "COLORSET_14_VEC", ""},
	{856, "COLORSET_15_VEC", 0, "COLORSET_15_VEC", ""},
	{857, "COLORSET_16_VEC", 0, "COLORSET_16_VEC", ""},
	{858, "COLORSET_17_VEC", 0, "COLORSET_17_VEC", ""},
	{859, "COLORSET_18_VEC", 0, "COLORSET_18_VEC", ""},
	{860, "COLORSET_19_VEC", 0, "COLORSET_19_VEC", ""},
	{861, "COLORSET_20_VEC", 0, "COLORSET_20_VEC", ""},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_WindowManager_popmenu_begin__internal_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_WindowManager_popmenu_begin__internal_icon_items, 571, 0
};
...
FunctionRNA rna_WindowManager_popmenu_end__internal_func = {
	{(FunctionRNA *)&rna_WindowManager_piemenu_begin__internal_func, (FunctionRNA *)&rna_WindowManager_popmenu_begin__internal_func,
	NULL,
...
static const EnumPropertyItem rna_WindowManager_piemenu_begin__internal_icon_items[572] = {
	{0, "NONE", 0, "NONE", ""},
	{1, "QUESTION", 0, "QUESTION", ""},
	{2, "ERROR", 0, "ERROR", ""},
	{3, "CANCEL", 0, "CANCEL", ""},
...
EnumPropertyRNA rna_WindowManager_piemenu_begin__internal_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_WindowManager_piemenu_begin__internal_icon_items, 571, 0
};
...
FunctionRNA rna_WindowManager_piemenu_begin__internal_func = {
	{(FunctionRNA *)&rna_WindowManager_piemenu_end__internal_func, (FunctionRNA *)&rna_WindowManager_popmenu_end__internal_func,
	NULL,
...
PointerPropertyRNA rna_KeyConfigurations_active = {
	...
	-1, "active", 8388609, 0, 0, 0, "Active KeyConfig",
...
PointerPropertyRNA rna_KeyConfigurations_default = {
	...
	-1, "default", 8388608, 0, 0, 0, "Default Key Configuration",
...
PointerPropertyRNA rna_KeyConfigurations_addon = {
	...
	-1, "addon", 8388608, 0, 0, 0, "Add-on Key Configuration",
...
PointerPropertyRNA rna_KeyConfigurations_user = {
	...
	-1, "user", 8388608, 0, 0, 0, "User Key Configuration",
...
PointerPropertyRNA rna_KeyConfigurations_new_keyconfig = {
	...
	-1, "keyconfig", 8388608, 2, 0, 0, "Key Configuration",
...
PointerPropertyRNA rna_KeyConfigurations_remove_keyconfig = {
	{NULL, NULL,
	-1, "keyconfig", 262144, 5, 0, 0, "Key Configuration",
...
StringPropertyRNA rna_KeyConfigurations_find_item_from_operator_idname = {
	...
	-1, "idname", 262145, 1, 0, 0, "Operator Identifier",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_KeyConfigurations_find_item_from_operator_properties = {
	{(PropertyRNA *)&rna_KeyConfigurations_find_item_from_operator_is_hotkey, (PropertyRNA *)&rna_KeyConfigurations_find_item_from_operator_context,
	-1, "properties", 8388608, 4, 0, 0, "",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_KeyConfigurations_find_item_from_operator_is_hotkey = {
	{(PropertyRNA *)&rna_KeyConfigurations_find_item_from_operator_item, (PropertyRNA *)&rna_KeyConfigurations_find_item_from_operator_properties,
	-1, "is_hotkey", 3, 0, 0, 0, "Hotkey",
	"Event is not a modifier",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
...
PointerPropertyRNA rna_KeyConfigurations_find_item_from_operator_item = {
	{(PropertyRNA *)&rna_KeyConfigurations_find_item_from_operator_keymap, (PropertyRNA *)&rna_KeyConfigurations_find_item_from_operator_is_hotkey,
	-1, "item", 8388608, 4, 0, 0, "",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_KeyConfigurations_find_item_from_operator_keymap = {
	{NULL, (PropertyRNA *)&rna_KeyConfigurations_find_item_from_operator_item,
	-1, "keymap", 8388608, 6, 0, 0, "",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
FunctionRNA rna_KeyConfigurations_find_item_from_operator_func = {
	...
	NULL,
	{(PropertyRNA *)&rna_KeyConfigurations_find_item_from_operator_idname, (PropertyRNA *)&rna_KeyConfigurations_find_item_from_operator_keymap}},
	"find_item_from_operator", 8, "find_item_from_operator",
	KeyConfigurations_find_item_from_operator_call,
	(PropertyRNA *)&rna_KeyConfigurations_find_item_from_operator_keymap
};
...
BoolPropertyRNA rna_KeyConfig_is_user_defined = {
	...
	-1, "is_user_defined", 2, 0, 0, 0, "User Defined",
...
EnumPropertyRNA rna_KeyMaps_new_space_type = {
	...
	-1, "space_type", 3, 0, 0, 0, "Space Type",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
static const EnumPropertyItem rna_KeyMaps_new_region_type_items[9] = {
	{0, "WINDOW", 0, "Window", ""},
	{1, "HEADER", 0, "Header", ""},
...
EnumPropertyRNA rna_KeyMaps_new_region_type = {
	...
	-1, "region_type", 3, 0, 0, 0, "Region Type",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_KeyMaps_new_keymap = {
	...
	-1, "keymap", 8388608, 2, 0, 0, "Key Map",
	"Added key map",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
static const EnumPropertyItem rna_KeyMaps_find_region_type_items[9] = {
	{0, "WINDOW", 0, "Window", ""},
	{1, "HEADER", 0, "Header", ""},
	{2, "CHANNELS", 0, "Channels", ""},
	{3, "TEMPORARY", 0, "Temporary", ""},
...
StringPropertyRNA rna_KeyMaps_find_modal_name = {
	...
	-1, "name", 262145, 1, 0, 0, "Operator Name",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
EnumPropertyRNA rna_KeyMap_space_type = {
	...
	-1, "space_type", 2, 0, 0, 0, "Space Type",
...
static const EnumPropertyItem rna_KeyMap_region_type_items[9] = {
	{0, "WINDOW", 0, "Window", ""},
	{1, "HEADER", 0, "Header", ""},
	{2, "CHANNELS", 0, "Channels", ""},
	{3, "TEMPORARY", 0, "Temporary", ""},
...
EnumPropertyRNA rna_KeyMap_region_type = {
	...
	-1, "region_type", 2, 0, 0, 0, "Region Type",
...
BoolPropertyRNA rna_KeyMap_is_user_modified = {
	...
	-1, "is_user_modified", 3, 0, 0, 0, "User Defined",
...
BoolPropertyRNA rna_KeyMap_is_modal = {
	...
	-1, "is_modal", 2, 0, 0, 0, "Modal Keymap",
...
BoolPropertyRNA rna_KeyMap_show_expanded_items = {
	...
	-1, "show_expanded_items", 4099, 0, 0, 0, "Items Expanded",
...
BoolPropertyRNA rna_KeyMap_show_expanded_children = {
	...
	-1, "show_expanded_children", 4099, 0, 0, 0, "Children Expanded",
...
static const EnumPropertyItem rna_KeyMapItems_new_type_items[203] = {
	{0, "NONE", 0, "", ""},
	{1, "LEFTMOUSE", 0, "Left Mouse", "LMB"},
	{2, "MIDDLEMOUSE", 0, "Middle Mouse", "MMB"},
	{3, "RIGHTMOUSE", 0, "Right Mouse", "RMB"},
...
EnumPropertyRNA rna_KeyMapItems_new_type = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_KeyMapItems_new_type_items, 202, 0
};
...
static const EnumPropertyItem rna_KeyMapItems_new_key_modifier_items[203] = {
	{0, "NONE", 0, "", ""},
	{1, "LEFTMOUSE", 0, "Left Mouse", "LMB"},
	{2, "MIDDLEMOUSE", 0, "Middle Mouse", "MMB"},
	{3, "RIGHTMOUSE", 0, "Right Mouse", "RMB"},
...
EnumPropertyRNA rna_KeyMapItems_new_key_modifier = {
	...
	-1, "key_modifier", 3, 0, 0, 0, "Key Modifier",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_KeyMapItems_new_key_modifier_items, 202, 0
};
...
StringPropertyRNA rna_KeyMapItems_new_modal_propvalue = {
	...
	-1, "propvalue", 262145, 1, 0, 0, "Property Value",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
static const EnumPropertyItem rna_KeyMapItems_new_modal_type_items[203] = {
	{0, "NONE", 0, "", ""},
	{1, "LEFTMOUSE", 0, "Left Mouse", "LMB"},
	{2, "MIDDLEMOUSE", 0, "Middle Mouse", "MMB"},
	{3, "RIGHTMOUSE", 0, "Right Mouse", "RMB"},
...
EnumPropertyRNA rna_KeyMapItems_new_modal_type = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_KeyMapItems_new_modal_type_items, 202, 0
};
...
static const EnumPropertyItem rna_KeyMapItems_new_modal_key_modifier_items[203] = {
	{0, "NONE", 0, "", ""},
	{1, "LEFTMOUSE", 0, "Left Mouse", "LMB"},
	{2, "MIDDLEMOUSE", 0, "Middle Mouse", "MMB"},
	{3, "RIGHTMOUSE", 0, "Right Mouse", "RMB"},
...
EnumPropertyRNA rna_KeyMapItems_new_modal_key_modifier = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_KeyMapItems_new_modal_key_modifier_items, 202, 0
};
...
StringPropertyRNA rna_KeyMapItem_idname = {
	...
	-1, "idname", 262145, 0, 0, 0, "Identifier",
...
PointerPropertyRNA rna_KeyMapItem_properties = {
	...
	-1, "properties", 8388608, 0, 0, 0, "Properties",
...
static const EnumPropertyItem rna_KeyMapItem_type_items[203] = {
	{0, "NONE", 0, "", ""},
	{1, "LEFTMOUSE", 0, "Left Mouse", "LMB"},
	{2, "MIDDLEMOUSE", 0, "Middle Mouse", "MMB"},
	{3, "RIGHTMOUSE", 0, "Right Mouse", "RMB"},
...
EnumPropertyRNA rna_KeyMapItem_type = {
	...
	rna_KeyMapItem_update, 0, NULL, NULL,
	0, -1, NULL},
	KeyMapItem_type_get, KeyMapItem_type_set, rna_KeyMapItem_type_itemf, NULL, NULL, NULL, rna_KeyMapItem_type_items, 202, 0
};
...
static const EnumPropertyItem rna_KeyMapItem_key_modifier_items[203] = {
	{0, "NONE", 0, "", ""},
	{1, "LEFTMOUSE", 0, "Left Mouse", "LMB"},
	{2, "MIDDLEMOUSE", 0, "Middle Mouse", "MMB"},
	{3, "RIGHTMOUSE", 0, "Right Mouse", "RMB"},
...
EnumPropertyRNA rna_KeyMapItem_key_modifier = {
	...
	rna_KeyMapItem_update, 0, NULL, NULL,
	0, -1, NULL},
	KeyMapItem_key_modifier_get, KeyMapItem_key_modifier_set, NULL, NULL, NULL, NULL, rna_KeyMapItem_key_modifier_items, 202, 0
};
...
EnumPropertyRNA rna_KeyMapItem_propvalue = {
	...
	-1, "propvalue", 3, 0, 0, 0, "Property Value",
...
BoolPropertyRNA rna_KeyMapItem_is_user_modified = {
	...
	-1, "is_user_modified", 2, 0, 0, 0, "User Modified",
...
BoolPropertyRNA rna_KeyMapItem_compare_result = {
	...
	-1, "result", 3, 2, 0, 0, "Comparison result",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
