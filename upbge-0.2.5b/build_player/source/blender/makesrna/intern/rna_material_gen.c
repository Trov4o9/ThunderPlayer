...
BoolPropertyRNA rna_Material_use_constant_material;
BoolPropertyRNA rna_Material_use_constant_lamp;
BoolPropertyRNA rna_Material_use_constant_texture;
BoolPropertyRNA rna_Material_use_constant_texture_uv;
BoolPropertyRNA rna_Material_use_constant_world;
BoolPropertyRNA rna_Material_use_constant_mist;
BoolPropertyRNA rna_Material_use_transparency;
EnumPropertyRNA rna_Material_transparency_method;
BoolPropertyRNA rna_Material_use_depth_transparency;
FloatPropertyRNA rna_Material_depth_transp_factor;
...
BoolPropertyRNA rna_Material_use_energy_conservation;
BoolPropertyRNA rna_Material_use_object_color;
BoolPropertyRNA rna_Material_use_instancing;
...
FloatPropertyRNA rna_Material_diffuse_roughness_bsdf;
FloatPropertyRNA rna_Material_diffuse_metallic_bsdf;
...
FloatPropertyRNA rna_Material_specular_roughness_bsdf;
FloatPropertyRNA rna_Material_specular_metallic_bsdf;
...
extern FloatPropertyRNA rna_TextureSlot_rotation;
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_parallax;
BoolPropertyRNA rna_MaterialTextureSlot_use_parallax_uv;
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_roughness;
BoolPropertyRNA rna_MaterialTextureSlot_use_map_metallic;
...
FloatPropertyRNA rna_MaterialTextureSlot_parallax_steps;
FloatPropertyRNA rna_MaterialTextureSlot_parallax_bump_scale;
BoolPropertyRNA rna_MaterialTextureSlot_parallax_uv_discard;
EnumPropertyRNA rna_MaterialTextureSlot_parallax_component;
FloatPropertyRNA rna_MaterialTextureSlot_lod_bias;
...
FloatPropertyRNA rna_MaterialTextureSlot_roughness_factor;
FloatPropertyRNA rna_MaterialTextureSlot_metallic_factor;
...
FloatPropertyRNA rna_MaterialTextureSlot_ior;
FloatPropertyRNA rna_MaterialTextureSlot_refraction_ratio;
...
bool Material_use_constant_material_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->constflag) & 1) != 0);
}

void Material_use_constant_material_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
	if (value) data->constflag |= 1;
	else data->constflag &= ~1;
}

bool Material_use_constant_lamp_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->constflag) & 2) != 0);
}

void Material_use_constant_lamp_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
	if (value) data->constflag |= 2;
	else data->constflag &= ~2;
}

bool Material_use_constant_texture_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->constflag) & 4) != 0);
}

void Material_use_constant_texture_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
	if (value) data->constflag |= 4;
	else data->constflag &= ~4;
}

bool Material_use_constant_texture_uv_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->constflag) & 32) != 0);
}

void Material_use_constant_texture_uv_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
	if (value) data->constflag |= 32;
	else data->constflag &= ~32;
}

bool Material_use_constant_world_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->constflag) & 8) != 0);
}

void Material_use_constant_world_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
	if (value) data->constflag |= 8;
	else data->constflag &= ~8;
}

bool Material_use_constant_mist_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->constflag) & 16) != 0);
}

void Material_use_constant_mist_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
	if (value) data->constflag |= 16;
	else data->constflag &= ~16;
}

bool Material_use_transparency_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 65536) != 0);
}

void Material_use_transparency_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_depth_transparency_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode2) & 4) != 0);
}

void Material_use_depth_transparency_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
	if (value) data->mode2 |= 4;
	else data->mode2 &= ~4;
}

float Material_depth_transp_factor_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (float)(data->depthtranspfactor);
}

void Material_depth_transp_factor_set(PointerRNA *ptr, float value)
{
	Material *data = (Material *)(ptr->data);
	data->depthtranspfactor = CLAMPIS(value, 0.0010000000f, FLT_MAX);
}
...
bool Material_use_cubic_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->shade_flag) & 1) != 0);
}

void Material_use_cubic_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_energy_conservation_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->shade_flag) & 32) != 0);
}

void Material_use_energy_conservation_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
	if (value) data->shade_flag |= 32;
	else data->shade_flag &= ~32;
}

bool Material_use_object_color_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->shade_flag) & 2) != 0);
}

void Material_use_object_color_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_instancing_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->shade_flag) & 16) != 0);
}

void Material_use_instancing_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
	if (value) data->shade_flag |= 16;
	else data->shade_flag &= ~16;
}
...
bool Material_use_light_group_exclusive_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 268435456) != 0);
}

void Material_use_light_group_exclusive_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_light_group_local_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->shade_flag) & 8) != 0);
}

void Material_use_light_group_local_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_raytrace_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 1) != 0);
}

void Material_use_raytrace_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_shadows_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 2) != 0);
}

void Material_use_shadows_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_shadeless_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 4) != 0);
}

void Material_use_shadeless_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_vertex_color_light_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 16) != 0);
}

void Material_use_vertex_color_light_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_vertex_color_paint_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 128) != 0);
}

void Material_use_vertex_color_paint_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_invert_z_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 256) != 0);
}

void Material_invert_z_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_sky_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 512) != 0);
}

void Material_use_sky_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_only_shadow_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 1024) != 0);
}

void Material_use_only_shadow_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_face_texture_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 2048) != 0);
}

void Material_use_face_texture_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_face_texture_alpha_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 536870912) != 0);
}

void Material_use_face_texture_alpha_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_cast_shadows_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode2) & 1) != 0);
}

void Material_use_cast_shadows_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_cast_shadows_only_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 8192) != 0);
}

void Material_use_cast_shadows_only_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_mist_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return !(((data->mode) & 16384) != 0);
}

void Material_use_mist_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_transparent_shadows_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 524288) != 0);
}

void Material_use_transparent_shadows_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_ray_shadow_bias_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 4194304) != 0);
}

void Material_use_ray_shadow_bias_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_full_oversampling_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 8388608) != 0);
}

void Material_use_full_oversampling_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_cast_buffer_shadows_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 33554432) != 0);
}

void Material_use_cast_buffer_shadows_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_cast_approximate_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->shade_flag) & 4) != 0);
}

void Material_use_cast_approximate_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_tangent_shading_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 67108864) != 0);
}

void Material_use_tangent_shading_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool Material_use_uv_project_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mapflag) & 1) != 0);
}

void Material_use_uv_project_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
void Material_use_textures_get(PointerRNA *ptr, bool values[18])
{
	Material *data = (Material *)(ptr->data);
	unsigned int i;
...
void Material_use_textures_set(PointerRNA *ptr, const bool values[18])
{
	Material *data = (Material *)(ptr->data);
	unsigned int i;
...
bool Material_use_diffuse_ramp_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 1048576) != 0);
}

void Material_use_diffuse_ramp_set(PointerRNA *ptr, bool value)
{
...
bool Material_use_specular_ramp_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 2097152) != 0);
}

void Material_use_specular_ramp_set(PointerRNA *ptr, bool value)
{
...
float Material_diffuse_roughness_bsdf_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (float)(data->roughness_bsdf);
}

void Material_diffuse_roughness_bsdf_set(PointerRNA *ptr, float value)
{
	Material *data = (Material *)(ptr->data);
	data->roughness_bsdf = CLAMPIS(value, 0.0f, 1.0f);
}

float Material_diffuse_metallic_bsdf_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (float)(data->metallic_bsdf);
}

void Material_diffuse_metallic_bsdf_set(PointerRNA *ptr, float value)
{
	Material *data = (Material *)(ptr->data);
	data->metallic_bsdf = CLAMPIS(value, 0.0f, 1.0f);
}
...
float Material_specular_roughness_bsdf_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (float)(data->roughness_bsdf);
}

void Material_specular_roughness_bsdf_set(PointerRNA *ptr, float value)
{
	Material *data = (Material *)(ptr->data);
	data->roughness_bsdf = CLAMPIS(value, 0.0f, 1.0f);
}

float Material_specular_metallic_bsdf_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (float)(data->metallic_bsdf);
}

void Material_specular_metallic_bsdf_set(PointerRNA *ptr, float value)
{
	Material *data = (Material *)(ptr->data);
	data->metallic_bsdf = CLAMPIS(value, 0.0f, 1.0f);
}
...
bool MaterialRaytraceMirror_use_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 262144) != 0);
}

void MaterialRaytraceMirror_use_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool MaterialVolume_use_external_shadows_get(PointerRNA *ptr)
{
	VolumeSettings *data = (VolumeSettings *)(ptr->data);
	return (((data->shadeflag) & 1) != 0);
}

void MaterialVolume_use_external_shadows_set(PointerRNA *ptr, bool value)
{
	VolumeSettings *data = (VolumeSettings *)(ptr->data);
...
bool MaterialVolume_use_light_cache_get(PointerRNA *ptr)
{
	VolumeSettings *data = (VolumeSettings *)(ptr->data);
	return (((data->shadeflag) & 8) != 0);
}

void MaterialVolume_use_light_cache_set(PointerRNA *ptr, bool value)
{
	VolumeSettings *data = (VolumeSettings *)(ptr->data);
...
bool MaterialHalo_use_flare_mode_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 32768) != 0);
}

void MaterialHalo_use_flare_mode_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool MaterialHalo_use_ring_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 256) != 0);
}

void MaterialHalo_use_ring_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
	if (value) data->mode |= 256;
	else data->mode &= ~256;
...
bool MaterialHalo_use_lines_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 512) != 0);
}

void MaterialHalo_use_lines_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
	if (value) data->mode |= 512;
	else data->mode &= ~512;
...
bool MaterialHalo_use_star_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 2048) != 0);
}

void MaterialHalo_use_star_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
	if (value) data->mode |= 2048;
	else data->mode &= ~2048;
...
bool MaterialHalo_use_texture_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 4096) != 0);
}

void MaterialHalo_use_texture_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool MaterialHalo_use_vertex_normal_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 8192) != 0);
}

void MaterialHalo_use_vertex_normal_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
	if (value) data->mode |= 8192;
	else data->mode &= ~8192;
...
bool MaterialHalo_use_extreme_alpha_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 1024) != 0);
}

void MaterialHalo_use_extreme_alpha_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
	if (value) data->mode |= 1024;
	else data->mode &= ~1024;
...
bool MaterialHalo_use_shaded_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 16384) != 0);
}

void MaterialHalo_use_shaded_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
	if (value) data->mode |= 16384;
	else data->mode &= ~16384;
...
bool MaterialHalo_use_soft_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 16) != 0);
}

void MaterialHalo_use_soft_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
	if (value) data->mode |= 16;
	else data->mode &= ~16;
...
bool MaterialSubsurfaceScattering_use_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->sss_flag) & 1) != 0);
}

void MaterialSubsurfaceScattering_use_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool MaterialTextureSlot_use_from_dupli_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->texflag) & 32) != 0);
}

void MaterialTextureSlot_use_from_dupli_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_map_to_bounds_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->texflag) & 16384) != 0);
}

void MaterialTextureSlot_use_map_to_bounds_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_from_original_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->texflag) & 64) != 0);
}

void MaterialTextureSlot_use_from_original_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_map_color_diffuse_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 1) != 0);
}

void MaterialTextureSlot_use_map_color_diffuse_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_map_normal_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 2) != 0);
}

void MaterialTextureSlot_use_map_normal_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_map_parallax_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 32768) != 0);
}

void MaterialTextureSlot_use_map_parallax_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
	if (value) data->mapto |= 32768;
	else data->mapto &= ~32768;
}

bool MaterialTextureSlot_use_parallax_uv_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->texflag) & 32768) != 0);
}

void MaterialTextureSlot_use_parallax_uv_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
	if (value) data->texflag |= 32768;
	else data->texflag &= ~32768;
}

bool MaterialTextureSlot_use_map_color_spec_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 4) != 0);
}

void MaterialTextureSlot_use_map_color_spec_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_map_mirror_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 8) != 0);
}

void MaterialTextureSlot_use_map_mirror_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_map_diffuse_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 16) != 0);
}

void MaterialTextureSlot_use_map_diffuse_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_map_specular_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 32) != 0);
}

void MaterialTextureSlot_use_map_specular_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_map_ambient_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 2048) != 0);
}

void MaterialTextureSlot_use_map_ambient_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_map_hardness_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 256) != 0);
}

void MaterialTextureSlot_use_map_hardness_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_map_raymir_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 512) != 0);
}

void MaterialTextureSlot_use_map_raymir_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_map_alpha_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 128) != 0);
}

void MaterialTextureSlot_use_map_alpha_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_map_emit_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 64) != 0);
}

void MaterialTextureSlot_use_map_emit_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_map_translucency_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 1024) != 0);
}

void MaterialTextureSlot_use_map_translucency_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_map_displacement_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 4096) != 0);
}

void MaterialTextureSlot_use_map_displacement_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_map_warp_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 8192) != 0);
}

void MaterialTextureSlot_use_map_warp_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool MaterialTextureSlot_use_map_roughness_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 16384) != 0);
}

void MaterialTextureSlot_use_map_roughness_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
	if (value) data->mapto |= 16384;
	else data->mapto &= ~16384;
}

bool MaterialTextureSlot_use_map_metallic_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 65536) != 0);
}

void MaterialTextureSlot_use_map_metallic_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
	if (value) data->mapto |= 65536;
	else data->mapto &= ~65536;
}
...
float MaterialTextureSlot_parallax_steps_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (float)(data->parallaxsteps);
}

void MaterialTextureSlot_parallax_steps_set(PointerRNA *ptr, float value)
{
	MTex *data = (MTex *)(ptr->data);
	data->parallaxsteps = value;
}

float MaterialTextureSlot_parallax_bump_scale_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (float)(data->parallaxbumpsc);
}

void MaterialTextureSlot_parallax_bump_scale_set(PointerRNA *ptr, float value)
{
	MTex *data = (MTex *)(ptr->data);
	data->parallaxbumpsc = value;
}

bool MaterialTextureSlot_parallax_uv_discard_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->parflag) & 1) != 0);
}

void MaterialTextureSlot_parallax_uv_discard_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
	if (value) data->parflag |= 1;
	else data->parflag &= ~1;
}

int MaterialTextureSlot_parallax_component_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (int)(data->parallaxcomp);
}

void MaterialTextureSlot_parallax_component_set(PointerRNA *ptr, int value)
{
	MTex *data = (MTex *)(ptr->data);
	data->parallaxcomp = value;
}

float MaterialTextureSlot_lod_bias_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (float)(data->lodbias);
}

void MaterialTextureSlot_lod_bias_set(PointerRNA *ptr, float value)
{
	MTex *data = (MTex *)(ptr->data);
	data->lodbias = value;
}
...
float MaterialTextureSlot_roughness_factor_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (float)(data->roughnessfac);
}

void MaterialTextureSlot_roughness_factor_set(PointerRNA *ptr, float value)
{
	MTex *data = (MTex *)(ptr->data);
	data->roughnessfac = CLAMPIS(value, 0.0f, 1.0f);
}

float MaterialTextureSlot_metallic_factor_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (float)(data->metallicfac);
}

void MaterialTextureSlot_metallic_factor_set(PointerRNA *ptr, float value)
{
	MTex *data = (MTex *)(ptr->data);
	data->metallicfac = value;
}
...
bool MaterialTextureSlot_use_map_color_emission_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 1) != 0);
}

void MaterialTextureSlot_use_map_color_emission_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
	if (value) data->mapto |= 1;
	else data->mapto &= ~1;
...
bool MaterialTextureSlot_use_map_color_reflection_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 4) != 0);
}

void MaterialTextureSlot_use_map_color_reflection_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
	if (value) data->mapto |= 4;
	else data->mapto &= ~4;
...
bool MaterialTextureSlot_use_map_color_transmission_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 8) != 0);
}

void MaterialTextureSlot_use_map_color_transmission_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
	if (value) data->mapto |= 8;
	else data->mapto &= ~8;
...
bool MaterialTextureSlot_use_map_density_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 128) != 0);
}

void MaterialTextureSlot_use_map_density_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
	if (value) data->mapto |= 128;
	else data->mapto &= ~128;
...
bool MaterialTextureSlot_use_map_emission_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 64) != 0);
}

void MaterialTextureSlot_use_map_emission_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
	if (value) data->mapto |= 64;
	else data->mapto &= ~64;
...
bool MaterialTextureSlot_use_map_scatter_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 16) != 0);
}

void MaterialTextureSlot_use_map_scatter_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
	if (value) data->mapto |= 16;
	else data->mapto &= ~16;
...
bool MaterialTextureSlot_use_map_reflect_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 32) != 0);
}

void MaterialTextureSlot_use_map_reflect_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
	if (value) data->mapto |= 32;
	else data->mapto &= ~32;
...
float MaterialTextureSlot_ior_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (float)(data->ior);
}

void MaterialTextureSlot_ior_set(PointerRNA *ptr, float value)
{
	MTex *data = (MTex *)(ptr->data);
	data->ior = CLAMPIS(value, 1.0f, 50.0f);
}

float MaterialTextureSlot_refraction_ratio_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (float)(data->refrratio);
}

void MaterialTextureSlot_refraction_ratio_set(PointerRNA *ptr, float value)
{
	MTex *data = (MTex *)(ptr->data);
	data->refrratio = CLAMPIS(value, 0.0f, 1.0f);
}

bool MaterialTextureSlot_use_get(PointerRNA *ptr)
{
	return rna_MaterialTextureSlot_use_get(ptr);
}

void MaterialTextureSlot_use_set(PointerRNA *ptr, bool value)
{
...
bool MaterialStrand_use_tangent_shading_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 16777216) != 0);
}

void MaterialStrand_use_tangent_shading_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool MaterialStrand_use_surface_diffuse_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
...
bool MaterialStrand_use_blender_units_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (((data->mode) & 1073741824) != 0);
}

void MaterialStrand_use_blender_units_set(PointerRNA *ptr, bool value)
{
	Material *data = (Material *)(ptr->data);
...
bool MaterialGameSettings_use_backface_culling_get(PointerRNA *ptr)
{
	GameSettings *data = (GameSettings *)(ptr->data);
	return (((data->flag) & 16) != 0);
}

void MaterialGameSettings_use_backface_culling_set(PointerRNA *ptr, bool value)
{
	GameSettings *data = (GameSettings *)(ptr->data);
...
bool MaterialGameSettings_invisible_get(PointerRNA *ptr)
{
	GameSettings *data = (GameSettings *)(ptr->data);
	return (((data->flag) & 256) != 0);
}

void MaterialGameSettings_invisible_set(PointerRNA *ptr, bool value)
{
	GameSettings *data = (GameSettings *)(ptr->data);
...
bool MaterialGameSettings_physics_get(PointerRNA *ptr)
{
	GameSettings *data = (GameSettings *)(ptr->data);
	return !(((data->flag) & 128) != 0);
}

void MaterialGameSettings_physics_set(PointerRNA *ptr, bool value)
{
	GameSettings *data = (GameSettings *)(ptr->data);
...
/* Material */
static const EnumPropertyItem rna_Material_type_items[5] = {
...
EnumPropertyRNA rna_Material_type = {
	{(PropertyRNA *)&rna_Material_use_constant_material, NULL,
	-1, "type", 3, 0, 0, 0, "Type",
...
BoolPropertyRNA rna_Material_use_constant_material = {
	{(PropertyRNA *)&rna_Material_use_constant_lamp, (PropertyRNA *)&rna_Material_type,
	-1, "use_constant_material", 3, 0, 0, 0, "Material",
	"Use constant values for material",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_draw_update, 0, NULL, NULL,
	0, -1, NULL},
	Material_use_constant_material_get, Material_use_constant_material_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Material_use_constant_lamp = {
	{(PropertyRNA *)&rna_Material_use_constant_texture, (PropertyRNA *)&rna_Material_use_constant_material,
	-1, "use_constant_lamp", 3, 0, 0, 0, "Lamp",
	"Use constant values for lamps",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_draw_update, 0, NULL, NULL,
	0, -1, NULL},
	Material_use_constant_lamp_get, Material_use_constant_lamp_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Material_use_constant_texture = {
	{(PropertyRNA *)&rna_Material_use_constant_texture_uv, (PropertyRNA *)&rna_Material_use_constant_lamp,
	-1, "use_constant_texture", 3, 0, 0, 0, "Texture",
	"Use constant values for textures",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_draw_update, 0, NULL, NULL,
	0, -1, NULL},
	Material_use_constant_texture_get, Material_use_constant_texture_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Material_use_constant_texture_uv = {
	{(PropertyRNA *)&rna_Material_use_constant_world, (PropertyRNA *)&rna_Material_use_constant_texture,
	-1, "use_constant_texture_uv", 3, 0, 0, 0, "Texture Uv",
	"Use constant values for textures uv transformation",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_draw_update, 0, NULL, NULL,
	0, -1, NULL},
	Material_use_constant_texture_uv_get, Material_use_constant_texture_uv_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Material_use_constant_world = {
	{(PropertyRNA *)&rna_Material_use_constant_mist, (PropertyRNA *)&rna_Material_use_constant_texture_uv,
	-1, "use_constant_world", 3, 0, 0, 0, "World",
	"Use constant values for world",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_draw_update, 0, NULL, NULL,
	0, -1, NULL},
	Material_use_constant_world_get, Material_use_constant_world_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Material_use_constant_mist = {
	{(PropertyRNA *)&rna_Material_use_transparency, (PropertyRNA *)&rna_Material_use_constant_world,
	-1, "use_constant_mist", 3, 0, 0, 0, "Mist",
	"Use constant values for mist",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_draw_update, 0, NULL, NULL,
	0, -1, NULL},
	Material_use_constant_mist_get, Material_use_constant_mist_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Material_use_transparency = {
	{(PropertyRNA *)&rna_Material_transparency_method, (PropertyRNA *)&rna_Material_use_constant_mist,
	-1, "use_transparency", 3, 0, 0, 0, "Transparency",
...
static const EnumPropertyItem rna_Material_transparency_method_items[4] = {
...
EnumPropertyRNA rna_Material_transparency_method = {
	{(PropertyRNA *)&rna_Material_use_depth_transparency, (PropertyRNA *)&rna_Material_use_transparency,
	-1, "transparency_method", 3, 0, 0, 0, "Transparency Method",
...
BoolPropertyRNA rna_Material_use_depth_transparency = {
	{(PropertyRNA *)&rna_Material_depth_transp_factor, (PropertyRNA *)&rna_Material_transparency_method,
	-1, "use_depth_transparency", 3, 0, 0, 0, "Depth Transparency",
	"Render material as transparent depending on the depth",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_draw_update, 0, NULL, NULL,
	0, -1, NULL},
	Material_use_depth_transparency_get, Material_use_depth_transparency_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

FloatPropertyRNA rna_Material_depth_transp_factor = {
	{(PropertyRNA *)&rna_Material_preview_render_type, (PropertyRNA *)&rna_Material_use_depth_transparency,
	-1, "depth_transp_factor", 3, 0, 4, 0, "Depth Transparency Factor",
	"Amount of transparency depending on the depth",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, depthtranspfactor), 5, NULL},
	Material_depth_transp_factor_get, Material_depth_transp_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0010000000f, FLT_MAX, 0.0010000000f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
EnumPropertyRNA rna_Material_preview_render_type = {
	{(PropertyRNA *)&rna_Material_ambient, (PropertyRNA *)&rna_Material_depth_transp_factor,
	-1, "preview_render_type", 3, 0, 0, 0, "Preview render type",
...
FloatPropertyRNA rna_Material_translucency = {
	...
	-1, "translucency", 3, 0, 4, 0, "Translucency",
	"Amount of diffuse shading on the back side",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, translucency), 5, NULL},
...
BoolPropertyRNA rna_Material_use_cubic = {
	{(PropertyRNA *)&rna_Material_use_energy_conservation, (PropertyRNA *)&rna_Material_translucency,
	-1, "use_cubic", 3, 0, 0, 0, "Cubic Interpolation",
...
BoolPropertyRNA rna_Material_use_energy_conservation = {
	{(PropertyRNA *)&rna_Material_use_object_color, (PropertyRNA *)&rna_Material_use_cubic,
	-1, "use_energy_conservation", 3, 0, 0, 0, "Energy conservation",
	"Use energy conservation, for real shading behaviour",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	0, -1, NULL},
	Material_use_energy_conservation_get, Material_use_energy_conservation_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Material_use_object_color = {
	{(PropertyRNA *)&rna_Material_use_instancing, (PropertyRNA *)&rna_Material_use_energy_conservation,
	-1, "use_object_color", 3, 0, 0, 0, "Object Color",
...
BoolPropertyRNA rna_Material_use_instancing = {
	{(PropertyRNA *)&rna_Material_shadow_ray_bias, (PropertyRNA *)&rna_Material_use_object_color,
	-1, "use_instancing", 3, 0, 0, 0, "Geometry Instancing",
	"Use special vertex shader for instancing rendering in game engine",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Material_use_instancing_get, Material_use_instancing_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

FloatPropertyRNA rna_Material_shadow_ray_bias = {
	{(PropertyRNA *)&rna_Material_shadow_buffer_bias, (PropertyRNA *)&rna_Material_use_instancing,
	-1, "shadow_ray_bias", 3, 0, 4, 0, "Shadow Ray Bias",
	"Shadow raytracing bias to prevent terminator problems on shadow boundary",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Material, sbias), 5, NULL},
...
FloatPropertyRNA rna_Material_shadow_buffer_bias = {
	...
	-1, "shadow_buffer_bias", 3, 0, 4, 0, "Shadow Buffer Bias",
	"Factor to multiply shadow buffer bias with (0 is ignore)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Material, lbias), 5, NULL},
...
FloatPropertyRNA rna_Material_shadow_cast_alpha = {
	...
	-1, "shadow_cast_alpha", 3, 0, 4, 0, "Shadow Casting Alpha",
	"Shadow casting alpha, in use for Irregular and Deep shadow buffer",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, shad_alpha), 5, NULL},
...
PointerPropertyRNA rna_Material_light_group = {
	...
	-1, "light_group", 8388609, 0, 0, 0, "Light Group",
...
IntPropertyRNA rna_Material_pass_index = {
	...
	-1, "pass_index", 3, 0, 4, 0, "Pass Index",
...
BoolPropertyRNA rna_Material_use_light_group_exclusive = {
	...
	-1, "use_light_group_exclusive", 3, 0, 0, 0, "Light Group Exclusive",
...
BoolPropertyRNA rna_Material_use_light_group_local = {
	...
	-1, "use_light_group_local", 3, 0, 0, 0, "Light Group Local",
...
BoolPropertyRNA rna_Material_use_raytrace = {
	...
	-1, "use_raytrace", 3, 0, 0, 0, "Traceable",
...
BoolPropertyRNA rna_Material_use_shadeless = {
	...
	-1, "use_shadeless", 3, 0, 0, 0, "Shadeless",
...
BoolPropertyRNA rna_Material_use_vertex_color_light = {
	...
	-1, "use_vertex_color_light", 3, 0, 0, 0, "Vertex Color Light",
...
BoolPropertyRNA rna_Material_use_vertex_color_paint = {
	...
	-1, "use_vertex_color_paint", 3, 0, 0, 0, "Vertex Color Paint",
...
BoolPropertyRNA rna_Material_invert_z = {
	...
	-1, "invert_z", 3, 0, 0, 0, "Invert Z Depth",
...
BoolPropertyRNA rna_Material_use_only_shadow = {
	...
	-1, "use_only_shadow", 3, 0, 0, 0, "Only Shadow",
...
static const EnumPropertyItem rna_Material_shadow_only_type_items[4] = {
...
EnumPropertyRNA rna_Material_shadow_only_type = {
	...
	-1, "shadow_only_type", 3, 0, 0, 0, "Shadow Type",
	"How to draw shadows",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_Material_use_face_texture = {
	...
	-1, "use_face_texture", 3, 0, 0, 0, "Face Textures",
...
BoolPropertyRNA rna_Material_use_face_texture_alpha = {
	...
	-1, "use_face_texture_alpha", 3, 0, 0, 0, "Face Textures Alpha",
...
BoolPropertyRNA rna_Material_use_cast_shadows = {
	...
	-1, "use_cast_shadows", 3, 0, 0, 0, "Cast Shadows",
...
BoolPropertyRNA rna_Material_use_cast_shadows_only = {
	...
	-1, "use_cast_shadows_only", 3, 0, 0, 0, "Cast Shadows Only",
...
BoolPropertyRNA rna_Material_use_transparent_shadows = {
	...
	-1, "use_transparent_shadows", 3, 0, 0, 0, "Receive Transparent Shadows",
...
BoolPropertyRNA rna_Material_use_ray_shadow_bias = {
	...
	-1, "use_ray_shadow_bias", 3, 0, 0, 0, "Ray Shadow Bias",
...
BoolPropertyRNA rna_Material_use_full_oversampling = {
	...
	-1, "use_full_oversampling", 3, 0, 0, 0, "Full Oversampling",
...
BoolPropertyRNA rna_Material_use_cast_buffer_shadows = {
	...
	-1, "use_cast_buffer_shadows", 3, 0, 0, 0, "Cast Buffer Shadows",
...
BoolPropertyRNA rna_Material_use_cast_approximate = {
	...
	-1, "use_cast_approximate", 3, 0, 0, 0, "Cast Approximate",
...
BoolPropertyRNA rna_Material_use_tangent_shading = {
	...
	-1, "use_tangent_shading", 3, 0, 0, 0, "Tangent Shading",
...
BoolPropertyRNA rna_Material_use_uv_project = {
	...
	-1, "use_uv_project", 3, 0, 0, 0, "UV Project",
...
PointerPropertyRNA rna_Material_raytrace_mirror = {
	...
	-1, "raytrace_mirror", 8650752, 0, 0, 0, "Raytrace Mirror",
...
PointerPropertyRNA rna_Material_raytrace_transparency = {
	...
	-1, "raytrace_transparency", 8650752, 0, 0, 0, "Raytrace Transparency",
...
PointerPropertyRNA rna_Material_subsurface_scattering = {
	...
	-1, "subsurface_scattering", 8650752, 0, 0, 0, "Subsurface Scattering",
...
PointerPropertyRNA rna_Material_strand = {
	{(PropertyRNA *)&rna_Material_game_settings, (PropertyRNA *)&rna_Material_subsurface_scattering,
	-1, "strand", 8650752, 0, 0, 0, "Strand",
...
PointerPropertyRNA rna_Material_game_settings = {
	{(PropertyRNA *)&rna_Material_node_tree, (PropertyRNA *)&rna_Material_strand,
	-1, "game_settings", 8650752, 0, 0, 0, "Game Settings",
...
BoolPropertyRNA rna_Material_use_nodes = {
	...
	-1, "use_nodes", 4194305, 0, 0, 0, "Use Nodes",
...
PointerPropertyRNA rna_Material_active_node_material = {
	...
	-1, "active_node_material", 8388609, 0, 0, 0, "Material",
...
CollectionPropertyRNA rna_Material_texture_slots = {
	...
	-1, "texture_slots", 0, 0, 0, 0, "Textures",
...
PointerPropertyRNA rna_Material_active_texture = {
	...
	-1, "active_texture", 8388609, 0, 0, 0, "Active Texture",
...
IntPropertyRNA rna_Material_active_texture_index = {
	...
	-1, "active_texture_index", 3, 0, 4, 0, "Active Texture Index",
...
CollectionPropertyRNA rna_Material_texture_paint_images = {
	...
	-1, "texture_paint_images", 0, 0, 0, 0, "Texture Slot Images",
...
CollectionPropertyRNA rna_Material_texture_paint_slots = {
	...
	-1, "texture_paint_slots", 0, 0, 8, 0, "Texture Slots",
	"Texture slots defining the mapping and influence of textures",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_Material_paint_active_slot = {
	...
	-1, "paint_active_slot", 3, 0, 4, 0, "Active Paint Texture Index",
...
IntPropertyRNA rna_Material_paint_clone_slot = {
	...
	-1, "paint_clone_slot", 3, 0, 4, 0, "Clone Paint Texture Index",
...
static bool rna_Material_use_textures_default[18] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_Material_use_textures = {
	...
	-1, "use_textures", 3, 0, 0, 0, "Use Textures",
...
FloatPropertyRNA rna_Material_mirror_color = {
	...
	-1, "mirror_color", 3, 0, 4, 0, "Mirror Color",
	"Mirror color of the material",
	0, "*",
	PROP_FLOAT, PROP_COLOR | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, mirr), 5, NULL},
...
FloatPropertyRNA rna_Material_alpha = {
	...
	-1, "alpha", 3, 0, 4, 0, "Alpha",
	"Alpha transparency of the material",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_draw_update, 0, NULL, NULL,
	offsetof(Material, alpha), 5, NULL},
...
FloatPropertyRNA rna_Material_specular_alpha = {
	...
	-1, "specular_alpha", 3, 0, 4, 0, "Specular Alpha",
	"Alpha transparency for specular areas",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, spectra), 5, NULL},
...
BoolPropertyRNA rna_Material_use_diffuse_ramp = {
	...
	-1, "use_diffuse_ramp", 3, 0, 0, 0, "Use Diffuse Ramp",
...
PointerPropertyRNA rna_Material_diffuse_ramp = {
	...
	-1, "diffuse_ramp", 8388608, 0, 0, 0, "Diffuse Ramp",
...
BoolPropertyRNA rna_Material_use_specular_ramp = {
	...
	-1, "use_specular_ramp", 3, 0, 0, 0, "Use Specular Ramp",
...
PointerPropertyRNA rna_Material_specular_ramp = {
	...
	-1, "specular_ramp", 8388608, 0, 0, 0, "Specular Ramp",
...
static const EnumPropertyItem rna_Material_diffuse_ramp_blend_items[19] = {
	{0, "MIX", 0, "Mix", ""},
	{1, "ADD", 0, "Add", ""},
...
EnumPropertyRNA rna_Material_diffuse_ramp_blend = {
	...
	-1, "diffuse_ramp_blend", 3, 0, 0, 0, "Diffuse Ramp Blend",
...
static const EnumPropertyItem rna_Material_specular_ramp_blend_items[19] = {
	{0, "MIX", 0, "Mix", ""},
	{1, "ADD", 0, "Add", ""},
	{2, "MULTIPLY", 0, "Multiply", ""},
	{3, "SUBTRACT", 0, "Subtract", ""},
...
EnumPropertyRNA rna_Material_specular_ramp_blend = {
	...
	-1, "specular_ramp_blend", 3, 0, 0, 0, "Specular Ramp Blend",
...
static const EnumPropertyItem rna_Material_diffuse_ramp_input_items[5] = {
	{0, "SHADER", 0, "Shader", ""},
	{1, "ENERGY", 0, "Energy", ""},
	{2, "NORMAL", 0, "Normal", ""},
	{3, "RESULT", 0, "Result", ""},
...
EnumPropertyRNA rna_Material_diffuse_ramp_input = {
	...
	-1, "diffuse_ramp_input", 3, 0, 0, 0, "Diffuse Ramp Input",
...
static const EnumPropertyItem rna_Material_specular_ramp_input_items[5] = {
	{0, "SHADER", 0, "Shader", ""},
	{1, "ENERGY", 0, "Energy", ""},
	{2, "NORMAL", 0, "Normal", ""},
	{3, "RESULT", 0, "Result", ""},
...
EnumPropertyRNA rna_Material_specular_ramp_input = {
	...
	-1, "specular_ramp_input", 3, 0, 0, 0, "Specular Ramp Input",
	"How the ramp maps on the surface",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_Material_diffuse_ramp_factor = {
	...
	-1, "diffuse_ramp_factor", 3, 0, 4, 0, "Diffuse Ramp Factor",
	"Blending factor (also uses alpha in Colorband)",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, rampfac_col), 5, NULL},
...
FloatPropertyRNA rna_Material_specular_ramp_factor = {
	...
	-1, "specular_ramp_factor", 3, 0, 4, 0, "Specular Ramp Factor",
	"Blending factor (also uses alpha in Colorband)",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, rampfac_spec), 5, NULL},
...
FloatPropertyRNA rna_Material_line_color = {
	...
	-1, "line_color", 3, 0, 4, 0, "Line Color",
...
IntPropertyRNA rna_Material_line_priority = {
	...
	-1, "line_priority", 3, 0, 4, 0, "Line Priority",
...
static const EnumPropertyItem rna_Material_diffuse_shader_items[8] = {
	...
	{5, "LAMBERT_CUSTOM", 0, "Lambert Custom BSDF", "Use a Lambert Custom BSDF shader"},
	{6, "BURLEY", 0, "Burley BSDF", "Use a Burley BSDF shader"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_Material_diffuse_shader = {
	{(PropertyRNA *)&rna_Material_diffuse_intensity, (PropertyRNA *)&rna_Material_line_priority,
	-1, "diffuse_shader", 3, 0, 0, 0, "Diffuse Shader Model",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	0, -1, NULL},
	Material_diffuse_shader_get, Material_diffuse_shader_set, NULL, NULL, NULL, NULL, rna_Material_diffuse_shader_items, 7, 0
};

FloatPropertyRNA rna_Material_diffuse_intensity = {
	{(PropertyRNA *)&rna_Material_roughness, (PropertyRNA *)&rna_Material_diffuse_shader,
	-1, "diffuse_intensity", 3, 0, 4, 0, "Diffuse Intensity",
	"Amount of diffuse reflection",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_draw_update, 0, NULL, NULL,
	offsetof(Material, ref), 5, NULL},
...
FloatPropertyRNA rna_Material_diffuse_toon_size = {
	...
	-1, "diffuse_toon_size", 3, 0, 4, 0, "Diffuse Toon Size",
	"Size of diffuse toon area",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, param[0]), 5, NULL},
...
FloatPropertyRNA rna_Material_diffuse_toon_smooth = {
	...
	-1, "diffuse_toon_smooth", 3, 0, 4, 0, "Diffuse Toon Smooth",
	"Smoothness of diffuse toon area",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, param[1]), 5, NULL},
...
FloatPropertyRNA rna_Material_diffuse_fresnel = {
	...
	-1, "diffuse_fresnel", 3, 0, 4, 0, "Diffuse Fresnel",
	"Power of Fresnel",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_Material_diffuse_fresnel_factor = {
	...
	-1, "diffuse_fresnel_factor", 3, 0, 4, 0, "Diffuse Fresnel Factor",
...
FloatPropertyRNA rna_Material_darkness = {
	{(PropertyRNA *)&rna_Material_diffuse_roughness_bsdf, (PropertyRNA *)&rna_Material_diffuse_fresnel_factor,
	-1, "darkness", 3, 0, 4, 0, "Darkness",
	"Minnaert darkness",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, darkness), 5, NULL},
...
FloatPropertyRNA rna_Material_diffuse_roughness_bsdf = {
	{(PropertyRNA *)&rna_Material_diffuse_metallic_bsdf, (PropertyRNA *)&rna_Material_darkness,
	-1, "diffuse_roughness_bsdf", 3, 0, 4, 0, "Roughness",
	"BSDF Roughness",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, roughness_bsdf), 5, NULL},
	Material_diffuse_roughness_bsdf_get, Material_diffuse_roughness_bsdf_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_Material_diffuse_metallic_bsdf = {
	{(PropertyRNA *)&rna_Material_specular_shader, (PropertyRNA *)&rna_Material_diffuse_roughness_bsdf,
	-1, "diffuse_metallic_bsdf", 3, 0, 4, 0, "Metallic",
	"BSDF MEtallic",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, metallic_bsdf), 5, NULL},
	Material_diffuse_metallic_bsdf_get, Material_diffuse_metallic_bsdf_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};

static const EnumPropertyItem rna_Material_specular_shader_items[7] = {
	...
	{5, "GGX", 0, "Optimized GGX BSDF", "Use an optimized GGX BSDF shader"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_Material_specular_shader = {
	{(PropertyRNA *)&rna_Material_specular_intensity, (PropertyRNA *)&rna_Material_diffuse_metallic_bsdf,
	-1, "specular_shader", 3, 0, 0, 0, "Specular Shader Model",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	0, -1, NULL},
	Material_specular_shader_get, Material_specular_shader_set, NULL, NULL, NULL, NULL, rna_Material_specular_shader_items, 6, 0
};

FloatPropertyRNA rna_Material_specular_intensity = {
	{(PropertyRNA *)&rna_Material_specular_hardness, (PropertyRNA *)&rna_Material_specular_shader,
	-1, "specular_intensity", 3, 0, 4, 0, "Specular Intensity",
...
IntPropertyRNA rna_Material_specular_hardness = {
	...
	-1, "specular_hardness", 3, 0, 4, 0, "Specular Hardness",
...
FloatPropertyRNA rna_Material_specular_ior = {
	{(PropertyRNA *)&rna_Material_specular_roughness_bsdf, (PropertyRNA *)&rna_Material_specular_hardness,
	-1, "specular_ior", 3, 0, 4, 0, "Specular IOR",
	"Specular index of refraction",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, refrac), 5, NULL},
...
FloatPropertyRNA rna_Material_specular_roughness_bsdf = {
	{(PropertyRNA *)&rna_Material_specular_metallic_bsdf, (PropertyRNA *)&rna_Material_specular_ior,
	-1, "specular_roughness_bsdf", 3, 0, 4, 0, "Roughness",
	"Roughness",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, roughness_bsdf), 5, NULL},
	Material_specular_roughness_bsdf_get, Material_specular_roughness_bsdf_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_Material_specular_metallic_bsdf = {
	{(PropertyRNA *)&rna_Material_specular_toon_size, (PropertyRNA *)&rna_Material_specular_roughness_bsdf,
	-1, "specular_metallic_bsdf", 3, 0, 4, 0, "Metallic",
	"Metallic",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, metallic_bsdf), 5, NULL},
	Material_specular_metallic_bsdf_get, Material_specular_metallic_bsdf_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_Material_specular_toon_size = {
	{(PropertyRNA *)&rna_Material_specular_toon_smooth, (PropertyRNA *)&rna_Material_specular_metallic_bsdf,
	-1, "specular_toon_size", 3, 0, 4, 0, "Specular Toon Size",
	"Size of specular toon area",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, param[2]), 5, NULL},
...
FloatPropertyRNA rna_Material_specular_toon_smooth = {
	...
	-1, "specular_toon_smooth", 3, 0, 4, 0, "Specular Toon Smooth",
	"Smoothness of specular toon area",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, param[3]), 5, NULL},
...
FloatPropertyRNA rna_Material_specular_slope = {
	...
	-1, "specular_slope", 3, 0, 4, 0, "Specular Slope",
	"The standard deviation of surface slope",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, rms), 5, NULL},
...
StructRNA RNA_Material = {
	{(ContainerRNA *)&RNA_MaterialTextureSlots, (ContainerRNA *)&RNA_BlendDataPaintCurves,
	NULL,
...
StructRNA RNA_MaterialTextureSlots = {
	...
	"MaterialTextureSlots", NULL, NULL, 516, NULL, "Texture Slots",
...
StringPropertyRNA rna_TexPaintSlot_uv_layer = {
	...
	-1, "uv_layer", 262145, 0, 0, 0, "UV Map",
	"Name of UV map",
	0, "*",
...
FloatPropertyRNA rna_MaterialRaytraceMirror_reflect_factor = {
	...
	-1, "reflect_factor", 3, 0, 4, 0, "Reflectivity",
	"Amount of mirror reflection for raytrace",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, ray_mirror), 5, NULL},
...
FloatPropertyRNA rna_MaterialRaytraceMirror_fresnel = {
	...
	-1, "fresnel", 3, 0, 4, 0, "Fresnel",
	"Power of Fresnel for mirror reflection",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, fresnel_mir), 5, NULL},
...
FloatPropertyRNA rna_MaterialRaytraceMirror_fresnel_factor = {
	...
	-1, "fresnel_factor", 3, 0, 4, 0, "Fresnel Factor",
	"Blending factor for Fresnel",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, fresnel_mir_i), 5, NULL},
...
IntPropertyRNA rna_MaterialRaytraceMirror_gloss_samples = {
	...
	-1, "gloss_samples", 3, 0, 4, 0, "Gloss Samples",
...
FloatPropertyRNA rna_MaterialRaytraceMirror_distance = {
	...
	-1, "distance", 3, 0, 4, 0, "Maximum Distance",
	...
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, dist_mir), 5, NULL},
...
static const EnumPropertyItem rna_MaterialRaytraceMirror_fade_to_items[3] = {
	{0, "FADE_TO_SKY", 0, "Sky", ""},
...
EnumPropertyRNA rna_MaterialRaytraceMirror_fade_to = {
	...
	-1, "fade_to", 3, 0, 0, 0, "Fade-out Color",
...
StructRNA RNA_MaterialRaytraceMirror = {
	...
	"MaterialRaytraceMirror", NULL, NULL, 516, NULL, "Material Raytrace Mirror",
...
FloatPropertyRNA rna_MaterialRaytraceTransparency_fresnel = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, fresnel_tra), 5, NULL},
...
FloatPropertyRNA rna_MaterialRaytraceTransparency_fresnel_factor = {
	...
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, fresnel_tra_i), 5, NULL},
...
FloatPropertyRNA rna_MaterialRaytraceTransparency_gloss_factor = {
	...
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, gloss_tra), 5, NULL},
...
FloatPropertyRNA rna_MaterialRaytraceTransparency_gloss_threshold = {
	...
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, adapt_thresh_tra), 5, NULL},
...
FloatPropertyRNA rna_MaterialRaytraceTransparency_falloff = {
	...
	-1, "falloff", 3, 0, 4, 0, "Falloff",
	"Falloff power for transmissivity filter effect (1.0 is linear)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, tx_falloff), 5, NULL},
...
StructRNA RNA_MaterialRaytraceTransparency = {
	...
	"MaterialRaytraceTransparency", NULL, NULL, 516, NULL, "Material Raytrace Transparency",
...
static const EnumPropertyItem rna_MaterialVolume_step_method_items[3] = {
...
EnumPropertyRNA rna_MaterialVolume_step_method = {
	...
	-1, "step_method", 3, 0, 0, 0, "Step Calculation",
...
FloatPropertyRNA rna_MaterialVolume_step_size = {
	...
	-1, "step_size", 3, 0, 4, 0, "Step Size",
	"Distance between subsequent volume depth samples",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(VolumeSettings, stepsize), 5, NULL},
...
static const EnumPropertyItem rna_MaterialVolume_light_method_items[6] = {
...
EnumPropertyRNA rna_MaterialVolume_light_method = {
	...
	-1, "light_method", 3, 0, 0, 0, "Lighting Mode",
...
BoolPropertyRNA rna_MaterialVolume_use_external_shadows = {
	...
	-1, "use_external_shadows", 3, 0, 0, 0, "External Shadows",
...
BoolPropertyRNA rna_MaterialVolume_use_light_cache = {
	...
	-1, "use_light_cache", 3, 0, 0, 0, "Light Cache",
...
IntPropertyRNA rna_MaterialVolume_cache_resolution = {
	...
	-1, "cache_resolution", 3, 0, 4, 0, "Resolution",
...
FloatPropertyRNA rna_MaterialVolume_ms_diffusion = {
	...
	-1, "ms_diffusion", 3, 0, 4, 0, "Diffusion",
	"Diffusion factor, the strength of the blurring effect",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(VolumeSettings, ms_diff), 5, NULL},
...
FloatPropertyRNA rna_MaterialVolume_ms_spread = {
	...
	-1, "ms_spread", 3, 0, 4, 0, "Spread",
	"Proportional distance over which the light is diffused",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(VolumeSettings, ms_spread), 5, NULL},
...
FloatPropertyRNA rna_MaterialVolume_ms_intensity = {
	...
	-1, "ms_intensity", 3, 0, 4, 0, "Intensity",
	"Multiplier for multiple scattered light energy",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(VolumeSettings, ms_intensity), 5, NULL},
...
FloatPropertyRNA rna_MaterialVolume_depth_threshold = {
	...
	-1, "depth_threshold", 3, 0, 4, 0, "Depth Cutoff",
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(VolumeSettings, depth_cutoff), 5, NULL},
...
FloatPropertyRNA rna_MaterialVolume_density = {
	...
	-1, "density", 3, 0, 4, 0, "Density",
	"The base density of the volume",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(VolumeSettings, density), 5, NULL},
...
FloatPropertyRNA rna_MaterialVolume_density_scale = {
	...
	-1, "density_scale", 3, 0, 4, 0, "Density Scale",
	"Multiplier for the material\'s density",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(VolumeSettings, density_scale), 5, NULL},
...
FloatPropertyRNA rna_MaterialVolume_transmission_color = {
	...
	-1, "transmission_color", 3, 0, 4, 0, "Transmission Color",
	"Result color of the volume, after other light has been scattered/absorbed",
	0, "*",
	PROP_FLOAT, PROP_COLOR | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_Material_draw_update, 0, NULL, NULL,
	offsetof(VolumeSettings, transmission_col), 5, NULL},
...
FloatPropertyRNA rna_MaterialVolume_reflection_color = {
	...
	-1, "reflection_color", 3, 0, 4, 0, "Reflection Color",
	"Color of light scattered out of the volume (does not affect transmission)",
	0, "*",
	PROP_FLOAT, PROP_COLOR | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_Material_draw_update, 0, NULL, NULL,
	offsetof(VolumeSettings, reflection_col), 5, NULL},
...
FloatPropertyRNA rna_MaterialVolume_emission_color = {
	...
	-1, "emission_color", 3, 0, 4, 0, "Emission Color",
	"Color of emitted light",
	0, "*",
	PROP_FLOAT, PROP_COLOR | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_Material_draw_update, 0, NULL, NULL,
	offsetof(VolumeSettings, emission_col), 5, NULL},
...
FloatPropertyRNA rna_MaterialVolume_emission = {
	...
	-1, "emission", 3, 0, 4, 0, "Emission",
	"Amount of light that gets emitted by the volume",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(VolumeSettings, emission), 5, NULL},
...
StructRNA RNA_MaterialVolume = {
	...
	"MaterialVolume", NULL, NULL, 516, NULL, "Material Volume",
...
FloatPropertyRNA rna_MaterialHalo_size = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, hasize), 5, NULL},
...
IntPropertyRNA rna_MaterialHalo_line_count = {
	...
	-1, "line_count", 3, 0, 4, 0, "Line Number",
...
IntPropertyRNA rna_MaterialHalo_star_tip_count = {
	...
	-1, "star_tip_count", 3, 0, 4, 0, "Star Tips",
...
BoolPropertyRNA rna_MaterialHalo_use_flare_mode = {
	...
	-1, "use_flare_mode", 3, 0, 0, 0, "Flare",
...
FloatPropertyRNA rna_MaterialHalo_flare_size = {
	...
	-1, "flare_size", 3, 0, 4, 0, "Flare Size",
	"Factor by which the flare is larger than the halo",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, flaresize), 5, NULL},
...
FloatPropertyRNA rna_MaterialHalo_flare_subflare_size = {
	...
	-1, "flare_subflare_size", 3, 0, 4, 0, "Flare Subsize",
	"Dimension of the sub-flares, dots and circles",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, subsize), 5, NULL},
...
FloatPropertyRNA rna_MaterialHalo_flare_boost = {
	...
	-1, "flare_boost", 3, 0, 4, 0, "Flare Boost",
	"Give the flare extra strength",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, flareboost), 5, NULL},
...
IntPropertyRNA rna_MaterialHalo_flare_seed = {
	...
	-1, "flare_seed", 3, 0, 4, 0, "Flare Seed",
...
IntPropertyRNA rna_MaterialHalo_flare_subflare_count = {
	...
	-1, "flare_subflare_count", 3, 0, 4, 0, "Flares Sub",
...
BoolPropertyRNA rna_MaterialHalo_use_vertex_normal = {
	...
	-1, "use_vertex_normal", 3, 0, 0, 0, "Vertex Normal",
...
BoolPropertyRNA rna_MaterialHalo_use_extreme_alpha = {
	...
	-1, "use_extreme_alpha", 3, 0, 0, 0, "Extreme Alpha",
	"Use extreme alpha",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
...
StructRNA RNA_MaterialHalo = {
	...
	"MaterialHalo", NULL, NULL, 516, NULL, "Material Halo",
...
FloatPropertyRNA rna_MaterialSubsurfaceScattering_color = {
	...
	PROP_FLOAT, PROP_COLOR | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, sss_col), 5, NULL},
...
FloatPropertyRNA rna_MaterialSubsurfaceScattering_error_threshold = {
	...
	-1, "error_threshold", 3, 0, 4, 0, "Error Tolerance",
	"Error tolerance (low values are slower and higher quality)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, sss_error), 5, NULL},
...
FloatPropertyRNA rna_MaterialSubsurfaceScattering_scale = {
	...
	-1, "scale", 3, 0, 4, 0, "Scale",
	"Object scale factor",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, sss_scale), 5, NULL},
...
FloatPropertyRNA rna_MaterialSubsurfaceScattering_ior = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, sss_ior), 5, NULL},
...
FloatPropertyRNA rna_MaterialSubsurfaceScattering_color_factor = {
	...
	-1, "color_factor", 3, 0, 4, 0, "Color Factor",
	"Blend factor for SSS colors",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, sss_colfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialSubsurfaceScattering_texture_factor = {
	...
	-1, "texture_factor", 3, 0, 4, 0, "Texture Factor",
	"Texture scattering blend factor",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, sss_texfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialSubsurfaceScattering_front = {
	...
	-1, "front", 3, 0, 4, 0, "Front",
	"Front scattering weight",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, sss_front), 5, NULL},
...
FloatPropertyRNA rna_MaterialSubsurfaceScattering_back = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, sss_back), 5, NULL},
...
StructRNA RNA_MaterialSubsurfaceScattering = {
	...
	"MaterialSubsurfaceScattering", NULL, NULL, 516, NULL, "Material Subsurface Scattering",
...
static const EnumPropertyItem rna_MaterialTextureSlot_texture_coords_items[11] = {
...
EnumPropertyRNA rna_MaterialTextureSlot_texture_coords = {
	...
	-1, "texture_coords", 3, 0, 0, 0, "Texture Coordinates",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_MaterialTextureSlot_use_from_dupli = {
	...
	-1, "use_from_dupli", 3, 0, 0, 0, "From Dupli",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_to_bounds = {
	...
	-1, "use_map_to_bounds", 3, 0, 0, 0, "Map to Bounds",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_from_original = {
	...
	-1, "use_from_original", 3, 0, 0, 0, "From Original",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_color_diffuse = {
	...
	-1, "use_map_color_diffuse", 3, 0, 0, 0, "Diffuse Color",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_normal = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_use_map_parallax, (PropertyRNA *)&rna_MaterialTextureSlot_use_map_color_diffuse,
	-1, "use_map_normal", 3, 0, 0, 0, "Normal",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_parallax = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_use_parallax_uv, (PropertyRNA *)&rna_MaterialTextureSlot_use_map_normal,
	-1, "use_map_parallax", 3, 0, 0, 0, "Parallax",
	"The texture affects the relief depth",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	0, -1, NULL},
	MaterialTextureSlot_use_map_parallax_get, MaterialTextureSlot_use_map_parallax_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_MaterialTextureSlot_use_parallax_uv = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_use_map_color_spec, (PropertyRNA *)&rna_MaterialTextureSlot_use_map_parallax,
	-1, "use_parallax_uv", 3, 0, 0, 0, "Use Parallax UV",
	"This is necessary for proper use of the parallax mapping",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	0, -1, NULL},
	MaterialTextureSlot_use_parallax_uv_get, MaterialTextureSlot_use_parallax_uv_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_MaterialTextureSlot_use_map_color_spec = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_use_map_mirror, (PropertyRNA *)&rna_MaterialTextureSlot_use_parallax_uv,
	-1, "use_map_color_spec", 3, 0, 0, 0, "Specular Color",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_mirror = {
	...
	-1, "use_map_mirror", 3, 0, 0, 0, "Mirror",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_diffuse = {
	...
	-1, "use_map_diffuse", 3, 0, 0, 0, "Diffuse",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_specular = {
	...
	-1, "use_map_specular", 3, 0, 0, 0, "Specular",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_ambient = {
	...
	-1, "use_map_ambient", 3, 0, 0, 0, "Ambient",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_hardness = {
	...
	-1, "use_map_hardness", 3, 0, 0, 0, "Hardness",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_raymir = {
	...
	-1, "use_map_raymir", 3, 0, 0, 0, "Ray-Mirror",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_translucency = {
	...
	-1, "use_map_translucency", 3, 0, 0, 0, "Translucency",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_displacement = {
	...
	-1, "use_map_displacement", 3, 0, 0, 0, "Displacement",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_warp = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_use_map_roughness, (PropertyRNA *)&rna_MaterialTextureSlot_use_map_displacement,
	-1, "use_map_warp", 3, 0, 0, 0, "Warp",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_roughness = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_use_map_metallic, (PropertyRNA *)&rna_MaterialTextureSlot_use_map_warp,
	-1, "use_map_roughness", 3, 0, 0, 0, "Roughness",
	"Let the texture affects the roughness value",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	0, -1, NULL},
	MaterialTextureSlot_use_map_roughness_get, MaterialTextureSlot_use_map_roughness_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_MaterialTextureSlot_use_map_metallic = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_mapping_x, (PropertyRNA *)&rna_MaterialTextureSlot_use_map_roughness,
	-1, "use_map_metallic", 3, 0, 0, 0, "Metallic",
	"Let the texture affects the metallic value",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	0, -1, NULL},
	MaterialTextureSlot_use_map_metallic_get, MaterialTextureSlot_use_map_metallic_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

static const EnumPropertyItem rna_MaterialTextureSlot_mapping_x_items[5] = {
	{0, "NONE", 0, "None", ""},
	{1, "X", 0, "X", ""},
	{2, "Y", 0, "Y", ""},
	{3, "Z", 0, "Z", ""},
...
EnumPropertyRNA rna_MaterialTextureSlot_mapping_x = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_mapping_y, (PropertyRNA *)&rna_MaterialTextureSlot_use_map_metallic,
	-1, "mapping_x", 3, 0, 0, 0, "X Mapping",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
...
static const EnumPropertyItem rna_MaterialTextureSlot_mapping_y_items[5] = {
	{0, "NONE", 0, "None", ""},
	{1, "X", 0, "X", ""},
	{2, "Y", 0, "Y", ""},
	{3, "Z", 0, "Z", ""},
...
static const EnumPropertyItem rna_MaterialTextureSlot_mapping_z_items[5] = {
	{0, "NONE", 0, "None", ""},
	{1, "X", 0, "X", ""},
	{2, "Y", 0, "Y", ""},
	{3, "Z", 0, "Z", ""},
...
static const EnumPropertyItem rna_MaterialTextureSlot_mapping_items[5] = {
...
static const EnumPropertyItem rna_MaterialTextureSlot_normal_map_space_items[5] = {
	{0, "CAMERA", 0, "Camera", ""},
	{1, "WORLD", 0, "World", ""},
	{2, "OBJECT", 0, "Object", ""},
	{3, "TANGENT", 0, "Tangent", ""},
...
EnumPropertyRNA rna_MaterialTextureSlot_normal_map_space = {
	...
	-1, "normal_map_space", 3, 0, 0, 0, "Normal Map Space",
...
FloatPropertyRNA rna_MaterialTextureSlot_normal_factor = {
	...
	-1, "normal_factor", 3, 0, 4, 0, "Normal Factor",
	"Amount texture affects normal values",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, norfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_displacement_factor = {
	...
	-1, "displacement_factor", 3, 0, 4, 0, "Displacement Factor",
	"Amount texture displaces the surface",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, dispfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_warp_factor = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_parallax_steps, (PropertyRNA *)&rna_MaterialTextureSlot_displacement_factor,
	-1, "warp_factor", 3, 0, 4, 0, "Warp Factor",
	"Amount texture affects texture coordinates of next channels",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, warpfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_parallax_steps = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_parallax_bump_scale, (PropertyRNA *)&rna_MaterialTextureSlot_warp_factor,
	-1, "parallax_steps", 3, 0, 4, 0, "Parallax Steps",
	"Number of steps taken to achieve result",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, parallaxsteps), 5, NULL},
	MaterialTextureSlot_parallax_steps_get, MaterialTextureSlot_parallax_steps_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 100.0f, -FLT_MAX, FLT_MAX, 1.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_MaterialTextureSlot_parallax_bump_scale = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_parallax_uv_discard, (PropertyRNA *)&rna_MaterialTextureSlot_parallax_steps,
	-1, "parallax_bump_scale", 3, 0, 4, 0, "Parallax Bump Scale",
	"Height of SPOM",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, parallaxbumpsc), 5, NULL},
	MaterialTextureSlot_parallax_bump_scale_get, MaterialTextureSlot_parallax_bump_scale_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 0.5000000000f, -FLT_MAX, FLT_MAX, 1.0f, 3, 0.0f, NULL
};

BoolPropertyRNA rna_MaterialTextureSlot_parallax_uv_discard = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_parallax_component, (PropertyRNA *)&rna_MaterialTextureSlot_parallax_bump_scale,
	-1, "parallax_uv_discard", 3, 0, 0, 0, "Parallax UV discard",
	"To discard parallax UV at edges",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	0, -1, NULL},
	MaterialTextureSlot_parallax_uv_discard_get, MaterialTextureSlot_parallax_uv_discard_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

static const EnumPropertyItem rna_MaterialTextureSlot_parallax_component_items[5] = {
	{0, "RED", 331, "Red", ""},
	{1, "GREEN", 332, "Green", ""},
	{2, "BLUE", 333, "Blue", ""},
	{3, "ALPHA", 765, "Alpha", ""},
...
EnumPropertyRNA rna_MaterialTextureSlot_parallax_component = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_lod_bias, (PropertyRNA *)&rna_MaterialTextureSlot_parallax_uv_discard,
	-1, "parallax_component", 3, 0, 0, 0, "Parallax Component",
	"The color component to extract the height information from",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	0, -1, NULL},
	MaterialTextureSlot_parallax_component_get, MaterialTextureSlot_parallax_component_set, NULL, NULL, NULL, NULL, rna_MaterialTextureSlot_parallax_component_items, 4, 0
};

FloatPropertyRNA rna_MaterialTextureSlot_lod_bias = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_specular_color_factor, (PropertyRNA *)&rna_MaterialTextureSlot_parallax_component,
	-1, "lod_bias", 3, 0, 4, 0, "Lod Bias",
	"Amount bias on mipmapping",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, lodbias), 5, NULL},
	MaterialTextureSlot_lod_bias_get, MaterialTextureSlot_lod_bias_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_MaterialTextureSlot_specular_color_factor = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_diffuse_color_factor, (PropertyRNA *)&rna_MaterialTextureSlot_lod_bias,
	-1, "specular_color_factor", 3, 0, 4, 0, "Specular Color Factor",
	"Amount texture affects specular color",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, colspecfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_diffuse_color_factor = {
	...
	-1, "diffuse_color_factor", 3, 0, 4, 0, "Diffuse Color Factor",
...
FloatPropertyRNA rna_MaterialTextureSlot_mirror_factor = {
	...
	-1, "mirror_factor", 3, 0, 4, 0, "Mirror Factor",
	"Amount texture affects mirror color",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, mirrfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_alpha_factor = {
	...
	-1, "alpha_factor", 3, 0, 4, 0, "Alpha Factor",
...
FloatPropertyRNA rna_MaterialTextureSlot_diffuse_factor = {
	...
	-1, "diffuse_factor", 3, 0, 4, 0, "Diffuse Factor",
	"Amount texture affects diffuse reflectivity",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, difffac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_specular_factor = {
	...
	-1, "specular_factor", 3, 0, 4, 0, "Specular Factor",
	"Amount texture affects specular reflectivity",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, specfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_emit_factor = {
	...
	-1, "emit_factor", 3, 0, 4, 0, "Emit Factor",
	"Amount texture affects emission",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, emitfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_hardness_factor = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_roughness_factor, (PropertyRNA *)&rna_MaterialTextureSlot_emit_factor,
	-1, "hardness_factor", 3, 0, 4, 0, "Hardness Factor",
	"Amount texture affects hardness",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, hardfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_roughness_factor = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_metallic_factor, (PropertyRNA *)&rna_MaterialTextureSlot_hardness_factor,
	-1, "roughness_factor", 3, 0, 4, 0, "Roughness Factor",
	"Amount texture affects roughness",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, roughnessfac), 5, NULL},
	MaterialTextureSlot_roughness_factor_get, MaterialTextureSlot_roughness_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_MaterialTextureSlot_metallic_factor = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_raymir_factor, (PropertyRNA *)&rna_MaterialTextureSlot_roughness_factor,
	-1, "metallic_factor", 3, 0, 4, 0, "Metallic Factor",
	"Amount texture affects metallic",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, metallicfac), 5, NULL},
	MaterialTextureSlot_metallic_factor_get, MaterialTextureSlot_metallic_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_MaterialTextureSlot_raymir_factor = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_translucency_factor, (PropertyRNA *)&rna_MaterialTextureSlot_metallic_factor,
	-1, "raymir_factor", 3, 0, 4, 0, "Ray Mirror Factor",
	"Amount texture affects ray mirror",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, raymirrfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_translucency_factor = {
	...
	-1, "translucency_factor", 3, 0, 4, 0, "Translucency Factor",
	"Amount texture affects translucency",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, translfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_ambient_factor = {
	...
	-1, "ambient_factor", 3, 0, 4, 0, "Ambient Factor",
	"Amount texture affects ambient",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, ambfac), 5, NULL},
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_color_emission = {
	...
	-1, "use_map_color_emission", 3, 0, 0, 0, "Emission Color",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_color_reflection = {
	...
	-1, "use_map_color_reflection", 3, 0, 0, 0, "Reflection Color",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_color_transmission = {
	...
	-1, "use_map_color_transmission", 3, 0, 0, 0, "Transmission Color",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_density = {
	...
	-1, "use_map_density", 3, 0, 0, 0, "Density",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_emission = {
	...
	-1, "use_map_emission", 3, 0, 0, 0, "Emission",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_scatter = {
	...
	-1, "use_map_scatter", 3, 0, 0, 0, "Scattering",
...
BoolPropertyRNA rna_MaterialTextureSlot_use_map_reflect = {
	...
	-1, "use_map_reflect", 3, 0, 0, 0, "Reflection",
...
FloatPropertyRNA rna_MaterialTextureSlot_emission_color_factor = {
	...
	-1, "emission_color_factor", 3, 0, 4, 0, "Emission Color Factor",
	"Amount texture affects emission color",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, colemitfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_reflection_color_factor = {
	...
	-1, "reflection_color_factor", 3, 0, 4, 0, "Reflection Color Factor",
	"Amount texture affects color of out-scattered light",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, colreflfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_transmission_color_factor = {
	...
	-1, "transmission_color_factor", 3, 0, 4, 0, "Transmission Color Factor",
	"Amount texture affects result color after light has been scattered/absorbed",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 117440512, NULL, NULL,
	offsetof(MTex, coltransfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_density_factor = {
	...
	-1, "density_factor", 3, 0, 4, 0, "Density Factor",
	"Amount texture affects density",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, densfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_emission_factor = {
	...
	-1, "emission_factor", 3, 0, 4, 0, "Emission Factor",
	"Amount texture affects emission",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_MaterialTextureSlot_scattering_factor = {
	...
	-1, "scattering_factor", 3, 0, 4, 0, "Scattering Factor",
	"Amount texture affects scattering",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, scatterfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_reflection_factor = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_ior, (PropertyRNA *)&rna_MaterialTextureSlot_scattering_factor,
	-1, "reflection_factor", 3, 0, 4, 0, "Reflection Factor",
	"Amount texture affects brightness of out-scattered light",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, reflfac), 5, NULL},
...
FloatPropertyRNA rna_MaterialTextureSlot_ior = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_refraction_ratio, (PropertyRNA *)&rna_MaterialTextureSlot_reflection_factor,
	-1, "ior", 3, 0, 4, 0, "Refraction Indice",
	"Indice of refraction",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, ior), 5, NULL},
	MaterialTextureSlot_ior_get, MaterialTextureSlot_ior_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1.0f, 50.0f, 1.0f, 50.0f, 1.0f, 2, 0.0f, NULL
};

FloatPropertyRNA rna_MaterialTextureSlot_refraction_ratio = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_use, (PropertyRNA *)&rna_MaterialTextureSlot_ior,
	-1, "refraction_ratio", 3, 0, 4, 0, "Refraction Ratio",
	"Amount refraction mixed with reflection",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(MTex, refrratio), 5, NULL},
	MaterialTextureSlot_refraction_ratio_get, MaterialTextureSlot_refraction_ratio_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 1.0f, 2, 0.0f, NULL
};

BoolPropertyRNA rna_MaterialTextureSlot_use = {
	{(PropertyRNA *)&rna_MaterialTextureSlot_bump_method, (PropertyRNA *)&rna_MaterialTextureSlot_refraction_ratio,
	-1, "use", 3, 0, 0, 0, "Enabled",
...
static const EnumPropertyItem rna_MaterialTextureSlot_bump_method_items[6] = {
...
EnumPropertyRNA rna_MaterialTextureSlot_bump_method = {
	...
	-1, "bump_method", 3, 0, 0, 0, "Bump Method",
...
static const EnumPropertyItem rna_MaterialTextureSlot_bump_objectspace_items[4] = {
...
EnumPropertyRNA rna_MaterialTextureSlot_bump_objectspace = {
	...
	-1, "bump_objectspace", 3, 0, 0, 0, "Bump Space",
...
StructRNA RNA_MaterialTextureSlot = {
	...
	"MaterialTextureSlot", NULL, NULL, 516, NULL, "Material Texture Slot",
...
BoolPropertyRNA rna_MaterialStrand_use_surface_diffuse = {
	...
	-1, "use_surface_diffuse", 2, 0, 0, 0, "Surface Diffuse",
...
FloatPropertyRNA rna_MaterialStrand_blend_distance = {
	...
	-1, "blend_distance", 3, 0, 4, 0, "Blend Distance",
	"Worldspace distance over which to blend in the surface normal",
	0, "*",
	PROP_FLOAT, PROP_DISTANCE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, strand_surfnor), 5, NULL},
...
BoolPropertyRNA rna_MaterialStrand_use_blender_units = {
	...
	-1, "use_blender_units", 3, 0, 0, 0, "Blender Units",
...
FloatPropertyRNA rna_MaterialStrand_tip_size = {
	...
	-1, "tip_size", 3, 0, 4, 0, "Tip Size",
	"End size of strands in pixels or Blender units",
	0, "*",
	PROP_FLOAT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, strand_end), 5, NULL},
...
FloatPropertyRNA rna_MaterialStrand_size_min = {
	...
	-1, "size_min", 3, 0, 4, 0, "Minimum Size",
	"Minimum size of strands in pixels",
	0, "*",
	PROP_FLOAT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, strand_min), 5, NULL},
...
FloatPropertyRNA rna_MaterialStrand_width_fade = {
	...
	-1, "width_fade", 3, 0, 4, 0, "Width Fade",
	"Transparency along the width of the strand",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_update, 0, NULL, NULL,
	offsetof(Material, strand_widthfade), 5, NULL},
...
StructRNA RNA_MaterialStrand = {
	{(ContainerRNA *)&RNA_MaterialGameSettings, (ContainerRNA *)&RNA_MaterialTextureSlot,
	NULL,
	{(PropertyRNA *)&rna_MaterialStrand_rna_properties, (PropertyRNA *)&rna_MaterialStrand_uv_layer}},
	"MaterialStrand", NULL, NULL, 516, NULL, "Material Strand",
...
BoolPropertyRNA rna_MaterialGameSettings_use_backface_culling = {
	{(PropertyRNA *)&rna_MaterialGameSettings_invisible, (PropertyRNA *)&rna_MaterialGameSettings_rna_type,
	-1, "use_backface_culling", 3, 0, 0, 0, "Backface Culling",
...
BoolPropertyRNA rna_MaterialGameSettings_invisible = {
	{(PropertyRNA *)&rna_MaterialGameSettings_alpha_blend, (PropertyRNA *)&rna_MaterialGameSettings_use_backface_culling,
	-1, "invisible", 3, 0, 0, 0, "Invisible",
	"Make face invisible",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_draw_update, 0, NULL, NULL,
...
static const EnumPropertyItem rna_MaterialGameSettings_alpha_blend_items[7] = {
...
EnumPropertyRNA rna_MaterialGameSettings_alpha_blend = {
	...
	-1, "alpha_blend", 3, 0, 0, 0, "Blend Mode",
...
static const EnumPropertyItem rna_MaterialGameSettings_face_orientation_items[5] = {
...
EnumPropertyRNA rna_MaterialGameSettings_face_orientation = {
	...
	-1, "face_orientation", 3, 0, 0, 0, "Face Orientations",
...
StructRNA RNA_MaterialGameSettings = {
	{(ContainerRNA *)&RNA_Mesh, (ContainerRNA *)&RNA_MaterialStrand,
	NULL,
	{(PropertyRNA *)&rna_MaterialGameSettings_rna_properties, (PropertyRNA *)&rna_MaterialGameSettings_physics}},
	"MaterialGameSettings", NULL, NULL, 516, NULL, "Material Game Settings",
