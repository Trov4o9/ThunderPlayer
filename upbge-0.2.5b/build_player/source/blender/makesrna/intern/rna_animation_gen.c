...
CollectionPropertyRNA rna_AnimData_nla_tracks = {
	...
	-1, "nla_tracks", 0, 0, 0, 0, "NLA Tracks",
...
EnumPropertyRNA rna_AnimData_action_extrapolation = {
	...
	-1, "action_extrapolation", 3, 0, 0, 0, "Action Extrapolation",
...
static const EnumPropertyItem rna_AnimData_action_blend_type_items[5] = {
...
EnumPropertyRNA rna_AnimData_action_blend_type = {
	...
	-1, "action_blend_type", 3, 0, 0, 0, "Action Blending",
...
FloatPropertyRNA rna_AnimData_action_influence = {
	...
	-1, "action_influence", 3, 0, 4, 0, "Action Influence",
...
BoolPropertyRNA rna_AnimData_use_nla = {
	...
	-1, "use_nla", 3, 0, 0, 0, "NLA Evaluation Enabled",
...
BoolPropertyRNA rna_AnimData_use_tweak_mode = {
	...
	-1, "use_tweak_mode", 3, 0, 0, 0, "Use NLA Tweak Mode",
...
StringPropertyRNA rna_KeyingSet_bl_label = {
	...
	-1, "bl_label", 262145, 0, 0, 0, "UI Name",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {64, 0, 0}, 0,
...
StringPropertyRNA rna_KeyingSet_bl_description = {
	...
	-1, "bl_description", 262193, 0, 0, 0, "Description",
...
PointerPropertyRNA rna_KeyingSet_type_info = {
	...
	-1, "type_info", 8388608, 0, 0, 0, "Type Info",
...
BoolPropertyRNA rna_KeyingSet_is_path_absolute = {
	...
	-1, "is_path_absolute", 2, 0, 0, 0, "Absolute",
...
BoolPropertyRNA rna_KeyingSet_use_insertkey_override_needed = {
	...
	-1, "use_insertkey_override_needed", 3, 0, 0, 0, "Override Insert Keyframes Default- Only Needed",
...
BoolPropertyRNA rna_KeyingSet_use_insertkey_override_visual = {
	...
	-1, "use_insertkey_override_visual", 3, 0, 0, 0, "Override Insert Keyframes Default - Visual",
...
BoolPropertyRNA rna_KeyingSet_use_insertkey_override_xyz_to_rgb = {
	...
	-1, "use_insertkey_override_xyz_to_rgb", 3, 0, 0, 0, "Override F-Curve Colors - XYZ to RGB",
...
BoolPropertyRNA rna_KeyingSet_use_insertkey_needed = {
	...
	-1, "use_insertkey_needed", 3, 0, 0, 0, "Insert Keyframes - Only Needed",
...
BoolPropertyRNA rna_KeyingSet_use_insertkey_visual = {
	...
	-1, "use_insertkey_visual", 3, 0, 0, 0, "Insert Keyframes - Visual",
...
BoolPropertyRNA rna_KeyingSet_use_insertkey_xyz_to_rgb = {
	...
	-1, "use_insertkey_xyz_to_rgb", 3, 0, 0, 0, "F-Curve Colors - XYZ to RGB",
...
IntPropertyRNA rna_KeyingSetPaths_active_index = {
	...
	-1, "active_index", 3, 0, 0, 0, "Active Path Index",
...
PointerPropertyRNA rna_KeyingSetPaths_add_target_id = {
	...
	-1, "target_id", 8388608, 1, 0, 0, "Target ID",
...
EnumPropertyRNA rna_KeyingSetPaths_add_group_method = {
	...
	-1, "group_method", 3, 0, 0, 0, "Grouping Method",
...
StringPropertyRNA rna_KeyingSetPaths_add_group_name = {
	...
	-1, "group_name", 262145, 0, 0, 0, "Group Name",
...
static const EnumPropertyItem rna_KeyingSetPath_id_type_items[34] = {
...
EnumPropertyRNA rna_KeyingSetPath_id_type = {
	...
	0, -1, NULL},
	KeyingSetPath_id_type_get, KeyingSetPath_id_type_set, NULL, NULL, NULL, NULL, rna_KeyingSetPath_id_type_items, 33, 16975
};

StringPropertyRNA rna_KeyingSetPath_group = {
	{(PropertyRNA *)&rna_KeyingSetPath_group_method, (PropertyRNA *)&rna_KeyingSetPath_id_type,
	-1, "group", 262145, 0, 0, 0, "Group Name",
...
BoolPropertyRNA rna_KeyingSetPath_use_entire_array = {
	...
	-1, "use_entire_array", 3, 0, 0, 0, "Entire Array",
...
StringPropertyRNA rna_KeyingSetInfo_bl_label = {
	...
	-1, "bl_label", 262161, 0, 0, 0, "UI Name",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
