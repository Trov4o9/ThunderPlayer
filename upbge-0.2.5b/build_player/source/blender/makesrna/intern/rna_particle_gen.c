...
PointerPropertyRNA rna_ParticleSettings_collision_group;
...
bool SPHFluidSettings_factor_repulsion_get(PointerRNA *ptr)
{
	SPHFluidSettings *data = (SPHFluidSettings *)(ptr->data);
	return (((data->flag) & 4) != 0);
}

void SPHFluidSettings_factor_repulsion_set(PointerRNA *ptr, bool value)
{
	SPHFluidSettings *data = (SPHFluidSettings *)(ptr->data);
...
bool SPHFluidSettings_factor_radius_get(PointerRNA *ptr)
{
	SPHFluidSettings *data = (SPHFluidSettings *)(ptr->data);
	return (((data->flag) & 16) != 0);
}

void SPHFluidSettings_factor_radius_set(PointerRNA *ptr, bool value)
{
	SPHFluidSettings *data = (SPHFluidSettings *)(ptr->data);
...
bool SPHFluidSettings_factor_stiff_viscosity_get(PointerRNA *ptr)
{
	SPHFluidSettings *data = (SPHFluidSettings *)(ptr->data);
	return (((data->flag) & 32) != 0);
}

void SPHFluidSettings_factor_stiff_viscosity_set(PointerRNA *ptr, bool value)
{
	SPHFluidSettings *data = (SPHFluidSettings *)(ptr->data);
...
bool SPHFluidSettings_factor_rest_length_get(PointerRNA *ptr)
{
	SPHFluidSettings *data = (SPHFluidSettings *)(ptr->data);
	return (((data->flag) & 64) != 0);
}

void SPHFluidSettings_factor_rest_length_set(PointerRNA *ptr, bool value)
{
	SPHFluidSettings *data = (SPHFluidSettings *)(ptr->data);
...
bool ParticleSettings_regrow_hair_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return (((data->flag) & 16) != 0);
}

void ParticleSettings_regrow_hair_set(PointerRNA *ptr, bool value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	if (value) data->flag |= 16;
	else data->flag &= ~16;
...
bool ParticleSettings_use_render_emitter_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return (((data->draw) & 8) != 0);
}

void ParticleSettings_use_render_emitter_set(PointerRNA *ptr, bool value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
...
bool ParticleSettings_use_group_pick_random_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return (((data->draw) & 1024) != 0);
}

void ParticleSettings_use_group_pick_random_set(PointerRNA *ptr, bool value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
...
bool ParticleSettings_use_group_count_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return (((data->draw) & 64) != 0);
}

void ParticleSettings_use_group_count_set(PointerRNA *ptr, bool value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
...
bool ParticleSettings_use_global_dupli_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return (((data->draw) & 2) != 0);
}

void ParticleSettings_use_global_dupli_set(PointerRNA *ptr, bool value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
...
bool ParticleSettings_use_rotation_dupli_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return (((data->draw) & 128) != 0);
}

void ParticleSettings_use_rotation_dupli_set(PointerRNA *ptr, bool value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
...
bool ParticleSettings_use_scale_dupli_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return !(((data->draw) & 65536) != 0);
}

void ParticleSettings_use_scale_dupli_set(PointerRNA *ptr, bool value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
...
bool ParticleSettings_use_whole_group_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return (((data->draw) & 16384) != 0);
}

void ParticleSettings_use_whole_group_set(PointerRNA *ptr, bool value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
...
bool ParticleSettings_lock_billboard_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return (((data->draw) & 128) != 0);
}

void ParticleSettings_lock_billboard_set(PointerRNA *ptr, bool value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	if (value) data->draw |= 128;
	else data->draw &= ~128;
...
bool ParticleSettings_use_simplify_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return (((data->simplify_flag) & 1) != 0);
}

void ParticleSettings_use_simplify_set(PointerRNA *ptr, bool value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
...
bool ParticleSettings_use_simplify_viewport_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return (((data->simplify_flag) & 2) != 0);
}

void ParticleSettings_use_simplify_viewport_set(PointerRNA *ptr, bool value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
...
PointerRNA ParticleSettings_collision_group_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return rna_pointer_inherit_refine(ptr, &RNA_Group, data->collision_group);
}

void ParticleSettings_collision_group_set(PointerRNA *ptr, PointerRNA value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	if (value.data)
		id_lib_extern((ID *)value.data);
...
void ParticleSystem_set_resolution(struct ParticleSystem *_self, Main *bmain, struct Scene *scene, struct Object *object, int resolution)
{
	rna_ParticleSystem_set_resolution(_self, bmain, scene, object, resolution);
}
...
void ParticleSystem_set_resolution_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	rna_ParticleSystem_set_resolution(_self, CTX_data_main(C), scene, object, resolution);
}
...
void rna_ParticleSystem_set_resolution(struct ParticleSystem *_self, Main *bmain, struct Scene *scene, struct Object *object, int resolution);
...
PointerPropertyRNA rna_ParticleTarget_object = {
	...
	-1, "object", 8388609, 0, 0, 0, "Target Object",
...
IntPropertyRNA rna_ParticleTarget_system = {
	...
	-1, "system", 3, 0, 4, 0, "Target Particle System",
...
FloatPropertyRNA rna_SPHFluidSettings_spring_force = {
	...
	-1, "spring_force", 3, 0, 4, 0, "Spring Force",
	"Spring force",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_reset, 0, NULL, NULL,
...
FloatPropertyRNA rna_SPHFluidSettings_fluid_radius = {
	...
	-1, "fluid_radius", 3, 0, 4, 0, "Interaction Radius",
...
BoolPropertyRNA rna_SPHFluidSettings_use_viscoelastic_springs = {
	...
	-1, "use_viscoelastic_springs", 3, 0, 0, 0, "Viscoelastic Springs",
...
BoolPropertyRNA rna_SPHFluidSettings_use_initial_rest_length = {
	...
	-1, "use_initial_rest_length", 3, 0, 0, 0, "Initial Rest Length",
...
FloatPropertyRNA rna_SPHFluidSettings_plasticity = {
	...
	-1, "plasticity", 3, 0, 4, 0, "Plasticity",
...
FloatPropertyRNA rna_SPHFluidSettings_yield_ratio = {
	...
	-1, "yield_ratio", 3, 0, 4, 0, "Elastic Limit",
...
IntPropertyRNA rna_SPHFluidSettings_spring_frames = {
	...
	-1, "spring_frames", 3, 0, 4, 0, "Spring Frames",
...
FloatPropertyRNA rna_SPHFluidSettings_linear_viscosity = {
	...
	-1, "linear_viscosity", 3, 0, 4, 0, "Viscosity",
	"Linear viscosity",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_reset, 0, NULL, NULL,
...
FloatPropertyRNA rna_SPHFluidSettings_stiff_viscosity = {
	...
	-1, "stiff_viscosity", 3, 0, 4, 0, "Stiff viscosity",
...
FloatPropertyRNA rna_SPHFluidSettings_repulsion = {
	...
	-1, "repulsion", 3, 0, 4, 0, "Repulsion Factor",
...
FloatPropertyRNA rna_SPHFluidSettings_rest_density = {
	...
	-1, "rest_density", 3, 0, 4, 0, "Rest Density",
	"Fluid rest density",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_reset, 0, NULL, NULL,
...
BoolPropertyRNA rna_SPHFluidSettings_factor_repulsion = {
	...
	-1, "factor_repulsion", 3, 0, 0, 0, "Factor Repulsion",
...
BoolPropertyRNA rna_SPHFluidSettings_use_factor_density = {
	...
	-1, "use_factor_density", 3, 0, 0, 0, "Factor Density",
...
BoolPropertyRNA rna_SPHFluidSettings_factor_radius = {
	...
	-1, "factor_radius", 3, 0, 0, 0, "Factor Radius",
...
BoolPropertyRNA rna_SPHFluidSettings_factor_stiff_viscosity = {
	...
	-1, "factor_stiff_viscosity", 3, 0, 0, 0, "Factor Stiff Viscosity",
...
BoolPropertyRNA rna_SPHFluidSettings_factor_rest_length = {
	...
	-1, "factor_rest_length", 3, 0, 0, 0, "Factor Rest Length",
...
FloatPropertyRNA rna_ParticleHairKey_co = {
	...
	-1, "co", 3, 0, 0, 0, "Location (Object Space)",
...
FloatPropertyRNA rna_Particle_location = {
	...
	-1, "location", 3, 0, 4, 0, "Particle Location",
	"",
	0, "*",
	PROP_FLOAT, PROP_TRANSLATION | PROP_UNIT_LENGTH, NULL, 1, {3, 0, 0}, 3,
	NULL, 0, NULL, NULL,
...
FloatPropertyRNA rna_Particle_velocity = {
	...
	-1, "velocity", 3, 0, 4, 0, "Particle Velocity",
	"",
	0, "*",
	PROP_FLOAT, PROP_VELOCITY | PROP_UNIT_VELOCITY, NULL, 1, {3, 0, 0}, 3,
	NULL, 0, NULL, NULL,
...
FloatPropertyRNA rna_Particle_prev_location = {
	...
	-1, "prev_location", 3, 0, 4, 0, "Previous Particle Location",
	"",
	0, "*",
	PROP_FLOAT, PROP_TRANSLATION | PROP_UNIT_LENGTH, NULL, 1, {3, 0, 0}, 3,
	NULL, 0, NULL, NULL,
...
FloatPropertyRNA rna_Particle_prev_velocity = {
	...
	-1, "prev_velocity", 3, 0, 4, 0, "Previous Particle Velocity",
	"",
	0, "*",
	PROP_FLOAT, PROP_VELOCITY | PROP_UNIT_VELOCITY, NULL, 1, {3, 0, 0}, 3,
	NULL, 0, NULL, NULL,
...
FloatPropertyRNA rna_Particle_prev_angular_velocity = {
	...
	-1, "prev_angular_velocity", 3, 0, 4, 0, "Previous Angular Velocity",
	"",
	0, "*",
	PROP_FLOAT, PROP_VELOCITY | PROP_UNIT_VELOCITY, NULL, 1, {3, 0, 0}, 3,
	NULL, 0, NULL, NULL,
...
FloatPropertyRNA rna_Particle_prev_rotation = {
	...
	-1, "prev_rotation", 3, 0, 4, 0, "Previous Rotation",
	"",
	0, "*",
	PROP_FLOAT, PROP_QUATERNION | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	NULL, 0, NULL, NULL,
...
CollectionPropertyRNA rna_Particle_particle_keys = {
	...
	-1, "particle_keys", 0, 0, 8, 0, "Keyed States",
	"",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
FloatPropertyRNA rna_Particle_birth_time = {
	...
	-1, "birth_time", 3, 0, 4, 0, "Birth Time",
	"",
	0, "*",
	PROP_FLOAT, PROP_TIME | PROP_UNIT_TIME, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
EnumPropertyRNA rna_Particle_alive_state = {
	...
	-1, "alive_state", 3, 0, 0, 0, "Alive State",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_ParticleSystem_settings = {
	...
	-1, "settings", 8650753, 0, 0, 0, "Settings",
...
CollectionPropertyRNA rna_ParticleSystem_child_particles = {
	...
	-1, "child_particles", 0, 0, 8, 0, "Child Particles",
...
IntPropertyRNA rna_ParticleSystem_child_seed = {
	...
	-1, "child_seed", 3, 0, 4, 0, "Child Seed",
...
BoolPropertyRNA rna_ParticleSystem_is_global_hair = {
	...
	-1, "is_global_hair", 2, 0, 0, 0, "Global Hair",
...
BoolPropertyRNA rna_ParticleSystem_use_hair_dynamics = {
	...
	-1, "use_hair_dynamics", 3, 0, 0, 0, "Hair Dynamics",
	"Enable hair dynamics using cloth simulation",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_hair_dynamics_update, 0, NULL, NULL,
	0, -1, NULL},
...
PointerPropertyRNA rna_ParticleSystem_reactor_target_object = {
	...
	-1, "reactor_target_object", 8388609, 0, 0, 0, "Reactor Target Object",
...
IntPropertyRNA rna_ParticleSystem_reactor_target_particle_system = {
	...
	-1, "reactor_target_particle_system", 3, 0, 4, 0, "Reactor Target Particle System",
...
BoolPropertyRNA rna_ParticleSystem_use_keyed_timing = {
	...
	-1, "use_keyed_timing", 1, 0, 0, 0, "Keyed timing",
	"Use key times",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_redo, 0, NULL, NULL,
...
PointerPropertyRNA rna_ParticleSystem_active_particle_target = {
	...
	-1, "active_particle_target", 8388608, 0, 0, 0, "Active Particle Target",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_ParticleSystem_active_particle_target_index = {
	...
	-1, "active_particle_target_index", 3, 0, 0, 0, "Active Particle Target Index",
	"",
	0, "*",
	PROP_INT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
StringPropertyRNA rna_ParticleSystem_billboard_normal_uv = {
	...
	-1, "billboard_normal_uv", 262145, 0, 0, 0, "Billboard Normal UV",
...
StringPropertyRNA rna_ParticleSystem_billboard_time_index_uv = {
	...
	-1, "billboard_time_index_uv", 262145, 0, 0, 0, "Billboard Time Index UV",
...
StringPropertyRNA rna_ParticleSystem_billboard_split_uv = {
	...
	-1, "billboard_split_uv", 262145, 0, 0, 0, "Billboard Split UV",
...
StringPropertyRNA rna_ParticleSystem_vertex_group_density = {
	...
	-1, "vertex_group_density", 262145, 0, 0, 0, "Vertex Group Density",
...
BoolPropertyRNA rna_ParticleSystem_invert_vertex_group_density = {
	...
	-1, "invert_vertex_group_density", 3, 0, 0, 0, "Vertex Group Density Negate",
...
StringPropertyRNA rna_ParticleSystem_vertex_group_velocity = {
	...
	-1, "vertex_group_velocity", 262145, 0, 0, 0, "Vertex Group Velocity",
...
BoolPropertyRNA rna_ParticleSystem_invert_vertex_group_velocity = {
	...
	-1, "invert_vertex_group_velocity", 3, 0, 0, 0, "Vertex Group Velocity Negate",
...
StringPropertyRNA rna_ParticleSystem_vertex_group_length = {
	...
	-1, "vertex_group_length", 262145, 0, 0, 0, "Vertex Group Length",
...
BoolPropertyRNA rna_ParticleSystem_invert_vertex_group_length = {
	...
	-1, "invert_vertex_group_length", 3, 0, 0, 0, "Vertex Group Length Negate",
...
StringPropertyRNA rna_ParticleSystem_vertex_group_clump = {
	...
	-1, "vertex_group_clump", 262145, 0, 0, 0, "Vertex Group Clump",
...
BoolPropertyRNA rna_ParticleSystem_invert_vertex_group_clump = {
	...
	-1, "invert_vertex_group_clump", 3, 0, 0, 0, "Vertex Group Clump Negate",
...
StringPropertyRNA rna_ParticleSystem_vertex_group_kink = {
	...
	-1, "vertex_group_kink", 262145, 0, 0, 0, "Vertex Group Kink",
...
BoolPropertyRNA rna_ParticleSystem_invert_vertex_group_kink = {
	...
	-1, "invert_vertex_group_kink", 3, 0, 0, 0, "Vertex Group Kink Negate",
...
StringPropertyRNA rna_ParticleSystem_vertex_group_roughness_1 = {
	...
	-1, "vertex_group_roughness_1", 262145, 0, 0, 0, "Vertex Group Roughness 1",
...
BoolPropertyRNA rna_ParticleSystem_invert_vertex_group_roughness_1 = {
	...
	-1, "invert_vertex_group_roughness_1", 3, 0, 0, 0, "Vertex Group Roughness 1 Negate",
...
StringPropertyRNA rna_ParticleSystem_vertex_group_roughness_2 = {
	...
	-1, "vertex_group_roughness_2", 262145, 0, 0, 0, "Vertex Group Roughness 2",
...
BoolPropertyRNA rna_ParticleSystem_invert_vertex_group_roughness_2 = {
	...
	-1, "invert_vertex_group_roughness_2", 3, 0, 0, 0, "Vertex Group Roughness 2 Negate",
...
StringPropertyRNA rna_ParticleSystem_vertex_group_roughness_end = {
	...
	-1, "vertex_group_roughness_end", 262145, 0, 0, 0, "Vertex Group Roughness End",
...
BoolPropertyRNA rna_ParticleSystem_invert_vertex_group_roughness_end = {
	...
	-1, "invert_vertex_group_roughness_end", 3, 0, 0, 0, "Vertex Group Roughness End Negate",
...
StringPropertyRNA rna_ParticleSystem_vertex_group_size = {
	...
	-1, "vertex_group_size", 262145, 0, 0, 0, "Vertex Group Size",
...
BoolPropertyRNA rna_ParticleSystem_invert_vertex_group_size = {
	...
	-1, "invert_vertex_group_size", 3, 0, 0, 0, "Vertex Group Size Negate",
...
StringPropertyRNA rna_ParticleSystem_vertex_group_tangent = {
	...
	-1, "vertex_group_tangent", 262145, 0, 0, 0, "Vertex Group Tangent",
...
BoolPropertyRNA rna_ParticleSystem_invert_vertex_group_tangent = {
	...
	-1, "invert_vertex_group_tangent", 3, 0, 0, 0, "Vertex Group Tangent Negate",
...
StringPropertyRNA rna_ParticleSystem_vertex_group_rotation = {
	...
	-1, "vertex_group_rotation", 262145, 0, 0, 0, "Vertex Group Rotation",
...
BoolPropertyRNA rna_ParticleSystem_invert_vertex_group_rotation = {
	...
	-1, "invert_vertex_group_rotation", 3, 0, 0, 0, "Vertex Group Rotation Negate",
...
StringPropertyRNA rna_ParticleSystem_vertex_group_field = {
	...
	-1, "vertex_group_field", 262145, 0, 0, 0, "Vertex Group Field",
...
BoolPropertyRNA rna_ParticleSystem_invert_vertex_group_field = {
	...
	-1, "invert_vertex_group_field", 3, 0, 0, 0, "Vertex Group Field Negate",
...
StringPropertyRNA rna_ParticleSystem_vertex_group_twist = {
	...
	-1, "vertex_group_twist", 262145, 0, 0, 0, "Vertex Group Twist",
...
BoolPropertyRNA rna_ParticleSystem_invert_vertex_group_twist = {
	...
	-1, "invert_vertex_group_twist", 3, 0, 0, 0, "Vertex Group Twist Negate",
...
PointerPropertyRNA rna_ParticleSystem_point_cache = {
	...
	-1, "point_cache", 8650752, 0, 0, 0, "Point Cache",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_ParticleSystem_has_multiple_caches = {
	...
	-1, "has_multiple_caches", 2, 0, 0, 0, "Multiple Caches",
...
BoolPropertyRNA rna_ParticleSystem_is_editable = {
	...
	-1, "is_editable", 2, 0, 0, 0, "Editable",
...
static const EnumPropertyItem rna_ParticleSystem_set_resolution_resolution_items[3] = {
...
FunctionRNA rna_ParticleSystem_set_resolution_func = {
	...
	"set_resolution", 4, "Set the resolution to use for the number of particles",
...
IntPropertyRNA rna_ParticleSystem_co_hair_particle_no = {
	...
	-1, "particle_no", 3, 0, 0, 0, "Particle no",
	"",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_ParticleSettingsTextureSlot_use_map_time = {
	...
	-1, "use_map_time", 3, 0, 0, 0, "Emission Time",
...
BoolPropertyRNA rna_ParticleSettingsTextureSlot_use_map_life = {
	...
	-1, "use_map_life", 3, 0, 0, 0, "Life Time",
...
BoolPropertyRNA rna_ParticleSettingsTextureSlot_use_map_velocity = {
	...
	-1, "use_map_velocity", 3, 0, 0, 0, "Initial Velocity",
...
BoolPropertyRNA rna_ParticleSettingsTextureSlot_use_map_field = {
	...
	-1, "use_map_field", 3, 0, 0, 0, "Force Field",
...
BoolPropertyRNA rna_ParticleSettingsTextureSlot_use_map_gravity = {
	...
	-1, "use_map_gravity", 3, 0, 0, 0, "Gravity",
...
BoolPropertyRNA rna_ParticleSettingsTextureSlot_use_map_kink_amp = {
	...
	-1, "use_map_kink_amp", 3, 0, 0, 0, "Kink Amplitude",
...
BoolPropertyRNA rna_ParticleSettingsTextureSlot_use_map_kink_freq = {
	...
	-1, "use_map_kink_freq", 3, 0, 0, 0, "Kink Frequency",
...
BoolPropertyRNA rna_ParticleSettingsTextureSlot_use_map_length = {
	...
	-1, "use_map_length", 3, 0, 0, 0, "Length",
...
FloatPropertyRNA rna_ParticleSettingsTextureSlot_time_factor = {
	...
	-1, "time_factor", 3, 0, 4, 0, "Emission Time Factor",
...
FloatPropertyRNA rna_ParticleSettingsTextureSlot_life_factor = {
	...
	-1, "life_factor", 3, 0, 4, 0, "Life Time Factor",
...
FloatPropertyRNA rna_ParticleSettingsTextureSlot_size_factor = {
	...
	-1, "size_factor", 3, 0, 4, 0, "Size Factor",
...
FloatPropertyRNA rna_ParticleSettingsTextureSlot_velocity_factor = {
	...
	-1, "velocity_factor", 3, 0, 4, 0, "Velocity Factor",
...
FloatPropertyRNA rna_ParticleSettingsTextureSlot_field_factor = {
	...
	-1, "field_factor", 3, 0, 4, 0, "Field Factor",
...
FloatPropertyRNA rna_ParticleSettingsTextureSlot_gravity_factor = {
	...
	-1, "gravity_factor", 3, 0, 4, 0, "Gravity Factor",
...
FloatPropertyRNA rna_ParticleSettingsTextureSlot_damp_factor = {
	...
	-1, "damp_factor", 3, 0, 4, 0, "Damp Factor",
...
FloatPropertyRNA rna_ParticleSettingsTextureSlot_length_factor = {
	...
	-1, "length_factor", 3, 0, 4, 0, "Length Factor",
...
FloatPropertyRNA rna_ParticleSettingsTextureSlot_clump_factor = {
	...
	-1, "clump_factor", 3, 0, 4, 0, "Clump Factor",
...
FloatPropertyRNA rna_ParticleSettingsTextureSlot_kink_amp_factor = {
	...
	-1, "kink_amp_factor", 3, 0, 4, 0, "Kink Amplitude Factor",
...
FloatPropertyRNA rna_ParticleSettingsTextureSlot_kink_freq_factor = {
	...
	-1, "kink_freq_factor", 3, 0, 4, 0, "Kink Frequency Factor",
...
FloatPropertyRNA rna_ParticleSettingsTextureSlot_rough_factor = {
	...
	-1, "rough_factor", 3, 0, 4, 0, "Rough Factor",
...
FloatPropertyRNA rna_ParticleSettingsTextureSlot_twist_factor = {
	...
	-1, "twist_factor", 3, 0, 4, 0, "Twist Factor",
...
BoolPropertyRNA rna_ParticleSettings_use_react_start_end = {
	...
	-1, "use_react_start_end", 1, 0, 0, 0, "Start/End",
...
BoolPropertyRNA rna_ParticleSettings_use_react_multiple = {
	...
	-1, "use_react_multiple", 1, 0, 0, 0, "Multi React",
...
BoolPropertyRNA rna_ParticleSettings_use_emit_random = {
	...
	-1, "use_emit_random", 1, 0, 0, 0, "Random",
...
BoolPropertyRNA rna_ParticleSettings_use_even_distribution = {
	...
	-1, "use_even_distribution", 1, 0, 0, 0, "Even Distribution",
...
BoolPropertyRNA rna_ParticleSettings_use_die_on_collision = {
	...
	-1, "use_die_on_collision", 1, 0, 0, 0, "Die on hit",
...
BoolPropertyRNA rna_ParticleSettings_use_size_deflect = {
	...
	-1, "use_size_deflect", 1, 0, 0, 0, "Size Deflect",
...
BoolPropertyRNA rna_ParticleSettings_use_rotations = {
	...
	-1, "use_rotations", 1, 0, 0, 0, "Rotations",
...
BoolPropertyRNA rna_ParticleSettings_use_dynamic_rotation = {
	...
	-1, "use_dynamic_rotation", 1, 0, 0, 0, "Dynamic",
...
BoolPropertyRNA rna_ParticleSettings_use_multiply_size_mass = {
	...
	-1, "use_multiply_size_mass", 1, 0, 0, 0, "Mass from Size",
...
BoolPropertyRNA rna_ParticleSettings_use_advanced_hair = {
	...
	-1, "use_advanced_hair", 1, 0, 0, 0, "Advanced",
...
BoolPropertyRNA rna_ParticleSettings_lock_boids_to_surface = {
	...
	-1, "lock_boids_to_surface", 3, 0, 0, 0, "Boids 2D",
...
BoolPropertyRNA rna_ParticleSettings_use_hair_bspline = {
	...
	-1, "use_hair_bspline", 3, 0, 0, 0, "B-Spline",
...
BoolPropertyRNA rna_ParticleSettings_invert_grid = {
	...
	-1, "invert_grid", 3, 0, 0, 0, "Invert Grid",
...
BoolPropertyRNA rna_ParticleSettings_hexagonal_grid = {
	...
	-1, "hexagonal_grid", 3, 0, 0, 0, "Hexagonal Grid",
...
BoolPropertyRNA rna_ParticleSettings_apply_effector_to_children = {
	...
	-1, "apply_effector_to_children", 3, 0, 0, 0, "Effect Children",
...
BoolPropertyRNA rna_ParticleSettings_create_long_hair_children = {
	...
	-1, "create_long_hair_children", 3, 0, 0, 0, "Long Hair",
...
BoolPropertyRNA rna_ParticleSettings_apply_guide_to_children = {
	...
	-1, "apply_guide_to_children", 3, 0, 0, 0, "apply_guide_to_children",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_redo, 0, NULL, NULL,
...
BoolPropertyRNA rna_ParticleSettings_use_self_effect = {
	...
	-1, "use_self_effect", 3, 0, 0, 0, "Self Effect",
...
EnumPropertyRNA rna_ParticleSettings_distribution = {
	...
	-1, "distribution", 1, 0, 0, 0, "Distribution",
...
EnumPropertyRNA rna_ParticleSettings_physics_type = {
	...
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_change_physics_type, 0, NULL, NULL,
	0, -1, NULL},
...
EnumPropertyRNA rna_ParticleSettings_rotation_mode = {
	...
	-1, "rotation_mode", 1, 0, 0, 0, "Orientation axis",
...
EnumPropertyRNA rna_ParticleSettings_angular_velocity_mode = {
	...
	-1, "angular_velocity_mode", 1, 0, 0, 0, "Angular Velocity Axis",
...
EnumPropertyRNA rna_ParticleSettings_react_event = {
	...
	-1, "react_event", 1, 0, 0, 0, "React On",
...
BoolPropertyRNA rna_ParticleSettings_show_guide_hairs = {
	...
	-1, "show_guide_hairs", 3, 0, 0, 0, "Guide Hairs",
	"Show guide hairs",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_redo, 0, NULL, NULL,
...
BoolPropertyRNA rna_ParticleSettings_show_hair_grid = {
	...
	-1, "show_hair_grid", 3, 0, 0, 0, "Guide Hairs",
...
BoolPropertyRNA rna_ParticleSettings_show_velocity = {
	...
	-1, "show_velocity", 3, 0, 0, 0, "Velocity",
...
BoolPropertyRNA rna_ParticleSettings_use_render_emitter = {
	...
	-1, "use_render_emitter", 3, 0, 0, 0, "Emitter",
...
BoolPropertyRNA rna_ParticleSettings_use_absolute_path_time = {
	...
	-1, "use_absolute_path_time", 3, 0, 0, 0, "Absolute Path Time",
...
BoolPropertyRNA rna_ParticleSettings_use_parent_particles = {
	...
	-1, "use_parent_particles", 3, 0, 0, 0, "Parents",
...
BoolPropertyRNA rna_ParticleSettings_use_group_pick_random = {
	...
	-1, "use_group_pick_random", 3, 0, 0, 0, "Pick Random",
...
BoolPropertyRNA rna_ParticleSettings_use_group_count = {
	...
	-1, "use_group_count", 3, 0, 0, 0, "Use Count",
...
BoolPropertyRNA rna_ParticleSettings_use_global_dupli = {
	...
	-1, "use_global_dupli", 3, 0, 0, 0, "Global",
...
BoolPropertyRNA rna_ParticleSettings_use_rotation_dupli = {
	...
	-1, "use_rotation_dupli", 3, 0, 0, 0, "Rotation",
...
BoolPropertyRNA rna_ParticleSettings_use_scale_dupli = {
	...
	-1, "use_scale_dupli", 3, 0, 0, 0, "Scale",
...
BoolPropertyRNA rna_ParticleSettings_use_render_adaptive = {
	...
	-1, "use_render_adaptive", 3, 0, 0, 0, "Adaptive Render",
...
BoolPropertyRNA rna_ParticleSettings_use_velocity_length = {
	...
	-1, "use_velocity_length", 3, 0, 0, 0, "Speed",
...
BoolPropertyRNA rna_ParticleSettings_use_whole_group = {
	...
	-1, "use_whole_group", 3, 0, 0, 0, "Whole Group",
...
BoolPropertyRNA rna_ParticleSettings_use_strand_primitive = {
	...
	-1, "use_strand_primitive", 3, 0, 0, 0, "Strand Render",
...
static const EnumPropertyItem rna_ParticleSettings_draw_method_items[7] = {
	{0, "NONE", 0, "None", ""},
...
EnumPropertyRNA rna_ParticleSettings_draw_method = {
	...
	-1, "draw_method", 3, 0, 0, 0, "Particle Drawing",
...
static const EnumPropertyItem rna_ParticleSettings_render_type_items[8] = {
	{0, "NONE", 0, "None", ""},
	{1, "HALO", 0, "Halo", ""},
	{5, "LINE", 0, "Line", ""},
	{6, "PATH", 0, "Path", ""},
...
EnumPropertyRNA rna_ParticleSettings_render_type = {
	...
	-1, "render_type", 3, 0, 0, 0, "Particle Rendering",
...
static const EnumPropertyItem rna_ParticleSettings_draw_color_items[5] = {
	{0, "NONE", 0, "None", ""},
...
EnumPropertyRNA rna_ParticleSettings_draw_color = {
	...
	-1, "draw_color", 3, 0, 0, 0, "Draw Color",
...
EnumPropertyRNA rna_ParticleSettings_child_type = {
	...
	-1, "child_type", 3, 0, 0, 0, "Children From",
...
FloatPropertyRNA rna_ParticleSettings_bending_random = {
	...
	-1, "bending_random", 3, 0, 4, 0, "Random Bending Stiffness",
...
IntPropertyRNA rna_ParticleSettings_adaptive_angle = {
	...
	-1, "adaptive_angle", 3, 0, 4, 0, "Degrees",
...
IntPropertyRNA rna_ParticleSettings_adaptive_pixel = {
	...
	-1, "adaptive_pixel", 3, 0, 4, 0, "Pixel",
...
IntPropertyRNA rna_ParticleSettings_draw_percentage = {
	...
	-1, "draw_percentage", 3, 0, 4, 0, "Display",
...
IntPropertyRNA rna_ParticleSettings_material = {
	...
	-1, "material", 3, 0, 4, 0, "Material Index",
...
EnumPropertyRNA rna_ParticleSettings_material_slot = {
	...
	-1, "material_slot", 3, 0, 0, 0, "Material Slot",
...
EnumPropertyRNA rna_ParticleSettings_integrator = {
	...
	-1, "integrator", 3, 0, 0, 0, "Integration",
...
BoolPropertyRNA rna_ParticleSettings_lock_billboard = {
	...
	-1, "lock_billboard", 3, 0, 0, 0, "Lock Billboard",
...
static const EnumPropertyItem rna_ParticleSettings_billboard_align_items[6] = {
	{0, "X", 0, "X", ""},
	{1, "Y", 0, "Y", ""},
	{2, "Z", 0, "Z", ""},
	{3, "VIEW", 0, "View", ""},
...
EnumPropertyRNA rna_ParticleSettings_billboard_align = {
	...
	-1, "billboard_align", 3, 0, 0, 0, "Align to",
...
IntPropertyRNA rna_ParticleSettings_billboard_uv_split = {
	...
	-1, "billboard_uv_split", 3, 0, 4, 0, "UV Split",
...
static const EnumPropertyItem rna_ParticleSettings_billboard_animation_items[5] = {
	{0, "NONE", 0, "None", ""},
	{1, "AGE", 0, "Age", ""},
	{3, "FRAME", 0, "Frame", ""},
	{2, "ANGLE", 0, "Angle", ""},
...
EnumPropertyRNA rna_ParticleSettings_billboard_animation = {
	...
	-1, "billboard_animation", 3, 0, 0, 0, "Animate",
...
static const EnumPropertyItem rna_ParticleSettings_billboard_offset_split_items[4] = {
	{0, "NONE", 0, "None", ""},
	{1, "LINEAR", 0, "Linear", ""},
	{2, "RANDOM", 0, "Random", ""},
	{0, NULL, 0, NULL, NULL}
...
EnumPropertyRNA rna_ParticleSettings_billboard_offset_split = {
	...
	-1, "billboard_offset_split", 3, 0, 0, 0, "Offset",
...
FloatPropertyRNA rna_ParticleSettings_billboard_tilt = {
	...
	-1, "billboard_tilt", 3, 0, 4, 0, "Tilt",
	"Tilt of the billboards",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_redo, 0, NULL, NULL,
	offsetof(ParticleSettings, bb_tilt), 5, NULL},
...
FloatPropertyRNA rna_ParticleSettings_color_maximum = {
	...
	-1, "color_maximum", 3, 0, 4, 0, "Color Maximum",
...
FloatPropertyRNA rna_ParticleSettings_billboard_tilt_random = {
	...
	-1, "billboard_tilt_random", 3, 0, 4, 0, "Random Tilt",
	"Random tilt of the billboards",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_redo, 0, NULL, NULL,
	offsetof(ParticleSettings, bb_rand_tilt), 5, NULL},
...
FloatPropertyRNA rna_ParticleSettings_billboard_offset = {
	...
	-1, "billboard_offset", 3, 0, 4, 0, "Billboard Offset",
	"",
	0, "*",
	PROP_FLOAT, PROP_TRANSLATION | PROP_UNIT_LENGTH, NULL, 1, {2, 0, 0}, 2,
	rna_Particle_redo, 0, NULL, NULL,
	offsetof(ParticleSettings, bb_offset), 5, NULL},
...
FloatPropertyRNA rna_ParticleSettings_billboard_velocity_head = {
	...
	-1, "billboard_velocity_head", 3, 0, 4, 0, "Billboard Velocity Head",
	"Scale billboards by velocity",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_redo, 0, NULL, NULL,
	offsetof(ParticleSettings, bb_vel_head), 5, NULL},
...
FloatPropertyRNA rna_ParticleSettings_billboard_velocity_tail = {
	...
	-1, "billboard_velocity_tail", 3, 0, 4, 0, "Billboard Velocity Tail",
	"Scale billboards by velocity",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_redo, 0, NULL, NULL,
	offsetof(ParticleSettings, bb_vel_tail), 5, NULL},
...
BoolPropertyRNA rna_ParticleSettings_use_simplify = {
	...
	-1, "use_simplify", 3, 0, 0, 0, "Child Simplification",
...
BoolPropertyRNA rna_ParticleSettings_use_simplify_viewport = {
	...
	-1, "use_simplify_viewport", 3, 0, 0, 0, "Viewport",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_ParticleSettings_simplify_refsize = {
	...
	-1, "simplify_refsize", 3, 0, 4, 0, "Reference Size",
...
FloatPropertyRNA rna_ParticleSettings_simplify_rate = {
	...
	-1, "simplify_rate", 3, 0, 4, 0, "Rate",
	"Speed of simplification",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(ParticleSettings, simplify_rate), 5, NULL},
...
FloatPropertyRNA rna_ParticleSettings_simplify_transition = {
	...
	-1, "simplify_transition", 3, 0, 4, 0, "Transition",
	"Transition period for fading out strands",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(ParticleSettings, simplify_transition), 5, NULL},
...
FloatPropertyRNA rna_ParticleSettings_simplify_viewport = {
	...
	-1, "simplify_viewport", 3, 0, 4, 0, "Rate",
	"Speed of Simplification",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(ParticleSettings, simplify_viewport), 5, NULL},
...
FloatPropertyRNA rna_ParticleSettings_lifetime_random = {
	...
	-1, "lifetime_random", 3, 0, 4, 0, "Random",
...
BoolPropertyRNA rna_ParticleSettings_use_adaptive_subframes = {
	...
	-1, "use_adaptive_subframes", 3, 0, 0, 0, "Automatic Subframes",
...
FloatPropertyRNA rna_ParticleSettings_courant_target = {
	...
	-1, "courant_target", 3, 0, 4, 0, "Adaptive Subframe Threshold",
...
FloatPropertyRNA rna_ParticleSettings_jitter_factor = {
	...
	-1, "jitter_factor", 1, 0, 4, 0, "Amount",
...
FloatPropertyRNA rna_ParticleSettings_effect_hair = {
	...
	-1, "effect_hair", 3, 0, 4, 0, "Stiffness",
...
IntPropertyRNA rna_ParticleSettings_grid_resolution = {
	...
	-1, "grid_resolution", 1, 0, 4, 0, "Resolution",
...
FloatPropertyRNA rna_ParticleSettings_grid_random = {
	...
	-1, "grid_random", 3, 0, 4, 0, "Grid Randomness",
...
IntPropertyRNA rna_ParticleSettings_effector_amount = {
	...
	-1, "effector_amount", 3, 0, 4, 0, "Effector Number",
...
FloatPropertyRNA rna_ParticleSettings_normal_factor = {
	...
	-1, "normal_factor", 3, 0, 4, 0, "Normal",
...
FloatPropertyRNA rna_ParticleSettings_object_factor = {
	...
	-1, "object_factor", 3, 0, 4, 0, "Object",
...
FloatPropertyRNA rna_ParticleSettings_factor_random = {
	...
	-1, "factor_random", 3, 0, 4, 0, "Random",
...
FloatPropertyRNA rna_ParticleSettings_particle_factor = {
	...
	-1, "particle_factor", 3, 0, 4, 0, "Particle",
...
FloatPropertyRNA rna_ParticleSettings_tangent_factor = {
	...
	-1, "tangent_factor", 3, 0, 4, 0, "Tangent",
...
FloatPropertyRNA rna_ParticleSettings_reactor_factor = {
	...
	-1, "reactor_factor", 3, 0, 4, 0, "Reactor",
...
FloatPropertyRNA rna_ParticleSettings_object_align_factor = {
	...
	-1, "object_align_factor", 3, 0, 4, 0, "Object Aligned",
...
FloatPropertyRNA rna_ParticleSettings_angular_velocity_factor = {
	...
	-1, "angular_velocity_factor", 3, 0, 4, 0, "Angular Velocity",
...
FloatPropertyRNA rna_ParticleSettings_rotation_factor_random = {
	...
	-1, "rotation_factor_random", 3, 0, 4, 0, "Random Orientation",
...
FloatPropertyRNA rna_ParticleSettings_phase_factor_random = {
	...
	-1, "phase_factor_random", 3, 0, 4, 0, "Random Phase",
...
FloatPropertyRNA rna_ParticleSettings_hair_length = {
	...
	-1, "hair_length", 3, 0, 0, 0, "Hair Length",
	"Length of the hair",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_reset, 0, NULL, NULL,
...
FloatPropertyRNA rna_ParticleSettings_size_random = {
	{(PropertyRNA *)&rna_ParticleSettings_collision_group, (PropertyRNA *)&rna_ParticleSettings_particle_size,
	-1, "size_random", 3, 0, 4, 0, "Random Size",
...
PointerPropertyRNA rna_ParticleSettings_collision_group = {
	...
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_reset_dependency, 0, NULL, NULL,
	0, -1, NULL},
	ParticleSettings_collision_group_get, ParticleSettings_collision_group_set, NULL, NULL,&RNA_Group
};

FloatPropertyRNA rna_ParticleSettings_drag_factor = {
	{(PropertyRNA *)&rna_ParticleSettings_brownian_factor, (PropertyRNA *)&rna_ParticleSettings_collision_group,
	-1, "drag_factor", 3, 0, 4, 0, "Drag",
	"Amount of air-drag",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_reset, 0, NULL, NULL,
...
FloatPropertyRNA rna_ParticleSettings_brownian_factor = {
	...
	-1, "brownian_factor", 3, 0, 4, 0, "Brownian",
...
FloatPropertyRNA rna_ParticleSettings_length_random = {
	...
	-1, "length_random", 3, 0, 4, 0, "Random Length",
...
IntPropertyRNA rna_ParticleSettings_child_nbr = {
	...
	-1, "child_nbr", 3, 0, 4, 0, "Children Per Parent",
...
IntPropertyRNA rna_ParticleSettings_rendered_child_count = {
	...
	-1, "rendered_child_count", 3, 0, 4, 0, "Rendered Children",
...
FloatPropertyRNA rna_ParticleSettings_virtual_parents = {
	...
	-1, "virtual_parents", 3, 0, 4, 0, "Virtual Parents",
...
FloatPropertyRNA rna_ParticleSettings_child_size = {
	...
	-1, "child_size", 3, 0, 4, 0, "Child Size",
...
FloatPropertyRNA rna_ParticleSettings_child_size_random = {
	...
	-1, "child_size_random", 3, 0, 4, 0, "Random Child Size",
...
FloatPropertyRNA rna_ParticleSettings_child_radius = {
	...
	-1, "child_radius", 3, 0, 4, 0, "Child Radius",
...
FloatPropertyRNA rna_ParticleSettings_child_roundness = {
	...
	-1, "child_roundness", 3, 0, 4, 0, "Child Roundness",
...
BoolPropertyRNA rna_ParticleSettings_use_clump_curve = {
	...
	-1, "use_clump_curve", 3, 0, 0, 0, "Use Clump Curve",
...
PointerPropertyRNA rna_ParticleSettings_clump_curve = {
	...
	-1, "clump_curve", 8388608, 0, 0, 0, "Clump Curve",
...
BoolPropertyRNA rna_ParticleSettings_use_clump_noise = {
	...
	-1, "use_clump_noise", 3, 0, 0, 0, "Use Clump Noise",
...
FloatPropertyRNA rna_ParticleSettings_clump_noise_size = {
	...
	-1, "clump_noise_size", 3, 0, 4, 0, "Clump Noise Size",
	"Size of clump noise",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_redo_child, 0, NULL, NULL,
...
FloatPropertyRNA rna_ParticleSettings_kink_amplitude = {
	...
	-1, "kink_amplitude", 3, 0, 4, 0, "Amplitude",
...
FloatPropertyRNA rna_ParticleSettings_kink_amplitude_clump = {
	...
	-1, "kink_amplitude_clump", 3, 0, 4, 0, "Amplitude Clump",
...
FloatPropertyRNA rna_ParticleSettings_kink_amplitude_random = {
	...
	-1, "kink_amplitude_random", 3, 0, 4, 0, "Amplitude Random",
...
FloatPropertyRNA rna_ParticleSettings_kink_frequency = {
	...
	-1, "kink_frequency", 3, 0, 4, 0, "Frequency",
...
IntPropertyRNA rna_ParticleSettings_kink_extra_steps = {
	...
	-1, "kink_extra_steps", 3, 0, 4, 0, "Extra Steps",
...
FloatPropertyRNA rna_ParticleSettings_kink_axis_random = {
	...
	-1, "kink_axis_random", 3, 0, 4, 0, "Axis Random",
...
FloatPropertyRNA rna_ParticleSettings_roughness_1_size = {
	...
	-1, "roughness_1_size", 3, 0, 4, 0, "Size1",
...
FloatPropertyRNA rna_ParticleSettings_roughness_2_size = {
	...
	-1, "roughness_2_size", 3, 0, 4, 0, "Size2",
...
FloatPropertyRNA rna_ParticleSettings_roughness_2_threshold = {
	...
	-1, "roughness_2_threshold", 3, 0, 4, 0, "Threshold",
...
FloatPropertyRNA rna_ParticleSettings_roughness_endpoint = {
	...
	-1, "roughness_endpoint", 3, 0, 4, 0, "Rough Endpoint",
...
FloatPropertyRNA rna_ParticleSettings_roughness_end_shape = {
	...
	-1, "roughness_end_shape", 3, 0, 4, 0, "Shape",
...
BoolPropertyRNA rna_ParticleSettings_use_roughness_curve = {
	...
	-1, "use_roughness_curve", 3, 0, 0, 0, "Use Roughness Curve",
...
PointerPropertyRNA rna_ParticleSettings_roughness_curve = {
	...
	-1, "roughness_curve", 8388608, 0, 0, 0, "Roughness Curve",
...
FloatPropertyRNA rna_ParticleSettings_child_length_threshold = {
	...
	-1, "child_length_threshold", 3, 0, 4, 0, "Threshold",
...
FloatPropertyRNA rna_ParticleSettings_child_parting_factor = {
	...
	-1, "child_parting_factor", 3, 0, 4, 0, "Parting Factor",
...
FloatPropertyRNA rna_ParticleSettings_child_parting_min = {
	...
	-1, "child_parting_min", 3, 0, 4, 0, "Parting Minimum",
...
FloatPropertyRNA rna_ParticleSettings_child_parting_max = {
	...
	-1, "child_parting_max", 3, 0, 4, 0, "Parting Maximum",
...
FloatPropertyRNA rna_ParticleSettings_branch_threshold = {
	...
	-1, "branch_threshold", 3, 0, 4, 0, "Threshold",
...
FloatPropertyRNA rna_ParticleSettings_line_length_tail = {
	...
	-1, "line_length_tail", 3, 0, 0, 0, "Tail",
...
FloatPropertyRNA rna_ParticleSettings_line_length_head = {
	...
	-1, "line_length_head", 3, 0, 0, 0, "Head",
...
FloatPropertyRNA rna_ParticleSettings_path_start = {
	...
	-1, "path_start", 3, 0, 4, 0, "Path Start",
...
IntPropertyRNA rna_ParticleSettings_trail_count = {
	...
	-1, "trail_count", 3, 0, 4, 0, "Trail Count",
...
IntPropertyRNA rna_ParticleSettings_keyed_loops = {
	...
	-1, "keyed_loops", 3, 0, 4, 0, "Loop count",
...
BoolPropertyRNA rna_ParticleSettings_use_modifier_stack = {
	...
	-1, "use_modifier_stack", 3, 0, 4, 0, "Use Modifier Stack",
...
CollectionPropertyRNA rna_ParticleSettings_dupli_weights = {
	...
	-1, "dupli_weights", 0, 0, 0, 0, "Dupli Group Weights",
...
PointerPropertyRNA rna_ParticleSettings_active_dupliweight = {
	...
	-1, "active_dupliweight", 8388608, 0, 0, 0, "Active Dupli Object",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_ParticleSettings_active_dupliweight_index = {
	...
	-1, "active_dupliweight_index", 3, 0, 0, 0, "Active Dupli Object Index",
	"",
	0, "*",
	PROP_INT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_ParticleSettings_dupli_object = {
	...
	-1, "dupli_object", 8388609, 0, 0, 0, "Dupli Object",
...
PointerPropertyRNA rna_ParticleSettings_billboard_object = {
	...
	-1, "billboard_object", 8388609, 0, 0, 0, "Billboard Object",
...
PointerPropertyRNA rna_ParticleSettings_boids = {
	...
	-1, "boids", 8388608, 0, 0, 0, "Boid Settings",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_ParticleSettings_fluid = {
	...
	-1, "fluid", 8388608, 0, 0, 0, "SPH Fluid Settings",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_ParticleSettings_force_field_1 = {
	...
	-1, "force_field_1", 8388608, 0, 0, 0, "Force Field 1",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_ParticleSettings_force_field_2 = {
	...
	-1, "force_field_2", 8388608, 0, 0, 0, "Force Field 2",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_ParticleSettings_use_twist_curve = {
	...
	-1, "use_twist_curve", 3, 0, 0, 0, "Use Twist Curve",
	"Use a curve to define twist",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_ParticleSettings_use_twist_curve_update, 0, NULL, NULL,
	0, -1, NULL},
	ParticleSettings_use_twist_curve_get, ParticleSettings_use_twist_curve_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

PointerPropertyRNA rna_ParticleSettings_twist_curve = {
	{NULL, (PropertyRNA *)&rna_ParticleSettings_use_twist_curve,
	-1, "twist_curve", 8388608, 0, 0, 0, "Twist Curve",
...
StructRNA RNA_ParticleSettings = {
	...
	NULL,
	{(PropertyRNA *)&rna_ParticleSettings_texture_slots, (PropertyRNA *)&rna_ParticleSettings_twist_curve}},
