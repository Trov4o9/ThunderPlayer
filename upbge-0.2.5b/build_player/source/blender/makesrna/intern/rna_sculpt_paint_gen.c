...
BoolPropertyRNA rna_GPencilSculptSettings_affect_position;
BoolPropertyRNA rna_GPencilSculptSettings_affect_strength;
BoolPropertyRNA rna_GPencilSculptSettings_affect_thickness;
FloatPropertyRNA rna_GPencilSculptSettings_selection_alpha;
EnumPropertyRNA rna_GPencilSculptSettings_lockaxis;
...
bool GPencilSculptSettings_affect_position_get(PointerRNA *ptr)
{
	GP_BrushEdit_Settings *data = (GP_BrushEdit_Settings *)(ptr->data);
	return (((data->flag) & 2) != 0);
}

void GPencilSculptSettings_affect_position_set(PointerRNA *ptr, bool value)
{
	GP_BrushEdit_Settings *data = (GP_BrushEdit_Settings *)(ptr->data);
	if (value) data->flag |= 2;
	else data->flag &= ~2;
...
bool GPencilSculptSettings_affect_strength_get(PointerRNA *ptr)
{
	GP_BrushEdit_Settings *data = (GP_BrushEdit_Settings *)(ptr->data);
	return (((data->flag) & 4) != 0);
}

void GPencilSculptSettings_affect_strength_set(PointerRNA *ptr, bool value)
{
	GP_BrushEdit_Settings *data = (GP_BrushEdit_Settings *)(ptr->data);
	if (value) data->flag |= 4;
	else data->flag &= ~4;
...
bool GPencilSculptSettings_affect_thickness_get(PointerRNA *ptr)
{
	GP_BrushEdit_Settings *data = (GP_BrushEdit_Settings *)(ptr->data);
	return (((data->flag) & 8) != 0);
}

void GPencilSculptSettings_affect_thickness_set(PointerRNA *ptr, bool value)
{
	GP_BrushEdit_Settings *data = (GP_BrushEdit_Settings *)(ptr->data);
	if (value) data->flag |= 8;
	else data->flag &= ~8;
...
float GPencilSculptSettings_selection_alpha_get(PointerRNA *ptr)
{
	GP_BrushEdit_Settings *data = (GP_BrushEdit_Settings *)(ptr->data);
	return (float)(data->alpha);
}

void GPencilSculptSettings_selection_alpha_set(PointerRNA *ptr, float value)
{
	GP_BrushEdit_Settings *data = (GP_BrushEdit_Settings *)(ptr->data);
	data->alpha = CLAMPIS(value, 0.0f, 1.0f);
}

int GPencilSculptSettings_lockaxis_get(PointerRNA *ptr)
{
	GP_BrushEdit_Settings *data = (GP_BrushEdit_Settings *)(ptr->data);
	return (int)(data->lock_axis);
}

void GPencilSculptSettings_lockaxis_set(PointerRNA *ptr, int value)
{
	GP_BrushEdit_Settings *data = (GP_BrushEdit_Settings *)(ptr->data);
...
bool GPencilSculptBrush_affect_pressure_get(PointerRNA *ptr)
{
	GP_EditBrush_Data *data = (GP_EditBrush_Data *)(ptr->data);
	return (((data->flag) & 8) != 0);
}

void GPencilSculptBrush_affect_pressure_set(PointerRNA *ptr, bool value)
{
	GP_EditBrush_Data *data = (GP_EditBrush_Data *)(ptr->data);
	if (value) data->flag |= 8;
	else data->flag &= ~8;
...
PointerPropertyRNA rna_Paint_palette = {
	...
	-1, "palette", 8388673, 0, 0, 0, "Palette",
	"Active Palette",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_Paint_show_brush = {
	...
	-1, "show_brush", 1, 0, 0, 0, "Show Brush",
	"",
	0, "*",
...
BoolPropertyRNA rna_Paint_show_brush_on_surface = {
	...
	-1, "show_brush_on_surface", 1, 0, 0, 0, "Show Brush On Surface",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 68091904, NULL, NULL,
...
BoolPropertyRNA rna_Paint_show_low_resolution = {
	...
	-1, "show_low_resolution", 1, 0, 0, 0, "Fast Navigate",
...
IntPropertyRNA rna_Paint_input_samples = {
	...
	-1, "input_samples", 1, 0, 4, 0, "Input Samples",
...
BoolPropertyRNA rna_Paint_use_symmetry_x = {
	...
	-1, "use_symmetry_x", 1, 0, 0, 0, "Symmetry X",
...
BoolPropertyRNA rna_Paint_use_symmetry_y = {
	...
	-1, "use_symmetry_y", 1, 0, 0, 0, "Symmetry Y",
...
BoolPropertyRNA rna_Paint_use_symmetry_z = {
	...
	-1, "use_symmetry_z", 1, 0, 0, 0, "Symmetry Z",
...
BoolPropertyRNA rna_Paint_use_symmetry_feather = {
	...
	-1, "use_symmetry_feather", 1, 0, 0, 0, "Symmetry Feathering",
...
PointerPropertyRNA rna_Paint_cavity_curve = {
	...
	-1, "cavity_curve", 8650752, 0, 0, 0, "Curve",
...
BoolPropertyRNA rna_Paint_use_cavity = {
	...
	-1, "use_cavity", 1, 0, 0, 0, "Cavity Mask",
...
FloatPropertyRNA rna_Paint_tile_offset = {
	...
	-1, "tile_offset", 1, 0, 4, 0, "Tiling offset for the X Axis",
...
IntPropertyRNA rna_Sculpt_radial_symmetry = {
	...
	-1, "radial_symmetry", 1, 0, 4, 0, "Radial Symmetry Count X Axis",
...
BoolPropertyRNA rna_Sculpt_use_threaded = {
	...
	-1, "use_threaded", 1, 0, 0, 0, "Use OpenMP",
...
BoolPropertyRNA rna_Sculpt_use_deform_only = {
	...
	-1, "use_deform_only", 1, 0, 0, 0, "Use Deform Only",
...
BoolPropertyRNA rna_Sculpt_show_diffuse_color = {
	...
	-1, "show_diffuse_color", 1, 0, 0, 0, "Show Diffuse Color",
...
BoolPropertyRNA rna_Sculpt_show_mask = {
	...
	-1, "show_mask", 1, 0, 0, 0, "Show Mask",
	"Show mask as overlay on object",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sculpt_ShowMask_update, 85393408, NULL, NULL,
	0, -1, NULL},
...
FloatPropertyRNA rna_Sculpt_detail_size = {
	...
	-1, "detail_size", 1, 0, 4, 0, "Detail Size",
...
FloatPropertyRNA rna_Sculpt_detail_percent = {
	...
	-1, "detail_percent", 1, 0, 4, 0, "Detail Percentage",
...
FloatPropertyRNA rna_Sculpt_constant_detail_resolution = {
	...
	-1, "constant_detail_resolution", 1, 0, 4, 0, "Resolution",
...
BoolPropertyRNA rna_Sculpt_use_smooth_shading = {
	...
	-1, "use_smooth_shading", 1, 0, 0, 0, "Smooth Shading",
...
EnumPropertyRNA rna_Sculpt_symmetrize_direction = {
	...
	-1, "symmetrize_direction", 1, 0, 0, 0, "Direction",
...
EnumPropertyRNA rna_Sculpt_detail_refine_method = {
	...
	-1, "detail_refine_method", 1, 0, 0, 0, "Detail Refine Method",
...
static const EnumPropertyItem rna_Sculpt_detail_type_method_items[4] = {
...
EnumPropertyRNA rna_Sculpt_detail_type_method = {
	...
	-1, "detail_type_method", 1, 0, 0, 0, "Detail Type Method",
...
PointerPropertyRNA rna_Sculpt_gravity_object = {
	...
	-1, "gravity_object", 8388609, 0, 0, 0, "Orientation",
...
BoolPropertyRNA rna_VertexPaint_use_group_restrict = {
	...
	-1, "use_group_restrict", 1, 0, 0, 0, "Restrict",
...
BoolPropertyRNA rna_ImagePaint_use_backface_culling = {
	...
	-1, "use_backface_culling", 1, 0, 0, 0, "Cull",
...
BoolPropertyRNA rna_ImagePaint_use_normal_falloff = {
	...
	-1, "use_normal_falloff", 1, 0, 0, 0, "Normal",
...
BoolPropertyRNA rna_ImagePaint_use_stencil_layer = {
	...
	-1, "use_stencil_layer", 1, 0, 0, 0, "Stencil Layer",
...
BoolPropertyRNA rna_ImagePaint_invert_stencil = {
	...
	-1, "invert_stencil", 1, 0, 0, 0, "Invert",
...
PointerPropertyRNA rna_ImagePaint_stencil_image = {
	...
	-1, "stencil_image", 8388673, 0, 0, 0, "Stencil Image",
...
FloatPropertyRNA rna_ImagePaint_stencil_color = {
	...
	-1, "stencil_color", 1, 0, 4, 0, "Stencil Color",
...
BoolPropertyRNA rna_ImagePaint_use_clone_layer = {
	...
	-1, "use_clone_layer", 1, 0, 0, 0, "Clone Map",
...
IntPropertyRNA rna_ImagePaint_screen_grab_size = {
	...
	-1, "screen_grab_size", 1, 0, 4, 0, "screen_grab_size",
...
BoolPropertyRNA rna_ImagePaint_missing_uvs = {
	...
	-1, "missing_uvs", 0, 0, 0, 0, "Missing UVs",
...
BoolPropertyRNA rna_ImagePaint_missing_materials = {
	...
	-1, "missing_materials", 0, 0, 0, 0, "Missing Materials",
...
BoolPropertyRNA rna_ImagePaint_missing_stencil = {
	...
	-1, "missing_stencil", 0, 0, 0, 0, "Missing Stencil",
...
BoolPropertyRNA rna_ImagePaint_missing_texture = {
	...
	-1, "missing_texture", 0, 0, 0, 0, "Missing Texture",
...
static const EnumPropertyItem rna_ParticleEdit_tool_items[9] = {
...
EnumPropertyRNA rna_ParticleEdit_select_mode = {
	...
	-1, "select_mode", 1, 0, 0, 0, "Selection Mode",
...
BoolPropertyRNA rna_ParticleEdit_use_preserve_length = {
	...
	-1, "use_preserve_length", 1, 0, 0, 0, "Keep Lengths",
...
BoolPropertyRNA rna_ParticleEdit_use_preserve_root = {
	...
	-1, "use_preserve_root", 1, 0, 0, 0, "Keep Root",
...
BoolPropertyRNA rna_ParticleEdit_use_emitter_deflect = {
	...
	-1, "use_emitter_deflect", 1, 0, 0, 0, "Deflect Emitter",
...
FloatPropertyRNA rna_ParticleEdit_emitter_distance = {
	...
	-1, "emitter_distance", 1, 0, 4, 0, "Emitter Distance",
...
BoolPropertyRNA rna_ParticleEdit_use_fade_time = {
	...
	-1, "use_fade_time", 1, 0, 0, 0, "Fade Time",
...
BoolPropertyRNA rna_ParticleEdit_use_auto_velocity = {
	...
	-1, "use_auto_velocity", 1, 0, 0, 0, "Auto Velocity",
...
BoolPropertyRNA rna_ParticleEdit_show_particles = {
	...
	-1, "show_particles", 1, 0, 0, 0, "Draw Particles",
...
BoolPropertyRNA rna_ParticleEdit_use_default_interpolate = {
	...
	-1, "use_default_interpolate", 1, 0, 0, 0, "Interpolate",
...
IntPropertyRNA rna_ParticleEdit_default_key_count = {
	...
	-1, "default_key_count", 1, 0, 4, 0, "Keys",
...
BoolPropertyRNA rna_ParticleEdit_is_editable = {
	...
	-1, "is_editable", 0, 0, 0, 0, "Editable",
...
PointerPropertyRNA rna_ParticleEdit_shape_object = {
	...
	-1, "shape_object", 8388609, 0, 0, 0, "Shape Object",
...
BoolPropertyRNA rna_ParticleBrush_use_puff_volume = {
	...
	-1, "use_puff_volume", 1, 0, 0, 0, "Puff Volume",
...
EnumPropertyRNA rna_ParticleBrush_length_mode = {
	...
	-1, "length_mode", 1, 0, 0, 0, "Length Mode",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
static const EnumPropertyItem rna_GPencilSculptSettings_tool_items[10] = {
	{0, "SMOOTH", 0, "Smooth", "Smooth stroke points"},
	{1, "THICKNESS", 0, "Thickness", "Adjust thickness of strokes"},
	{10, "STRENGTH", 0, "Strength", "Adjust color strength of strokes"},
...
EnumPropertyRNA rna_GPencilSculptSettings_tool = {
	...
	NULL, 68091904, NULL, NULL,
	0, -1, NULL},
	GPencilSculptSettings_tool_get, GPencilSculptSettings_tool_set, NULL, NULL, NULL, NULL, rna_GPencilSculptSettings_tool_items, 9, 0
};
...
PointerPropertyRNA rna_GPencilSculptSettings_brush = {
	...
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {11, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
...
BoolPropertyRNA rna_GPencilSculptSettings_use_select_mask = {
	{(PropertyRNA *)&rna_GPencilSculptSettings_affect_position, (PropertyRNA *)&rna_GPencilSculptSettings_brush,
	-1, "use_select_mask", 1, 0, 0, 0, "Selection Mask",
...
BoolPropertyRNA rna_GPencilSculptSettings_affect_position = {
	{(PropertyRNA *)&rna_GPencilSculptSettings_affect_strength, (PropertyRNA *)&rna_GPencilSculptSettings_use_select_mask,
	-1, "affect_position", 1, 0, 0, 0, "Affect Position",
	"The brush affects the position of the point",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 68091904, NULL, NULL,
	0, -1, NULL},
	GPencilSculptSettings_affect_position_get, GPencilSculptSettings_affect_position_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_GPencilSculptSettings_affect_strength = {
	{(PropertyRNA *)&rna_GPencilSculptSettings_affect_thickness, (PropertyRNA *)&rna_GPencilSculptSettings_affect_position,
	-1, "affect_strength", 1, 0, 0, 0, "Affect Strength",
	"The brush affects the color strength of the point",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 68091904, NULL, NULL,
	0, -1, NULL},
	GPencilSculptSettings_affect_strength_get, GPencilSculptSettings_affect_strength_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_GPencilSculptSettings_affect_thickness = {
	{(PropertyRNA *)&rna_GPencilSculptSettings_selection_alpha, (PropertyRNA *)&rna_GPencilSculptSettings_affect_strength,
	-1, "affect_thickness", 1, 0, 0, 0, "Affect Thickness",
	"The brush affects the thickness of the point",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 68091904, NULL, NULL,
	0, -1, NULL},
	GPencilSculptSettings_affect_thickness_get, GPencilSculptSettings_affect_thickness_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

FloatPropertyRNA rna_GPencilSculptSettings_selection_alpha = {
	{(PropertyRNA *)&rna_GPencilSculptSettings_lockaxis, (PropertyRNA *)&rna_GPencilSculptSettings_affect_thickness,
	-1, "selection_alpha", 1, 0, 4, 0, "Alpha",
	"Alpha value for selected vertices",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_GPencil_update, 68091904, NULL, NULL,
	offsetof(GP_BrushEdit_Settings, alpha), 5, NULL},
	GPencilSculptSettings_selection_alpha_get, GPencilSculptSettings_selection_alpha_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};

static const EnumPropertyItem rna_GPencilSculptSettings_lockaxis_items[5] = {
	{0, "GP_LOCKAXIS_NONE", 0, "None", ""},
	{1, "GP_LOCKAXIS_X", 0, "X", "Project strokes to plane locked to X"},
	{2, "GP_LOCKAXIS_Y", 0, "Y", "Project strokes to plane locked to Y"},
	{3, "GP_LOCKAXIS_Z", 0, "Z", "Project strokes to plane locked to Z"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_GPencilSculptSettings_lockaxis = {
	{NULL, (PropertyRNA *)&rna_GPencilSculptSettings_selection_alpha,
	-1, "lockaxis", 1, 0, 0, 0, "Lock",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 68091904, NULL, NULL,
	0, -1, NULL},
	GPencilSculptSettings_lockaxis_get, GPencilSculptSettings_lockaxis_set, NULL, NULL, NULL, NULL, rna_GPencilSculptSettings_lockaxis_items, 4, 0
};

StructRNA RNA_GPencilSculptSettings = {
	{(ContainerRNA *)&RNA_GPencilSculptBrush, (ContainerRNA *)&RNA_ParticleBrush,
	NULL,
	{(PropertyRNA *)&rna_GPencilSculptSettings_rna_properties, (PropertyRNA *)&rna_GPencilSculptSettings_lockaxis}},
...
FloatPropertyRNA rna_GPencilSculptBrush_strength = {
	...
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 68091904, NULL, NULL,
	offsetof(GP_EditBrush_Data, strength), 5, NULL},
...
BoolPropertyRNA rna_GPencilSculptBrush_use_falloff = {
	...
	-1, "use_falloff", 1, 0, 0, 0, "Use Falloff",
...
BoolPropertyRNA rna_GPencilSculptBrush_affect_pressure = {
	...
	-1, "affect_pressure", 1, 0, 0, 0, "Affect Pressure",
