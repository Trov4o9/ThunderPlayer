...
bool Driver_show_debug_info_get(PointerRNA *ptr)
{
	ChannelDriver *data = (ChannelDriver *)(ptr->data);
	return (((data->flag) & 32) != 0);
}

void Driver_show_debug_info_set(PointerRNA *ptr, bool value)
{
	ChannelDriver *data = (ChannelDriver *)(ptr->data);
...
EnumPropertyRNA rna_FCurve_extrapolation = {
	...
	-1, "extrapolation", 3, 0, 0, 0, "Extrapolation",
...
StringPropertyRNA rna_FCurve_data_path = {
	...
	-1, "data_path", 262145, 0, 0, 0, "Data Path",
...
IntPropertyRNA rna_FCurve_array_index = {
	...
	-1, "array_index", 3, 0, 4, 0, "RNA Array Index",
...
EnumPropertyRNA rna_FCurve_color_mode = {
	...
	-1, "color_mode", 3, 0, 0, 0, "Color Mode",
...
EnumPropertyRNA rna_FCurve_auto_smoothing = {
	...
	-1, "auto_smoothing", 3, 0, 0, 0, "Auto Handle Smoothing",
...
CollectionPropertyRNA rna_FCurve_sampled_points = {
	...
	-1, "sampled_points", 0, 0, 8, 0, "Sampled Points",
...
CollectionPropertyRNA rna_FCurve_keyframe_points = {
	...
	-1, "keyframe_points", 0, 0, 8, 0, "Keyframes",
...
PointerPropertyRNA rna_FCurveModifiers_active = {
	...
	-1, "active", 8388609, 0, 0, 0, "Active F-Curve Modifier",
...
BoolPropertyRNA rna_Keyframe_select_control_point = {
	...
	-1, "select_control_point", 3, 0, 4, 0, "Select",
...
EnumPropertyRNA rna_Keyframe_handle_left_type = {
	...
	-1, "handle_left_type", 3, 0, 0, 0, "Left Handle Type",
	"Handle types",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 239534080, NULL, NULL,
...
EnumPropertyRNA rna_Keyframe_handle_right_type = {
	...
	-1, "handle_right_type", 3, 0, 0, 0, "Right Handle Type",
	"Handle types",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 239534080, NULL, NULL,
...
FloatPropertyRNA rna_Keyframe_handle_left = {
	...
	-1, "handle_left", 3, 0, 0, 0, "Left Handle",
...
FloatPropertyRNA rna_Keyframe_handle_right = {
	...
	-1, "handle_right", 3, 0, 0, 0, "Right Handle",
...
static const EnumPropertyItem rna_DriverTarget_id_type_items[34] = {
...
EnumPropertyRNA rna_DriverTarget_id_type = {
	...
	-1, "id_type", 3, 0, 0, 0, "ID Type",
	"Type of ID-block that can be used",
	0, "ID",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_DriverTarget_update_data, 0, rna_DriverTarget_id_type_editable, NULL,
	0, -1, NULL},
	DriverTarget_id_type_get, DriverTarget_id_type_set, NULL, NULL, NULL, NULL, rna_DriverTarget_id_type_items, 33, 16975
};
...
StringPropertyRNA rna_DriverTarget_bone_target = {
	...
	-1, "bone_target", 262145, 0, 0, 0, "Bone Name",
...
EnumPropertyRNA rna_DriverTarget_transform_space = {
	...
	-1, "transform_space", 3, 0, 0, 0, "Transform Space",
...
static const EnumPropertyItem rna_DriverVariable_type_items[5] = {
	...
	{3, "TRANSFORMS", 575, "Transform Channel", "Final transformation value of object or bone"},
	{1, "ROTATION_DIFF", 570, "Rotational Difference", "Use the angle between two bones"},
	{2, "LOC_DIFF", 75, "Distance", "Distance between two bones or objects"},
	{0, NULL, 0, NULL, NULL}
};
...
BoolPropertyRNA rna_DriverVariable_is_name_valid = {
	...
	-1, "is_name_valid", 2, 0, 0, 0, "Is Name Valid",
...
StringPropertyRNA rna_Driver_expression = {
	...
	-1, "expression", 262145, 0, 0, 0, "Expression",
...
BoolPropertyRNA rna_Driver_show_debug_info = {
	{(PropertyRNA *)&rna_Driver_use_self, (PropertyRNA *)&rna_Driver_variables,
	-1, "show_debug_info", 3, 0, 0, 0, "Show Debug Info",
...
BoolPropertyRNA rna_Driver_use_self = {
	{(PropertyRNA *)&rna_Driver_is_valid, (PropertyRNA *)&rna_Driver_show_debug_info,
	-1, "use_self", 3, 0, 0, 0, "Use Self",
...
BoolPropertyRNA rna_Driver_is_valid = {
	{NULL, (PropertyRNA *)&rna_Driver_use_self,
	-1, "is_valid", 3, 0, 0, 0, "Invalid",
...
BoolPropertyRNA rna_FModifier_mute = {
	...
	-1, "mute", 4099, 0, 0, 0, "Muted",
	"F-Curve Modifier will not be evaluated",
	515, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_FModifier_update, 239534080, NULL, NULL,
	0, -1, NULL},
...
BoolPropertyRNA rna_FModifier_use_restricted_range = {
	...
	-1, "use_restricted_range", 4099, 0, 0, 0, "Restrict Frame Range",
...
FloatPropertyRNA rna_FModifier_frame_start = {
	...
	-1, "frame_start", 3, 0, 0, 0, "Start Frame",
...
BoolPropertyRNA rna_FModifier_use_influence = {
	...
	-1, "use_influence", 4099, 0, 0, 0, "Use Influence",
...
IntPropertyRNA rna_FModifierGenerator_poly_order = {
	...
	-1, "poly_order", 3, 0, 4, 0, "Polynomial Order",
...
FloatPropertyRNA rna_FModifierGenerator_coefficients = {
	...
	-1, "coefficients", 131075, 0, 0, 0, "Coefficients",
...
FloatPropertyRNA rna_FModifierFunctionGenerator_phase_multiplier = {
	...
	-1, "phase_multiplier", 3, 0, 4, 0, "Phase Multiplier",
...
FloatPropertyRNA rna_FModifierFunctionGenerator_phase_offset = {
	...
	-1, "phase_offset", 3, 0, 4, 0, "Phase Offset",
...
FloatPropertyRNA rna_FModifierFunctionGenerator_value_offset = {
	...
	-1, "value_offset", 3, 0, 4, 0, "Value Offset",
...
CollectionPropertyRNA rna_FModifierEnvelope_control_points = {
	...
	-1, "control_points", 0, 0, 8, 0, "Control Points",
...
FloatPropertyRNA rna_FModifierEnvelope_reference_value = {
	...
	-1, "reference_value", 3, 0, 4, 0, "Reference Value",
...
FloatPropertyRNA rna_FModifierEnvelope_default_min = {
	...
	-1, "default_min", 3, 0, 4, 0, "Default Minimum",
...
FloatPropertyRNA rna_FModifierEnvelope_default_max = {
	...
	-1, "default_max", 3, 0, 4, 0, "Default Maximum",
...
EnumPropertyRNA rna_FModifierCycles_mode_before = {
	...
	-1, "mode_before", 3, 0, 0, 0, "Before Mode",
...
IntPropertyRNA rna_FModifierCycles_cycles_before = {
	...
	-1, "cycles_before", 3, 0, 4, 0, "Before Cycles",
...
EnumPropertyRNA rna_FModifierCycles_mode_after = {
	...
	-1, "mode_after", 3, 0, 0, 0, "After Mode",
...
IntPropertyRNA rna_FModifierCycles_cycles_after = {
	...
	-1, "cycles_after", 3, 0, 4, 0, "After Cycles",
...
FloatPropertyRNA rna_FModifierStepped_frame_step = {
	...
	-1, "frame_step", 3, 0, 4, 0, "Step Size",
...
BoolPropertyRNA rna_FModifierStepped_use_frame_start = {
	...
	-1, "use_frame_start", 3, 0, 0, 0, "Use Start Frame",
...
BoolPropertyRNA rna_FModifierStepped_use_frame_end = {
	...
	-1, "use_frame_end", 3, 0, 0, 0, "Use End Frame",
