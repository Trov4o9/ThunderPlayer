...
bool ClothSettings_use_pin_cloth_get(PointerRNA *ptr)
{
	ClothSimSettings *data = (ClothSimSettings *)(ptr->data);
	return (((data->flags) & 8) != 0);
}

void ClothSettings_use_pin_cloth_set(PointerRNA *ptr, bool value)
{
	ClothSimSettings *data = (ClothSimSettings *)(ptr->data);
...
bool ClothSettings_use_stiffness_scale_get(PointerRNA *ptr)
{
	ClothSimSettings *data = (ClothSimSettings *)(ptr->data);
	return (((data->flags) & 256) != 0);
}

void ClothSettings_use_stiffness_scale_set(PointerRNA *ptr, bool value)
{
	ClothSimSettings *data = (ClothSimSettings *)(ptr->data);
...
{
	rna_ClothSettings_structural_set(ptr, value);
}
...
{
	ClothCollSettings *data = (ClothCollSettings *)(ptr->data);
	data->self_loop_count = CLAMPIS(value, 1, 32767);
}
...
FloatPropertyRNA rna_ClothSolverResult_max_error = {
	...
	-1, "max_error", 2, 0, 0, 0, "Maximum Error",
...
FloatPropertyRNA rna_ClothSolverResult_min_error = {
	...
	-1, "min_error", 2, 0, 0, 0, "Minimum Error",
...
FloatPropertyRNA rna_ClothSolverResult_avg_error = {
	...
	-1, "avg_error", 2, 0, 0, 0, "Average Error",
...
IntPropertyRNA rna_ClothSolverResult_max_iterations = {
	...
	-1, "max_iterations", 2, 0, 0, 0, "Maximum Iterations",
...
IntPropertyRNA rna_ClothSolverResult_min_iterations = {
	...
	-1, "min_iterations", 2, 0, 0, 0, "Minimum Iterations",
...
FloatPropertyRNA rna_ClothSolverResult_avg_iterations = {
	...
	-1, "avg_iterations", 2, 0, 0, 0, "Average Iterations",
...
StructRNA RNA_ClothSolverResult = {
	{(ContainerRNA *)&RNA_ClothSettings, (ContainerRNA *)&RNA_GameCameraViewportData,
	NULL,
...
FloatPropertyRNA rna_ClothSettings_goal_default = {
	...
	-1, "goal_default", 3, 0, 4, 0, "Goal Default",
...
FloatPropertyRNA rna_ClothSettings_internal_friction = {
	...
	-1, "internal_friction", 3, 0, 4, 0, "Internal Friction",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ClothSettings_collider_friction = {
	...
	-1, "collider_friction", 3, 0, 4, 0, "Collider Friction",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ClothSettings_density_target = {
	...
	-1, "density_target", 3, 0, 4, 0, "Target Density",
...
FloatPropertyRNA rna_ClothSettings_density_strength = {
	...
	-1, "density_strength", 3, 0, 4, 0, "Target Density Strength",
...
FloatPropertyRNA rna_ClothSettings_air_damping = {
	...
	-1, "air_damping", 3, 0, 4, 0, "Air Damping",
...
BoolPropertyRNA rna_ClothSettings_use_pin_cloth = {
	...
	-1, "use_pin_cloth", 1, 0, 0, 0, "Pin Cloth",
...
FloatPropertyRNA rna_ClothSettings_pin_stiffness = {
	...
	-1, "pin_stiffness", 3, 0, 4, 0, "Pin Stiffness",
...
StringPropertyRNA rna_ClothSettings_vertex_group_shrink = {
	...
	-1, "vertex_group_shrink", 262145, 0, 0, 0, "Shrink Vertex Group",
...
FloatPropertyRNA rna_ClothSettings_shrink_min = {
	...
	-1, "shrink_min", 3, 0, 4, 0, "Shrink Factor Min",
	"Min amount to shrink cloth by",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
	offsetof(ClothSimSettings, shrink_min), 5, NULL},
...
FloatPropertyRNA rna_ClothSettings_shrink_max = {
	...
	-1, "shrink_max", 3, 0, 4, 0, "Shrink Factor Max",
	"Max amount to shrink cloth by",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
	offsetof(ClothSimSettings, shrink_max), 5, NULL},
...
FloatPropertyRNA rna_ClothSettings_voxel_cell_size = {
	...
	-1, "voxel_cell_size", 3, 0, 4, 0, "Voxel Grid Cell Size",
...
BoolPropertyRNA rna_ClothSettings_use_stiffness_scale = {
	...
	-1, "use_stiffness_scale", 1, 0, 0, 0, "Stiffness Scaling",
...
FloatPropertyRNA rna_ClothSettings_spring_damping = {
	...
	-1, "spring_damping", 3, 0, 4, 0, "Spring Damping",
	"Damping of cloth velocity (higher = more smooth, less jiggling)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
	offsetof(ClothSimSettings, Cdis), 5, NULL},
...
FloatPropertyRNA rna_ClothSettings_structural_stiffness = {
	...
	-1, "structural_stiffness", 3, 0, 0, 0, "Structural Stiffness",
...
FloatPropertyRNA rna_ClothSettings_structural_stiffness_max = {
	...
	-1, "structural_stiffness_max", 3, 0, 0, 0, "Structural Stiffness Maximum",
...
FloatPropertyRNA rna_ClothSettings_sewing_force_max = {
	...
	-1, "sewing_force_max", 3, 0, 0, 0, "Sewing Force Max",
...
StringPropertyRNA rna_ClothSettings_vertex_group_structural_stiffness = {
	...
	-1, "vertex_group_structural_stiffness", 262145, 0, 0, 0, "Structural Stiffness Vertex Group",
...
FloatPropertyRNA rna_ClothSettings_bending_stiffness = {
	...
	-1, "bending_stiffness", 3, 0, 0, 0, "Bending Stiffness",
...
FloatPropertyRNA rna_ClothSettings_bending_stiffness_max = {
	...
	-1, "bending_stiffness_max", 3, 0, 0, 0, "Bending Stiffness Maximum",
...
FloatPropertyRNA rna_ClothSettings_bending_damping = {
	...
	-1, "bending_damping", 3, 0, 4, 0, "Bending Spring Damping",
...
BoolPropertyRNA rna_ClothSettings_use_sewing_springs = {
	...
	-1, "use_sewing_springs", 1, 0, 0, 0, "Sew Cloth",
...
StringPropertyRNA rna_ClothSettings_vertex_group_bending = {
	...
	-1, "vertex_group_bending", 262145, 0, 0, 0, "Bending Stiffness Vertex Group",
...
PointerPropertyRNA rna_ClothSettings_rest_shape_key = {
	...
	-1, "rest_shape_key", 8388609, 0, 0, 0, "Rest Shape Key",
...
BoolPropertyRNA rna_ClothSettings_use_dynamic_mesh = {
	{NULL, (PropertyRNA *)&rna_ClothSettings_rest_shape_key,
	-1, "use_dynamic_mesh", 1, 0, 0, 0, "Dynamic Base Mesh",
...
StructRNA RNA_ClothSettings = {
	...
	NULL,
	{(PropertyRNA *)&rna_ClothSettings_rna_properties, (PropertyRNA *)&rna_ClothSettings_use_dynamic_mesh}},
...
BoolPropertyRNA rna_ClothCollisionSettings_use_collision = {
	...
	-1, "use_collision", 3, 0, 0, 0, "Enable Collision",
...
FloatPropertyRNA rna_ClothCollisionSettings_repel_force = {
	...
	-1, "repel_force", 3, 0, 4, 0, "Repulsion Force",
	"Repulsion force to apply on cloth when close to colliding",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
	offsetof(ClothCollSettings, repel_force), 5, NULL},
...
FloatPropertyRNA rna_ClothCollisionSettings_distance_repel = {
	...
	-1, "distance_repel", 3, 0, 4, 0, "Repulsion Distance",
	"Maximum distance to apply repulsion force, must be greater than minimum distance",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
	offsetof(ClothCollSettings, distance_repel), 5, NULL},
...
IntPropertyRNA rna_ClothCollisionSettings_collision_quality = {
	...
	-1, "collision_quality", 3, 0, 4, 0, "Collision Quality",
...
BoolPropertyRNA rna_ClothCollisionSettings_use_self_collision = {
	...
	-1, "use_self_collision", 3, 0, 0, 0, "Enable Self Collision",
...
FloatPropertyRNA rna_ClothCollisionSettings_self_distance_min = {
	...
	-1, "self_distance_min", 3, 0, 4, 0, "Self Minimum Distance",
...
FloatPropertyRNA rna_ClothCollisionSettings_self_friction = {
	...
	-1, "self_friction", 3, 0, 4, 0, "Self Friction",
...
IntPropertyRNA rna_ClothCollisionSettings_self_collision_quality = {
	...
	-1, "self_collision_quality", 3, 0, 4, 0, "Self Collision Quality",
...
PointerPropertyRNA rna_ClothCollisionSettings_group = {
	...
	-1, "group", 8388609, 0, 0, 0, "Collision Group",
	"Limit colliders to this Group",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_dependency_update, 0, NULL, NULL,
	0, -1, NULL},
...
StringPropertyRNA rna_ClothCollisionSettings_vertex_group_self_collisions = {
	...
	-1, "vertex_group_self_collisions", 262145, 0, 0, 0, "Selfcollision Vertex Group",
