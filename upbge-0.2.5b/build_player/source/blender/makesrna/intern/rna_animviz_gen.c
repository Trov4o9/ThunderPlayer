...
bool AnimVizOnionSkinning_show_only_selected_get(PointerRNA *ptr)
{
	bAnimVizSettings *data = (bAnimVizSettings *)(ptr->data);
	return (((data->ghost_flag) & 1) != 0);
}

void AnimVizOnionSkinning_show_only_selected_set(PointerRNA *ptr, bool value)
{
	bAnimVizSettings *data = (bAnimVizSettings *)(ptr->data);
...
PointerPropertyRNA rna_AnimViz_onion_skin_frames = {
	...
	-1, "onion_skin_frames", 8650752, 0, 0, 0, "Onion Skinning",
...
PointerPropertyRNA rna_AnimViz_motion_path = {
	...
	-1, "motion_path", 8650752, 0, 0, 0, "Motion Paths",
...
static const EnumPropertyItem rna_AnimVizOnionSkinning_type_items[5] = {
...
BoolPropertyRNA rna_AnimVizOnionSkinning_show_only_selected = {
	...
	-1, "show_only_selected", 3, 0, 0, 0, "On Selected Bones Only",
...
IntPropertyRNA rna_AnimVizOnionSkinning_frame_step = {
	...
	-1, "frame_step", 3, 0, 4, 0, "Frame Step",
...
IntPropertyRNA rna_AnimVizOnionSkinning_frame_before = {
	...
	-1, "frame_before", 3, 0, 4, 0, "Before Current",
...
IntPropertyRNA rna_AnimVizOnionSkinning_frame_after = {
	...
	-1, "frame_after", 3, 0, 4, 0, "After Current",
...
StructRNA RNA_AnimVizOnionSkinning = {
	...
	"AnimVizOnionSkinning", NULL, NULL, 516, NULL, "Onion Skinning Settings",
...
EnumPropertyRNA rna_AnimVizMotionPaths_bake_location = {
	...
	-1, "bake_location", 3, 0, 0, 0, "Bake Location",
...
BoolPropertyRNA rna_AnimVizMotionPaths_show_frame_numbers = {
	...
	-1, "show_frame_numbers", 3, 0, 0, 0, "Show Frame Numbers",
...
BoolPropertyRNA rna_AnimVizMotionPaths_show_keyframe_highlight = {
	...
	-1, "show_keyframe_highlight", 3, 0, 0, 0, "Highlight Keyframes",
...
BoolPropertyRNA rna_AnimVizMotionPaths_show_keyframe_numbers = {
	...
	-1, "show_keyframe_numbers", 3, 0, 0, 0, "Show Keyframe Numbers",
...
BoolPropertyRNA rna_AnimVizMotionPaths_show_keyframe_action_all = {
	...
	-1, "show_keyframe_action_all", 3, 0, 0, 0, "All Action Keyframes",
...
BoolPropertyRNA rna_AnimVizMotionPaths_has_motion_paths = {
	...
	-1, "has_motion_paths", 2, 0, 0, 0, "Has Motion Paths",
...
CollectionPropertyRNA rna_MotionPath_points = {
	...
	-1, "points", 0, 0, 8, 0, "Motion Path Points",
...
IntPropertyRNA rna_MotionPath_frame_start = {
	...
	-1, "frame_start", 2, 0, 4, 0, "Start Frame",
...
BoolPropertyRNA rna_MotionPath_use_bone_head = {
	...
	-1, "use_bone_head", 2, 0, 0, 0, "Use Bone Heads",
...
BoolPropertyRNA rna_MotionPath_is_modified = {
	...
	-1, "is_modified", 3, 0, 0, 0, "Edit Path",
...
BoolPropertyRNA rna_MotionPath_use_custom_color = {
	...
	-1, "use_custom_color", 3, 0, 0, 0, "Custom colors",
