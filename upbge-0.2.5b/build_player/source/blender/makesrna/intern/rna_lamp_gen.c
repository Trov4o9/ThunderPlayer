...
FloatPropertyRNA rna_PointLamp_constant_coefficient;
FloatPropertyRNA rna_PointLamp_linear_coefficient;
FloatPropertyRNA rna_PointLamp_quadratic_coefficient;
FloatPropertyRNA rna_PointLamp_radius;
FloatPropertyRNA rna_PointLamp_cutoff_threshold;
...
BoolPropertyRNA rna_PointLamp_static_shadow;
...
FloatPropertyRNA rna_PointLamp_shadow_buffer_slope_bias;
FloatPropertyRNA rna_PointLamp_shadow_buffer_bleed_bias;
FloatPropertyRNA rna_PointLamp_shadow_buffer_soft;
FloatPropertyRNA rna_PointLamp_shadow_buffer_sharp;
...
EnumPropertyRNA rna_PointLamp_shadow_filter;
...
BoolPropertyRNA rna_PointLamp_show_shadow_box;
...
BoolPropertyRNA rna_AreaLamp_static_shadow;
...
FloatPropertyRNA rna_AreaLamp_shadow_buffer_slope_bias;
FloatPropertyRNA rna_AreaLamp_shadow_buffer_bleed_bias;
FloatPropertyRNA rna_AreaLamp_shadow_buffer_soft;
FloatPropertyRNA rna_AreaLamp_shadow_buffer_sharp;
...
EnumPropertyRNA rna_AreaLamp_shadow_filter;
...
BoolPropertyRNA rna_AreaLamp_show_shadow_box;
...
FloatPropertyRNA rna_SpotLamp_constant_coefficient;
FloatPropertyRNA rna_SpotLamp_linear_coefficient;
FloatPropertyRNA rna_SpotLamp_quadratic_coefficient;
FloatPropertyRNA rna_SpotLamp_radius;
FloatPropertyRNA rna_SpotLamp_cutoff_threshold;
...
BoolPropertyRNA rna_SpotLamp_static_shadow;
...
FloatPropertyRNA rna_SpotLamp_shadow_buffer_slope_bias;
FloatPropertyRNA rna_SpotLamp_shadow_buffer_bleed_bias;
FloatPropertyRNA rna_SpotLamp_shadow_buffer_soft;
FloatPropertyRNA rna_SpotLamp_shadow_buffer_sharp;
...
EnumPropertyRNA rna_SpotLamp_shadow_filter;
...
BoolPropertyRNA rna_SpotLamp_show_shadow_box;
...
BoolPropertyRNA rna_SunLamp_static_shadow;
...
FloatPropertyRNA rna_SunLamp_shadow_buffer_slope_bias;
FloatPropertyRNA rna_SunLamp_shadow_buffer_bleed_bias;
FloatPropertyRNA rna_SunLamp_shadow_buffer_soft;
FloatPropertyRNA rna_SunLamp_shadow_buffer_sharp;
...
EnumPropertyRNA rna_SunLamp_shadow_filter;
...
FloatPropertyRNA rna_LampTextureSlot_lod_bias;
...
bool Lamp_use_own_layer_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 4) != 0);
}

void Lamp_use_own_layer_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool Lamp_use_negative_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 16) != 0);
}

void Lamp_use_negative_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool Lamp_use_specular_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return !(((data->mode) & 4096) != 0);
}

void Lamp_use_specular_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool Lamp_use_diffuse_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return !(((data->mode) & 2048) != 0);
}

void Lamp_use_diffuse_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool Lamp_use_nodes_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->use_nodes) & 1) != 0);
}

void Lamp_use_nodes_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool PointLamp_use_sphere_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 64) != 0);
}

void PointLamp_use_sphere_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
float PointLamp_constant_coefficient_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->coeff_const);
}

void PointLamp_constant_coefficient_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->coeff_const = CLAMPIS(value, 0.0f, FLT_MAX);
}

float PointLamp_linear_coefficient_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->coeff_lin);
}

void PointLamp_linear_coefficient_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->coeff_lin = CLAMPIS(value, 0.0f, FLT_MAX);
}

float PointLamp_quadratic_coefficient_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->coeff_quad);
}

void PointLamp_quadratic_coefficient_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->coeff_quad = CLAMPIS(value, 0.0f, FLT_MAX);
}

float PointLamp_radius_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->radius);
}

void PointLamp_radius_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->radius = CLAMPIS(value, 0.0010000000f, FLT_MAX);
}

float PointLamp_cutoff_threshold_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->cutoff);
}

void PointLamp_cutoff_threshold_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->cutoff = CLAMPIS(value, 0.0f, 0.9990000129f);
}

bool PointLamp_use_shadow_get(PointerRNA *ptr)
{
	return rna_use_shadow_get(ptr);
}

void PointLamp_use_shadow_set(PointerRNA *ptr, bool value)
{
...
bool PointLamp_static_shadow_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 524288) != 0);
}

void PointLamp_static_shadow_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
float PointLamp_shadow_buffer_slope_bias_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->slopebias);
}

void PointLamp_shadow_buffer_slope_bias_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->slopebias = CLAMPIS(value, 0.0f, 5.0f);
}
...
float PointLamp_shadow_buffer_sharp_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->bufsharp);
}

void PointLamp_shadow_buffer_sharp_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->bufsharp = CLAMPIS(value, -1.0f, 1.0f);
}
...
int PointLamp_shadow_filter_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (int)(data->shadow_filter);
}

void PointLamp_shadow_filter_set(PointerRNA *ptr, int value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->shadow_filter = value;
}

bool PointLamp_use_auto_clip_start_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->bufflag) & 1) != 0);
}

void PointLamp_use_auto_clip_start_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool PointLamp_use_auto_clip_end_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->bufflag) & 2) != 0);
}

void PointLamp_use_auto_clip_end_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool PointLamp_use_only_shadow_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 32) != 0);
}

void PointLamp_use_only_shadow_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool PointLamp_use_shadow_layer_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 32768) != 0);
}

void PointLamp_use_shadow_layer_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool PointLamp_show_shadow_box_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 262144) != 0);
}

void PointLamp_show_shadow_box_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool AreaLamp_use_shadow_get(PointerRNA *ptr)
{
	return rna_use_shadow_get(ptr);
}

void AreaLamp_use_shadow_set(PointerRNA *ptr, bool value)
{
	rna_use_shadow_set(ptr, value);
}
...
bool AreaLamp_static_shadow_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 524288) != 0);
}

void AreaLamp_static_shadow_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->mode |= 524288;
	else data->mode &= ~524288;
...
float AreaLamp_shadow_buffer_slope_bias_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->slopebias);
}

void AreaLamp_shadow_buffer_slope_bias_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->slopebias = CLAMPIS(value, 0.0f, 5.0f);
}
...
float AreaLamp_shadow_buffer_sharp_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->bufsharp);
}

void AreaLamp_shadow_buffer_sharp_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->bufsharp = CLAMPIS(value, -1.0f, 1.0f);
}
...
int AreaLamp_shadow_filter_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (int)(data->shadow_filter);
}

void AreaLamp_shadow_filter_set(PointerRNA *ptr, int value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->shadow_filter = value;
}

bool AreaLamp_use_auto_clip_start_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->bufflag) & 1) != 0);
}

void AreaLamp_use_auto_clip_start_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->bufflag |= 1;
	else data->bufflag &= ~1;
...
bool AreaLamp_use_auto_clip_end_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->bufflag) & 2) != 0);
}

void AreaLamp_use_auto_clip_end_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->bufflag |= 2;
	else data->bufflag &= ~2;
...
bool AreaLamp_use_only_shadow_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 32) != 0);
}

void AreaLamp_use_only_shadow_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->mode |= 32;
	else data->mode &= ~32;
...
bool AreaLamp_use_shadow_layer_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 32768) != 0);
}

void AreaLamp_use_shadow_layer_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->mode |= 32768;
	else data->mode &= ~32768;
...
bool AreaLamp_show_shadow_box_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 262144) != 0);
}

void AreaLamp_show_shadow_box_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->mode |= 262144;
	else data->mode &= ~262144;
...
bool AreaLamp_use_umbra_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->ray_samp_type) & 2) != 0);
}

void AreaLamp_use_umbra_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool AreaLamp_use_dither_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->ray_samp_type) & 4) != 0);
}

void AreaLamp_use_dither_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool AreaLamp_use_jitter_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->ray_samp_type) & 8) != 0);
}

void AreaLamp_use_jitter_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool SpotLamp_use_sphere_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 64) != 0);
}

void SpotLamp_use_sphere_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->mode |= 64;
	else data->mode &= ~64;
...
float SpotLamp_constant_coefficient_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->coeff_const);
}

void SpotLamp_constant_coefficient_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->coeff_const = CLAMPIS(value, 0.0f, FLT_MAX);
}

float SpotLamp_linear_coefficient_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->coeff_lin);
}

void SpotLamp_linear_coefficient_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->coeff_lin = CLAMPIS(value, 0.0f, FLT_MAX);
}

float SpotLamp_quadratic_coefficient_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->coeff_quad);
}

void SpotLamp_quadratic_coefficient_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->coeff_quad = CLAMPIS(value, 0.0f, FLT_MAX);
}

float SpotLamp_radius_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->radius);
}

void SpotLamp_radius_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->radius = CLAMPIS(value, 0.0010000000f, FLT_MAX);
}

float SpotLamp_cutoff_threshold_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->cutoff);
}

void SpotLamp_cutoff_threshold_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->cutoff = CLAMPIS(value, 0.0f, 0.9990000129f);
}

bool SpotLamp_use_shadow_get(PointerRNA *ptr)
{
	return rna_use_shadow_get(ptr);
}

void SpotLamp_use_shadow_set(PointerRNA *ptr, bool value)
{
	rna_use_shadow_set(ptr, value);
}
...
bool SpotLamp_static_shadow_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 524288) != 0);
}

void SpotLamp_static_shadow_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->mode |= 524288;
	else data->mode &= ~524288;
...
float SpotLamp_shadow_buffer_slope_bias_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->slopebias);
}

void SpotLamp_shadow_buffer_slope_bias_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->slopebias = CLAMPIS(value, 0.0f, 5.0f);
}
...
float SpotLamp_shadow_buffer_sharp_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->bufsharp);
}

void SpotLamp_shadow_buffer_sharp_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->bufsharp = CLAMPIS(value, -1.0f, 1.0f);
}
...
int SpotLamp_shadow_filter_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (int)(data->shadow_filter);
}

void SpotLamp_shadow_filter_set(PointerRNA *ptr, int value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->shadow_filter = value;
}

bool SpotLamp_use_auto_clip_start_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->bufflag) & 1) != 0);
}

void SpotLamp_use_auto_clip_start_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->bufflag |= 1;
	else data->bufflag &= ~1;
...
bool SpotLamp_use_auto_clip_end_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->bufflag) & 2) != 0);
}

void SpotLamp_use_auto_clip_end_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->bufflag |= 2;
	else data->bufflag &= ~2;
...
bool SpotLamp_use_only_shadow_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 32) != 0);
}

void SpotLamp_use_only_shadow_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->mode |= 32;
	else data->mode &= ~32;
...
bool SpotLamp_use_shadow_layer_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 32768) != 0);
}

void SpotLamp_use_shadow_layer_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->mode |= 32768;
	else data->mode &= ~32768;
...
bool SpotLamp_show_shadow_box_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 262144) != 0);
}

void SpotLamp_show_shadow_box_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->mode |= 262144;
	else data->mode &= ~262144;
...
bool SpotLamp_use_square_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 128) != 0);
}

void SpotLamp_use_square_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool SpotLamp_use_halo_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 2) != 0);
}

void SpotLamp_use_halo_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool SpotLamp_show_cone_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 131072) != 0);
}

void SpotLamp_show_cone_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool SunLamp_use_shadow_get(PointerRNA *ptr)
{
	return rna_use_shadow_get(ptr);
}

void SunLamp_use_shadow_set(PointerRNA *ptr, bool value)
{
	rna_use_shadow_set(ptr, value);
}
...
bool SunLamp_static_shadow_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 524288) != 0);
}

void SunLamp_static_shadow_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->mode |= 524288;
	else data->mode &= ~524288;
...
float SunLamp_shadow_buffer_slope_bias_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->slopebias);
}

void SunLamp_shadow_buffer_slope_bias_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->slopebias = CLAMPIS(value, 0.0f, 5.0f);
}
...
float SunLamp_shadow_buffer_sharp_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (float)(data->bufsharp);
}

void SunLamp_shadow_buffer_sharp_set(PointerRNA *ptr, float value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->bufsharp = CLAMPIS(value, -1.0f, 1.0f);
}
...
int SunLamp_shadow_filter_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (int)(data->shadow_filter);
}

void SunLamp_shadow_filter_set(PointerRNA *ptr, int value)
{
	Lamp *data = (Lamp *)(ptr->data);
	data->shadow_filter = value;
}

bool SunLamp_use_auto_clip_start_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->bufflag) & 1) != 0);
}

void SunLamp_use_auto_clip_start_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->bufflag |= 1;
	else data->bufflag &= ~1;
...
bool SunLamp_use_auto_clip_end_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->bufflag) & 2) != 0);
}

void SunLamp_use_auto_clip_end_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->bufflag |= 2;
	else data->bufflag &= ~2;
...
bool SunLamp_use_only_shadow_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 32) != 0);
}

void SunLamp_use_only_shadow_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->mode |= 32;
	else data->mode &= ~32;
...
bool SunLamp_use_shadow_layer_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 32768) != 0);
}

void SunLamp_use_shadow_layer_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->mode |= 32768;
	else data->mode &= ~32768;
...
bool SunLamp_show_shadow_box_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 262144) != 0);
}

void SunLamp_show_shadow_box_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
	if (value) data->mode |= 262144;
	else data->mode &= ~262144;
...
bool LampSkySettings_use_sky_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->sun_effect_type) & 1) != 0);
}

void LampSkySettings_use_sky_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool LampSkySettings_use_atmosphere_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->sun_effect_type) & 2) != 0);
}

void LampSkySettings_use_atmosphere_set(PointerRNA *ptr, bool value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
bool LampTextureSlot_use_map_color_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 1) != 0);
}

void LampTextureSlot_use_map_color_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool LampTextureSlot_use_map_shadow_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 2) != 0);
}

void LampTextureSlot_use_map_shadow_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
float LampTextureSlot_lod_bias_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (float)(data->lodbias);
}

void LampTextureSlot_lod_bias_set(PointerRNA *ptr, float value)
{
	MTex *data = (MTex *)(ptr->data);
	data->lodbias = value;
}
...
/* Lamp */
static const EnumPropertyItem rna_Lamp_type_items[6] = {
...
FloatPropertyRNA rna_Lamp_energy = {
	...
	-1, "energy", 3, 0, 4, 0, "Energy",
	"Amount of light that the lamp emits",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, energy), 5, NULL},
...
BoolPropertyRNA rna_Lamp_use_negative = {
	...
	-1, "use_negative", 3, 0, 0, 0, "Negative",
	"Cast negative light",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_Lamp_use_specular = {
	...
	-1, "use_specular", 3, 0, 0, 0, "Specular",
...
StructRNA RNA_LampTextureSlots = {
	...
	"LampTextureSlots", NULL, NULL, 516, NULL, "Texture Slots",
...
/* Point Lamp */
static const EnumPropertyItem rna_PointLamp_falloff_type_items[8] = {
	{0, "CONSTANT", 0, "Constant", ""},
	{1, "INVERSE_LINEAR", 0, "Inverse Linear", ""},
	{2, "INVERSE_SQUARE", 0, "Inverse Square", ""},
	{6, "INVSQUARE_CUTOFF", 0, "Inverse Square Cutoff", ""},
...
EnumPropertyRNA rna_PointLamp_falloff_type = {
	...
	-1, "falloff_type", 3, 0, 0, 0, "Falloff Type",
	"Intensity Decay with distance",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	0, -1, NULL},
	PointLamp_falloff_type_get, PointLamp_falloff_type_set, NULL, NULL, NULL, NULL, rna_PointLamp_falloff_type_items, 7, 0
};

PointerPropertyRNA rna_PointLamp_falloff_curve = {
	{(PropertyRNA *)&rna_PointLamp_use_sphere, (PropertyRNA *)&rna_PointLamp_falloff_type,
	-1, "falloff_curve", 8388608, 0, 0, 0, "Falloff Curve",
...
FloatPropertyRNA rna_PointLamp_linear_attenuation = {
	...
	-1, "linear_attenuation", 3, 0, 4, 0, "Linear Attenuation",
	"Linear distance attenuation",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, att1), 5, NULL},
...
FloatPropertyRNA rna_PointLamp_quadratic_attenuation = {
	{(PropertyRNA *)&rna_PointLamp_constant_coefficient, (PropertyRNA *)&rna_PointLamp_linear_attenuation,
	-1, "quadratic_attenuation", 3, 0, 4, 0, "Quadratic Attenuation",
	"Quadratic distance attenuation",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, att2), 5, NULL},
...
FloatPropertyRNA rna_PointLamp_constant_coefficient = {
	{(PropertyRNA *)&rna_PointLamp_linear_coefficient, (PropertyRNA *)&rna_PointLamp_quadratic_attenuation,
	-1, "constant_coefficient", 3, 0, 4, 0, "Constant Coefficient",
	"Constant distance attenuation coefficient",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, coeff_const), 5, NULL},
	PointLamp_constant_coefficient_get, PointLamp_constant_coefficient_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_PointLamp_linear_coefficient = {
	{(PropertyRNA *)&rna_PointLamp_quadratic_coefficient, (PropertyRNA *)&rna_PointLamp_constant_coefficient,
	-1, "linear_coefficient", 3, 0, 4, 0, "Linear Coefficient",
	"Linear distance attenuation coefficient",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, coeff_lin), 5, NULL},
	PointLamp_linear_coefficient_get, PointLamp_linear_coefficient_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_PointLamp_quadratic_coefficient = {
	{(PropertyRNA *)&rna_PointLamp_radius, (PropertyRNA *)&rna_PointLamp_linear_coefficient,
	-1, "quadratic_coefficient", 3, 0, 4, 0, "Quadratic Coefficient",
	"Quadratic distance attenuation coefficient",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, coeff_quad), 5, NULL},
	PointLamp_quadratic_coefficient_get, PointLamp_quadratic_coefficient_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_PointLamp_radius = {
	{(PropertyRNA *)&rna_PointLamp_cutoff_threshold, (PropertyRNA *)&rna_PointLamp_quadratic_coefficient,
	-1, "radius", 3, 0, 4, 0, "Radius",
	"The ligth\'s radius",
	0, "*",
	PROP_FLOAT, PROP_DISTANCE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, radius), 5, NULL},
	PointLamp_radius_get, PointLamp_radius_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0010000000f, 1000.0f, 0.0010000000f, FLT_MAX, 1.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_PointLamp_cutoff_threshold = {
	{(PropertyRNA *)&rna_PointLamp_use_shadow, (PropertyRNA *)&rna_PointLamp_radius,
	-1, "cutoff_threshold", 3, 0, 4, 0, "Cutoff",
	"Cutoff Threshold",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, cutoff), 5, NULL},
	PointLamp_cutoff_threshold_get, PointLamp_cutoff_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 0.9990000129f, 0.0f, 0.9990000129f, 10.0f, 3, 0.0f, NULL
};

BoolPropertyRNA rna_PointLamp_use_shadow = {
	{(PropertyRNA *)&rna_PointLamp_shadow_method, (PropertyRNA *)&rna_PointLamp_cutoff_threshold,
	-1, "use_shadow", 3, 0, 0, 0, "use_shadow",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
...
static const EnumPropertyItem rna_PointLamp_shadow_method_items[3] = {
...
EnumPropertyRNA rna_PointLamp_shadow_method = {
	...
	-1, "shadow_method", 3, 0, 0, 0, "shadow_method",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
...
IntPropertyRNA rna_PointLamp_shadow_buffer_size = {
	{(PropertyRNA *)&rna_PointLamp_static_shadow, (PropertyRNA *)&rna_PointLamp_shadow_method,
	-1, "shadow_buffer_size", 3, 0, 0, 0, "Shadow Buffer Size",
...
BoolPropertyRNA rna_PointLamp_static_shadow = {
	{(PropertyRNA *)&rna_PointLamp_shadow_filter_type, (PropertyRNA *)&rna_PointLamp_shadow_buffer_size,
	-1, "static_shadow", 3, 0, 0, 0, "Static Shadow",
	"Enable static shadows",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	PointLamp_static_shadow_get, PointLamp_static_shadow_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

static const EnumPropertyItem rna_PointLamp_shadow_filter_type_items[4] = {
...
EnumPropertyRNA rna_PointLamp_shadow_filter_type = {
	{(PropertyRNA *)&rna_PointLamp_shadow_sample_buffers, (PropertyRNA *)&rna_PointLamp_static_shadow,
	-1, "shadow_filter_type", 3, 0, 0, 0, "Shadow Filter Type",
...
static const EnumPropertyItem rna_PointLamp_shadow_sample_buffers_items[4] = {
...
EnumPropertyRNA rna_PointLamp_shadow_sample_buffers = {
	...
	-1, "shadow_sample_buffers", 3, 0, 0, 0, "Shadow Sample Buffers",
...
FloatPropertyRNA rna_PointLamp_shadow_buffer_clip_start = {
	...
	-1, "shadow_buffer_clip_start", 3, 0, 4, 0, "Shadow Buffer Clip Start",
	"Shadow map clip start, below which objects will not generate shadows",
	0, "*",
	PROP_FLOAT, PROP_DISTANCE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, clipsta), 5, NULL},
...
FloatPropertyRNA rna_PointLamp_shadow_buffer_clip_end = {
	...
	-1, "shadow_buffer_clip_end", 3, 0, 4, 0, "Shadow Buffer Clip End",
	"Shadow map clip end, beyond which objects will not generate shadows",
	0, "*",
	PROP_FLOAT, PROP_DISTANCE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, clipend), 5, NULL},
...
FloatPropertyRNA rna_PointLamp_shadow_buffer_bias = {
	{(PropertyRNA *)&rna_PointLamp_shadow_buffer_slope_bias, (PropertyRNA *)&rna_PointLamp_shadow_buffer_clip_end,
	-1, "shadow_buffer_bias", 3, 0, 4, 0, "Shadow Buffer Bias",
	"Shadow buffer sampling bias",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(Lamp, bias), 5, NULL},
...
FloatPropertyRNA rna_PointLamp_shadow_buffer_slope_bias = {
	{(PropertyRNA *)&rna_PointLamp_shadow_buffer_bleed_bias, (PropertyRNA *)&rna_PointLamp_shadow_buffer_bias,
	-1, "shadow_buffer_slope_bias", 3, 0, 4, 0, "Shadow Buffer Slope Bias",
	"Shadow buffer sampling slope bias",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(Lamp, slopebias), 5, NULL},
	PointLamp_shadow_buffer_slope_bias_get, PointLamp_shadow_buffer_slope_bias_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 5.0f, 0.0f, 5.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_PointLamp_shadow_buffer_bleed_bias = {
	{(PropertyRNA *)&rna_PointLamp_shadow_buffer_soft, (PropertyRNA *)&rna_PointLamp_shadow_buffer_slope_bias,
	-1, "shadow_buffer_bleed_bias", 3, 0, 4, 0, "Shadow Buffer Bleed Bias",
	"Bias for reducing light-bleed on variance shadow maps",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(Lamp, bleedbias), 5, NULL},
...
FloatPropertyRNA rna_PointLamp_shadow_buffer_soft = {
	{(PropertyRNA *)&rna_PointLamp_shadow_buffer_sharp, (PropertyRNA *)&rna_PointLamp_shadow_buffer_bleed_bias,
	-1, "shadow_buffer_soft", 3, 0, 4, 0, "Shadow Buffer Soft",
	"Size of shadow buffer sampling area",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(Lamp, soft), 5, NULL},
...
FloatPropertyRNA rna_PointLamp_shadow_buffer_sharp = {
	{(PropertyRNA *)&rna_PointLamp_shadow_buffer_samples, (PropertyRNA *)&rna_PointLamp_shadow_buffer_soft,
	-1, "shadow_buffer_sharp", 3, 0, 4, 0, "Shadow Buffer Sharpness",
	"Sharpness of buffer sampling",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(Lamp, bufsharp), 5, NULL},
	PointLamp_shadow_buffer_sharp_get, PointLamp_shadow_buffer_sharp_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -1.0f, 1.0f, -1.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};

IntPropertyRNA rna_PointLamp_shadow_buffer_samples = {
	{(PropertyRNA *)&rna_PointLamp_shadow_buffer_type, (PropertyRNA *)&rna_PointLamp_shadow_buffer_sharp,
	-1, "shadow_buffer_samples", 3, 0, 4, 0, "Samples",
...
static const EnumPropertyItem rna_PointLamp_shadow_buffer_type_items[5] = {
...
EnumPropertyRNA rna_PointLamp_shadow_buffer_type = {
	...
	-1, "shadow_buffer_type", 3, 0, 0, 0, "Shadow Buffer Type",
...
static const EnumPropertyItem rna_PointLamp_ge_shadow_buffer_type_items[3] = {
...
EnumPropertyRNA rna_PointLamp_ge_shadow_buffer_type = {
	{(PropertyRNA *)&rna_PointLamp_shadow_filter, (PropertyRNA *)&rna_PointLamp_shadow_buffer_type,
	-1, "ge_shadow_buffer_type", 3, 0, 0, 0, "Shadow Map Type",
...
static const EnumPropertyItem rna_PointLamp_shadow_filter_items[5] = {
	{0, "NONE", 0, "None", "None filtering"},
	{1, "PCF", 0, "PCF", "Percentage Closer Filtering"},
	{2, "PCF_BAIL", 0, "PCF Early Bail", "Percentage Closer Filtering Early Bail"},
	{3, "PCF_JITTER", 0, "PCF Jitter", "Percentage Closer Filtering Jitter"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_PointLamp_shadow_filter = {
	{(PropertyRNA *)&rna_PointLamp_use_auto_clip_start, (PropertyRNA *)&rna_PointLamp_ge_shadow_buffer_type,
	-1, "shadow_filter", 3, 0, 0, 0, "Shadow Map Filter Type",
	"The shadow mapping filtering algorithm used",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	0, -1, NULL},
	PointLamp_shadow_filter_get, PointLamp_shadow_filter_set, NULL, NULL, NULL, NULL, rna_PointLamp_shadow_filter_items, 4, 0
};

BoolPropertyRNA rna_PointLamp_use_auto_clip_start = {
	{(PropertyRNA *)&rna_PointLamp_use_auto_clip_end, (PropertyRNA *)&rna_PointLamp_shadow_filter,
	-1, "use_auto_clip_start", 3, 0, 0, 0, "Autoclip Start",
...
BoolPropertyRNA rna_PointLamp_use_auto_clip_end = {
	...
	-1, "use_auto_clip_end", 3, 0, 0, 0, "Autoclip End",
...
FloatPropertyRNA rna_PointLamp_compression_threshold = {
	...
	-1, "compression_threshold", 3, 0, 4, 0, "Compress",
	"Deep shadow map compression threshold",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(Lamp, compressthresh), 5, NULL},
...
FloatPropertyRNA rna_PointLamp_shadow_color = {
	...
	-1, "shadow_color", 3, 0, 4, 0, "Shadow Color",
	"Color of shadows cast by the lamp",
	0, "*",
	PROP_FLOAT, PROP_COLOR | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(Lamp, shdwr), 5, NULL},
...
static const EnumPropertyItem rna_PointLamp_shadow_ray_sample_method_items[3] = {
...
EnumPropertyRNA rna_PointLamp_shadow_ray_sample_method = {
	...
	-1, "shadow_ray_sample_method", 3, 0, 0, 0, "Shadow Ray Sampling Method",
...
IntPropertyRNA rna_PointLamp_shadow_ray_samples = {
	...
	-1, "shadow_ray_samples", 3, 0, 4, 0, "Shadow Ray Samples X",
...
FloatPropertyRNA rna_PointLamp_shadow_adaptive_threshold = {
	...
	-1, "shadow_adaptive_threshold", 3, 0, 4, 0, "Shadow Adaptive Threshold",
	"Threshold for Adaptive Sampling (Raytraced shadows)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(Lamp, adapt_thresh), 5, NULL},
...
FloatPropertyRNA rna_PointLamp_shadow_soft_size = {
	...
	-1, "shadow_soft_size", 3, 0, 4, 0, "Shadow Soft Size",
	"Light size for ray shadow sampling (Raytraced shadows)",
	0, "*",
	PROP_FLOAT, PROP_DISTANCE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(Lamp, area_size), 5, NULL},
...
BoolPropertyRNA rna_PointLamp_use_shadow_layer = {
	{(PropertyRNA *)&rna_PointLamp_show_shadow_box, (PropertyRNA *)&rna_PointLamp_shadow_soft_size,
	-1, "use_shadow_layer", 3, 0, 0, 0, "Shadow Layer",
...
BoolPropertyRNA rna_PointLamp_show_shadow_box = {
	{NULL, (PropertyRNA *)&rna_PointLamp_use_shadow_layer,
	-1, "show_shadow_box", 3, 0, 0, 0, "Show Shadow Box",
	"Draw a box in 3D view to visualize which objects are contained in it",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	0, -1, NULL},
	PointLamp_show_shadow_box_get, PointLamp_show_shadow_box_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

StructRNA RNA_PointLamp = {
	{(ContainerRNA *)&RNA_AreaLamp, (ContainerRNA *)&RNA_LampTextureSlots,
	NULL,
	{(PropertyRNA *)&rna_PointLamp_falloff_type, (PropertyRNA *)&rna_PointLamp_show_shadow_box}},
	"PointLamp", NULL, NULL, 519, NULL, "Point Lamp",
...
static const EnumPropertyItem rna_AreaLamp_shadow_method_items[3] = {
	{0, "NOSHADOW", 0, "No Shadow", ""},
	{8192, "RAY_SHADOW", 0, "Ray Shadow", "Use ray tracing for shadow"},
	{0, NULL, 0, NULL, NULL}
};
...
IntPropertyRNA rna_AreaLamp_shadow_buffer_size = {
	{(PropertyRNA *)&rna_AreaLamp_static_shadow, (PropertyRNA *)&rna_AreaLamp_shadow_method,
	-1, "shadow_buffer_size", 3, 0, 0, 0, "Shadow Buffer Size",
	"Resolution of the shadow buffer, higher values give crisper shadows but use more memory",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
BoolPropertyRNA rna_AreaLamp_static_shadow = {
	{(PropertyRNA *)&rna_AreaLamp_shadow_filter_type, (PropertyRNA *)&rna_AreaLamp_shadow_buffer_size,
	-1, "static_shadow", 3, 0, 0, 0, "Static Shadow",
	"Enable static shadows",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	AreaLamp_static_shadow_get, AreaLamp_static_shadow_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

static const EnumPropertyItem rna_AreaLamp_shadow_filter_type_items[4] = {
	{0, "BOX", 0, "Box", "Apply the Box filter to shadow buffer samples"},
	{1, "TENT", 0, "Tent", "Apply the Tent Filter to shadow buffer samples"},
	{2, "GAUSS", 0, "Gauss", "Apply the Gauss filter to shadow buffer samples"},
	{0, NULL, 0, NULL, NULL}
...
EnumPropertyRNA rna_AreaLamp_shadow_filter_type = {
	{(PropertyRNA *)&rna_AreaLamp_shadow_sample_buffers, (PropertyRNA *)&rna_AreaLamp_static_shadow,
	-1, "shadow_filter_type", 3, 0, 0, 0, "Shadow Filter Type",
	"Type of shadow filter (Buffer Shadows)",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static const EnumPropertyItem rna_AreaLamp_shadow_sample_buffers_items[4] = {
	{1, "BUFFERS_1", 0, "1", "Only one buffer rendered"},
	{4, "BUFFERS_4", 0, "4", "Render 4 buffers for better AA, this quadruples memory usage"},
	{9, "BUFFERS_9", 0, "9", "Render 9 buffers for better AA, this uses nine times more memory"},
	{0, NULL, 0, NULL, NULL}
...
FloatPropertyRNA rna_AreaLamp_shadow_buffer_bias = {
	{(PropertyRNA *)&rna_AreaLamp_shadow_buffer_slope_bias, (PropertyRNA *)&rna_AreaLamp_shadow_buffer_clip_end,
	-1, "shadow_buffer_bias", 3, 0, 4, 0, "Shadow Buffer Bias",
	"Shadow buffer sampling bias",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_AreaLamp_shadow_buffer_slope_bias = {
	{(PropertyRNA *)&rna_AreaLamp_shadow_buffer_bleed_bias, (PropertyRNA *)&rna_AreaLamp_shadow_buffer_bias,
	-1, "shadow_buffer_slope_bias", 3, 0, 4, 0, "Shadow Buffer Slope Bias",
	"Shadow buffer sampling slope bias",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(Lamp, slopebias), 5, NULL},
	AreaLamp_shadow_buffer_slope_bias_get, AreaLamp_shadow_buffer_slope_bias_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 5.0f, 0.0f, 5.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_AreaLamp_shadow_buffer_bleed_bias = {
	{(PropertyRNA *)&rna_AreaLamp_shadow_buffer_soft, (PropertyRNA *)&rna_AreaLamp_shadow_buffer_slope_bias,
	-1, "shadow_buffer_bleed_bias", 3, 0, 4, 0, "Shadow Buffer Bleed Bias",
	"Bias for reducing light-bleed on variance shadow maps",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_AreaLamp_shadow_buffer_soft = {
	{(PropertyRNA *)&rna_AreaLamp_shadow_buffer_sharp, (PropertyRNA *)&rna_AreaLamp_shadow_buffer_bleed_bias,
	-1, "shadow_buffer_soft", 3, 0, 4, 0, "Shadow Buffer Soft",
	"Size of shadow buffer sampling area",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_AreaLamp_shadow_buffer_sharp = {
	{(PropertyRNA *)&rna_AreaLamp_shadow_buffer_samples, (PropertyRNA *)&rna_AreaLamp_shadow_buffer_soft,
	-1, "shadow_buffer_sharp", 3, 0, 4, 0, "Shadow Buffer Sharpness",
	"Sharpness of buffer sampling",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(Lamp, bufsharp), 5, NULL},
	AreaLamp_shadow_buffer_sharp_get, AreaLamp_shadow_buffer_sharp_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -1.0f, 1.0f, -1.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};

IntPropertyRNA rna_AreaLamp_shadow_buffer_samples = {
	{(PropertyRNA *)&rna_AreaLamp_shadow_buffer_type, (PropertyRNA *)&rna_AreaLamp_shadow_buffer_sharp,
	-1, "shadow_buffer_samples", 3, 0, 4, 0, "Samples",
	"Number of shadow buffer samples",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static const EnumPropertyItem rna_AreaLamp_shadow_buffer_type_items[5] = {
	{0, "REGULAR", 0, "Classical", "Classic shadow buffer"},
	{2, "HALFWAY", 0, "Classic-Halfway", "Regular buffer, averaging the closest and 2nd closest Z value to reducing bias artifacts"},
	{1, "IRREGULAR", 0, "Irregular", "Irregular buffer produces sharp shadow always, but it doesn\'t show up for raytracing"},
	{3, "DEEP", 0, "Deep", "Deep shadow buffer supports transparency and better filtering, at the cost of more memory usage and processing time"},
...
static const EnumPropertyItem rna_AreaLamp_ge_shadow_buffer_type_items[3] = {
	{0, "SIMPLE", 0, "Simple", "Simple shadow maps"},
	{1, "VARIANCE", 0, "Variance", "Variance shadow maps"},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_AreaLamp_ge_shadow_buffer_type = {
	{(PropertyRNA *)&rna_AreaLamp_shadow_filter, (PropertyRNA *)&rna_AreaLamp_shadow_buffer_type,
	-1, "ge_shadow_buffer_type", 3, 0, 0, 0, "Shadow Map Type",
	"The shadow mapping algorithm used",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static const EnumPropertyItem rna_AreaLamp_shadow_filter_items[5] = {
	{0, "NONE", 0, "None", "None filtering"},
	{1, "PCF", 0, "PCF", "Percentage Closer Filtering"},
	{2, "PCF_BAIL", 0, "PCF Early Bail", "Percentage Closer Filtering Early Bail"},
	{3, "PCF_JITTER", 0, "PCF Jitter", "Percentage Closer Filtering Jitter"},
...
EnumPropertyRNA rna_AreaLamp_shadow_filter = {
	{(PropertyRNA *)&rna_AreaLamp_use_auto_clip_start, (PropertyRNA *)&rna_AreaLamp_ge_shadow_buffer_type,
	-1, "shadow_filter", 3, 0, 0, 0, "Shadow Map Filter Type",
	"The shadow mapping filtering algorithm used",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	0, -1, NULL},
	AreaLamp_shadow_filter_get, AreaLamp_shadow_filter_set, NULL, NULL, NULL, NULL, rna_AreaLamp_shadow_filter_items, 4, 0
};

BoolPropertyRNA rna_AreaLamp_use_auto_clip_start = {
	{(PropertyRNA *)&rna_AreaLamp_use_auto_clip_end, (PropertyRNA *)&rna_AreaLamp_shadow_filter,
	-1, "use_auto_clip_start", 3, 0, 0, 0, "Autoclip Start",
	"Automatic calculation of clipping-start, based on visible vertices",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static const EnumPropertyItem rna_AreaLamp_shadow_ray_sample_method_items[4] = {
	{1, "ADAPTIVE_QMC", 0, "Adaptive QMC", ""},
	{2, "CONSTANT_QMC", 0, "Constant QMC", ""},
...
IntPropertyRNA rna_AreaLamp_shadow_ray_samples_x = {
	...
	-1, "shadow_ray_samples_x", 3, 0, 4, 0, "Shadow Ray Samples",
	"Number of samples taken extra (samples x samples)",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
...
IntPropertyRNA rna_AreaLamp_shadow_ray_samples_y = {
	...
	-1, "shadow_ray_samples_y", 3, 0, 4, 0, "Shadow Ray Samples Y",
	"Number of samples taken extra (samples x samples)",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_AreaLamp_use_shadow_layer = {
	{(PropertyRNA *)&rna_AreaLamp_show_shadow_box, (PropertyRNA *)&rna_AreaLamp_shadow_soft_size,
	-1, "use_shadow_layer", 3, 0, 0, 0, "Shadow Layer",
	"Objects on the same layers only cast shadows",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
BoolPropertyRNA rna_AreaLamp_show_shadow_box = {
	{(PropertyRNA *)&rna_AreaLamp_use_umbra, (PropertyRNA *)&rna_AreaLamp_use_shadow_layer,
	-1, "show_shadow_box", 3, 0, 0, 0, "Show Shadow Box",
	"Draw a box in 3D view to visualize which objects are contained in it",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	0, -1, NULL},
	AreaLamp_show_shadow_box_get, AreaLamp_show_shadow_box_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_AreaLamp_use_umbra = {
	{(PropertyRNA *)&rna_AreaLamp_use_dither, (PropertyRNA *)&rna_AreaLamp_show_shadow_box,
	-1, "use_umbra", 3, 0, 0, 0, "Umbra",
...
static const EnumPropertyItem rna_AreaLamp_shape_items[3] = {
	{0, "SQUARE", 0, "Square", ""},
...
FloatPropertyRNA rna_AreaLamp_gamma = {
	...
	-1, "gamma", 3, 0, 4, 0, "Gamma",
	"Light gamma correction value",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, k), 5, NULL},
...
StructRNA RNA_AreaLamp = {
	...
	"AreaLamp", NULL, NULL, 519, NULL, "Area Lamp",
...
/* Spot Lamp */
static const EnumPropertyItem rna_SpotLamp_falloff_type_items[8] = {
	{0, "CONSTANT", 0, "Constant", ""},
	{1, "INVERSE_LINEAR", 0, "Inverse Linear", ""},
	{2, "INVERSE_SQUARE", 0, "Inverse Square", ""},
	{6, "INVSQUARE_CUTOFF", 0, "Inverse Square Cutoff", ""},
...
EnumPropertyRNA rna_SpotLamp_falloff_type = {
	...
	rna_Lamp_update, 0, NULL, NULL,
	0, -1, NULL},
	SpotLamp_falloff_type_get, SpotLamp_falloff_type_set, NULL, NULL, NULL, NULL, rna_SpotLamp_falloff_type_items, 7, 0
};
...
FloatPropertyRNA rna_SpotLamp_quadratic_attenuation = {
	{(PropertyRNA *)&rna_SpotLamp_constant_coefficient, (PropertyRNA *)&rna_SpotLamp_linear_attenuation,
	-1, "quadratic_attenuation", 3, 0, 4, 0, "Quadratic Attenuation",
	"Quadratic distance attenuation",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_SpotLamp_constant_coefficient = {
	{(PropertyRNA *)&rna_SpotLamp_linear_coefficient, (PropertyRNA *)&rna_SpotLamp_quadratic_attenuation,
	-1, "constant_coefficient", 3, 0, 4, 0, "Constant Coefficient",
	"Constant distance attenuation coefficient",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, coeff_const), 5, NULL},
	SpotLamp_constant_coefficient_get, SpotLamp_constant_coefficient_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_SpotLamp_linear_coefficient = {
	{(PropertyRNA *)&rna_SpotLamp_quadratic_coefficient, (PropertyRNA *)&rna_SpotLamp_constant_coefficient,
	-1, "linear_coefficient", 3, 0, 4, 0, "Linear Coefficient",
	"Linear distance attenuation coefficient",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, coeff_lin), 5, NULL},
	SpotLamp_linear_coefficient_get, SpotLamp_linear_coefficient_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_SpotLamp_quadratic_coefficient = {
	{(PropertyRNA *)&rna_SpotLamp_radius, (PropertyRNA *)&rna_SpotLamp_linear_coefficient,
	-1, "quadratic_coefficient", 3, 0, 4, 0, "Quadratic Coefficient",
	"Quadratic distance attenuation coefficient",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, coeff_quad), 5, NULL},
	SpotLamp_quadratic_coefficient_get, SpotLamp_quadratic_coefficient_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_SpotLamp_radius = {
	{(PropertyRNA *)&rna_SpotLamp_cutoff_threshold, (PropertyRNA *)&rna_SpotLamp_quadratic_coefficient,
	-1, "radius", 3, 0, 4, 0, "Radius",
	"The ligth\'s radius",
	0, "*",
	PROP_FLOAT, PROP_DISTANCE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, radius), 5, NULL},
	SpotLamp_radius_get, SpotLamp_radius_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0010000000f, 1000.0f, 0.0010000000f, FLT_MAX, 1.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_SpotLamp_cutoff_threshold = {
	{(PropertyRNA *)&rna_SpotLamp_use_shadow, (PropertyRNA *)&rna_SpotLamp_radius,
	-1, "cutoff_threshold", 3, 0, 4, 0, "Cutoff",
	"Cutoff Threshold",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, cutoff), 5, NULL},
	SpotLamp_cutoff_threshold_get, SpotLamp_cutoff_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 0.9990000129f, 0.0f, 0.9990000129f, 10.0f, 3, 0.0f, NULL
};

BoolPropertyRNA rna_SpotLamp_use_shadow = {
	{(PropertyRNA *)&rna_SpotLamp_shadow_method, (PropertyRNA *)&rna_SpotLamp_cutoff_threshold,
	-1, "use_shadow", 3, 0, 0, 0, "use_shadow",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static const EnumPropertyItem rna_SpotLamp_shadow_method_items[4] = {
	{0, "NOSHADOW", 0, "No Shadow", ""},
...
IntPropertyRNA rna_SpotLamp_shadow_buffer_size = {
	{(PropertyRNA *)&rna_SpotLamp_static_shadow, (PropertyRNA *)&rna_SpotLamp_shadow_method,
	-1, "shadow_buffer_size", 3, 0, 0, 0, "Shadow Buffer Size",
	"Resolution of the shadow buffer, higher values give crisper shadows but use more memory",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
BoolPropertyRNA rna_SpotLamp_static_shadow = {
	{(PropertyRNA *)&rna_SpotLamp_shadow_filter_type, (PropertyRNA *)&rna_SpotLamp_shadow_buffer_size,
	-1, "static_shadow", 3, 0, 0, 0, "Static Shadow",
	"Enable static shadows",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	SpotLamp_static_shadow_get, SpotLamp_static_shadow_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

static const EnumPropertyItem rna_SpotLamp_shadow_filter_type_items[4] = {
	{0, "BOX", 0, "Box", "Apply the Box filter to shadow buffer samples"},
	{1, "TENT", 0, "Tent", "Apply the Tent Filter to shadow buffer samples"},
	{2, "GAUSS", 0, "Gauss", "Apply the Gauss filter to shadow buffer samples"},
	{0, NULL, 0, NULL, NULL}
...
EnumPropertyRNA rna_SpotLamp_shadow_filter_type = {
	{(PropertyRNA *)&rna_SpotLamp_shadow_sample_buffers, (PropertyRNA *)&rna_SpotLamp_static_shadow,
	-1, "shadow_filter_type", 3, 0, 0, 0, "Shadow Filter Type",
	"Type of shadow filter (Buffer Shadows)",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static const EnumPropertyItem rna_SpotLamp_shadow_sample_buffers_items[4] = {
	{1, "BUFFERS_1", 0, "1", "Only one buffer rendered"},
	{4, "BUFFERS_4", 0, "4", "Render 4 buffers for better AA, this quadruples memory usage"},
	{9, "BUFFERS_9", 0, "9", "Render 9 buffers for better AA, this uses nine times more memory"},
	{0, NULL, 0, NULL, NULL}
...
FloatPropertyRNA rna_SpotLamp_shadow_buffer_bias = {
	{(PropertyRNA *)&rna_SpotLamp_shadow_buffer_slope_bias, (PropertyRNA *)&rna_SpotLamp_shadow_buffer_clip_end,
	-1, "shadow_buffer_bias", 3, 0, 4, 0, "Shadow Buffer Bias",
	"Shadow buffer sampling bias",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_SpotLamp_shadow_buffer_slope_bias = {
	{(PropertyRNA *)&rna_SpotLamp_shadow_buffer_bleed_bias, (PropertyRNA *)&rna_SpotLamp_shadow_buffer_bias,
	-1, "shadow_buffer_slope_bias", 3, 0, 4, 0, "Shadow Buffer Slope Bias",
	"Shadow buffer sampling slope bias",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(Lamp, slopebias), 5, NULL},
	SpotLamp_shadow_buffer_slope_bias_get, SpotLamp_shadow_buffer_slope_bias_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 5.0f, 0.0f, 5.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_SpotLamp_shadow_buffer_bleed_bias = {
	{(PropertyRNA *)&rna_SpotLamp_shadow_buffer_soft, (PropertyRNA *)&rna_SpotLamp_shadow_buffer_slope_bias,
	-1, "shadow_buffer_bleed_bias", 3, 0, 4, 0, "Shadow Buffer Bleed Bias",
	"Bias for reducing light-bleed on variance shadow maps",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_SpotLamp_shadow_buffer_soft = {
	{(PropertyRNA *)&rna_SpotLamp_shadow_buffer_sharp, (PropertyRNA *)&rna_SpotLamp_shadow_buffer_bleed_bias,
	-1, "shadow_buffer_soft", 3, 0, 4, 0, "Shadow Buffer Soft",
	"Size of shadow buffer sampling area",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_SpotLamp_shadow_buffer_sharp = {
	{(PropertyRNA *)&rna_SpotLamp_shadow_buffer_samples, (PropertyRNA *)&rna_SpotLamp_shadow_buffer_soft,
	-1, "shadow_buffer_sharp", 3, 0, 4, 0, "Shadow Buffer Sharpness",
	"Sharpness of buffer sampling",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(Lamp, bufsharp), 5, NULL},
	SpotLamp_shadow_buffer_sharp_get, SpotLamp_shadow_buffer_sharp_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -1.0f, 1.0f, -1.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};

IntPropertyRNA rna_SpotLamp_shadow_buffer_samples = {
	{(PropertyRNA *)&rna_SpotLamp_shadow_buffer_type, (PropertyRNA *)&rna_SpotLamp_shadow_buffer_sharp,
	-1, "shadow_buffer_samples", 3, 0, 4, 0, "Samples",
	"Number of shadow buffer samples",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static const EnumPropertyItem rna_SpotLamp_shadow_buffer_type_items[5] = {
	{0, "REGULAR", 0, "Classical", "Classic shadow buffer"},
	{2, "HALFWAY", 0, "Classic-Halfway", "Regular buffer, averaging the closest and 2nd closest Z value to reducing bias artifacts"},
	{1, "IRREGULAR", 0, "Irregular", "Irregular buffer produces sharp shadow always, but it doesn\'t show up for raytracing"},
	{3, "DEEP", 0, "Deep", "Deep shadow buffer supports transparency and better filtering, at the cost of more memory usage and processing time"},
...
static const EnumPropertyItem rna_SpotLamp_ge_shadow_buffer_type_items[3] = {
	{0, "SIMPLE", 0, "Simple", "Simple shadow maps"},
	{1, "VARIANCE", 0, "Variance", "Variance shadow maps"},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_SpotLamp_ge_shadow_buffer_type = {
	{(PropertyRNA *)&rna_SpotLamp_shadow_filter, (PropertyRNA *)&rna_SpotLamp_shadow_buffer_type,
	-1, "ge_shadow_buffer_type", 3, 0, 0, 0, "Shadow Map Type",
	"The shadow mapping algorithm used",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static const EnumPropertyItem rna_SpotLamp_shadow_filter_items[5] = {
	{0, "NONE", 0, "None", "None filtering"},
	{1, "PCF", 0, "PCF", "Percentage Closer Filtering"},
	{2, "PCF_BAIL", 0, "PCF Early Bail", "Percentage Closer Filtering Early Bail"},
	{3, "PCF_JITTER", 0, "PCF Jitter", "Percentage Closer Filtering Jitter"},
...
EnumPropertyRNA rna_SpotLamp_shadow_filter = {
	{(PropertyRNA *)&rna_SpotLamp_use_auto_clip_start, (PropertyRNA *)&rna_SpotLamp_ge_shadow_buffer_type,
	-1, "shadow_filter", 3, 0, 0, 0, "Shadow Map Filter Type",
	"The shadow mapping filtering algorithm used",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	0, -1, NULL},
	SpotLamp_shadow_filter_get, SpotLamp_shadow_filter_set, NULL, NULL, NULL, NULL, rna_SpotLamp_shadow_filter_items, 4, 0
};

BoolPropertyRNA rna_SpotLamp_use_auto_clip_start = {
	{(PropertyRNA *)&rna_SpotLamp_use_auto_clip_end, (PropertyRNA *)&rna_SpotLamp_shadow_filter,
	-1, "use_auto_clip_start", 3, 0, 0, 0, "Autoclip Start",
	"Automatic calculation of clipping-start, based on visible vertices",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static const EnumPropertyItem rna_SpotLamp_shadow_ray_sample_method_items[3] = {
	{1, "ADAPTIVE_QMC", 0, "Adaptive QMC", ""},
	{2, "CONSTANT_QMC", 0, "Constant QMC", ""},
	{0, NULL, 0, NULL, NULL}
};
...
BoolPropertyRNA rna_SpotLamp_use_shadow_layer = {
	{(PropertyRNA *)&rna_SpotLamp_show_shadow_box, (PropertyRNA *)&rna_SpotLamp_shadow_soft_size,
	-1, "use_shadow_layer", 3, 0, 0, 0, "Shadow Layer",
	"Objects on the same layers only cast shadows",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
BoolPropertyRNA rna_SpotLamp_show_shadow_box = {
	{(PropertyRNA *)&rna_SpotLamp_use_square, (PropertyRNA *)&rna_SpotLamp_use_shadow_layer,
	-1, "show_shadow_box", 3, 0, 0, 0, "Show Shadow Box",
	"Draw a box in 3D view to visualize which objects are contained in it",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	0, -1, NULL},
	SpotLamp_show_shadow_box_get, SpotLamp_show_shadow_box_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_SpotLamp_use_square = {
	{(PropertyRNA *)&rna_SpotLamp_use_halo, (PropertyRNA *)&rna_SpotLamp_show_shadow_box,
	-1, "use_square", 3, 0, 0, 0, "Square",
...
FloatPropertyRNA rna_SpotLamp_halo_intensity = {
	...
	-1, "halo_intensity", 3, 0, 4, 0, "Halo Intensity",
	"Brightness of the spotlight\'s halo cone",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(Lamp, haint), 5, NULL},
...
FloatPropertyRNA rna_SpotLamp_spot_blend = {
	...
	-1, "spot_blend", 3, 0, 4, 0, "Spot Blend",
	"The softness of the spotlight edge",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, spotblend), 5, NULL},
...
StructRNA RNA_SpotLamp = {
	...
	"SpotLamp", NULL, NULL, 519, NULL, "Spot Lamp",
...
static const EnumPropertyItem rna_SunLamp_shadow_method_items[3] = {
	{0, "NOSHADOW", 0, "No Shadow", ""},
	{8192, "RAY_SHADOW", 0, "Ray Shadow", "Use ray tracing for shadow"},
	{0, NULL, 0, NULL, NULL}
};
...
IntPropertyRNA rna_SunLamp_shadow_buffer_size = {
	{(PropertyRNA *)&rna_SunLamp_static_shadow, (PropertyRNA *)&rna_SunLamp_shadow_method,
	-1, "shadow_buffer_size", 3, 0, 0, 0, "Shadow Buffer Size",
	"Resolution of the shadow buffer, higher values give crisper shadows but use more memory",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
BoolPropertyRNA rna_SunLamp_static_shadow = {
	{(PropertyRNA *)&rna_SunLamp_shadow_filter_type, (PropertyRNA *)&rna_SunLamp_shadow_buffer_size,
	-1, "static_shadow", 3, 0, 0, 0, "Static Shadow",
	"Enable static shadows",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	SunLamp_static_shadow_get, SunLamp_static_shadow_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

static const EnumPropertyItem rna_SunLamp_shadow_filter_type_items[4] = {
	{0, "BOX", 0, "Box", "Apply the Box filter to shadow buffer samples"},
	{1, "TENT", 0, "Tent", "Apply the Tent Filter to shadow buffer samples"},
	{2, "GAUSS", 0, "Gauss", "Apply the Gauss filter to shadow buffer samples"},
	{0, NULL, 0, NULL, NULL}
...
EnumPropertyRNA rna_SunLamp_shadow_filter_type = {
	{(PropertyRNA *)&rna_SunLamp_shadow_sample_buffers, (PropertyRNA *)&rna_SunLamp_static_shadow,
	-1, "shadow_filter_type", 3, 0, 0, 0, "Shadow Filter Type",
	"Type of shadow filter (Buffer Shadows)",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static const EnumPropertyItem rna_SunLamp_shadow_sample_buffers_items[4] = {
	{1, "BUFFERS_1", 0, "1", "Only one buffer rendered"},
	{4, "BUFFERS_4", 0, "4", "Render 4 buffers for better AA, this quadruples memory usage"},
	{9, "BUFFERS_9", 0, "9", "Render 9 buffers for better AA, this uses nine times more memory"},
	{0, NULL, 0, NULL, NULL}
...
FloatPropertyRNA rna_SunLamp_shadow_buffer_bias = {
	{(PropertyRNA *)&rna_SunLamp_shadow_buffer_slope_bias, (PropertyRNA *)&rna_SunLamp_shadow_buffer_clip_end,
	-1, "shadow_buffer_bias", 3, 0, 4, 0, "Shadow Buffer Bias",
	"Shadow buffer sampling bias",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_SunLamp_shadow_buffer_slope_bias = {
	{(PropertyRNA *)&rna_SunLamp_shadow_buffer_bleed_bias, (PropertyRNA *)&rna_SunLamp_shadow_buffer_bias,
	-1, "shadow_buffer_slope_bias", 3, 0, 4, 0, "Shadow Buffer Slope Bias",
	"Shadow buffer sampling slope bias",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(Lamp, slopebias), 5, NULL},
	SunLamp_shadow_buffer_slope_bias_get, SunLamp_shadow_buffer_slope_bias_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 5.0f, 0.0f, 5.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_SunLamp_shadow_buffer_bleed_bias = {
	{(PropertyRNA *)&rna_SunLamp_shadow_buffer_soft, (PropertyRNA *)&rna_SunLamp_shadow_buffer_slope_bias,
	-1, "shadow_buffer_bleed_bias", 3, 0, 4, 0, "Shadow Buffer Bleed Bias",
	"Bias for reducing light-bleed on variance shadow maps",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_SunLamp_shadow_buffer_soft = {
	{(PropertyRNA *)&rna_SunLamp_shadow_buffer_sharp, (PropertyRNA *)&rna_SunLamp_shadow_buffer_bleed_bias,
	-1, "shadow_buffer_soft", 3, 0, 4, 0, "Shadow Buffer Soft",
	"Size of shadow buffer sampling area",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_SunLamp_shadow_buffer_sharp = {
	{(PropertyRNA *)&rna_SunLamp_shadow_buffer_samples, (PropertyRNA *)&rna_SunLamp_shadow_buffer_soft,
	-1, "shadow_buffer_sharp", 3, 0, 4, 0, "Shadow Buffer Sharpness",
	"Sharpness of buffer sampling",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(Lamp, bufsharp), 5, NULL},
	SunLamp_shadow_buffer_sharp_get, SunLamp_shadow_buffer_sharp_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -1.0f, 1.0f, -1.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};

IntPropertyRNA rna_SunLamp_shadow_buffer_samples = {
	{(PropertyRNA *)&rna_SunLamp_shadow_buffer_type, (PropertyRNA *)&rna_SunLamp_shadow_buffer_sharp,
	-1, "shadow_buffer_samples", 3, 0, 4, 0, "Samples",
	"Number of shadow buffer samples",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static const EnumPropertyItem rna_SunLamp_shadow_buffer_type_items[5] = {
	{0, "REGULAR", 0, "Classical", "Classic shadow buffer"},
	{2, "HALFWAY", 0, "Classic-Halfway", "Regular buffer, averaging the closest and 2nd closest Z value to reducing bias artifacts"},
	{1, "IRREGULAR", 0, "Irregular", "Irregular buffer produces sharp shadow always, but it doesn\'t show up for raytracing"},
	{3, "DEEP", 0, "Deep", "Deep shadow buffer supports transparency and better filtering, at the cost of more memory usage and processing time"},
...
static const EnumPropertyItem rna_SunLamp_ge_shadow_buffer_type_items[3] = {
	{0, "SIMPLE", 0, "Simple", "Simple shadow maps"},
	{1, "VARIANCE", 0, "Variance", "Variance shadow maps"},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_SunLamp_ge_shadow_buffer_type = {
	{(PropertyRNA *)&rna_SunLamp_shadow_filter, (PropertyRNA *)&rna_SunLamp_shadow_buffer_type,
	-1, "ge_shadow_buffer_type", 3, 0, 0, 0, "Shadow Map Type",
	"The shadow mapping algorithm used",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static const EnumPropertyItem rna_SunLamp_shadow_filter_items[5] = {
	{0, "NONE", 0, "None", "None filtering"},
	{1, "PCF", 0, "PCF", "Percentage Closer Filtering"},
	{2, "PCF_BAIL", 0, "PCF Early Bail", "Percentage Closer Filtering Early Bail"},
	{3, "PCF_JITTER", 0, "PCF Jitter", "Percentage Closer Filtering Jitter"},
...
EnumPropertyRNA rna_SunLamp_shadow_filter = {
	{(PropertyRNA *)&rna_SunLamp_use_auto_clip_start, (PropertyRNA *)&rna_SunLamp_ge_shadow_buffer_type,
	-1, "shadow_filter", 3, 0, 0, 0, "Shadow Map Filter Type",
	"The shadow mapping filtering algorithm used",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	0, -1, NULL},
	SunLamp_shadow_filter_get, SunLamp_shadow_filter_set, NULL, NULL, NULL, NULL, rna_SunLamp_shadow_filter_items, 4, 0
};

BoolPropertyRNA rna_SunLamp_use_auto_clip_start = {
	{(PropertyRNA *)&rna_SunLamp_use_auto_clip_end, (PropertyRNA *)&rna_SunLamp_shadow_filter,
	-1, "use_auto_clip_start", 3, 0, 0, 0, "Autoclip Start",
	"Automatic calculation of clipping-start, based on visible vertices",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static const EnumPropertyItem rna_SunLamp_shadow_ray_sample_method_items[3] = {
	{1, "ADAPTIVE_QMC", 0, "Adaptive QMC", ""},
	{2, "CONSTANT_QMC", 0, "Constant QMC", ""},
	{0, NULL, 0, NULL, NULL}
};
...
BoolPropertyRNA rna_SunLamp_use_shadow_layer = {
	{(PropertyRNA *)&rna_SunLamp_show_shadow_box, (PropertyRNA *)&rna_SunLamp_shadow_soft_size,
	-1, "use_shadow_layer", 3, 0, 0, 0, "Shadow Layer",
	"Objects on the same layers only cast shadows",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
BoolPropertyRNA rna_SunLamp_show_shadow_box = {
	{(PropertyRNA *)&rna_SunLamp_sky, (PropertyRNA *)&rna_SunLamp_use_shadow_layer,
	-1, "show_shadow_box", 3, 0, 0, 0, "Show Shadow Box",
	"Draw a box in 3D view to visualize which objects are contained in it",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
PointerPropertyRNA rna_SunLamp_sky = {
	{(PropertyRNA *)&rna_SunLamp_shadow_frustum_size, (PropertyRNA *)&rna_SunLamp_show_shadow_box,
	-1, "sky", 8650752, 0, 0, 0, "Sky Settings",
...
FloatPropertyRNA rna_SunLamp_shadow_frustum_size = {
	...
	-1, "shadow_frustum_size", 3, 0, 4, 0, "Frustum Size",
	"Size of the frustum used for creating the shadow map",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, shadow_frustum_size), 5, NULL},
...
StructRNA RNA_SunLamp = {
	...
	"SunLamp", NULL, NULL, 519, NULL, "Sun Lamp",
...
static const EnumPropertyItem rna_LampSkySettings_sky_color_space_items[4] = {
	{0, "SMPTE", 0, "SMPTE", ""},
	{1, "REC709", 0, "REC709", ""},
	{2, "CIE", 0, "CIE", ""},
	{0, NULL, 0, NULL, NULL}
...
EnumPropertyRNA rna_LampSkySettings_sky_color_space = {
	...
	-1, "sky_color_space", 3, 0, 0, 0, "Sky Color Space",
...
static const EnumPropertyItem rna_LampSkySettings_sky_blend_type_items[19] = {
	{0, "MIX", 0, "Mix", ""},
	{1, "ADD", 0, "Add", ""},
...
EnumPropertyRNA rna_LampSkySettings_sky_blend_type = {
	...
	-1, "sky_blend_type", 3, 0, 0, 0, "Sky Blend Mode",
...
FloatPropertyRNA rna_LampSkySettings_horizon_brightness = {
	...
	-1, "horizon_brightness", 3, 0, 4, 0, "Horizon Brightness",
	"Horizon brightness",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_sky_update, 0, NULL, NULL,
	offsetof(Lamp, horizon_brightness), 5, NULL},
...
FloatPropertyRNA rna_LampSkySettings_spread = {
	...
	-1, "spread", 3, 0, 4, 0, "Horizon Spread",
	"Horizon Spread",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_sky_update, 0, NULL, NULL,
	offsetof(Lamp, spread), 5, NULL},
...
FloatPropertyRNA rna_LampSkySettings_sun_brightness = {
	...
	-1, "sun_brightness", 3, 0, 4, 0, "Sun Brightness",
	"Sun brightness",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_sky_update, 0, NULL, NULL,
	offsetof(Lamp, sun_brightness), 5, NULL},
...
FloatPropertyRNA rna_LampSkySettings_sun_size = {
	...
	-1, "sun_size", 3, 0, 4, 0, "Sun Size",
	"Sun size",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_sky_update, 0, NULL, NULL,
	offsetof(Lamp, sun_size), 5, NULL},
...
FloatPropertyRNA rna_LampSkySettings_backscattered_light = {
	...
	-1, "backscattered_light", 3, 0, 4, 0, "Backscattered Light",
	"Backscattered light",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_sky_update, 0, NULL, NULL,
	offsetof(Lamp, backscattered_light), 5, NULL},
...
FloatPropertyRNA rna_LampSkySettings_sun_intensity = {
	...
	-1, "sun_intensity", 3, 0, 4, 0, "Sun Intensity",
	"Sun intensity",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_sky_update, 0, NULL, NULL,
	offsetof(Lamp, sun_intensity), 5, NULL},
...
FloatPropertyRNA rna_LampSkySettings_atmosphere_turbidity = {
	...
	-1, "atmosphere_turbidity", 3, 0, 4, 0, "Atmosphere Turbidity",
	"Sky turbidity",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_sky_update, 0, NULL, NULL,
	offsetof(Lamp, atm_turbidity), 5, NULL},
...
FloatPropertyRNA rna_LampSkySettings_atmosphere_inscattering = {
	...
	-1, "atmosphere_inscattering", 3, 0, 4, 0, "Atmosphere Inscatter",
	"Scatter contribution factor",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_sky_update, 0, NULL, NULL,
	offsetof(Lamp, atm_inscattering_factor), 5, NULL},
...
FloatPropertyRNA rna_LampSkySettings_atmosphere_extinction = {
	...
	-1, "atmosphere_extinction", 3, 0, 4, 0, "Atmosphere Extinction",
	"Extinction scattering contribution factor",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_sky_update, 0, NULL, NULL,
	offsetof(Lamp, atm_extinction_factor), 5, NULL},
...
FloatPropertyRNA rna_LampSkySettings_atmosphere_distance_factor = {
	...
	-1, "atmosphere_distance_factor", 3, 0, 4, 0, "Atmosphere Distance Factor",
	"Multiplier to convert blender units to physical distance",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_sky_update, 0, NULL, NULL,
	offsetof(Lamp, atm_distance_factor), 5, NULL},
...
FloatPropertyRNA rna_LampSkySettings_sky_blend = {
	...
	-1, "sky_blend", 3, 0, 4, 0, "Sky Blend",
	"Blend factor with sky",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_sky_update, 0, NULL, NULL,
	offsetof(Lamp, skyblendfac), 5, NULL},
...
FloatPropertyRNA rna_LampSkySettings_sky_exposure = {
	...
	-1, "sky_exposure", 3, 0, 4, 0, "Sky Exposure",
	"Strength of sky shading exponential exposure correction",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_sky_update, 0, NULL, NULL,
	offsetof(Lamp, sky_exposure), 5, NULL},
...
BoolPropertyRNA rna_LampSkySettings_use_atmosphere = {
	...
	-1, "use_atmosphere", 3, 0, 0, 0, "Atmosphere",
...
StructRNA RNA_LampSkySettings = {
	...
	"LampSkySettings", NULL, NULL, 516, NULL, "Lamp Sky Settings",
...
StructRNA RNA_HemiLamp = {
	...
	NULL,
	{NULL, NULL}},
	"HemiLamp", NULL, NULL, 519, NULL, "Hemi Lamp",
...
/* Lamp Texture Slot */
static const EnumPropertyItem rna_LampTextureSlot_texture_coords_items[4] = {
...
BoolPropertyRNA rna_LampTextureSlot_use_map_shadow = {
	...
	-1, "use_map_shadow", 3, 0, 0, 0, "Shadow",
...
FloatPropertyRNA rna_LampTextureSlot_shadow_factor = {
	{(PropertyRNA *)&rna_LampTextureSlot_lod_bias, (PropertyRNA *)&rna_LampTextureSlot_color_factor,
	-1, "shadow_factor", 3, 0, 4, 0, "Shadow Factor",
	"Amount texture affects shadow",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_update, 0, NULL, NULL,
	offsetof(MTex, shadowfac), 5, NULL},
...
FloatPropertyRNA rna_LampTextureSlot_lod_bias = {
	...
	LampTextureSlot_lod_bias_get, LampTextureSlot_lod_bias_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

StructRNA RNA_LampTextureSlot = {
	{(ContainerRNA *)&RNA_Lattice, (ContainerRNA *)&RNA_HemiLamp,
	NULL,
	{(PropertyRNA *)&rna_LampTextureSlot_texture_coords, (PropertyRNA *)&rna_LampTextureSlot_lod_bias}},
	"LampTextureSlot", NULL, NULL, 516, NULL, "Lamp Texture Slot",
