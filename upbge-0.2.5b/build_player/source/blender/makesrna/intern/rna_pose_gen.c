...
BoolPropertyRNA rna_PoseBone_use_bbone_custom_handles;
PointerPropertyRNA rna_PoseBone_bbone_custom_handle_start;
BoolPropertyRNA rna_PoseBone_use_bbone_relative_start_handle;
PointerPropertyRNA rna_PoseBone_bbone_custom_handle_end;
BoolPropertyRNA rna_PoseBone_use_bbone_relative_end_handle;
...
bool PoseBone_use_bbone_custom_handles_get(PointerRNA *ptr)
{
	bPoseChannel *data = (bPoseChannel *)(ptr->data);
	return (((data->bboneflag) & 2) != 0);
}

void PoseBone_use_bbone_custom_handles_set(PointerRNA *ptr, bool value)
{
	bPoseChannel *data = (bPoseChannel *)(ptr->data);
	if (value) data->bboneflag |= 2;
	else data->bboneflag &= ~2;
}
...
void PoseBone_bbone_custom_handle_start_set(PointerRNA *ptr, PointerRNA value)
{
	bPoseChannel *data = (bPoseChannel *)(ptr->data);
	data->bbone_prev = value.data;
}

bool PoseBone_use_bbone_relative_start_handle_get(PointerRNA *ptr)
{
	bPoseChannel *data = (bPoseChannel *)(ptr->data);
	return (((data->bboneflag) & 4) != 0);
}

void PoseBone_use_bbone_relative_start_handle_set(PointerRNA *ptr, bool value)
{
	bPoseChannel *data = (bPoseChannel *)(ptr->data);
	if (value) data->bboneflag |= 4;
	else data->bboneflag &= ~4;
}
...
void PoseBone_bbone_custom_handle_end_set(PointerRNA *ptr, PointerRNA value)
{
	bPoseChannel *data = (bPoseChannel *)(ptr->data);
	data->bbone_next = value.data;
}

bool PoseBone_use_bbone_relative_end_handle_get(PointerRNA *ptr)
{
	bPoseChannel *data = (bPoseChannel *)(ptr->data);
	return (((data->bboneflag) & 8) != 0);
}

void PoseBone_use_bbone_relative_end_handle_set(PointerRNA *ptr, bool value)
{
	bPoseChannel *data = (bPoseChannel *)(ptr->data);
	if (value) data->bboneflag |= 8;
	else data->bboneflag &= ~8;
}
...
CollectionPropertyRNA rna_Pose_bone_groups = {
	...
	-1, "bone_groups", 0, 0, 0, 0, "Bone Groups",
	"Groups of the bones",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Pose_ik_param = {
	...
	-1, "ik_param", 8388608, 0, 0, 0, "IK Param",
...
PointerPropertyRNA rna_BoneGroups_active = {
	...
	-1, "active", 8388609, 0, 0, 0, "Active Bone Group",
...
IntPropertyRNA rna_BoneGroups_active_index = {
	...
	-1, "active_index", 3, 0, 0, 0, "Active Bone Group Index",
...
FloatPropertyRNA rna_PoseBone_bbone_rollin = {
	...
	-1, "bbone_rollin", 3, 0, 4, 0, "Roll In",
...
FloatPropertyRNA rna_PoseBone_bbone_rollout = {
	...
	-1, "bbone_rollout", 3, 0, 4, 0, "Roll Out",
...
FloatPropertyRNA rna_PoseBone_bbone_curveoutx = {
	...
	-1, "bbone_curveoutx", 3, 0, 4, 0, "Out X",
...
FloatPropertyRNA rna_PoseBone_bbone_curveouty = {
	...
	-1, "bbone_curveouty", 3, 0, 4, 0, "Out Y",
...
FloatPropertyRNA rna_PoseBone_bbone_easein = {
	...
	-1, "bbone_easein", 3, 0, 4, 0, "Ease In",
...
FloatPropertyRNA rna_PoseBone_bbone_easeout = {
	...
	-1, "bbone_easeout", 3, 0, 4, 0, "Ease Out",
...
FloatPropertyRNA rna_PoseBone_bbone_scalein = {
	...
	-1, "bbone_scalein", 3, 0, 4, 0, "Scale In",
...
FloatPropertyRNA rna_PoseBone_bbone_scaleout = {
	{(PropertyRNA *)&rna_PoseBone_use_bbone_custom_handles, (PropertyRNA *)&rna_PoseBone_bbone_scalein,
	-1, "bbone_scaleout", 3, 0, 4, 0, "Scale Out",
...
BoolPropertyRNA rna_PoseBone_use_bbone_custom_handles = {
	{(PropertyRNA *)&rna_PoseBone_bbone_custom_handle_start, (PropertyRNA *)&rna_PoseBone_bbone_scaleout,
	-1, "use_bbone_custom_handles", 3, 0, 0, 0, "Use Custom Handle References",
	...
	rna_Pose_update, 85196800, rna_PoseChannel_proxy_editable, NULL,
	0, -1, NULL},
	PoseBone_use_bbone_custom_handles_get, PoseBone_use_bbone_custom_handles_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

PointerPropertyRNA rna_PoseBone_bbone_custom_handle_start = {
	{(PropertyRNA *)&rna_PoseBone_use_bbone_relative_start_handle, (PropertyRNA *)&rna_PoseBone_use_bbone_custom_handles,
	-1, "bbone_custom_handle_start", 8388609, 0, 0, 0, "B-Bone Start Handle",
	"Bone that serves as the start handle for the B-Bone curve",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Pose_update, 85196800, rna_PoseChannel_proxy_editable, NULL,
	0, -1, NULL},
	PoseBone_bbone_custom_handle_start_get, PoseBone_bbone_custom_handle_start_set, NULL, NULL,&RNA_PoseBone
};

BoolPropertyRNA rna_PoseBone_use_bbone_relative_start_handle = {
	{(PropertyRNA *)&rna_PoseBone_bbone_custom_handle_end, (PropertyRNA *)&rna_PoseBone_bbone_custom_handle_start,
	-1, "use_bbone_relative_start_handle", 3, 0, 0, 0, "Relative B-Bone Start Handle",
	"Treat custom start handle position as a relative value",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Pose_update, 85196800, rna_PoseChannel_proxy_editable, NULL,
	0, -1, NULL},
	PoseBone_use_bbone_relative_start_handle_get, PoseBone_use_bbone_relative_start_handle_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

PointerPropertyRNA rna_PoseBone_bbone_custom_handle_end = {
	{(PropertyRNA *)&rna_PoseBone_use_bbone_relative_end_handle, (PropertyRNA *)&rna_PoseBone_use_bbone_relative_start_handle,
	-1, "bbone_custom_handle_end", 8388609, 0, 0, 0, "B-Bone End Handle",
	"Bone that serves as the end handle for the B-Bone curve",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Pose_update, 85196800, rna_PoseChannel_proxy_editable, NULL,
	0, -1, NULL},
	PoseBone_bbone_custom_handle_end_get, PoseBone_bbone_custom_handle_end_set, NULL, NULL,&RNA_PoseBone
};

BoolPropertyRNA rna_PoseBone_use_bbone_relative_end_handle = {
	{(PropertyRNA *)&rna_PoseBone_matrix_channel, (PropertyRNA *)&rna_PoseBone_bbone_custom_handle_end,
	-1, "use_bbone_relative_end_handle", 3, 0, 0, 0, "Relative B-Bone End Handle",
	"Treat custom end handle position as a relative value",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Pose_update, 85196800, rna_PoseChannel_proxy_editable, NULL,
	0, -1, NULL},
	PoseBone_use_bbone_relative_end_handle_get, PoseBone_use_bbone_relative_end_handle_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
FloatPropertyRNA rna_PoseBone_matrix_channel = {
	{(PropertyRNA *)&rna_PoseBone_matrix_basis, (PropertyRNA *)&rna_PoseBone_use_bbone_relative_end_handle,
	-1, "matrix_channel", 2, 0, 4, 0, "Channel Matrix",
...
FloatPropertyRNA rna_PoseBone_matrix_basis = {
	...
	-1, "matrix_basis", 1, 0, 0, 0, "Basis Matrix",
...
FloatPropertyRNA rna_PoseBone_head = {
	...
	-1, "head", 2, 0, 4, 0, "Pose Head Position",
...
FloatPropertyRNA rna_PoseBone_tail = {
	...
	-1, "tail", 2, 0, 4, 0, "Pose Tail Position",
...
BoolPropertyRNA rna_PoseBone_is_in_ik_chain = {
	...
	-1, "is_in_ik_chain", 2, 0, 0, 0, "Has IK",
...
BoolPropertyRNA rna_PoseBone_lock_ik_x = {
	...
	-1, "lock_ik_x", 4099, 0, 0, 0, "IK X Lock",
...
BoolPropertyRNA rna_PoseBone_lock_ik_y = {
	...
	-1, "lock_ik_y", 4099, 0, 0, 0, "IK Y Lock",
...
BoolPropertyRNA rna_PoseBone_lock_ik_z = {
	...
	-1, "lock_ik_z", 4099, 0, 0, 0, "IK Z Lock",
...
BoolPropertyRNA rna_PoseBone_use_ik_limit_x = {
	...
	-1, "use_ik_limit_x", 3, 0, 0, 0, "IK X Limit",
...
BoolPropertyRNA rna_PoseBone_use_ik_limit_y = {
	...
	-1, "use_ik_limit_y", 3, 0, 0, 0, "IK Y Limit",
...
BoolPropertyRNA rna_PoseBone_use_ik_limit_z = {
	...
	-1, "use_ik_limit_z", 3, 0, 0, 0, "IK Z Limit",
...
BoolPropertyRNA rna_PoseBone_use_ik_rotation_control = {
	...
	-1, "use_ik_rotation_control", 3, 0, 0, 0, "IK rot control",
...
BoolPropertyRNA rna_PoseBone_use_ik_linear_control = {
	...
	-1, "use_ik_linear_control", 3, 0, 0, 0, "IK rot control",
...
FloatPropertyRNA rna_PoseBone_ik_min_x = {
	...
	-1, "ik_min_x", 3, 0, 4, 0, "IK X Minimum",
...
FloatPropertyRNA rna_PoseBone_ik_max_x = {
	...
	-1, "ik_max_x", 3, 0, 4, 0, "IK X Maximum",
...
FloatPropertyRNA rna_PoseBone_ik_min_y = {
	...
	-1, "ik_min_y", 3, 0, 4, 0, "IK Y Minimum",
	"Minimum angles for IK Limit",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Pose_IK_update, 85196800, rna_PoseChannel_proxy_editable, NULL,
...
FloatPropertyRNA rna_PoseBone_ik_max_y = {
	...
	-1, "ik_max_y", 3, 0, 4, 0, "IK Y Maximum",
	"Maximum angles for IK Limit",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Pose_IK_update, 85196800, rna_PoseChannel_proxy_editable, NULL,
...
FloatPropertyRNA rna_PoseBone_ik_min_z = {
	...
	-1, "ik_min_z", 3, 0, 4, 0, "IK Z Minimum",
	"Minimum angles for IK Limit",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Pose_IK_update, 85196800, rna_PoseChannel_proxy_editable, NULL,
...
FloatPropertyRNA rna_PoseBone_ik_max_z = {
	...
	-1, "ik_max_z", 3, 0, 4, 0, "IK Z Maximum",
	"Maximum angles for IK Limit",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Pose_IK_update, 85196800, rna_PoseChannel_proxy_editable, NULL,
...
FloatPropertyRNA rna_PoseBone_ik_stiffness_x = {
	...
	-1, "ik_stiffness_x", 3, 0, 4, 0, "IK X Stiffness",
...
FloatPropertyRNA rna_PoseBone_ik_stiffness_y = {
	...
	-1, "ik_stiffness_y", 3, 0, 4, 0, "IK Y Stiffness",
...
FloatPropertyRNA rna_PoseBone_ik_stiffness_z = {
	...
	-1, "ik_stiffness_z", 3, 0, 4, 0, "IK Z Stiffness",
...
FloatPropertyRNA rna_PoseBone_ik_stretch = {
	...
	-1, "ik_stretch", 3, 0, 4, 0, "IK Stretch",
...
FloatPropertyRNA rna_PoseBone_ik_rotation_weight = {
	...
	-1, "ik_rotation_weight", 3, 0, 4, 0, "IK Rot Weight",
...
FloatPropertyRNA rna_PoseBone_ik_linear_weight = {
	...
	-1, "ik_linear_weight", 3, 0, 4, 0, "IK Lin Weight",
...
PointerPropertyRNA rna_PoseBone_custom_shape = {
	...
	-1, "custom_shape", 8388609, 0, 0, 0, "Custom Object",
...
FloatPropertyRNA rna_PoseBone_custom_shape_scale = {
	...
	-1, "custom_shape_scale", 3, 0, 4, 0, "Custom Shape Scale",
...
BoolPropertyRNA rna_PoseBone_use_custom_shape_bone_size = {
	...
	-1, "use_custom_shape_bone_size", 3, 0, 0, 0, "Use Bone Size",
...
PointerPropertyRNA rna_PoseBone_custom_shape_transform = {
	...
	-1, "custom_shape_transform", 8388609, 0, 0, 0, "Custom Shape Transform",
...
IntPropertyRNA rna_PoseBone_bone_group_index = {
	...
	-1, "bone_group_index", 1, 0, 0, 0, "Bone Group Index",
...
PointerPropertyRNA rna_PoseBone_bone_group = {
	...
	-1, "bone_group", 8388609, 0, 0, 0, "Bone Group",
...
IntPropertyRNA rna_Itasc_step_count = {
	...
	-1, "step_count", 3, 0, 4, 0, "Num steps",
...
EnumPropertyRNA rna_Itasc_reiteration_method = {
	...
	-1, "reiteration_method", 3, 0, 0, 0, "Reiteration",
...
BoolPropertyRNA rna_Itasc_use_auto_step = {
	...
	-1, "use_auto_step", 3, 0, 0, 0, "Auto step",
...
FloatPropertyRNA rna_Itasc_velocity_max = {
	...
	-1, "velocity_max", 3, 0, 4, 0, "Max Velocity",
...
FloatPropertyRNA rna_Itasc_damping_epsilon = {
	...
	-1, "damping_epsilon", 3, 0, 4, 0, "Epsilon",
...
static const EnumPropertyItem rna_BoneGroup_color_set_items[23] = {
	...
	{1, "THEME01", 842, "01 - Theme Color Set", ""},
	{2, "THEME02", 843, "02 - Theme Color Set", ""},
	{3, "THEME03", 844, "03 - Theme Color Set", ""},
	{4, "THEME04", 845, "04 - Theme Color Set", ""},
	{5, "THEME05", 846, "05 - Theme Color Set", ""},
	{6, "THEME06", 847, "06 - Theme Color Set", ""},
	{7, "THEME07", 848, "07 - Theme Color Set", ""},
	{8, "THEME08", 849, "08 - Theme Color Set", ""},
	{9, "THEME09", 850, "09 - Theme Color Set", ""},
	{10, "THEME10", 851, "10 - Theme Color Set", ""},
	{11, "THEME11", 852, "11 - Theme Color Set", ""},
	{12, "THEME12", 853, "12 - Theme Color Set", ""},
	{13, "THEME13", 854, "13 - Theme Color Set", ""},
	{14, "THEME14", 855, "14 - Theme Color Set", ""},
	{15, "THEME15", 856, "15 - Theme Color Set", ""},
	{16, "THEME16", 857, "16 - Theme Color Set", ""},
	{17, "THEME17", 858, "17 - Theme Color Set", ""},
	{18, "THEME18", 859, "18 - Theme Color Set", ""},
	{19, "THEME19", 860, "19 - Theme Color Set", ""},
	{20, "THEME20", 861, "20 - Theme Color Set", ""},
...
BoolPropertyRNA rna_BoneGroup_is_custom_color_set = {
	...
	-1, "is_custom_color_set", 2, 0, 0, 0, "Custom Color Set",
...
StructRNA RNA_BoneGroup = {
	{(ContainerRNA *)&RNA_PythonComponent, (ContainerRNA *)&RNA_Itasc,
	NULL,
