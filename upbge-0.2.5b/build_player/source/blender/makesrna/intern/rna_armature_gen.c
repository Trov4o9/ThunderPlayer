...
bool Armature_show_only_ghost_selected_get(PointerRNA *ptr)
{
	bArmature *data = (bArmature *)(ptr->data);
	return (((data->flag) & 4096) != 0);
}

void Armature_show_only_ghost_selected_set(PointerRNA *ptr, bool value)
{
	bArmature *data = (bArmature *)(ptr->data);
...
CollectionPropertyRNA rna_Armature_edit_bones = {
	...
	-1, "edit_bones", 0, 0, 0, 0, "Edit Bones",
	"",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
EnumPropertyRNA rna_Armature_pose_position = {
	...
	-1, "pose_position", 65539, 0, 0, 0, "Pose Position",
...
static const EnumPropertyItem rna_Armature_draw_type_items[6] = {
...
EnumPropertyRNA rna_Armature_draw_type = {
	...
	-1, "draw_type", 65539, 0, 0, 0, "Draw Type",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static const EnumPropertyItem rna_Armature_deform_method_items[3] = {
...
EnumPropertyRNA rna_Armature_deform_method = {
	...
	-1, "deform_method", 65539, 0, 0, 0, "Vertex Deformer",
...
static const EnumPropertyItem rna_Armature_ghost_type_items[4] = {
...
EnumPropertyRNA rna_Armature_ghost_type = {
	...
	-1, "ghost_type", 65539, 0, 0, 0, "Ghost Type",
...
BoolPropertyRNA rna_Armature_layers = {
	...
	-1, "layers", 65539, 0, 0, 0, "Visible Layers",
...
BoolPropertyRNA rna_Armature_layers_protected = {
	...
	-1, "layers_protected", 3, 0, 0, 0, "Layer Proxy Protection",
...
BoolPropertyRNA rna_Armature_show_axes = {
	...
	-1, "show_axes", 65539, 0, 0, 0, "Draw Axes",
	"Draw bone axes",
	0, "*",
...
BoolPropertyRNA rna_Armature_show_names = {
	...
	-1, "show_names", 65539, 0, 0, 0, "Draw Names",
	"Draw bone names",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_redraw_data, 0, NULL, NULL,
...
BoolPropertyRNA rna_Armature_use_deform_delay = {
	...
	-1, "use_deform_delay", 3, 0, 0, 0, "Delay Deform",
...
BoolPropertyRNA rna_Armature_use_mirror_x = {
	...
	-1, "use_mirror_x", 65539, 0, 0, 0, "X-Axis Mirror",
...
BoolPropertyRNA rna_Armature_use_auto_ik = {
	...
	-1, "use_auto_ik", 65539, 0, 0, 0, "Auto IK",
...
BoolPropertyRNA rna_Armature_show_bone_custom_shapes = {
	...
	-1, "show_bone_custom_shapes", 3, 0, 0, 0, "Draw Custom Bone Shapes",
...
BoolPropertyRNA rna_Armature_show_group_colors = {
	...
	-1, "show_group_colors", 3, 0, 0, 0, "Draw Bone Group Colors",
...
BoolPropertyRNA rna_Armature_show_only_ghost_selected = {
	...
	-1, "show_only_ghost_selected", 65539, 0, 0, 0, "Draw Ghosts on Selected Bones Only",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_redraw_data, 0, NULL, NULL,
...
IntPropertyRNA rna_Armature_ghost_step = {
	...
	-1, "ghost_step", 65539, 0, 4, 0, "Ghosting Step",
...
IntPropertyRNA rna_Armature_ghost_size = {
	...
	-1, "ghost_size", 65539, 0, 4, 0, "Ghosting Frame Step",
...
IntPropertyRNA rna_Armature_ghost_frame_start = {
	...
	-1, "ghost_frame_start", 65539, 0, 0, 0, "Ghosting Start Frame",
...
IntPropertyRNA rna_Armature_ghost_frame_end = {
	...
	-1, "ghost_frame_end", 65539, 0, 0, 0, "Ghosting End Frame",
...
PointerPropertyRNA rna_ArmatureBones_active = {
	...
	-1, "active", 8388609, 0, 0, 0, "Active Bone",
...
PointerPropertyRNA rna_ArmatureEditBones_active = {
	...
	-1, "active", 8388609, 0, 0, 0, "Active EditBone",
...
BoolPropertyRNA rna_Bone_use_connect = {
	...
	-1, "use_connect", 2, 0, 0, 0, "Connected",
...
BoolPropertyRNA rna_Bone_use_inherit_rotation = {
	...
	-1, "use_inherit_rotation", 3, 0, 0, 0, "Inherit Rotation",
...
BoolPropertyRNA rna_Bone_use_envelope_multiply = {
	...
	-1, "use_envelope_multiply", 3, 0, 0, 0, "Multiply Vertex Group with Envelope",
...
BoolPropertyRNA rna_Bone_use_inherit_scale = {
	...
	-1, "use_inherit_scale", 3, 0, 0, 0, "Inherit Scale",
...
BoolPropertyRNA rna_Bone_use_local_location = {
	...
	-1, "use_local_location", 3, 0, 0, 0, "Local Location",
...
BoolPropertyRNA rna_Bone_use_relative_parent = {
	...
	-1, "use_relative_parent", 3, 0, 0, 0, "Relative Parenting",
...
BoolPropertyRNA rna_Bone_use_cyclic_offset = {
	...
	-1, "use_cyclic_offset", 3, 0, 0, 0, "Cyclic Offset",
...
BoolPropertyRNA rna_Bone_hide_select = {
	...
	-1, "hide_select", 3, 0, 0, 0, "Selectable",
...
FloatPropertyRNA rna_Bone_envelope_distance = {
	...
	-1, "envelope_distance", 3, 0, 4, 0, "Envelope Deform Distance",
...
FloatPropertyRNA rna_Bone_envelope_weight = {
	...
	-1, "envelope_weight", 3, 0, 4, 0, "Envelope Deform Weight",
...
FloatPropertyRNA rna_Bone_head_radius = {
	...
	-1, "head_radius", 3, 0, 4, 0, "Envelope Head Radius",
...
FloatPropertyRNA rna_Bone_tail_radius = {
	...
	-1, "tail_radius", 3, 0, 4, 0, "Envelope Tail Radius",
...
IntPropertyRNA rna_Bone_bbone_segments = {
	...
	-1, "bbone_segments", 3, 0, 4, 0, "B-Bone Segments",
...
FloatPropertyRNA rna_Bone_bbone_x = {
	...
	-1, "bbone_x", 3, 0, 4, 0, "B-Bone Display X Width",
	"B-Bone X size",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_Bone_bbone_z = {
	{(PropertyRNA *)&rna_Bone_bbone_rollin, (PropertyRNA *)&rna_Bone_bbone_x,
	-1, "bbone_z", 3, 0, 4, 0, "B-Bone Display Z Width",
	"B-Bone Z size",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_Bone_bbone_rollin = {
	{(PropertyRNA *)&rna_Bone_bbone_rollout, (PropertyRNA *)&rna_Bone_bbone_z,
...
BoolPropertyRNA rna_Bone_use_endroll_as_inroll = {
	...
	-1, "use_endroll_as_inroll", 3, 0, 0, 0, "Inherit End Roll",
...
BoolPropertyRNA rna_Bone_select_head = {
	...
	-1, "select_head", 1, 0, 0, 0, "Select Head",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_redraw_data, 0, NULL, NULL,
...
BoolPropertyRNA rna_Bone_select_tail = {
	...
	-1, "select_tail", 1, 0, 0, 0, "Select Tail",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_redraw_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_Bone_matrix_local = {
	...
	-1, "matrix_local", 1, 0, 4, 0, "Bone Armature-Relative Matrix",
...
FloatPropertyRNA rna_Bone_tail_local = {
	...
	-1, "tail_local", 1, 0, 4, 0, "Armature-Relative Tail",
...
FloatPropertyRNA rna_Bone_head_local = {
	...
	-1, "head_local", 1, 0, 4, 0, "Armature-Relative Head",
...
BoolPropertyRNA rna_EditBone_use_connect = {
	...
	-1, "use_connect", 3, 0, 0, 0, "Connected",
	"When bone has a parent, bone\'s head is stuck to the parent\'s tail",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_EditBone_envelope_distance = {
	...
	-1, "envelope_distance", 3, 0, 0, 0, "Envelope Deform Distance",
	"Bone deformation distance (for Envelope deform only)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_EditBone_envelope_weight = {
	...
	-1, "envelope_weight", 3, 0, 0, 0, "Envelope Deform Weight",
	"Bone deformation weight (for Envelope deform only)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_EditBone_head_radius = {
	...
	-1, "head_radius", 3, 0, 0, 0, "Envelope Head Radius",
	"Radius of head of bone (for Envelope deform only)",
	0, "*",
	PROP_FLOAT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_editbone_transform_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_EditBone_tail_radius = {
	...
	-1, "tail_radius", 3, 0, 0, 0, "Envelope Tail Radius",
	"Radius of tail of bone (for Envelope deform only)",
	0, "*",
	PROP_FLOAT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_editbone_transform_update, 0, NULL, NULL,
...
IntPropertyRNA rna_EditBone_bbone_segments = {
	...
	-1, "bbone_segments", 3, 0, 0, 0, "B-Bone Segments",
	"Number of subdivisions of bone (for B-Bones only)",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_EditBone_bbone_x = {
	...
	-1, "bbone_x", 3, 0, 0, 0, "B-Bone Display X Width",
	"B-Bone X size",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_EditBone_bbone_z = {
	{(PropertyRNA *)&rna_EditBone_bbone_rollin, (PropertyRNA *)&rna_EditBone_bbone_x,
	-1, "bbone_z", 3, 0, 0, 0, "B-Bone Display Z Width",
	"B-Bone Z size",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_EditBone_bbone_rollin = {
	{(PropertyRNA *)&rna_EditBone_bbone_rollout, (PropertyRNA *)&rna_EditBone_bbone_z,
	-1, "bbone_rollin", 3, 0, 0, 0, "Roll In",
	"Roll offset for the start of the B-Bone, adjusts twist",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_EditBone_bbone_rollout = {
	...
	-1, "bbone_rollout", 3, 0, 0, 0, "Roll Out",
	"Roll offset for the end of the B-Bone, adjusts twist",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_EditBone_bbone_curveoutx = {
	...
	-1, "bbone_curveoutx", 3, 0, 0, 0, "Out X",
	"X-axis handle offset for end of the B-Bone\'s curve, adjusts curvature",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_EditBone_bbone_curveouty = {
	...
	-1, "bbone_curveouty", 3, 0, 0, 0, "Out Y",
	"Y-axis handle offset for end of the B-Bone\'s curve, adjusts curvature",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_EditBone_bbone_easein = {
	...
	-1, "bbone_easein", 3, 0, 0, 0, "Ease In",
	"Length of first Bezier Handle (for B-Bones only)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_EditBone_bbone_easeout = {
	...
	-1, "bbone_easeout", 3, 0, 0, 0, "Ease Out",
	"Length of second Bezier Handle (for B-Bones only)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_EditBone_bbone_scalein = {
	...
	-1, "bbone_scalein", 3, 0, 0, 0, "Scale In",
	"Scale factor for start of the B-Bone, adjusts thickness (for tapering effects)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_EditBone_bbone_scaleout = {
	...
	-1, "bbone_scaleout", 3, 0, 0, 0, "Scale Out",
	"Scale factor for end of the B-Bone, adjusts thickness (for tapering effects)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL,
...
BoolPropertyRNA rna_EditBone_select_head = {
	...
	-1, "select_head", 1, 0, 0, 0, "Head Select",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_redraw_data, 0, NULL, NULL,
...
BoolPropertyRNA rna_EditBone_select_tail = {
	...
	-1, "select_tail", 1, 0, 0, 0, "Tail Select",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_redraw_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_EditBone_matrix = {
	...
	-1, "matrix", 8388611, 0, 0, 0, "Editbone Matrix",
