...
BoolPropertyRNA rna_SmokeDomainSettings_draw_velocity;
EnumPropertyRNA rna_SmokeDomainSettings_vector_draw_type;
...
bool SmokeDomainSettings_draw_velocity_get(PointerRNA *ptr)
{
	SmokeDomainSettings *data = (SmokeDomainSettings *)(ptr->data);
	return (bool)(data->draw_velocity);
}

void SmokeDomainSettings_draw_velocity_set(PointerRNA *ptr, bool value)
{
	SmokeDomainSettings *data = (SmokeDomainSettings *)(ptr->data);
	data->draw_velocity = value;
}

int SmokeDomainSettings_vector_draw_type_get(PointerRNA *ptr)
{
	SmokeDomainSettings *data = (SmokeDomainSettings *)(ptr->data);
	return (int)(data->vector_draw_type);
}

void SmokeDomainSettings_vector_draw_type_set(PointerRNA *ptr, int value)
{
	SmokeDomainSettings *data = (SmokeDomainSettings *)(ptr->data);
...
IntPropertyRNA rna_SmokeDomainSettings_resolution_max = {
	...
	-1, "resolution_max", 1, 0, 4, 0, "Max Res",
...
IntPropertyRNA rna_SmokeDomainSettings_amplify = {
	...
	-1, "amplify", 1, 0, 4, 0, "Amplification",
...
BoolPropertyRNA rna_SmokeDomainSettings_use_high_resolution = {
	...
	-1, "use_high_resolution", 1, 0, 0, 0, "High res",
...
BoolPropertyRNA rna_SmokeDomainSettings_show_high_resolution = {
	...
	-1, "show_high_resolution", 3, 0, 0, 0, "Show High Resolution",
...
EnumPropertyRNA rna_SmokeDomainSettings_noise_type = {
	...
	-1, "noise_type", 1, 0, 0, 0, "Noise Method",
...
PointerPropertyRNA rna_SmokeDomainSettings_fluid_group = {
	...
	-1, "fluid_group", 8388609, 0, 0, 0, "Fluid Group",
...
PointerPropertyRNA rna_SmokeDomainSettings_effector_group = {
	...
	-1, "effector_group", 8388609, 0, 0, 0, "Effector Group",
...
IntPropertyRNA rna_SmokeDomainSettings_dissolve_speed = {
	...
	-1, "dissolve_speed", 3, 0, 4, 0, "Dissolve Speed",
	"Dissolve Speed",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Smoke_resetCache, 85458944, NULL, NULL,
...
BoolPropertyRNA rna_SmokeDomainSettings_use_dissolve_smoke = {
	...
	-1, "use_dissolve_smoke", 3, 0, 0, 0, "Dissolve Smoke",
...
BoolPropertyRNA rna_SmokeDomainSettings_use_dissolve_smoke_log = {
	...
	-1, "use_dissolve_smoke_log", 3, 0, 0, 0, "Logarithmic dissolve",
	"Using 1/x ",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Smoke_resetCache, 85458944, NULL, NULL,
...
EnumPropertyRNA rna_SmokeDomainSettings_point_cache_compress_type = {
	...
	-1, "point_cache_compress_type", 3, 0, 0, 0, "Cache Compression",
...
EnumPropertyRNA rna_SmokeDomainSettings_openvdb_cache_compress_type = {
	...
	-1, "openvdb_cache_compress_type", 3, 0, 0, 0, "Compression",
	"Compression method to be used",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
EnumPropertyRNA rna_SmokeDomainSettings_data_depth = {
	...
	-1, "data_depth", 3, 0, 0, 0, "Data Depth",
...
EnumPropertyRNA rna_SmokeDomainSettings_collision_extents = {
	...
	-1, "collision_extents", 3, 0, 0, 0, "Border Collisions",
...
EnumPropertyRNA rna_SmokeDomainSettings_highres_sampling = {
	...
	-1, "highres_sampling", 3, 0, 0, 0, "Emitter",
...
FloatPropertyRNA rna_SmokeDomainSettings_time_scale = {
	...
	-1, "time_scale", 3, 0, 4, 0, "Time Scale",
...
FloatPropertyRNA rna_SmokeDomainSettings_density_grid = {
	...
	-1, "density_grid", 131074, 0, 0, 0, "Density Grid",
	"Smoke density grid",
	0, "*",
...
FloatPropertyRNA rna_SmokeDomainSettings_velocity_grid = {
	...
	-1, "velocity_grid", 131074, 0, 0, 0, "Velocity Grid",
	"Smoke velocity grid",
	0, "*",
...
FloatPropertyRNA rna_SmokeDomainSettings_flame_grid = {
	...
	-1, "flame_grid", 131074, 0, 0, 0, "Flame Grid",
	"Smoke flame grid",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, rna_SmokeModifier_grid_get_length, 1, {32, 0, 0}, 32,
	NULL, 0, NULL, NULL,
...
FloatPropertyRNA rna_SmokeDomainSettings_color_grid = {
	...
	-1, "color_grid", 131074, 0, 0, 0, "Color Grid",
	"Smoke color grid",
	0, "*",
...
FloatPropertyRNA rna_SmokeDomainSettings_heat_grid = {
	...
	-1, "heat_grid", 131074, 0, 0, 0, "Heat Grid",
	"Smoke heat grid",
	0, "*",
...
FloatPropertyRNA rna_SmokeDomainSettings_temperature_grid = {
	...
	-1, "temperature_grid", 131074, 0, 0, 0, "Temperature Grid",
...
IntPropertyRNA rna_SmokeDomainSettings_domain_resolution = {
	...
	-1, "domain_resolution", 2, 0, 4, 0, "res",
...
FloatPropertyRNA rna_SmokeDomainSettings_flame_vorticity = {
	...
	-1, "flame_vorticity", 3, 0, 4, 0, "Vorticity",
...
FloatPropertyRNA rna_SmokeDomainSettings_flame_ignition = {
	...
	-1, "flame_ignition", 3, 0, 4, 0, "Ignition",
...
FloatPropertyRNA rna_SmokeDomainSettings_flame_max_temp = {
	...
	-1, "flame_max_temp", 3, 0, 4, 0, "Maximum",
...
FloatPropertyRNA rna_SmokeDomainSettings_flame_smoke_color = {
	...
	-1, "flame_smoke_color", 3, 0, 4, 0, "Smoke Color",
...
BoolPropertyRNA rna_SmokeDomainSettings_use_adaptive_domain = {
	...
	-1, "use_adaptive_domain", 1, 0, 0, 0, "Adaptive Domain",
...
IntPropertyRNA rna_SmokeDomainSettings_additional_res = {
	...
	-1, "additional_res", 3, 0, 4, 0, "Additional",
...
FloatPropertyRNA rna_SmokeDomainSettings_adapt_threshold = {
	...
	-1, "adapt_threshold", 3, 0, 4, 0, "Threshold",
...
EnumPropertyRNA rna_SmokeDomainSettings_cache_file_format = {
	...
	-1, "cache_file_format", 3, 0, 0, 0, "File Format",
...
EnumPropertyRNA rna_SmokeDomainSettings_slice_method = {
	...
	-1, "slice_method", 3, 0, 0, 0, "View Method",
...
EnumPropertyRNA rna_SmokeDomainSettings_axis_slice_method = {
	...
	-1, "axis_slice_method", 3, 0, 0, 0, "Method",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 85393408, NULL, NULL,
...
FloatPropertyRNA rna_SmokeDomainSettings_slice_per_voxel = {
	...
	-1, "slice_per_voxel", 3, 0, 4, 0, "Slice Per Voxel",
...
FloatPropertyRNA rna_SmokeDomainSettings_slice_depth = {
	...
	-1, "slice_depth", 3, 0, 4, 0, "Position",
...
FloatPropertyRNA rna_SmokeDomainSettings_display_thickness = {
	{(PropertyRNA *)&rna_SmokeDomainSettings_draw_velocity, (PropertyRNA *)&rna_SmokeDomainSettings_slice_depth,
	-1, "display_thickness", 3, 0, 4, 0, "Thickness",
...
BoolPropertyRNA rna_SmokeDomainSettings_draw_velocity = {
	{(PropertyRNA *)&rna_SmokeDomainSettings_vector_draw_type, (PropertyRNA *)&rna_SmokeDomainSettings_display_thickness,
	-1, "draw_velocity", 3, 0, 4, 0, "Draw Velocity",
	"Toggle visualization of the velocity field as needles",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 85393408, NULL, NULL,
	offsetof(SmokeDomainSettings, draw_velocity), 2, NULL},
	SmokeDomainSettings_draw_velocity_get, SmokeDomainSettings_draw_velocity_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

static const EnumPropertyItem rna_SmokeDomainSettings_vector_draw_type_items[3] = {
	{0, "NEEDLE", 0, "Needle", "Draw vectors as needles"},
	{1, "STREAMLINE", 0, "Streamlines", "Draw vectors as streamlines"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_SmokeDomainSettings_vector_draw_type = {
	{(PropertyRNA *)&rna_SmokeDomainSettings_vector_scale, (PropertyRNA *)&rna_SmokeDomainSettings_draw_velocity,
	-1, "vector_draw_type", 3, 0, 0, 0, "Draw Type",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 85393408, NULL, NULL,
	0, -1, NULL},
	SmokeDomainSettings_vector_draw_type_get, SmokeDomainSettings_vector_draw_type_set, NULL, NULL, NULL, NULL, rna_SmokeDomainSettings_vector_draw_type_items, 2, 0
};

FloatPropertyRNA rna_SmokeDomainSettings_vector_scale = {
	{(PropertyRNA *)&rna_SmokeDomainSettings_use_color_ramp, (PropertyRNA *)&rna_SmokeDomainSettings_vector_draw_type,
	-1, "vector_scale", 3, 0, 4, 0, "Scale",
...
FloatPropertyRNA rna_SmokeFlowSettings_smoke_color = {
	...
	-1, "smoke_color", 3, 0, 4, 0, "Smoke Color",
	"Color of smoke",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_Smoke_reset, 85458944, NULL, NULL,
...
FloatPropertyRNA rna_SmokeFlowSettings_fuel_amount = {
	...
	-1, "fuel_amount", 3, 0, 4, 0, "Flame Rate",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Smoke_reset, 85458944, NULL, NULL,
...
FloatPropertyRNA rna_SmokeFlowSettings_temperature = {
	...
	-1, "temperature", 3, 0, 4, 0, "Temp. Diff.",
...
PointerPropertyRNA rna_SmokeFlowSettings_particle_system = {
	...
	-1, "particle_system", 8388609, 0, 0, 0, "Particle Systems",
...
EnumPropertyRNA rna_SmokeFlowSettings_smoke_flow_type = {
	...
	-1, "smoke_flow_type", 3, 0, 0, 0, "Flow Type",
...
EnumPropertyRNA rna_SmokeFlowSettings_smoke_flow_source = {
	...
	-1, "smoke_flow_source", 3, 0, 0, 0, "Source",
...
BoolPropertyRNA rna_SmokeFlowSettings_use_absolute = {
	...
	-1, "use_absolute", 3, 0, 0, 0, "Absolute Density",
...
BoolPropertyRNA rna_SmokeFlowSettings_use_initial_velocity = {
	...
	-1, "use_initial_velocity", 3, 0, 0, 0, "Initial Velocity",
...
FloatPropertyRNA rna_SmokeFlowSettings_velocity_factor = {
	...
	-1, "velocity_factor", 3, 0, 4, 0, "Source",
...
FloatPropertyRNA rna_SmokeFlowSettings_velocity_normal = {
	...
	-1, "velocity_normal", 3, 0, 4, 0, "Normal",
...
FloatPropertyRNA rna_SmokeFlowSettings_velocity_random = {
	...
	-1, "velocity_random", 3, 0, 4, 0, "Random",
...
FloatPropertyRNA rna_SmokeFlowSettings_volume_density = {
	...
	-1, "volume_density", 3, 0, 4, 0, "Volume",
...
FloatPropertyRNA rna_SmokeFlowSettings_surface_distance = {
	...
	-1, "surface_distance", 3, 0, 4, 0, "Surface",
...
BoolPropertyRNA rna_SmokeFlowSettings_use_particle_size = {
	...
	-1, "use_particle_size", 3, 0, 0, 0, "Set Size",
...
StringPropertyRNA rna_SmokeFlowSettings_density_vertex_group = {
	...
	-1, "density_vertex_group", 262145, 0, 0, 0, "Vertex Group",
...
BoolPropertyRNA rna_SmokeFlowSettings_use_texture = {
	...
	-1, "use_texture", 3, 0, 0, 0, "Use Texture",
...
EnumPropertyRNA rna_SmokeFlowSettings_texture_map_type = {
	...
	-1, "texture_map_type", 3, 0, 0, 0, "Mapping",
...
PointerPropertyRNA rna_SmokeFlowSettings_noise_texture = {
	...
	-1, "noise_texture", 8388673, 0, 0, 0, "Texture",
...
FloatPropertyRNA rna_SmokeFlowSettings_texture_offset = {
	...
	-1, "texture_offset", 3, 0, 4, 0, "Offset",
...
EnumPropertyRNA rna_SmokeCollSettings_collision_type = {
	...
	-1, "collision_type", 3, 0, 0, 0, "Collision type",
	"Collision type",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Smoke_reset, 85458944, NULL, NULL,
