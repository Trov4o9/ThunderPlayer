...
FloatPropertyRNA rna_Object_lod_factor;
...
CollectionPropertyRNA rna_GameObjectSettings_components;
...
FloatPropertyRNA rna_GameObjectSettings_max_slope;
...
PointerPropertyRNA rna_GameObjectSettings_predefined_bound;
BoolPropertyRNA rna_GameObjectSettings_use_physics_fh;
...
FloatPropertyRNA rna_GameObjectSettings_friction;
FloatPropertyRNA rna_GameObjectSettings_rolling_friction;
FloatPropertyRNA rna_GameObjectSettings_elasticity;
BoolPropertyRNA rna_GameObjectSettings_use_fh_normal;
FloatPropertyRNA rna_GameObjectSettings_fh_force;
FloatPropertyRNA rna_GameObjectSettings_fh_distance;
FloatPropertyRNA rna_GameObjectSettings_fh_damping;
...
PointerPropertyRNA rna_GameObjectSettings_activity_culling;


CollectionPropertyRNA rna_ObjectActivityCulling_rna_properties;
PointerPropertyRNA rna_ObjectActivityCulling_rna_type;
FloatPropertyRNA rna_ObjectActivityCulling_physics_radius;
FloatPropertyRNA rna_ObjectActivityCulling_logic_radius;
BoolPropertyRNA rna_ObjectActivityCulling_use_physics;
BoolPropertyRNA rna_ObjectActivityCulling_use_logic;
...
IntPropertyRNA rna_DupliObject_random_id;
...
void Object_layers_get(PointerRNA *ptr, bool values[20])
{
	Object *data = (Object *)(ptr->data);
	unsigned int i;
...
void Object_layers_set(PointerRNA *ptr, const bool values[20])
{
	rna_Object_layer_set(ptr, values);
}

void Object_layers_local_view_get(PointerRNA *ptr, bool values[8])
{
	Object *data = (Object *)(ptr->data);
	unsigned int i;
...
bool Object_select_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->flag) & 1) != 0);
}

void Object_select_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool Object_hide_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->restrictflag) & 1) != 0);
}

void Object_hide_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool Object_use_slow_parent_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->partype) & 16) != 0);
}

void Object_use_slow_parent_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
{
	Object *data = (Object *)(ptr->data);
	data->sf = CLAMPIS(value, -1048574.0f, 1048574.0f);
}

bool Object_use_extra_recalc_object_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->depsflag) & 1) != 0);
}

void Object_use_extra_recalc_object_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool Object_use_extra_recalc_data_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->depsflag) & 2) != 0);
}

void Object_use_extra_recalc_data_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool Object_use_dupli_frames_speed_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return !(((data->transflag) & 64) != 0);
}

void Object_use_dupli_frames_speed_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool Object_use_dupli_vertices_rotation_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->transflag) & 32) != 0);
}

void Object_use_dupli_vertices_rotation_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool Object_use_dupli_faces_scale_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->transflag) & 1024) != 0);
}

void Object_use_dupli_faces_scale_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
{
	Object *data = (Object *)(ptr->data);
	data->dupsta = CLAMPIS(value, -1048574, 1048574);
}
...
{
	Object *data = (Object *)(ptr->data);
	data->dupend = CLAMPIS(value, -1048574, 1048574);
}
...
{
	Object *data = (Object *)(ptr->data);
	data->dupon = CLAMPIS(value, 1, 1048574);
}
...
{
	Object *data = (Object *)(ptr->data);
	data->dupoff = CLAMPIS(value, 0, 1048574);
}
...
bool Object_is_duplicator_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
...
bool Object_show_x_ray_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->dtx) & 64) != 0);
}

void Object_show_x_ray_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
float Object_lod_factor_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (float)(data->lodfactor);
}

void Object_lod_factor_set(PointerRNA *ptr, float value)
{
	Object *data = (Object *)(ptr->data);
...
static PointerRNA GameObjectSettings_components_get(CollectionPropertyIterator *iter)
{
	return rna_pointer_inherit_refine(&iter->parent, &RNA_PythonComponent, rna_iterator_listbase_get(iter));
}

void GameObjectSettings_components_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);

	memset(iter, 0, sizeof(*iter));
	iter->parent = *ptr;
	iter->prop = (PropertyRNA *)&rna_GameObjectSettings_components;

	rna_iterator_listbase_begin(iter, &data->components, NULL);

	if (iter->valid)
		iter->ptr = GameObjectSettings_components_get(iter);
}

void GameObjectSettings_components_next(CollectionPropertyIterator *iter)
{
	rna_iterator_listbase_next(iter);
...
void GameObjectSettings_components_end(CollectionPropertyIterator *iter)
{
	rna_iterator_listbase_end(iter);
}

int GameObjectSettings_components_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
	int found = 0;
	CollectionPropertyIterator iter;

	GameObjectSettings_components_begin(&iter, ptr);
	...
	if (iter.valid) {
		...
		if (found) *r_ptr = GameObjectSettings_components_get(&iter);
	}

	GameObjectSettings_components_end(&iter);

	return found;
}

int GameObjectSettings_components_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	extern int PythonComponent_module_length(PointerRNA *);
	extern void PythonComponent_module_get(PointerRNA *, char *);
	...
	while (iter.valid) {
		if (iter.ptr.data) {
			int namelen = PythonComponent_module_length(&iter.ptr);
			if (namelen < 1024) {
				PythonComponent_module_get(&iter.ptr, namebuf);
				if (strcmp(namebuf, key) == 0) {
					found = true;
					*r_ptr = iter.ptr;
					break;
				...
				name = MEM_mallocN(namelen+1, "name string");
				PythonComponent_module_get(&iter.ptr, name);
				if (strcmp(name, key) == 0) {
					MEM_freeN(name);
		...
		GameObjectSettings_components_next(&iter);
	}
	GameObjectSettings_components_end(&iter);
...
bool GameObjectSettings_show_sensors_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->scaflag) & 64) != 0);
}

void GameObjectSettings_show_sensors_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool GameObjectSettings_show_controllers_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->scaflag) & 2048) != 0);
}

void GameObjectSettings_show_controllers_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool GameObjectSettings_show_actuators_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->scaflag) & 128) != 0);
}

void GameObjectSettings_show_actuators_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool GameObjectSettings_use_actor_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->gameflag) & 4) != 0);
}

void GameObjectSettings_use_actor_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool GameObjectSettings_use_ghost_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->gameflag) & 512) != 0);
}

void GameObjectSettings_use_ghost_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
{
	Object *data = (Object *)(ptr->data);
	data->mass = CLAMPIS(value, 0.0099999998f, 1000000.0f);
}
...
bool GameObjectSettings_use_sleep_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->gameflag) & 4096) != 0);
}

void GameObjectSettings_use_sleep_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
float GameObjectSettings_max_slope_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (float)(data->max_slope);
}

void GameObjectSettings_max_slope_set(PointerRNA *ptr, float value)
{
	Object *data = (Object *)(ptr->data);
	data->max_slope = CLAMPIS(value, 0.0f, 1.5707963705f);
}
...
void GameObjectSettings_collision_group_get(PointerRNA *ptr, bool values[16])
{
	rna_GameObjectSettings_col_group_get(ptr, values);
}

void GameObjectSettings_collision_group_set(PointerRNA *ptr, const bool values[16])
{
	rna_GameObjectSettings_col_group_set(ptr, values);
}

void GameObjectSettings_collision_mask_get(PointerRNA *ptr, bool values[16])
{
	rna_GameObjectSettings_col_mask_get(ptr, values);
}

void GameObjectSettings_collision_mask_set(PointerRNA *ptr, const bool values[16])
{
	rna_GameObjectSettings_col_mask_set(ptr, values);
}

bool GameObjectSettings_lock_location_x_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->gameflag2) & 4) != 0);
}

void GameObjectSettings_lock_location_x_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool GameObjectSettings_lock_location_y_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->gameflag2) & 8) != 0);
}

void GameObjectSettings_lock_location_y_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool GameObjectSettings_lock_location_z_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->gameflag2) & 16) != 0);
}

void GameObjectSettings_lock_location_z_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool GameObjectSettings_lock_rotation_x_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->gameflag2) & 32) != 0);
}

void GameObjectSettings_lock_rotation_x_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool GameObjectSettings_lock_rotation_y_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->gameflag2) & 64) != 0);
}

void GameObjectSettings_lock_rotation_y_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool GameObjectSettings_lock_rotation_z_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->gameflag2) & 128) != 0);
}

void GameObjectSettings_lock_rotation_z_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
PointerRNA GameObjectSettings_predefined_bound_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return rna_pointer_inherit_refine(ptr, &RNA_Mesh, data->gamePredefinedBound);
}

void GameObjectSettings_predefined_bound_set(PointerRNA *ptr, PointerRNA value)
{
	Object *data = (Object *)(ptr->data);

	if (data->gamePredefinedBound)
		id_us_min((ID *)data->gamePredefinedBound);
	if (value.data)
		id_us_plus((ID *)value.data);

	data->gamePredefinedBound = value.data;
}

bool GameObjectSettings_use_physics_fh_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->gameflag) & 64) != 0);
}

void GameObjectSettings_use_physics_fh_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool GameObjectSettings_use_rotate_from_normal_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->gameflag) & 128) != 0);
}

void GameObjectSettings_use_rotate_from_normal_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
{
	Object *data = (Object *)(ptr->data);
	data->formfactor = CLAMPIS(value, 0.0f, 1000.0f);
}

bool GameObjectSettings_use_anisotropic_friction_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->gameflag) & 256) != 0);
}

void GameObjectSettings_use_anisotropic_friction_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool GameObjectSettings_use_collision_bounds_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->gameflag) & 2048) != 0);
}

void GameObjectSettings_use_collision_bounds_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool GameObjectSettings_use_collision_compound_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->gameflag) & 2) != 0);
}

void GameObjectSettings_use_collision_compound_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool GameObjectSettings_use_obstacle_create_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->gameflag) & 2097152) != 0);
}

void GameObjectSettings_use_obstacle_create_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
float GameObjectSettings_friction_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (float)(data->friction);
}

void GameObjectSettings_friction_set(PointerRNA *ptr, float value)
{
	Object *data = (Object *)(ptr->data);
	data->friction = CLAMPIS(value, 0.0f, 100.0f);
}

float GameObjectSettings_rolling_friction_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (float)(data->rolling_friction);
}

void GameObjectSettings_rolling_friction_set(PointerRNA *ptr, float value)
{
	Object *data = (Object *)(ptr->data);
	data->rolling_friction = CLAMPIS(value, 0.0f, 100.0f);
}

float GameObjectSettings_elasticity_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (float)(data->reflect);
}

void GameObjectSettings_elasticity_set(PointerRNA *ptr, float value)
{
	Object *data = (Object *)(ptr->data);
	data->reflect = CLAMPIS(value, 0.0f, 1.0f);
}

bool GameObjectSettings_use_fh_normal_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->dynamode) & 2) != 0);
}

void GameObjectSettings_use_fh_normal_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
float GameObjectSettings_fh_force_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (float)(data->fh);
}

void GameObjectSettings_fh_force_set(PointerRNA *ptr, float value)
{
	Object *data = (Object *)(ptr->data);
	data->fh = CLAMPIS(value, 0.0f, 1.0f);
}

float GameObjectSettings_fh_distance_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (float)(data->fhdist);
}

void GameObjectSettings_fh_distance_set(PointerRNA *ptr, float value)
{
	Object *data = (Object *)(ptr->data);
	data->fhdist = CLAMPIS(value, 0.0f, 20.0f);
}

float GameObjectSettings_fh_damping_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (float)(data->xyfrict);
}

void GameObjectSettings_fh_damping_set(PointerRNA *ptr, float value)
{
	Object *data = (Object *)(ptr->data);
	data->xyfrict = CLAMPIS(value, 0.0f, 1.0f);
}

void GameObjectSettings_states_visible_get(PointerRNA *ptr, bool values[30])
{
	rna_GameObjectSettings_state_get(ptr, values);
}

void GameObjectSettings_states_visible_set(PointerRNA *ptr, const bool values[30])
{
	rna_GameObjectSettings_state_set(ptr, values);
}

void GameObjectSettings_used_states_get(PointerRNA *ptr, bool values[30])
{
	rna_GameObjectSettings_used_state_get(ptr, values);
}

void GameObjectSettings_states_initial_get(PointerRNA *ptr, bool values[30])
{
	Object *data = (Object *)(ptr->data);
	unsigned int i;
...
void GameObjectSettings_states_initial_set(PointerRNA *ptr, const bool values[30])
{
	Object *data = (Object *)(ptr->data);
	unsigned int i;
...
bool GameObjectSettings_show_debug_state_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->scaflag) & 16384) != 0);
}

void GameObjectSettings_show_debug_state_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool GameObjectSettings_use_all_states_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->scaflag) & 4096) != 0);
}

void GameObjectSettings_use_all_states_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
bool GameObjectSettings_show_state_panel_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (((data->scaflag) & 32768) != 0);
}

void GameObjectSettings_show_state_panel_set(PointerRNA *ptr, bool value)
{
	Object *data = (Object *)(ptr->data);
...
PointerRNA GameObjectSettings_activity_culling_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return rna_pointer_inherit_refine(ptr, &RNA_ObjectActivityCulling, &data->activityCulling);
}

static PointerRNA ObjectActivityCulling_rna_properties_get(CollectionPropertyIterator *iter)
{
	return rna_builtin_properties_get(iter);
}

void ObjectActivityCulling_rna_properties_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{

	memset(iter, 0, sizeof(*iter));
	iter->parent = *ptr;
	iter->prop = (PropertyRNA *)&rna_ObjectActivityCulling_rna_properties;

	rna_builtin_properties_begin(iter, ptr);

	if (iter->valid)
		iter->ptr = ObjectActivityCulling_rna_properties_get(iter);
}

void ObjectActivityCulling_rna_properties_next(CollectionPropertyIterator *iter)
{
	rna_builtin_properties_next(iter);
...
void ObjectActivityCulling_rna_properties_end(CollectionPropertyIterator *iter)
{
	rna_iterator_listbase_end(iter);
}

int ObjectActivityCulling_rna_properties_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_builtin_properties_lookup_string(ptr, key, r_ptr);
}

PointerRNA ObjectActivityCulling_rna_type_get(PointerRNA *ptr)
{
	return rna_builtin_type_get(ptr);
}

float ObjectActivityCulling_physics_radius_get(PointerRNA *ptr)
{
	ObjectActivityCulling *data = (ObjectActivityCulling *)(ptr->data);
	return (float)(data->physicsRadius);
}

void ObjectActivityCulling_physics_radius_set(PointerRNA *ptr, float value)
{
	ObjectActivityCulling *data = (ObjectActivityCulling *)(ptr->data);
	data->physicsRadius = CLAMPIS(value, 0.0f, FLT_MAX);
}

float ObjectActivityCulling_logic_radius_get(PointerRNA *ptr)
{
	ObjectActivityCulling *data = (ObjectActivityCulling *)(ptr->data);
	return (float)(data->logicRadius);
}

void ObjectActivityCulling_logic_radius_set(PointerRNA *ptr, float value)
{
	ObjectActivityCulling *data = (ObjectActivityCulling *)(ptr->data);
	data->logicRadius = CLAMPIS(value, 0.0f, FLT_MAX);
}

bool ObjectActivityCulling_use_physics_get(PointerRNA *ptr)
{
	ObjectActivityCulling *data = (ObjectActivityCulling *)(ptr->data);
	return (((data->flags) & 1) != 0);
}

void ObjectActivityCulling_use_physics_set(PointerRNA *ptr, bool value)
{
	ObjectActivityCulling *data = (ObjectActivityCulling *)(ptr->data);
...
bool ObjectActivityCulling_use_logic_get(PointerRNA *ptr)
{
	ObjectActivityCulling *data = (ObjectActivityCulling *)(ptr->data);
	return (((data->flags) & 2) != 0);
}

void ObjectActivityCulling_use_logic_set(PointerRNA *ptr, bool value)
{
	ObjectActivityCulling *data = (ObjectActivityCulling *)(ptr->data);
...
void ObjectBase_layers_get(PointerRNA *ptr, bool values[20])
{
	Base *data = (Base *)(ptr->data);
	unsigned int i;
...
void ObjectBase_layers_set(PointerRNA *ptr, const bool values[20])
{
	rna_Base_layer_set(ptr, values);
}

void ObjectBase_layers_local_view_get(PointerRNA *ptr, bool values[8])
{
	Base *data = (Base *)(ptr->data);
	unsigned int i;
...
bool DupliObject_hide_get(PointerRNA *ptr)
{
	DupliObject *data = (DupliObject *)(ptr->data);
	return (bool)(data->no_draw);
}
...
void DupliObject_persistent_id_get(PointerRNA *ptr, int values[16])
{
	DupliObject *data = (DupliObject *)(ptr->data);
	unsigned int i;
...
int DupliObject_random_id_get(PointerRNA *ptr)
{
	DupliObject *data = (DupliObject *)(ptr->data);
	return (int)(data->random_id);
}
...
bool LodLevel_use_mesh_get(PointerRNA *ptr)
{
	LodLevel *data = (LodLevel *)(ptr->data);
	return (((data->flags) & 1) != 0);
}

void LodLevel_use_mesh_set(PointerRNA *ptr, bool value)
{
	LodLevel *data = (LodLevel *)(ptr->data);
	if (value) data->flags |= 1;
	else data->flags &= ~1;
...
bool LodLevel_use_material_get(PointerRNA *ptr)
{
	LodLevel *data = (LodLevel *)(ptr->data);
	return (((data->flags) & 2) != 0);
}

void LodLevel_use_material_set(PointerRNA *ptr, bool value)
{
	LodLevel *data = (LodLevel *)(ptr->data);
	if (value) data->flags |= 2;
	else data->flags &= ~2;
...
bool LodLevel_use_object_hysteresis_get(PointerRNA *ptr)
{
	LodLevel *data = (LodLevel *)(ptr->data);
	return (((data->flags) & 4) != 0);
}

void LodLevel_use_object_hysteresis_set(PointerRNA *ptr, bool value)
{
	LodLevel *data = (LodLevel *)(ptr->data);
...
void Object_camera_fit_coords(struct Object *_self, struct Scene *scene, int coordinates_len, float *coordinates, float coord_return[3], float *scale_return)
{
	rna_Object_camera_fit_coords(_self, scene, coordinates_len, coordinates, coord_return, scale_return);
}
...
struct Mesh *Object_to_mesh(struct Object *_self, Main *bmain, ReportList *reports, struct Scene *scene, bool apply_modifiers, int settings, bool calc_tessface, bool calc_undeformed)
{
	return rna_Object_to_mesh(_self, bmain, reports, scene, apply_modifiers, settings, calc_tessface, calc_undeformed);
}
...
void Object_to_mesh_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	settings = *((int *)_data);
	_data += 4;
	calc_tessface = *((bool *)_data);
	_data += 1;
	calc_undeformed = *((bool *)_data);
	_data += 1;
	_retdata = _data;
	
	mesh = rna_Object_to_mesh(_self, CTX_data_main(C), reports, scene, apply_modifiers, settings, calc_tessface, calc_undeformed);
	*((struct Mesh **)_retdata) = mesh;
}

void Object_dupli_list_create(struct Object *_self, Main *bmain, ReportList *reports, struct Scene *scene, int settings)
{
	rna_Object_create_duplilist(_self, bmain, reports, scene, settings);
}
...
void Object_dupli_list_create_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	rna_Object_create_duplilist(_self, CTX_data_main(C), reports, scene, settings);
}
...
void Object_ray_cast(struct Object *_self, ReportList *reports, float origin[3], float direction[3], float distance, bool *result, float location[3], float normal[3], int *index)
{
...
void Object_closest_point_on_mesh(struct Object *_self, ReportList *reports, float origin[3], float distance, bool *result, float location[3], float normal[3], int *index)
{
...
bool Object_is_visible(struct Object *_self, struct Scene *scene)
{
...
void rna_Object_camera_fit_coords(struct Object *_self, struct Scene *scene, int coordinates_len, float *coordinates, float coord_return[3], float *scale_return);
struct Mesh *rna_Object_to_mesh(struct Object *_self, Main *bmain, ReportList *reports, struct Scene *scene, bool apply_modifiers, int settings, bool calc_tessface, bool calc_undeformed);
void rna_Object_create_duplilist(struct Object *_self, Main *bmain, ReportList *reports, struct Scene *scene, int settings);
...
void rna_Object_ray_cast(struct Object *_self, ReportList *reports, float origin[3], float direction[3], float distance, bool *result, float location[3], float normal[3], int *index);
void rna_Object_closest_point_on_mesh(struct Object *_self, ReportList *reports, float origin[3], float distance, bool *result, float location[3], float normal[3], int *index);
bool rna_Object_is_visible(struct Object *_self, struct Scene *scene);
...
static const EnumPropertyItem rna_Object_type_items[14] = {
	{1, "MESH", 0, "Mesh", ""},
	{2, "CURVE", 0, "Curve", ""},
	{3, "SURFACE", 0, "Surface", ""},
	{5, "META", 0, "Meta", ""},
...
static const EnumPropertyItem rna_Object_mode_items[10] = {
...
static bool rna_Object_layers_default[20] = {
	0,
	0,
	0,
	0,
...
static bool rna_Object_layers_local_view_default[8] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_Object_layers_local_view = {
	...
	-1, "layers_local_view", 2, 0, 0, 0, "Local View Layers",
...
FloatPropertyRNA rna_Object_bound_box = {
	...
	-1, "bound_box", 2, 0, 0, 0, "Bounding Box",
...
IntPropertyRNA rna_Object_parent_vertices = {
	...
	-1, "parent_vertices", 3, 0, 4, 0, "Parent Vertices",
...
EnumPropertyRNA rna_Object_track_axis = {
	...
	-1, "track_axis", 3, 0, 0, 0, "Track Axis",
...
PointerPropertyRNA rna_Object_proxy_group = {
	...
	-1, "proxy_group", 8388608, 0, 0, 0, "Proxy Group",
...
CollectionPropertyRNA rna_Object_material_slots = {
	...
	-1, "material_slots", 0, 0, 8, 0, "Material Slots",
...
PointerPropertyRNA rna_Object_active_material = {
	...
	-1, "active_material", 8388609, 0, 0, 0, "Active Material",
...
IntPropertyRNA rna_Object_active_material_index = {
	...
	-1, "active_material_index", 1, 0, 0, 0, "Active Material Index",
...
FloatPropertyRNA rna_Object_rotation_quaternion = {
	...
	-1, "rotation_quaternion", 3, 0, 4, 0, "Quaternion Rotation",
...
FloatPropertyRNA rna_Object_rotation_axis_angle = {
	...
	-1, "rotation_axis_angle", 3, 0, 0, 0, "Axis-Angle Rotation",
...
FloatPropertyRNA rna_Object_rotation_euler = {
	...
	-1, "rotation_euler", 3, 0, 4, 0, "Euler Rotation",
	"Rotation in Eulers",
	0, "*",
...
EnumPropertyRNA rna_Object_rotation_mode = {
	...
	-1, "rotation_mode", 3, 0, 0, 0, "Rotation Mode",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_Object_dimensions = {
	...
	-1, "dimensions", 1, 0, 0, 0, "Dimensions",
...
FloatPropertyRNA rna_Object_delta_location = {
	...
	-1, "delta_location", 3, 0, 4, 0, "Delta Location",
...
FloatPropertyRNA rna_Object_delta_rotation_euler = {
	...
	-1, "delta_rotation_euler", 3, 0, 4, 0, "Delta Rotation (Euler)",
...
FloatPropertyRNA rna_Object_delta_rotation_quaternion = {
	...
	-1, "delta_rotation_quaternion", 3, 0, 4, 0, "Delta Rotation (Quaternion)",
...
FloatPropertyRNA rna_Object_delta_scale = {
	...
	-1, "delta_scale", 67108867, 0, 4, 0, "Delta Scale",
...
BoolPropertyRNA rna_Object_lock_location = {
	...
	-1, "lock_location", 4099, 0, 0, 0, "Lock Location",
...
BoolPropertyRNA rna_Object_lock_rotation = {
	...
	-1, "lock_rotation", 4099, 0, 0, 0, "Lock Rotation",
...
BoolPropertyRNA rna_Object_lock_rotation_w = {
	...
	-1, "lock_rotation_w", 4099, 0, 0, 0, "Lock Rotation (4D Angle)",
...
BoolPropertyRNA rna_Object_lock_rotations_4d = {
	...
	-1, "lock_rotations_4d", 3, 0, 0, 0, "Lock Rotations (4D)",
...
BoolPropertyRNA rna_Object_lock_scale = {
	...
	-1, "lock_scale", 4099, 0, 0, 0, "Lock Scale",
...
FloatPropertyRNA rna_Object_matrix_world = {
	...
	-1, "matrix_world", 1, 0, 4, 0, "Matrix World",
...
FloatPropertyRNA rna_Object_matrix_local = {
	...
	-1, "matrix_local", 1, 0, 0, 0, "Local Matrix",
...
FloatPropertyRNA rna_Object_matrix_basis = {
	...
	-1, "matrix_basis", 1, 0, 0, 0, "Input Matrix",
...
FloatPropertyRNA rna_Object_matrix_parent_inverse = {
	...
	-1, "matrix_parent_inverse", 3, 0, 4, 0, "Matrix",
...
CollectionPropertyRNA rna_Object_constraints = {
	...
	-1, "constraints", 0, 0, 0, 0, "Constraints",
...
PointerPropertyRNA rna_Object_game = {
	...
	-1, "game", 8650752, 0, 0, 0, "Game Settings",
...
CollectionPropertyRNA rna_Object_vertex_groups = {
	...
	-1, "vertex_groups", 0, 0, 0, 0, "Vertex Groups",
...
static const EnumPropertyItem rna_Object_empty_draw_type_items[9] = {
...
EnumPropertyRNA rna_Object_empty_draw_type = {
	...
	-1, "empty_draw_type", 3, 0, 0, 0, "Empty Display Type",
...
FloatPropertyRNA rna_Object_empty_draw_size = {
	...
	-1, "empty_draw_size", 3, 0, 4, 0, "Empty Display Size",
...
FloatPropertyRNA rna_Object_empty_image_offset = {
	...
	-1, "empty_image_offset", 3, 0, 4, 0, "Origin Offset",
...
PointerPropertyRNA rna_Object_image_user = {
	...
	-1, "image_user", 8650752, 0, 0, 0, "Image User",
...
IntPropertyRNA rna_Object_pass_index = {
	...
	0, "*",
	PROP_INT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Object_internal_update_draw, 83886080, NULL, NULL,
...
PointerPropertyRNA rna_Object_field = {
	...
	-1, "field", 8388608, 0, 0, 0, "Field Settings",
...
PointerPropertyRNA rna_Object_collision = {
	...
	-1, "collision", 8388608, 0, 0, 0, "Collision Settings",
...
PointerPropertyRNA rna_Object_soft_body = {
	...
	-1, "soft_body", 8388608, 0, 0, 0, "Soft Body Settings",
...
CollectionPropertyRNA rna_Object_particle_systems = {
	...
	-1, "particle_systems", 0, 0, 0, 0, "Particle Systems",
...
PointerPropertyRNA rna_Object_rigid_body = {
	...
	-1, "rigid_body", 8388608, 0, 0, 0, "Rigid Body Settings",
...
PointerPropertyRNA rna_Object_rigid_body_constraint = {
	...
	-1, "rigid_body_constraint", 8388608, 0, 0, 0, "Rigid Body Constraint",
...
BoolPropertyRNA rna_Object_hide = {
	...
	-1, "hide", 4099, 0, 0, 0, "Restrict View",
...
BoolPropertyRNA rna_Object_hide_select = {
	...
	-1, "hide_select", 4099, 0, 0, 0, "Restrict Select",
...
BoolPropertyRNA rna_Object_hide_render = {
	...
	-1, "hide_render", 4099, 0, 0, 0, "Restrict Render",
...
PointerPropertyRNA rna_Object_animation_visualization = {
	...
	-1, "animation_visualization", 8650752, 0, 0, 0, "Animation Visualization",
	"Animation data for this data-block",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Object_motion_path = {
	...
	-1, "motion_path", 8388608, 0, 0, 0, "Motion Path",
...
BoolPropertyRNA rna_Object_use_slow_parent = {
	...
	-1, "use_slow_parent", 3, 0, 0, 0, "Slow Parent",
...
FloatPropertyRNA rna_Object_slow_parent_offset = {
	...
	-1, "slow_parent_offset", 3, 0, 4, 0, "Slow Parent Offset",
	"Delay in the parent relationship",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_TIME, NULL, 0, {0, 0, 0}, 0,
	rna_Object_internal_update, 85065728, NULL, NULL,
	offsetof(Object, sf), 5, NULL},
	Object_slow_parent_offset_get, Object_slow_parent_offset_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -1048574.0f, 1048574.0f, -1048574.0f, 1048574.0f, 10.0f, 3, 0.0f, NULL
};

BoolPropertyRNA rna_Object_use_extra_recalc_object = {
	{(PropertyRNA *)&rna_Object_use_extra_recalc_data, (PropertyRNA *)&rna_Object_slow_parent_offset,
	-1, "use_extra_recalc_object", 3, 0, 0, 0, "Extra Object Update",
...
BoolPropertyRNA rna_Object_use_extra_recalc_data = {
	...
	-1, "use_extra_recalc_data", 3, 0, 0, 0, "Extra Data Update",
...
static const EnumPropertyItem rna_Object_dupli_type_items[6] = {
	{0, "NONE", 0, "None", ""},
...
EnumPropertyRNA rna_Object_dupli_type = {
	...
	-1, "dupli_type", 3, 0, 0, 0, "Dupli Type",
...
BoolPropertyRNA rna_Object_use_dupli_frames_speed = {
	...
	-1, "use_dupli_frames_speed", 3, 0, 0, 0, "Dupli Frames Speed",
...
BoolPropertyRNA rna_Object_use_dupli_vertices_rotation = {
	...
	-1, "use_dupli_vertices_rotation", 3, 0, 0, 0, "Dupli Verts Rotation",
...
BoolPropertyRNA rna_Object_use_dupli_faces_scale = {
	...
	-1, "use_dupli_faces_scale", 3, 0, 0, 0, "Dupli Faces Inherit Scale",
...
FloatPropertyRNA rna_Object_dupli_faces_scale = {
	...
	-1, "dupli_faces_scale", 3, 0, 4, 0, "Dupli Faces Scale",
	"Scale the DupliFace objects",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Object_internal_update, 85393408, NULL, NULL,
	offsetof(Object, dupfacesca), 5, NULL},
...
PointerPropertyRNA rna_Object_dupli_group = {
	...
	-1, "dupli_group", 8388609, 0, 0, 0, "Dupli Group",
...
IntPropertyRNA rna_Object_dupli_frames_start = {
	...
	-1, "dupli_frames_start", 3, 0, 4, 0, "Dupli Frames Start",
...
IntPropertyRNA rna_Object_dupli_frames_end = {
	...
	-1, "dupli_frames_end", 3, 0, 4, 0, "Dupli Frames End",
...
IntPropertyRNA rna_Object_dupli_frames_on = {
	...
	-1, "dupli_frames_on", 3, 0, 4, 0, "Dupli Frames On",
...
BoolPropertyRNA rna_Object_is_duplicator = {
	...
	-1, "is_duplicator", 2, 0, 0, 0, "is_duplicator",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
static const EnumPropertyItem rna_Object_draw_type_items[5] = {
...
EnumPropertyRNA rna_Object_draw_type = {
	...
	-1, "draw_type", 3, 0, 0, 0, "Maximum Draw Type",
...
BoolPropertyRNA rna_Object_show_bounds = {
	...
	-1, "show_bounds", 3, 0, 0, 0, "Draw Bounds",
...
static const EnumPropertyItem rna_Object_draw_bounds_type_items[6] = {
...
EnumPropertyRNA rna_Object_draw_bounds_type = {
	...
	-1, "draw_bounds_type", 3, 0, 0, 0, "Draw Bounds Type",
...
BoolPropertyRNA rna_Object_show_texture_space = {
	...
	-1, "show_texture_space", 3, 0, 0, 0, "Draw Texture Space",
...
BoolPropertyRNA rna_Object_show_all_edges = {
	...
	-1, "show_all_edges", 3, 0, 0, 0, "Draw All Edges",
...
BoolPropertyRNA rna_Object_show_transparent = {
	...
	-1, "show_transparent", 3, 0, 0, 0, "Draw Transparent",
...
PointerPropertyRNA rna_Object_pose_library = {
	...
	-1, "pose_library", 8388673, 0, 0, 0, "Pose Library",
...
BoolPropertyRNA rna_Object_show_only_shape_key = {
	...
	-1, "show_only_shape_key", 4099, 0, 0, 0, "Shape Key Lock",
...
BoolPropertyRNA rna_Object_use_shape_key_edit_mode = {
	...
	-1, "use_shape_key_edit_mode", 3, 0, 0, 0, "Shape Key Edit Mode",
...
PointerPropertyRNA rna_Object_active_shape_key = {
	...
	-1, "active_shape_key", 8388608, 0, 0, 0, "Active Shape Key",
	"Current shape key",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_Object_active_shape_key_index = {
	...
	-1, "active_shape_key_index", 1, 0, 0, 0, "Active Shape Key Index",
...
BoolPropertyRNA rna_Object_use_dynamic_topology_sculpting = {
	...
	-1, "use_dynamic_topology_sculpting", 2, 0, 0, 0, "Dynamic Topology Sculpting",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
CollectionPropertyRNA rna_Object_lod_levels = {
	{(PropertyRNA *)&rna_Object_lod_factor, (PropertyRNA *)&rna_Object_use_dynamic_topology_sculpting,
	-1, "lod_levels", 0, 0, 0, 0, "Level of Detail Levels",
...
FloatPropertyRNA rna_Object_lod_factor = {
	{NULL, (PropertyRNA *)&rna_Object_lod_levels,
	-1, "lod_factor", 3, 0, 4, 0, "Level of Detail Distance Factor",
	"The factor applied to distance computed in Lod",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 85852160, NULL, NULL,
	offsetof(Object, lodfactor), 5, NULL},
	Object_lod_factor_get, Object_lod_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 1.0f, NULL
};

PointerPropertyRNA rna_Object_convert_space_pose_bone = {
	{(PropertyRNA *)&rna_Object_convert_space_matrix, NULL,
	-1, "pose_bone", 8388608, 0, 0, 0, "",
...
static const EnumPropertyItem rna_Object_to_mesh_settings_items[3] = {
...
BoolPropertyRNA rna_Object_to_mesh_calc_tessface = {
	...
	-1, "calc_tessface", 3, 0, 0, 0, "Calculate Tessellation",
...
BoolPropertyRNA rna_Object_to_mesh_calc_undeformed = {
	...
	-1, "calc_undeformed", 3, 0, 0, 0, "Calculate Undeformed",
...
FunctionRNA rna_Object_to_mesh_func = {
	...
	"to_mesh", 20, "Create a Mesh data-block with modifiers applied",
	Object_to_mesh_call,
...
static const EnumPropertyItem rna_Object_dupli_list_create_settings_items[4] = {
...
FunctionRNA rna_Object_dupli_list_create_func = {
	...
	"dupli_list_create", 20, "Create a list of dupli objects for this object, needs to be freed manually with free_dupli_list to restore the objects real matrix and layers",
...
StructRNA RNA_Object = {
	...
	NULL,
	{(PropertyRNA *)&rna_Object_data, (PropertyRNA *)&rna_Object_lod_factor}},
...
static const EnumPropertyItem rna_ObjectModifiers_new_type_items[57] = {
	{0, "", 0, "Modify", ""},
...
PointerPropertyRNA rna_ObjectConstraints_active = {
	...
	-1, "active", 8388609, 0, 0, 0, "Active Constraint",
...
static const EnumPropertyItem rna_ObjectConstraints_new_type_items[33] = {
	...
	{29, "TRANSFORM_CACHE", 459, "Transform Cache", "Look up the transformation matrix from an external file"},
	{0, "", 0, "Tracking", ""},
...
PointerPropertyRNA rna_VertexGroups_active = {
	...
	-1, "active", 8388608, 0, 0, 0, "Active Vertex Group",
	"Vertex groups of the object",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
IntPropertyRNA rna_VertexGroups_active_index = {
	...
	-1, "active_index", 1, 0, 0, 0, "Active Vertex Group Index",
...
PointerPropertyRNA rna_ParticleSystems_active = {
	...
	-1, "active", 8388608, 0, 0, 0, "Active Particle System",
...
IntPropertyRNA rna_ParticleSystems_active_index = {
	...
	-1, "active_index", 1, 0, 0, 0, "Active Particle System Index",
...
CollectionPropertyRNA rna_GameObjectSettings_controllers = {
	...
	-1, "controllers", 0, 0, 0, 0, "Controllers",
...
CollectionPropertyRNA rna_GameObjectSettings_properties = {
	{(PropertyRNA *)&rna_GameObjectSettings_components, (PropertyRNA *)&rna_GameObjectSettings_actuators,
...
CollectionPropertyRNA rna_GameObjectSettings_components = {
	{(PropertyRNA *)&rna_GameObjectSettings_show_sensors, (PropertyRNA *)&rna_GameObjectSettings_properties,
	-1, "components", 0, 0, 0, 0, "Components",
	"Game engine components",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	GameObjectSettings_components_begin, GameObjectSettings_components_next, GameObjectSettings_components_end, GameObjectSettings_components_get, NULL, GameObjectSettings_components_lookup_int, GameObjectSettings_components_lookup_string, NULL, &RNA_PythonComponent
};

BoolPropertyRNA rna_GameObjectSettings_show_sensors = {
	{(PropertyRNA *)&rna_GameObjectSettings_show_controllers, (PropertyRNA *)&rna_GameObjectSettings_components,
	-1, "show_sensors", 1, 0, 0, 0, "Show Sensors",
...
BoolPropertyRNA rna_GameObjectSettings_show_controllers = {
	...
	-1, "show_controllers", 1, 0, 0, 0, "Show Controllers",
...
BoolPropertyRNA rna_GameObjectSettings_show_actuators = {
	...
	-1, "show_actuators", 1, 0, 0, 0, "Show Actuators",
...
static const EnumPropertyItem rna_GameObjectSettings_physics_type_items[10] = {
...
EnumPropertyRNA rna_GameObjectSettings_physics_type = {
	{(PropertyRNA *)&rna_GameObjectSettings_use_actor, (PropertyRNA *)&rna_GameObjectSettings_show_actuators,
	-1, "physics_type", 1, 0, 0, 0, "Physics Type",
...
BoolPropertyRNA rna_GameObjectSettings_use_actor = {
	{(PropertyRNA *)&rna_GameObjectSettings_use_ghost, (PropertyRNA *)&rna_GameObjectSettings_physics_type,
	-1, "use_actor", 1, 0, 0, 0, "Actor",
...
FloatPropertyRNA rna_GameObjectSettings_mass = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, mass), 5, NULL},
	GameObjectSettings_mass_get, GameObjectSettings_mass_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0099999998f, 1000000.0f, 0.0099999998f, 1000000.0f, 10.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_GameObjectSettings_radius = {
	{(PropertyRNA *)&rna_GameObjectSettings_use_sleep, (PropertyRNA *)&rna_GameObjectSettings_mass,
	-1, "radius", 1, 0, 4, 0, "Radius",
	"Radius of bounding sphere and material physics",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	NULL, 85393408, NULL, NULL,
	offsetof(Object, inertia), 5, NULL},
...
BoolPropertyRNA rna_GameObjectSettings_use_sleep = {
	...
	-1, "use_sleep", 1, 0, 0, 0, "No Sleeping",
...
FloatPropertyRNA rna_GameObjectSettings_damping = {
	...
	-1, "damping", 1, 0, 4, 0, "Damping",
	"General movement damping",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, damping), 5, NULL},
...
FloatPropertyRNA rna_GameObjectSettings_rotation_damping = {
	...
	-1, "rotation_damping", 1, 0, 4, 0, "Rotation Damping",
	"General rotation damping",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, rdamping), 5, NULL},
...
FloatPropertyRNA rna_GameObjectSettings_velocity_max = {
	...
	-1, "velocity_max", 1, 0, 4, 0, "Velocity Max",
	"Clamp velocity to this maximum speed, in distance per second",
	0, "*",
	PROP_FLOAT, PROP_DISTANCE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, max_vel), 5, NULL},
...
FloatPropertyRNA rna_GameObjectSettings_angular_velocity_min = {
	...
	-1, "angular_velocity_min", 1, 0, 4, 0, "Angular Velocity Min",
	...
	NULL, 0, NULL, NULL,
	offsetof(Object, min_angvel), 5, NULL},
...
FloatPropertyRNA rna_GameObjectSettings_angular_velocity_max = {
	...
	-1, "angular_velocity_max", 1, 0, 4, 0, "Angular Velocity Max",
	"Clamp angular velocity to this maximum speed, in angle per second",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, max_angvel), 5, NULL},
...
FloatPropertyRNA rna_GameObjectSettings_step_height = {
	...
	-1, "step_height", 1, 0, 4, 0, "Step Height",
	"Maximum height of steps the character can run over",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, step_height), 5, NULL},
...
FloatPropertyRNA rna_GameObjectSettings_jump_speed = {
	...
	-1, "jump_speed", 1, 0, 4, 0, "Jump Force",
	"Upward velocity applied to the character when jumping",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, jump_speed), 5, NULL},
...
FloatPropertyRNA rna_GameObjectSettings_fall_speed = {
	{(PropertyRNA *)&rna_GameObjectSettings_max_slope, (PropertyRNA *)&rna_GameObjectSettings_jump_speed,
	-1, "fall_speed", 1, 0, 4, 0, "Fall Speed Max",
	"Maximum speed at which the character will fall",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, fall_speed), 5, NULL},
...
FloatPropertyRNA rna_GameObjectSettings_max_slope = {
	{(PropertyRNA *)&rna_GameObjectSettings_jump_max, (PropertyRNA *)&rna_GameObjectSettings_fall_speed,
	-1, "max_slope", 1, 0, 4, 0, "Max Slope",
	"Maximum slope angle which the character will climb",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, max_slope), 5, NULL},
	GameObjectSettings_max_slope_get, GameObjectSettings_max_slope_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.5707963705f, 0.0f, 1.5707963705f, 10.0f, 3, 1.5707963705f, NULL
};

IntPropertyRNA rna_GameObjectSettings_jump_max = {
	{(PropertyRNA *)&rna_GameObjectSettings_collision_group, (PropertyRNA *)&rna_GameObjectSettings_max_slope,
	-1, "jump_max", 1, 0, 4, 0, "Max Jumps",
...
static bool rna_GameObjectSettings_collision_group_default[16] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_GameObjectSettings_collision_group = {
	...
	-1, "collision_group", 1, 0, 0, 0, "Collision Group",
...
static bool rna_GameObjectSettings_collision_mask_default[16] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_GameObjectSettings_collision_mask = {
	...
	-1, "collision_mask", 1, 0, 0, 0, "Collision Mask",
...
BoolPropertyRNA rna_GameObjectSettings_lock_location_x = {
	...
	-1, "lock_location_x", 1, 0, 0, 0, "Lock X Axis",
...
BoolPropertyRNA rna_GameObjectSettings_lock_location_y = {
	...
	-1, "lock_location_y", 1, 0, 0, 0, "Lock Y Axis",
...
BoolPropertyRNA rna_GameObjectSettings_lock_location_z = {
	...
	-1, "lock_location_z", 1, 0, 0, 0, "Lock Z Axis",
...
BoolPropertyRNA rna_GameObjectSettings_lock_rotation_x = {
	...
	-1, "lock_rotation_x", 1, 0, 0, 0, "Lock X Rotation Axis",
...
BoolPropertyRNA rna_GameObjectSettings_lock_rotation_y = {
	...
	-1, "lock_rotation_y", 1, 0, 0, 0, "Lock Y Rotation Axis",
...
BoolPropertyRNA rna_GameObjectSettings_lock_rotation_z = {
	{(PropertyRNA *)&rna_GameObjectSettings_predefined_bound, (PropertyRNA *)&rna_GameObjectSettings_lock_rotation_y,
	-1, "lock_rotation_z", 1, 0, 0, 0, "Lock Z Rotation Axis",
...
PointerPropertyRNA rna_GameObjectSettings_predefined_bound = {
	{(PropertyRNA *)&rna_GameObjectSettings_use_physics_fh, (PropertyRNA *)&rna_GameObjectSettings_lock_rotation_z,
	-1, "predefined_bound", 8388673, 0, 0, 0, "Predefined Bound",
	"Predefined mesh bounding volume used when Auto Update Bound is disable",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	GameObjectSettings_predefined_bound_get, GameObjectSettings_predefined_bound_set, NULL, NULL,&RNA_Mesh
};

BoolPropertyRNA rna_GameObjectSettings_use_physics_fh = {
	{(PropertyRNA *)&rna_GameObjectSettings_use_rotate_from_normal, (PropertyRNA *)&rna_GameObjectSettings_predefined_bound,
	-1, "use_physics_fh", 1, 0, 0, 0, "Use Force Field",
	"React to force field physics settings",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	GameObjectSettings_use_physics_fh_get, GameObjectSettings_use_physics_fh_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_GameObjectSettings_use_rotate_from_normal = {
	{(PropertyRNA *)&rna_GameObjectSettings_form_factor, (PropertyRNA *)&rna_GameObjectSettings_use_physics_fh,
	-1, "use_rotate_from_normal", 1, 0, 0, 0, "Rotate From Normal",
...
FloatPropertyRNA rna_GameObjectSettings_form_factor = {
	...
	-1, "form_factor", 1, 0, 4, 0, "Form Factor",
	"Form factor scales the inertia tensor",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, formfactor), 5, NULL},
	GameObjectSettings_form_factor_get, GameObjectSettings_form_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, 0.0f, 1000.0f, 10.0f, 3, 0.4000000060f, NULL
};

BoolPropertyRNA rna_GameObjectSettings_use_anisotropic_friction = {
	{(PropertyRNA *)&rna_GameObjectSettings_friction_coefficients, (PropertyRNA *)&rna_GameObjectSettings_form_factor,
	-1, "use_anisotropic_friction", 1, 0, 0, 0, "Anisotropic Friction",
...
BoolPropertyRNA rna_GameObjectSettings_use_collision_bounds = {
	...
	-1, "use_collision_bounds", 1, 0, 0, 0, "Use Collision Bounds",
...
static const EnumPropertyItem rna_GameObjectSettings_collision_bounds_type_items[9] = {
	{0, "BOX", 287, "Box", ""},
	{1, "SPHERE", 289, "Sphere", ""},
...
EnumPropertyRNA rna_GameObjectSettings_collision_bounds_type = {
	...
	-1, "collision_bounds_type", 1, 0, 0, 0, "Collision Shape",
	"Select the collision shape that better fits the object",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 85393408, NULL, NULL,
	0, -1, NULL},
	GameObjectSettings_collision_bounds_type_get, GameObjectSettings_collision_bounds_type_set, rna_Object_collision_bounds_itemf, NULL, NULL, NULL, rna_GameObjectSettings_collision_bounds_type_items, 8, 0
};

BoolPropertyRNA rna_GameObjectSettings_use_collision_compound = {
	{(PropertyRNA *)&rna_GameObjectSettings_collision_margin, (PropertyRNA *)&rna_GameObjectSettings_collision_bounds_type,
	-1, "use_collision_compound", 1, 0, 0, 0, "Collision Compound",
...
FloatPropertyRNA rna_GameObjectSettings_collision_margin = {
	...
	-1, "collision_margin", 1, 0, 4, 0, "Collision Margin",
...
BoolPropertyRNA rna_GameObjectSettings_use_obstacle_create = {
	...
	-1, "use_obstacle_create", 1, 0, 0, 0, "Create obstacle",
...
FloatPropertyRNA rna_GameObjectSettings_obstacle_radius = {
	{(PropertyRNA *)&rna_GameObjectSettings_friction, (PropertyRNA *)&rna_GameObjectSettings_use_obstacle_create,
	-1, "obstacle_radius", 1, 0, 4, 0, "Obstacle Radius",
	"Radius of object representation in obstacle simulation",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, obstacleRad), 5, NULL},
...
FloatPropertyRNA rna_GameObjectSettings_friction = {
	{(PropertyRNA *)&rna_GameObjectSettings_rolling_friction, (PropertyRNA *)&rna_GameObjectSettings_obstacle_radius,
	-1, "friction", 1, 0, 4, 0, "Friction",
	"Coulomb friction coefficient, when inside the physics distance area",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, friction), 5, NULL},
	GameObjectSettings_friction_get, GameObjectSettings_friction_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 100.0f, 0.0f, 100.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_GameObjectSettings_rolling_friction = {
	{(PropertyRNA *)&rna_GameObjectSettings_elasticity, (PropertyRNA *)&rna_GameObjectSettings_friction,
	-1, "rolling_friction", 1, 0, 4, 0, "Rolling Friction",
	"Coulomb friction coefficient of rounded shapes",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, rolling_friction), 5, NULL},
	GameObjectSettings_rolling_friction_get, GameObjectSettings_rolling_friction_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 100.0f, 0.0f, 100.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_GameObjectSettings_elasticity = {
	{(PropertyRNA *)&rna_GameObjectSettings_use_fh_normal, (PropertyRNA *)&rna_GameObjectSettings_rolling_friction,
	-1, "elasticity", 1, 0, 4, 0, "Elasticity",
	"Elasticity of collisions",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, reflect), 5, NULL},
	GameObjectSettings_elasticity_get, GameObjectSettings_elasticity_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};

BoolPropertyRNA rna_GameObjectSettings_use_fh_normal = {
	{(PropertyRNA *)&rna_GameObjectSettings_fh_force, (PropertyRNA *)&rna_GameObjectSettings_elasticity,
	-1, "use_fh_normal", 1, 0, 0, 0, "Align to Normal",
	"Align dynamic game objects along the surface normal, when inside the physics distance area",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	GameObjectSettings_use_fh_normal_get, GameObjectSettings_use_fh_normal_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

FloatPropertyRNA rna_GameObjectSettings_fh_force = {
	{(PropertyRNA *)&rna_GameObjectSettings_fh_distance, (PropertyRNA *)&rna_GameObjectSettings_use_fh_normal,
	-1, "fh_force", 1, 0, 4, 0, "Force",
	"Upward spring force, when inside the physics distance area",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, fh), 5, NULL},
	GameObjectSettings_fh_force_get, GameObjectSettings_fh_force_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 2, 0.0f, NULL
};

FloatPropertyRNA rna_GameObjectSettings_fh_distance = {
	{(PropertyRNA *)&rna_GameObjectSettings_fh_damping, (PropertyRNA *)&rna_GameObjectSettings_fh_force,
	-1, "fh_distance", 1, 0, 4, 0, "Distance",
	"Distance of the physics area",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, fhdist), 5, NULL},
	GameObjectSettings_fh_distance_get, GameObjectSettings_fh_distance_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 20.0f, 0.0f, 20.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_GameObjectSettings_fh_damping = {
	{(PropertyRNA *)&rna_GameObjectSettings_states_visible, (PropertyRNA *)&rna_GameObjectSettings_fh_distance,
	-1, "fh_damping", 1, 0, 4, 0, "Damping",
	"Damping of the spring force, when inside the physics distance area",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, xyfrict), 5, NULL},
	GameObjectSettings_fh_damping_get, GameObjectSettings_fh_damping_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};

static bool rna_GameObjectSettings_states_visible_default[30] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_GameObjectSettings_states_visible = {
	{(PropertyRNA *)&rna_GameObjectSettings_used_states, (PropertyRNA *)&rna_GameObjectSettings_fh_damping,
	-1, "states_visible", 1, 0, 0, 0, "State",
...
static bool rna_GameObjectSettings_used_states_default[30] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_GameObjectSettings_used_states = {
	...
	-1, "used_states", 0, 0, 0, 0, "Used State",
...
static bool rna_GameObjectSettings_states_initial_default[30] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_GameObjectSettings_states_initial = {
	...
	-1, "states_initial", 1, 0, 0, 0, "Initial State",
...
BoolPropertyRNA rna_GameObjectSettings_show_debug_state = {
	...
	-1, "show_debug_state", 1, 0, 0, 0, "Debug State",
...
BoolPropertyRNA rna_GameObjectSettings_show_state_panel = {
	{(PropertyRNA *)&rna_GameObjectSettings_activity_culling, (PropertyRNA *)&rna_GameObjectSettings_use_all_states,
	-1, "show_state_panel", 4097, 0, 0, 0, "States",
	"Show state panel",
	11, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_GameObjectSettings_activity_culling = {
	{NULL, (PropertyRNA *)&rna_GameObjectSettings_show_state_panel,
	-1, "activity_culling", 8650752, 0, 0, 0, "Object Activity Culling",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	GameObjectSettings_activity_culling_get, NULL, NULL, NULL,&RNA_ObjectActivityCulling
};

StructRNA RNA_GameObjectSettings = {
	{(ContainerRNA *)&RNA_ObjectActivityCulling, (ContainerRNA *)&RNA_ParticleSystems,
	NULL,
	{(PropertyRNA *)&rna_GameObjectSettings_rna_properties, (PropertyRNA *)&rna_GameObjectSettings_activity_culling}},
	"GameObjectSettings", NULL, NULL, 516, NULL, "Game Object Settings",
	"Game engine related settings for the object",
	"*", 85,
...
CollectionPropertyRNA rna_ObjectActivityCulling_rna_properties = {
	{(PropertyRNA *)&rna_ObjectActivityCulling_rna_type, NULL,
	-1, "rna_properties", 0, 0, 1, 0, "Properties",
	"RNA property collection",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	ObjectActivityCulling_rna_properties_begin, ObjectActivityCulling_rna_properties_next, ObjectActivityCulling_rna_properties_end, ObjectActivityCulling_rna_properties_get, NULL, NULL, ObjectActivityCulling_rna_properties_lookup_string, NULL, &RNA_Property
};

PointerPropertyRNA rna_ObjectActivityCulling_rna_type = {
	{(PropertyRNA *)&rna_ObjectActivityCulling_physics_radius, (PropertyRNA *)&rna_ObjectActivityCulling_rna_properties,
	-1, "rna_type", 8912896, 0, 0, 0, "RNA",
	"RNA type definition",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	ObjectActivityCulling_rna_type_get, NULL, NULL, NULL,&RNA_Struct
};

FloatPropertyRNA rna_ObjectActivityCulling_physics_radius = {
	{(PropertyRNA *)&rna_ObjectActivityCulling_logic_radius, (PropertyRNA *)&rna_ObjectActivityCulling_rna_type,
	-1, "physics_radius", 1, 0, 4, 0, "Physics Radius",
	"Distance to begin suspend physics of this object",
	0, "*",
	PROP_FLOAT, PROP_DISTANCE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(ObjectActivityCulling, physicsRadius), 5, NULL},
	ObjectActivityCulling_physics_radius_get, ObjectActivityCulling_physics_radius_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_ObjectActivityCulling_logic_radius = {
	{(PropertyRNA *)&rna_ObjectActivityCulling_use_physics, (PropertyRNA *)&rna_ObjectActivityCulling_physics_radius,
	-1, "logic_radius", 1, 0, 4, 0, "Logic Radius",
	"Distance to begin suspend logic and animation of this object",
	0, "*",
	PROP_FLOAT, PROP_DISTANCE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(ObjectActivityCulling, logicRadius), 5, NULL},
	ObjectActivityCulling_logic_radius_get, ObjectActivityCulling_logic_radius_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

BoolPropertyRNA rna_ObjectActivityCulling_use_physics = {
	{(PropertyRNA *)&rna_ObjectActivityCulling_use_logic, (PropertyRNA *)&rna_ObjectActivityCulling_logic_radius,
	-1, "use_physics", 1, 0, 0, 0, "Cull Physics",
	"Suspend physics of this object by its distance to nearest camera",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	ObjectActivityCulling_use_physics_get, ObjectActivityCulling_use_physics_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_ObjectActivityCulling_use_logic = {
	{NULL, (PropertyRNA *)&rna_ObjectActivityCulling_use_physics,
	-1, "use_logic", 1, 0, 0, 0, "Cull Logic",
	"Suspend logic and animation of this object by its distance to nearest camera",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	ObjectActivityCulling_use_logic_get, ObjectActivityCulling_use_logic_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

StructRNA RNA_ObjectActivityCulling = {
	{(ContainerRNA *)&RNA_ObjectBase, (ContainerRNA *)&RNA_GameObjectSettings,
	NULL,
	{(PropertyRNA *)&rna_ObjectActivityCulling_rna_properties, (PropertyRNA *)&rna_ObjectActivityCulling_use_logic}},
	"ObjectActivityCulling", NULL, NULL, 516, NULL, "Object Activity Culling",
	"Object activity culling info",
	"*", 17,
	NULL, (PropertyRNA *)&rna_ObjectActivityCulling_rna_properties,
	NULL,
	&RNA_Object,
	NULL,
	NULL,
...
static bool rna_ObjectBase_layers_default[20] = {
	0,
	0,
	0,
	0,
...
static bool rna_ObjectBase_layers_local_view_default[8] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_ObjectBase_layers_local_view = {
	...
	-1, "layers_local_view", 0, 0, 0, 0, "Local View Layers",
...
StructRNA RNA_ObjectBase = {
	{(ContainerRNA *)&RNA_VertexGroup, (ContainerRNA *)&RNA_ObjectActivityCulling,
	NULL,
...
PointerPropertyRNA rna_MaterialSlot_material = {
	...
	-1, "material", 8388609, 0, 0, 0, "Material",
...
FloatPropertyRNA rna_DupliObject_matrix = {
	...
	-1, "matrix", 0, 0, 4, 0, "Object Duplicate Matrix",
	"Object duplicate transformation matrix",
	0, "*",
	PROP_FLOAT, PROP_MATRIX | PROP_UNIT_NONE, NULL, 2, {4, 4, 0}, 16,
	NULL, 0, NULL, NULL,
	offsetof(DupliObject, mat), 5, NULL},
...
static int rna_DupliObject_persistent_id_default[16] = {
	0,
	0,
	0,
	0,
...
IntPropertyRNA rna_DupliObject_persistent_id = {
	...
	-1, "persistent_id", 0, 0, 4, 0, "Persistent ID",
...
PointerPropertyRNA rna_DupliObject_particle_system = {
	...
	-1, "particle_system", 8388608, 0, 0, 0, "Particle System",
...
FloatPropertyRNA rna_DupliObject_orco = {
	...
	-1, "orco", 0, 0, 4, 0, "Generated Coordinates",
	"Generated coordinates in parent object space",
	0, "*",
	PROP_FLOAT, PROP_TRANSLATION | PROP_UNIT_LENGTH, NULL, 1, {3, 0, 0}, 3,
	NULL, 0, NULL, NULL,
	offsetof(DupliObject, orco), 5, NULL},
...
FloatPropertyRNA rna_DupliObject_uv = {
	...
	-1, "uv", 0, 0, 4, 0, "UV Coordinates",
	"UV coordinates in parent object space",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 1, {2, 0, 0}, 2,
	NULL, 0, NULL, NULL,
	offsetof(DupliObject, uv), 5, NULL},
...
static const EnumPropertyItem rna_DupliObject_type_items[6] = {
	{0, "NONE", 0, "None", ""},
	{8, "FRAMES", 0, "Frames", "Make copy of object for every frame"},
	{16, "VERTS", 0, "Verts", "Duplicate child objects on all vertices"},
	{512, "FACES", 0, "Faces", "Duplicate child objects on all faces"},
...
EnumPropertyRNA rna_DupliObject_type = {
	{(PropertyRNA *)&rna_DupliObject_random_id, (PropertyRNA *)&rna_DupliObject_uv,
	-1, "type", 0, 0, 0, 0, "Dupli Type",
...
IntPropertyRNA rna_DupliObject_random_id = {
	{NULL, (PropertyRNA *)&rna_DupliObject_type,
	-1, "random_id", 0, 0, 4, 0, "Dupli random id",
	"Random id for this dupli object",
	0, "*",
	PROP_INT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(DupliObject, random_id), 0, NULL},
	DupliObject_random_id_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	0, 10000, 0, INT_MAX, 1, 0, NULL
};
...
StructRNA RNA_DupliObject = {
	...
	NULL,
	{(PropertyRNA *)&rna_DupliObject_rna_properties, (PropertyRNA *)&rna_DupliObject_random_id}},
	"DupliObject", NULL, NULL, 516, NULL, "Object Duplicate",
	"An object duplicate",
	"*", 17,
...
IntPropertyRNA rna_LodLevel_object_hysteresis_percentage = {
	...
	-1, "object_hysteresis_percentage", 3, 0, 4, 0, "Hysteresis %",
...
BoolPropertyRNA rna_LodLevel_use_material = {
	...
	-1, "use_material", 3, 0, 0, 0, "Use Material",
...
BoolPropertyRNA rna_LodLevel_use_object_hysteresis = {
	...
	-1, "use_object_hysteresis", 3, 0, 0, 0, "Hysteresis Override",
...
StructRNA RNA_LodLevel = {
	...
	"LodLevel", NULL, NULL, 516, NULL, "LodLevel",
	"",
	"*", 17,
