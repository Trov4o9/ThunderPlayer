...
bool SpeedControlSequence_scale_to_length_get(PointerRNA *ptr)
{
	SpeedControlVars *data = (SpeedControlVars *)(((Sequence *)ptr->data)->effectdata);
	return (((data->flags) & 4) != 0);
}

void SpeedControlSequence_scale_to_length_set(PointerRNA *ptr, bool value)
{
	SpeedControlVars *data = (SpeedControlVars *)(((Sequence *)ptr->data)->effectdata);
...
BoolPropertyRNA rna_SequenceColorBalanceData_invert_gain = {
	...
	-1, "invert_gain", 3, 0, 0, 0, "Inverse Gain",
...
BoolPropertyRNA rna_SequenceColorBalanceData_invert_gamma = {
	...
	-1, "invert_gamma", 3, 0, 0, 0, "Inverse Gamma",
...
BoolPropertyRNA rna_SequenceColorBalanceData_invert_lift = {
	...
	-1, "invert_lift", 3, 0, 0, 0, "Inverse Lift",
...
StringPropertyRNA rna_SequenceElement_filename = {
	...
	-1, "filename", 262145, 0, 0, 0, "Filename",
...
IntPropertyRNA rna_SequenceElement_orig_width = {
	...
	-1, "orig_width", 2, 0, 4, 0, "Orig Width",
...
IntPropertyRNA rna_SequenceElement_orig_height = {
	...
	-1, "orig_height", 2, 0, 4, 0, "Orig Height",
...
BoolPropertyRNA rna_SequenceProxy_build_record_run = {
	...
	-1, "build_record_run", 3, 0, 0, 0, "Rec Run",
...
BoolPropertyRNA rna_SequenceProxy_build_free_run = {
	...
	-1, "build_free_run", 3, 0, 0, 0, "Free Run",
...
BoolPropertyRNA rna_SequenceProxy_build_free_run_rec_date = {
	...
	-1, "build_free_run_rec_date", 3, 0, 0, 0, "Free Run (Rec Date)",
...
BoolPropertyRNA rna_SequenceProxy_use_proxy_custom_directory = {
	...
	-1, "use_proxy_custom_directory", 3, 0, 0, 0, "Proxy Custom Directory",
...
BoolPropertyRNA rna_SequenceProxy_use_proxy_custom_file = {
	...
	-1, "use_proxy_custom_file", 3, 0, 0, 0, "Proxy Custom File",
...
BoolPropertyRNA rna_Sequence_select_left_handle = {
	...
	-1, "select_left_handle", 3, 0, 0, 0, "Left Handle Selected",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 67502086, NULL, NULL,
...
BoolPropertyRNA rna_Sequence_select_right_handle = {
	...
	-1, "select_right_handle", 3, 0, 0, 0, "Right Handle Selected",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 67502086, NULL, NULL,
...
IntPropertyRNA rna_Sequence_frame_final_duration = {
	...
	-1, "frame_final_duration", 1, 0, 0, 0, "Length",
...
IntPropertyRNA rna_Sequence_frame_duration = {
	...
	-1, "frame_duration", 0, 0, 4, 0, "Length",
...
IntPropertyRNA rna_Sequence_frame_final_start = {
	...
	-1, "frame_final_start", 1, 0, 0, 0, "Start Frame",
...
IntPropertyRNA rna_Sequence_frame_final_end = {
	...
	-1, "frame_final_end", 1, 0, 0, 0, "End Frame",
...
IntPropertyRNA rna_Sequence_frame_offset_start = {
	...
	-1, "frame_offset_start", 3, 0, 4, 0, "Start Offset",
	"",
	0, "*",
	PROP_INT, PROP_TIME | PROP_UNIT_TIME, NULL, 0, {0, 0, 0}, 0,
...
IntPropertyRNA rna_Sequence_frame_offset_end = {
	...
	-1, "frame_offset_end", 3, 0, 4, 0, "End Offset",
	"",
	0, "*",
	PROP_INT, PROP_TIME | PROP_UNIT_TIME, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_frame_change_update, 67502080, NULL, NULL,
...
IntPropertyRNA rna_Sequence_frame_still_start = {
	...
	-1, "frame_still_start", 3, 0, 4, 0, "Start Still",
	"",
	0, "*",
	PROP_INT, PROP_TIME | PROP_UNIT_TIME, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_frame_change_update, 67502080, NULL, NULL,
...
IntPropertyRNA rna_Sequence_frame_still_end = {
	...
	-1, "frame_still_end", 3, 0, 4, 0, "End Still",
	"",
	0, "*",
	PROP_INT, PROP_TIME | PROP_UNIT_TIME, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_frame_change_update, 67502080, NULL, NULL,
...
BoolPropertyRNA rna_Sequence_use_linear_modifiers = {
	...
	-1, "use_linear_modifiers", 3, 0, 0, 0, "Use Linear Modifiers",
...
static const EnumPropertyItem rna_Sequence_blend_type_items[28] = {
	{0, "REPLACE", 0, "Replace", ""},
	{8, "CROSS", 0, "Cross", ""},
	{9, "ADD", 0, "Add", ""},
	{10, "SUBTRACT", 0, "Subtract", ""},
...
EnumPropertyRNA rna_Sequence_blend_type = {
	...
	-1, "blend_type", 3, 0, 0, 0, "Blend Mode",
	"Method for controlling how the strip combines with other strips",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_update, 67502080, NULL, NULL,
	0, -1, NULL},
	Sequence_blend_type_get, Sequence_blend_type_set, NULL, NULL, NULL, NULL, rna_Sequence_blend_type_items, 27, 0
};

FloatPropertyRNA rna_Sequence_blend_alpha = {
	{(PropertyRNA *)&rna_Sequence_effect_fader, (PropertyRNA *)&rna_Sequence_blend_type,
	-1, "blend_alpha", 3, 0, 0, 0, "Blend Opacity",
...
FloatPropertyRNA rna_Sequence_effect_fader = {
	...
	-1, "effect_fader", 3, 0, 4, 0, "Effect fader position",
	"Custom fade value",
	0, "*",
...
BoolPropertyRNA rna_Sequence_use_default_fade = {
	...
	-1, "use_default_fade", 3, 0, 0, 0, "Use Default Fade",
...
FloatPropertyRNA rna_Sequence_speed_factor = {
	...
	-1, "speed_factor", 3, 0, 4, 0, "Speed factor",
...
CollectionPropertyRNA rna_SequenceEditor_sequences_all = {
	...
	-1, "sequences_all", 0, 0, 0, 0, "All Sequences",
...
CollectionPropertyRNA rna_SequenceEditor_meta_stack = {
	...
	-1, "meta_stack", 0, 0, 0, 0, "Meta Stack",
...
PointerPropertyRNA rna_SequenceEditor_active_strip = {
	...
	-1, "active_strip", 8388609, 0, 0, 0, "Active Strip",
...
BoolPropertyRNA rna_SequenceEditor_show_overlay = {
	...
	-1, "show_overlay", 3, 0, 0, 0, "Draw Axes",
...
BoolPropertyRNA rna_SequenceEditor_use_overlay_lock = {
	...
	-1, "use_overlay_lock", 3, 0, 0, 0, "Overlay Lock",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252706816, NULL, NULL,
...
IntPropertyRNA rna_SequenceEditor_overlay_frame = {
	...
	-1, "overlay_frame", 3, 0, 0, 0, "Overlay Offset",
	"",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252706816, NULL, NULL,
...
EnumPropertyRNA rna_SequenceEditor_proxy_storage = {
	...
	-1, "proxy_storage", 3, 0, 0, 0, "Proxy Storage",
...
StringPropertyRNA rna_SequenceEditor_proxy_dir = {
	...
	-1, "proxy_dir", 262145, 0, 0, 0, "Proxy Directory",
	"",
	0, "*",
...
BoolPropertyRNA rna_ImageSequence_use_multiview = {
	...
	-1, "use_multiview", 3, 0, 0, 0, "Use Multi-View",
...
EnumPropertyRNA rna_ImageSequence_views_format = {
	...
	-1, "views_format", 3, 0, 0, 0, "Views Format",
...
BoolPropertyRNA rna_ImageSequence_use_deinterlace = {
	...
	-1, "use_deinterlace", 3, 0, 0, 0, "Deinterlace",
...
BoolPropertyRNA rna_ImageSequence_use_float = {
	...
	-1, "use_float", 3, 0, 0, 0, "Convert Float",
...
BoolPropertyRNA rna_ImageSequence_use_reverse_frames = {
	...
	-1, "use_reverse_frames", 3, 0, 0, 0, "Flip Time",
	"Reverse frame order",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_update, 67502080, NULL, NULL,
...
FloatPropertyRNA rna_ImageSequence_color_multiply = {
	...
	-1, "color_multiply", 3, 0, 4, 0, "Multiply Colors",
	"",
	0, "*",
...
FloatPropertyRNA rna_ImageSequence_color_saturation = {
	...
	-1, "color_saturation", 3, 0, 4, 0, "Saturation",
...
BoolPropertyRNA rna_ImageSequence_use_translation = {
	...
	-1, "use_translation", 3, 0, 0, 0, "Use Translation",
...
PointerPropertyRNA rna_ImageSequence_transform = {
	...
	-1, "transform", 8388608, 0, 0, 0, "Transform",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_ImageSequence_use_proxy = {
	...
	-1, "use_proxy", 3, 0, 0, 0, "Use Proxy / Timecode",
...
IntPropertyRNA rna_ImageSequence_animation_offset_start = {
	...
	-1, "animation_offset_start", 1, 0, 0, 0, "Animation Start Offset",
...
IntPropertyRNA rna_ImageSequence_animation_offset_end = {
	...
	-1, "animation_offset_end", 1, 0, 0, 0, "Animation End Offset",
...
PointerPropertyRNA rna_ImageSequence_colorspace_settings = {
	...
	-1, "colorspace_settings", 8388608, 0, 0, 0, "Color Space Settings",
...
PointerPropertyRNA rna_SceneSequence_scene_camera = {
	...
	-1, "scene_camera", 8388609, 0, 0, 0, "Camera Override",
...
BoolPropertyRNA rna_SceneSequence_use_sequence = {
	...
	-1, "use_sequence", 3, 0, 0, 0, "Use Sequence",
...
BoolPropertyRNA rna_SceneSequence_use_grease_pencil = {
	...
	-1, "use_grease_pencil", 3, 0, 0, 0, "Use Grease Pencil",
...
IntPropertyRNA rna_MovieSequence_mpeg_preseek = {
	...
	-1, "mpeg_preseek", 3, 0, 4, 0, "MPEG Preseek",
...
IntPropertyRNA rna_MovieSequence_stream_index = {
	...
	-1, "stream_index", 3, 0, 4, 0, "Stream Index",
...
BoolPropertyRNA rna_MovieClipSequence_undistort = {
	...
	-1, "undistort", 3, 0, 0, 0, "Undistort Clip",
...
BoolPropertyRNA rna_MovieClipSequence_stabilize2d = {
	...
	-1, "stabilize2d", 3, 0, 0, 0, "Stabilize 2D Clip",
...
BoolPropertyRNA rna_SoundSequence_show_waveform = {
	...
	-1, "show_waveform", 3, 0, 0, 0, "Draw Waveform",
...
IntPropertyRNA rna_AddSequence_input_count = {
	...
	-1, "input_count", 2, 0, 0, 0, "input_count",
	"",
	0, "*",
	PROP_INT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_AddSequence_input_1 = {
	...
	-1, "input_1", 8650753, 0, 0, 0, "Input 1",
...
PointerPropertyRNA rna_AddSequence_input_2 = {
	...
	-1, "input_2", 8650753, 0, 0, 0, "Input 2",
...
FloatPropertyRNA rna_GlowSequence_boost_factor = {
	...
	-1, "boost_factor", 3, 0, 4, 0, "Boost Factor",
...
FloatPropertyRNA rna_GlowSequence_blur_radius = {
	...
	-1, "blur_radius", 3, 0, 4, 0, "Blur Distance",
...
BoolPropertyRNA rna_GlowSequence_use_only_boost = {
	...
	-1, "use_only_boost", 3, 0, 4, 0, "Only Boost",
...
IntPropertyRNA rna_MulticamSequence_multicam_source = {
	...
	-1, "multicam_source", 3, 0, 4, 0, "Multicam Source Channel",
	"",
	0, "*",
	PROP_INT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_update, 67502080, NULL, NULL,
...
FloatPropertyRNA rna_SpeedControlSequence_multiply_speed = {
	...
	-1, "multiply_speed", 1, 0, 4, 0, "Multiply Speed",
...
BoolPropertyRNA rna_SpeedControlSequence_use_as_speed = {
	...
	-1, "use_as_speed", 3, 0, 0, 0, "Use as speed",
...
BoolPropertyRNA rna_SpeedControlSequence_scale_to_length = {
	...
	-1, "scale_to_length", 3, 0, 0, 0, "Scale to length",
...
FloatPropertyRNA rna_TransformSequence_scale_start_x = {
	...
	-1, "scale_start_x", 3, 0, 4, 0, "Scale X",
...
FloatPropertyRNA rna_TransformSequence_scale_start_y = {
	...
	-1, "scale_start_y", 3, 0, 4, 0, "Scale Y",
...
BoolPropertyRNA rna_TransformSequence_use_uniform_scale = {
	...
	-1, "use_uniform_scale", 3, 0, 4, 0, "Uniform Scale",
...
FloatPropertyRNA rna_TransformSequence_translate_start_x = {
	...
	-1, "translate_start_x", 3, 0, 4, 0, "Translate X",
...
FloatPropertyRNA rna_TransformSequence_translate_start_y = {
	...
	-1, "translate_start_y", 3, 0, 4, 0, "Translate Y",
...
FloatPropertyRNA rna_TransformSequence_rotation_start = {
	...
	-1, "rotation_start", 3, 0, 4, 0, "Rotation",
...
EnumPropertyRNA rna_TransformSequence_translation_unit = {
	...
	-1, "translation_unit", 1, 0, 0, 0, "Translation Unit",
...
EnumPropertyRNA rna_TransformSequence_interpolation = {
	...
	-1, "interpolation", 1, 0, 0, 0, "Interpolation",
...
FloatPropertyRNA rna_WipeSequence_blur_width = {
	...
	-1, "blur_width", 3, 0, 4, 0, "Blur Width",
...
EnumPropertyRNA rna_WipeSequence_transition_type = {
	...
	-1, "transition_type", 3, 0, 0, 0, "Transition Type",
	"",
	0, "Sequence",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_update, 67502080, NULL, NULL,
...
FloatPropertyRNA rna_TextSequence_wrap_width = {
	...
	-1, "wrap_width", 3, 0, 4, 0, "Wrap Width",
...
EnumPropertyRNA rna_ColorMixSequence_blend_effect = {
	...
	-1, "blend_effect", 3, 0, 0, 0, "Blend Effect",
	"Method for controlling how the strip combines with other strips",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_update, 67502080, NULL, NULL,
...
EnumPropertyRNA rna_SequenceModifier_input_mask_type = {
	...
	-1, "input_mask_type", 3, 0, 0, 0, "Mask Input Type",
...
PointerPropertyRNA rna_SequenceModifier_input_mask_strip = {
	...
	-1, "input_mask_strip", 8388609, 0, 0, 0, "Mask Strip",
...
PointerPropertyRNA rna_SequenceModifier_input_mask_id = {
	...
	-1, "input_mask_id", 8388673, 0, 0, 0, "Mask",
...
PointerPropertyRNA rna_ColorBalanceModifier_color_balance = {
	...
	-1, "color_balance", 8388608, 0, 0, 0, "color_balance",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_CurvesModifier_curve_mapping = {
	{NULL, NULL,
	-1, "curve_mapping", 8388608, 0, 0, 0, "Curve Mapping",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_SequenceModifier_update, 67502080, NULL, NULL,
...
FloatPropertyRNA rna_WhiteBalanceModifier_white_value = {
	{NULL, NULL,
	-1, "white_value", 3, 0, 4, 0, "White value",
...
EnumPropertyRNA rna_SequencerTonemapModifierData_tonemap_type = {
	...
	-1, "tonemap_type", 3, 0, 0, 0, "Tonemap Type",
...
FloatPropertyRNA rna_SequencerTonemapModifierData_adaptation = {
	...
	-1, "adaptation", 3, 0, 4, 0, "Adaptation",
...
FloatPropertyRNA rna_SequencerTonemapModifierData_correction = {
	...
	-1, "correction", 3, 0, 4, 0, "Color Correction",
