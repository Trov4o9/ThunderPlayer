...
bool ID_is_updated_get(PointerRNA *ptr)
{
	ID *data = (ID *)(ptr->data);
	return (((data->recalc) & 1) != 0);
}

bool ID_is_updated_data_get(PointerRNA *ptr)
{
	ID *data = (ID *)(ptr->data);
	return (((data->recalc) & 2) != 0);
}
...
BoolPropertyRNA rna_ID_use_fake_user = {
	...
	-1, "use_fake_user", 3, 0, 0, 0, "Fake User",
...
BoolPropertyRNA rna_ID_is_updated = {
	...
	-1, "is_updated", 2, 0, 0, 0, "Is Updated",
...
BoolPropertyRNA rna_ID_is_updated_data = {
	...
	-1, "is_updated_data", 2, 0, 0, 0, "Is Updated Data",
...
BoolPropertyRNA rna_ID_is_library_indirect = {
	...
	-1, "is_library_indirect", 2, 0, 0, 0, "Is Indirect",
...
PointerPropertyRNA rna_ID_library = {
	...
	-1, "library", 8388672, 0, 0, 0, "Library",
...
PointerPropertyRNA rna_ID_preview = {
	...
	-1, "preview", 8388608, 0, 0, 0, "Preview",
...
FunctionRNA rna_ID_user_clear_func = {
	{(FunctionRNA *)&rna_ID_user_remap_func, (FunctionRNA *)&rna_ID_copy_func,
	NULL,
	{NULL, NULL}},
...
BoolPropertyRNA rna_ImagePreview_is_image_custom = {
	...
	-1, "is_image_custom", 3, 0, 0, 0, "Custom Image",
...
IntPropertyRNA rna_ImagePreview_image_size = {
	...
	-1, "image_size", 3, 0, 0, 0, "Image Size",
...
IntPropertyRNA rna_ImagePreview_image_pixels = {
	...
	-1, "image_pixels", 131075, 0, 0, 0, "Image Pixels",
...
FloatPropertyRNA rna_ImagePreview_image_pixels_float = {
	...
	-1, "image_pixels_float", 131075, 0, 0, 0, "Float Image Pixels",
...
BoolPropertyRNA rna_ImagePreview_is_icon_custom = {
	...
	-1, "is_icon_custom", 3, 0, 0, 0, "Custom Icon",
...
IntPropertyRNA rna_ImagePreview_icon_pixels = {
	...
	-1, "icon_pixels", 131075, 0, 0, 0, "Icon Pixels",
...
FloatPropertyRNA rna_ImagePreview_icon_pixels_float = {
	...
	-1, "icon_pixels_float", 131075, 0, 0, 0, "Float Icon Pixels",
...
IntPropertyRNA rna_PropertyGroupItem_int_array = {
	...
	-1, "int_array", 1283, 0, 0, 0, "int_array",
	"",
	0, "*",
...
FloatPropertyRNA rna_PropertyGroupItem_float_array = {
	...
	-1, "float_array", 1283, 0, 0, 0, "float_array",
	"",
	0, "*",
...
FloatPropertyRNA rna_PropertyGroupItem_double_array = {
	...
	-1, "double_array", 1283, 0, 0, 0, "double_array",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 1, {1, 0, 0}, 1,
	NULL, 0, NULL, NULL,
...
CollectionPropertyRNA rna_PropertyGroupItem_collection = {
	...
	-1, "collection", 1280, 0, 0, 0, "collection",
	"",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
CollectionPropertyRNA rna_PropertyGroupItem_idp_array = {
	...
	-1, "idp_array", 1280, 0, 8, 0, "idp_array",
	"",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
