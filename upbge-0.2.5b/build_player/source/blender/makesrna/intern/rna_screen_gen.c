...
BoolPropertyRNA rna_Screen_is_animation_playing = {
	...
	-1, "is_animation_playing", 2, 0, 0, 0, "Animation Playing",
...
BoolPropertyRNA rna_Screen_show_fullscreen = {
	...
	-1, "show_fullscreen", 2, 0, 0, 0, "Maximize",
...
BoolPropertyRNA rna_Screen_use_play_top_left_3d_editor = {
	...
	-1, "use_play_top_left_3d_editor", 3, 0, 0, 0, "Top-Left 3D Editor",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
BoolPropertyRNA rna_Screen_use_play_3d_editors = {
	...
	-1, "use_play_3d_editors", 3, 0, 0, 0, "All 3D View Editors",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Screen_redraw_update, 252444672, NULL, NULL,
...
BoolPropertyRNA rna_Screen_use_play_animation_editors = {
	...
	-1, "use_play_animation_editors", 3, 0, 0, 0, "Animation Editors",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Screen_redraw_update, 252444672, NULL, NULL,
...
BoolPropertyRNA rna_Screen_use_play_properties_editors = {
	...
	-1, "use_play_properties_editors", 3, 0, 0, 0, "Property Editors",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Screen_redraw_update, 252444672, NULL, NULL,
...
BoolPropertyRNA rna_Screen_use_play_image_editors = {
	...
	-1, "use_play_image_editors", 3, 0, 0, 0, "Image Editors",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Screen_redraw_update, 252444672, NULL, NULL,
...
BoolPropertyRNA rna_Screen_use_play_sequence_editors = {
	...
	-1, "use_play_sequence_editors", 3, 0, 0, 0, "Sequencer Editors",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Screen_redraw_update, 252444672, NULL, NULL,
...
BoolPropertyRNA rna_Screen_use_play_node_editors = {
	...
	-1, "use_play_node_editors", 3, 0, 0, 0, "Node Editors",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Screen_redraw_update, 252444672, NULL, NULL,
...
BoolPropertyRNA rna_Screen_use_play_clip_editors = {
	...
	-1, "use_play_clip_editors", 3, 0, 0, 0, "Clip Editors",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Screen_redraw_update, 252444672, NULL, NULL,
...
BoolPropertyRNA rna_Area_show_menus = {
	...
	-1, "show_menus", 3, 0, 0, 0, "Show Menus",
...
EnumPropertyRNA rna_Area_type = {
	...
	-1, "type", 4194305, 0, 0, 0, "Editor Type",
...
PointerPropertyRNA rna_AreaSpaces_active = {
	...
	-1, "active", 8388608, 0, 0, 0, "Active Space",
...
static const EnumPropertyItem rna_Region_type_items[9] = {
	{0, "WINDOW", 0, "Window", ""},
	{1, "HEADER", 0, "Header", ""},
