...
bool Image_use_fields_get(PointerRNA *ptr)
{
	Image *data = (Image *)(ptr->data);
	return (((data->flag) & 1) != 0);
}

void Image_use_fields_set(PointerRNA *ptr, bool value)
{
	Image *data = (Image *)(ptr->data);
...
bool Image_use_animation_get(PointerRNA *ptr)
{
	Image *data = (Image *)(ptr->data);
	return (((data->tpageflag) & 2) != 0);
}

void Image_use_animation_set(PointerRNA *ptr, bool value)
{
	Image *data = (Image *)(ptr->data);
...
bool Image_use_tiles_get(PointerRNA *ptr)
{
	Image *data = (Image *)(ptr->data);
	return (((data->tpageflag) & 1) != 0);
}

void Image_use_tiles_set(PointerRNA *ptr, bool value)
{
	Image *data = (Image *)(ptr->data);
...
bool Image_use_clamp_x_get(PointerRNA *ptr)
{
	Image *data = (Image *)(ptr->data);
	return (((data->tpageflag) & 16) != 0);
}

void Image_use_clamp_x_set(PointerRNA *ptr, bool value)
{
	Image *data = (Image *)(ptr->data);
...
bool Image_use_clamp_y_get(PointerRNA *ptr)
{
	Image *data = (Image *)(ptr->data);
	return (((data->tpageflag) & 32) != 0);
}

void Image_use_clamp_y_set(PointerRNA *ptr, bool value)
{
	Image *data = (Image *)(ptr->data);
...
PointerPropertyRNA rna_RenderSlots_active = {
	...
	-1, "active", 41943041, 0, 0, 0, "Active",
...
IntPropertyRNA rna_RenderSlots_active_index = {
	...
	-1, "active_index", 1, 0, 0, 0, "Active Index",
...
StructRNA RNA_RenderSlots = {
	...
	"RenderSlots", NULL, NULL, 516, NULL, "Render Slots",
...
StringPropertyRNA rna_Image_filepath = {
	...
	-1, "filepath", 262145, 0, 0, 0, "File Name",
...
StringPropertyRNA rna_Image_filepath_raw = {
	...
	-1, "filepath_raw", 262145, 0, 0, 0, "File Name",
...
static const EnumPropertyItem rna_Image_file_format_items[21] = {
	{0, "", 0, "Image", NULL},
...
EnumPropertyRNA rna_Image_file_format = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Image_file_format_get, Image_file_format_set, NULL, NULL, NULL, NULL, rna_Image_file_format_items, 20, 0
};
...
PointerPropertyRNA rna_Image_packed_file = {
	...
	-1, "packed_file", 8388608, 0, 0, 0, "Packed File",
...
CollectionPropertyRNA rna_Image_packed_files = {
	...
	-1, "packed_files", 0, 0, 0, 0, "Packed Files",
...
static const EnumPropertyItem rna_Image_field_order_items[3] = {
...
BoolPropertyRNA rna_Image_use_view_as_render = {
	...
	-1, "use_view_as_render", 3, 0, 0, 0, "View as Render",
...
BoolPropertyRNA rna_Image_is_stereo_3d = {
	...
	-1, "is_stereo_3d", 2, 0, 0, 0, "Stereo 3D",
...
BoolPropertyRNA rna_Image_is_multiview = {
	...
	-1, "is_multiview", 2, 0, 0, 0, "Multiple Views",
...
EnumPropertyRNA rna_Image_generated_type = {
	...
	-1, "generated_type", 1, 0, 0, 0, "Generated Type",
...
IntPropertyRNA rna_Image_generated_width = {
	...
	-1, "generated_width", 67108865, 0, 4, 0, "Generated Width",
...
IntPropertyRNA rna_Image_generated_height = {
	...
	-1, "generated_height", 67108865, 0, 4, 0, "Generated Height",
...
BoolPropertyRNA rna_Image_use_generated_float = {
	...
	-1, "use_generated_float", 1, 0, 0, 0, "Float Buffer",
...
FloatPropertyRNA rna_Image_generated_color = {
	...
	-1, "generated_color", 1, 0, 4, 0, "Color",
...
static const EnumPropertyItem rna_Image_mapping_items[3] = {
...
FloatPropertyRNA rna_Image_display_aspect = {
	...
	-1, "display_aspect", 3, 0, 4, 0, "Display Aspect",
...
BoolPropertyRNA rna_Image_use_animation = {
	...
	-1, "use_animation", 3, 0, 0, 0, "Animated",
...
IntPropertyRNA rna_Image_frame_start = {
	...
	-1, "frame_start", 3, 0, 4, 0, "Animation Start",
...
IntPropertyRNA rna_Image_frame_end = {
	...
	-1, "frame_end", 3, 0, 4, 0, "Animation End",
...
CollectionPropertyRNA rna_Image_render_slots = {
	...
	-1, "render_slots", 0, 0, 8, 0, "Render Slots",
...
IntPropertyRNA rna_Image_frame_duration = {
	...
	-1, "frame_duration", 2, 0, 0, 0, "Duration",
...
BoolPropertyRNA rna_ImageUser_use_auto_refresh = {
	...
	-1, "use_auto_refresh", 1, 0, 0, 0, "Auto Refresh",
...
IntPropertyRNA rna_ImageUser_frame_duration = {
	...
	-1, "frame_duration", 1, 0, 4, 0, "Frames",
...
IntPropertyRNA rna_ImageUser_fields_per_frame = {
	...
	-1, "fields_per_frame", 1, 0, 4, 0, "Fields per Frame",
...
IntPropertyRNA rna_ImageUser_multilayer_layer = {
	...
	-1, "multilayer_layer", 2, 0, 4, 0, "Layer",
...
IntPropertyRNA rna_ImageUser_multilayer_pass = {
	...
	-1, "multilayer_pass", 2, 0, 4, 0, "Pass",
...
IntPropertyRNA rna_ImageUser_multilayer_view = {
	...
	-1, "multilayer_view", 2, 0, 4, 0, "View",
...
StringPropertyRNA rna_ImagePackedFile_filepath = {
	...
	-1, "filepath", 262145, 0, 0, 0, "filepath",
	"",
	0, "*",
	PROP_STRING, PROP_FILEPATH | PROP_UNIT_NONE, NULL, 0, {1024, 0, 0}, 0,
	NULL, 0, NULL, NULL,
