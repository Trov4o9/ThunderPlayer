...
PointerPropertyRNA rna_Context_window_manager = {
	...
	-1, "window_manager", 8388608, 0, 0, 0, "window_manager",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Context_space_data = {
	...
	-1, "space_data", 8388608, 0, 0, 0, "space_data",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Context_region_data = {
	...
	-1, "region_data", 8388608, 0, 0, 0, "region_data",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Context_blend_data = {
	...
	-1, "blend_data", 8388608, 0, 0, 0, "blend_data",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Context_tool_settings = {
	...
	-1, "tool_settings", 8388608, 0, 0, 0, "tool_settings",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Context_user_preferences = {
	...
	-1, "user_preferences", 8388608, 0, 0, 0, "user_preferences",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
static const EnumPropertyItem rna_Context_mode_items[15] = {
...
StructRNA RNA_Context = {
	{(ContainerRNA *)&RNA_Controller, (ContainerRNA *)&RNA_TransformCacheConstraint,
	NULL,
