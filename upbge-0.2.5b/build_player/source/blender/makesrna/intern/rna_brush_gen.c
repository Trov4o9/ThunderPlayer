...
bool Brush_use_locked_size_get(PointerRNA *ptr)
{
	Brush *data = (Brush *)(ptr->data);
	return (((data->flag) & 1048576) != 0);
}

void Brush_use_locked_size_set(PointerRNA *ptr, bool value)
{
	Brush *data = (Brush *)(ptr->data);
...
bool SculptToolCapabilities_has_accumulate_get(PointerRNA *ptr)
{
	return rna_SculptToolCapabilities_has_accumulate_get(ptr);
}

bool SculptToolCapabilities_has_auto_smooth_get(PointerRNA *ptr)
{
	return rna_SculptToolCapabilities_has_auto_smooth_get(ptr);
}

bool SculptToolCapabilities_has_height_get(PointerRNA *ptr)
{
	return rna_SculptToolCapabilities_has_height_get(ptr);
}

bool SculptToolCapabilities_has_jitter_get(PointerRNA *ptr)
{
	return rna_SculptToolCapabilities_has_jitter_get(ptr);
}

bool SculptToolCapabilities_has_normal_weight_get(PointerRNA *ptr)
{
	return rna_SculptToolCapabilities_has_normal_weight_get(ptr);
}

bool SculptToolCapabilities_has_rake_factor_get(PointerRNA *ptr)
{
	return rna_SculptToolCapabilities_has_rake_factor_get(ptr);
}

bool SculptToolCapabilities_has_persistence_get(PointerRNA *ptr)
{
	return rna_SculptToolCapabilities_has_persistence_get(ptr);
}

bool SculptToolCapabilities_has_pinch_factor_get(PointerRNA *ptr)
{
	return rna_SculptToolCapabilities_has_pinch_factor_get(ptr);
}

bool SculptToolCapabilities_has_plane_offset_get(PointerRNA *ptr)
{
	return rna_SculptToolCapabilities_has_plane_offset_get(ptr);
}

bool SculptToolCapabilities_has_random_texture_angle_get(PointerRNA *ptr)
{
	return rna_SculptToolCapabilities_has_random_texture_angle_get(ptr);
}

bool SculptToolCapabilities_has_sculpt_plane_get(PointerRNA *ptr)
{
	return rna_SculptToolCapabilities_has_sculpt_plane_get(ptr);
}

bool SculptToolCapabilities_has_secondary_color_get(PointerRNA *ptr)
{
	return rna_SculptToolCapabilities_has_secondary_color_get(ptr);
}

bool SculptToolCapabilities_has_smooth_stroke_get(PointerRNA *ptr)
{
	return rna_SculptToolCapabilities_has_smooth_stroke_get(ptr);
}

bool SculptToolCapabilities_has_space_attenuation_get(PointerRNA *ptr)
{
	return rna_SculptToolCapabilities_has_space_attenuation_get(ptr);
}

bool SculptToolCapabilities_has_strength_pressure_get(PointerRNA *ptr)
{
	return rna_SculptToolCapabilities_has_strength_pressure_get(ptr);
}

bool SculptToolCapabilities_has_gravity_get(PointerRNA *ptr)
{
...
bool ImapaintToolCapabilities_has_accumulate_get(PointerRNA *ptr)
{
	return rna_ImapaintToolCapabilities_has_accumulate_get(ptr);
}

bool ImapaintToolCapabilities_has_space_attenuation_get(PointerRNA *ptr)
{
	return rna_ImapaintToolCapabilities_has_space_attenuation_get(ptr);
}

bool ImapaintToolCapabilities_has_radius_get(PointerRNA *ptr)
{
...
/* Brush */
static const EnumPropertyItem rna_Brush_blend_items[25] = {
...
static const EnumPropertyItem rna_Brush_sculpt_tool_items[20] = {
	{17, "BLOB", 781, "Blob", ""},
	{8, "CLAY", 783, "Clay", ""},
...
EnumPropertyRNA rna_Brush_sculpt_tool = {
	...
	-1, "sculpt_tool", 3, 0, 0, 0, "Sculpt Tool",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static const EnumPropertyItem rna_Brush_vertex_tool_items[22] = {
	...
	{7, "AVERAGE", 782, "Average", "Use average blending mode while painting"},
	{8, "SMEAR", 782, "Smear", "Use smear blending mode while painting"},
	{9, "COLORDODGE", 782, "Color Dodge", "Use color dodge blending mode while painting"},
	{10, "DIFFERENCE", 782, "Difference", "Use difference blending mode while painting"},
	{11, "SCREEN", 782, "Screen", "Use screen blending mode while painting"},
	{12, "HARDLIGHT", 782, "Hardlight", "Use hardlight blending mode while painting"},
	{13, "OVERLAY", 782, "Overlay", "Use overlay blending mode while painting"},
	{14, "SOFTLIGHT", 782, "Softlight", "Use softlight blending mode while painting"},
	{15, "EXCLUSION", 782, "Exclusion", "Use exclusion blending mode while painting"},
	{16, "LUMINOCITY", 782, "Luminocity", "Use luminocity blending mode while painting"},
	{17, "SATURATION", 782, "Saturation", "Use saturation blending mode while painting"},
	{18, "HUE", 782, "Hue", "Use hue blending mode while painting"},
	{19, "ERASE_ALPHA", 0, "Erase Alpha", "Erase alpha while painting"},
	{20, "ADD_ALPHA", 0, "Add Alpha", "Add alpha while painting"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_Brush_vertex_tool = {
	{(PropertyRNA *)&rna_Brush_image_tool, (PropertyRNA *)&rna_Brush_sculpt_tool,
	-1, "vertex_tool", 3, 0, 0, 0, "Blending mode",
	"Brush blending mode",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Brush_vertex_tool_update, 0, NULL, NULL,
	0, -1, NULL},
	Brush_vertex_tool_get, Brush_vertex_tool_set, NULL, NULL, NULL, NULL, rna_Brush_vertex_tool_items, 21, 0
};
...
EnumPropertyRNA rna_Brush_image_tool = {
	...
	-1, "image_tool", 3, 0, 0, 0, "Image Paint Tool",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
EnumPropertyRNA rna_Brush_stroke_method = {
	...
	-1, "stroke_method", 3, 0, 0, 0, "Stroke Method",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
EnumPropertyRNA rna_Brush_sculpt_plane = {
	...
	-1, "sculpt_plane", 3, 0, 0, 0, "Sculpt Plane",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Brush_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_Brush_unprojected_radius = {
	...
	-1, "unprojected_radius", 3, 0, 0, 0, "Unprojected Radius",
...
IntPropertyRNA rna_Brush_jitter_absolute = {
	...
	-1, "jitter_absolute", 3, 0, 4, 0, "Jitter",
...
IntPropertyRNA rna_Brush_grad_spacing = {
	...
	-1, "grad_spacing", 3, 0, 4, 0, "Gradient Spacing",
...
IntPropertyRNA rna_Brush_smooth_stroke_radius = {
	...
	-1, "smooth_stroke_radius", 3, 0, 4, 0, "Smooth Stroke Radius",
...
FloatPropertyRNA rna_Brush_smooth_stroke_factor = {
	...
	-1, "smooth_stroke_factor", 3, 0, 4, 0, "Smooth Stroke Factor",
...
FloatPropertyRNA rna_Brush_secondary_color = {
	...
	-1, "secondary_color", 3, 0, 4, 0, "Secondary Color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_Brush_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_Brush_plane_offset = {
	...
	-1, "plane_offset", 3, 0, 4, 0, "Plane Offset",
...
FloatPropertyRNA rna_Brush_plane_trim = {
	...
	-1, "plane_trim", 3, 0, 4, 0, "Plane Trim",
...
FloatPropertyRNA rna_Brush_texture_sample_bias = {
	...
	-1, "texture_sample_bias", 3, 0, 4, 0, "Texture Sample Bias",
...
FloatPropertyRNA rna_Brush_normal_weight = {
	...
	-1, "normal_weight", 3, 0, 4, 0, "Normal Weight",
...
FloatPropertyRNA rna_Brush_crease_pinch_factor = {
	...
	-1, "crease_pinch_factor", 3, 0, 4, 0, "Crease Brush Pinch Factor",
...
FloatPropertyRNA rna_Brush_auto_smooth_factor = {
	...
	-1, "auto_smooth_factor", 3, 0, 4, 0, "Autosmooth",
...
FloatPropertyRNA rna_Brush_stencil_pos = {
	...
	-1, "stencil_pos", 3, 0, 4, 0, "Stencil Position",
...
FloatPropertyRNA rna_Brush_stencil_dimension = {
	...
	-1, "stencil_dimension", 3, 0, 4, 0, "Stencil Dimensions",
...
FloatPropertyRNA rna_Brush_mask_stencil_pos = {
	...
	-1, "mask_stencil_pos", 3, 0, 4, 0, "Mask Stencil Position",
...
FloatPropertyRNA rna_Brush_mask_stencil_dimension = {
	...
	-1, "mask_stencil_dimension", 3, 0, 4, 0, "Mask Stencil Dimensions",
...
FloatPropertyRNA rna_Brush_sharp_threshold = {
	...
	-1, "sharp_threshold", 3, 0, 4, 0, "Sharp Threshold",
...
FloatPropertyRNA rna_Brush_fill_threshold = {
	...
	-1, "fill_threshold", 3, 0, 4, 0, "Fill Threshold",
...
IntPropertyRNA rna_Brush_blur_kernel_radius = {
	...
	-1, "blur_kernel_radius", 3, 0, 4, 0, "Kernel Radius",
...
FloatPropertyRNA rna_Brush_falloff_angle = {
	...
	-1, "falloff_angle", 3, 0, 4, 0, "Falloff Angle",
...
BoolPropertyRNA rna_Brush_use_projected = {
	...
	-1, "use_projected", 3, 0, 0, 0, "2D Falloff",
...
BoolPropertyRNA rna_Brush_use_airbrush = {
	...
	-1, "use_airbrush", 3, 0, 0, 0, "Airbrush",
...
BoolPropertyRNA rna_Brush_use_original_normal = {
	...
	-1, "use_original_normal", 4099, 0, 0, 0, "Original Normal",
...
BoolPropertyRNA rna_Brush_use_pressure_strength = {
	...
	-1, "use_pressure_strength", 3, 0, 0, 0, "Strength Pressure",
...
BoolPropertyRNA rna_Brush_use_offset_pressure = {
	...
	-1, "use_offset_pressure", 3, 0, 0, 0, "Plane Offset Pressure",
...
BoolPropertyRNA rna_Brush_use_pressure_size = {
	...
	-1, "use_pressure_size", 3, 0, 0, 0, "Size Pressure",
...
BoolPropertyRNA rna_Brush_use_gradient = {
	...
	-1, "use_gradient", 3, 0, 0, 0, "Use Gradient",
...
BoolPropertyRNA rna_Brush_use_pressure_jitter = {
	...
	-1, "use_pressure_jitter", 3, 0, 0, 0, "Jitter Pressure",
...
BoolPropertyRNA rna_Brush_use_pressure_spacing = {
	...
	-1, "use_pressure_spacing", 3, 0, 0, 0, "Spacing Pressure",
...
EnumPropertyRNA rna_Brush_use_pressure_masking = {
	...
	-1, "use_pressure_masking", 3, 0, 0, 0, "Mask Pressure Mode",
...
BoolPropertyRNA rna_Brush_use_inverse_smooth_pressure = {
	...
	-1, "use_inverse_smooth_pressure", 3, 0, 0, 0, "Inverse Smooth Pressure",
...
BoolPropertyRNA rna_Brush_use_relative_jitter = {
	...
	-1, "use_relative_jitter", 4099, 0, 0, 0, "Absolute Jitter",
...
BoolPropertyRNA rna_Brush_use_plane_trim = {
	...
	-1, "use_plane_trim", 3, 0, 0, 0, "Use Plane Trim",
	"Enable Plane Trim",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Brush_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_Brush_use_frontface = {
	...
	-1, "use_frontface", 3, 0, 0, 0, "Use Front-Face",
...
BoolPropertyRNA rna_Brush_use_frontface_falloff = {
	...
	-1, "use_frontface_falloff", 3, 0, 0, 0, "Use Front-Face Falloff",
...
BoolPropertyRNA rna_Brush_use_smooth_stroke = {
	...
	-1, "use_smooth_stroke", 3, 0, 0, 0, "Smooth Stroke",
...
BoolPropertyRNA rna_Brush_use_persistent = {
	...
	-1, "use_persistent", 3, 0, 0, 0, "Persistent",
...
BoolPropertyRNA rna_Brush_use_accumulate = {
	...
	-1, "use_accumulate", 3, 0, 0, 0, "Accumulate",
...
BoolPropertyRNA rna_Brush_use_space_attenuation = {
	...
	-1, "use_space_attenuation", 4099, 0, 0, 0, "Use Automatic Strength Adjustment",
...
BoolPropertyRNA rna_Brush_use_adaptive_space = {
	...
	-1, "use_adaptive_space", 3, 0, 0, 0, "Adaptive Spacing",
...
BoolPropertyRNA rna_Brush_use_locked_size = {
	...
	-1, "use_locked_size", 3, 0, 0, 0, "Use Blender Units",
...
BoolPropertyRNA rna_Brush_use_edge_to_edge = {
	...
	-1, "use_edge_to_edge", 3, 0, 0, 0, "Edge-to-edge",
...
BoolPropertyRNA rna_Brush_use_restore_mesh = {
	...
	-1, "use_restore_mesh", 3, 0, 0, 0, "Restore Mesh",
...
PointerPropertyRNA rna_Brush_paint_curve = {
	...
	-1, "paint_curve", 8388673, 0, 0, 0, "Paint Curve",
	"Active Paint Curve",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Brush_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_Brush_gradient = {
	...
	-1, "gradient", 8388608, 0, 0, 0, "Gradient",
	"",
	0, "*",
...
EnumPropertyRNA rna_Brush_gradient_stroke_mode = {
	...
	-1, "gradient_stroke_mode", 3, 0, 0, 0, "Gradient Stroke Mode",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Brush_update, 0, NULL, NULL,
...
EnumPropertyRNA rna_Brush_gradient_fill_mode = {
	...
	-1, "gradient_fill_mode", 3, 0, 0, 0, "Gradient Fill Mode",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Brush_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_Brush_use_primary_overlay = {
	...
	-1, "use_primary_overlay", 3, 0, 0, 0, "Use Texture Overlay",
...
BoolPropertyRNA rna_Brush_use_secondary_overlay = {
	...
	-1, "use_secondary_overlay", 3, 0, 0, 0, "Use Texture Overlay",
	"Show texture in viewport",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Brush_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_Brush_use_cursor_overlay = {
	...
	-1, "use_cursor_overlay", 3, 0, 0, 0, "Use Cursor Overlay",
...
BoolPropertyRNA rna_Brush_use_cursor_overlay_override = {
	...
	-1, "use_cursor_overlay_override", 3, 0, 0, 0, "Override Overlay",
...
BoolPropertyRNA rna_Brush_use_primary_overlay_override = {
	...
	-1, "use_primary_overlay_override", 3, 0, 0, 0, "Override Overlay",
	"Don\'t show overlay during a stroke",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Brush_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_Brush_use_secondary_overlay_override = {
	...
	-1, "use_secondary_overlay_override", 3, 0, 0, 0, "Override Overlay",
	"Don\'t show overlay during a stroke",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Brush_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_Brush_use_paint_sculpt = {
	...
	-1, "use_paint_sculpt", 3, 0, 0, 0, "Use Sculpt",
...
BoolPropertyRNA rna_Brush_use_paint_vertex = {
	...
	-1, "use_paint_vertex", 3, 0, 0, 0, "Use Vertex",
...
BoolPropertyRNA rna_Brush_use_paint_weight = {
	...
	-1, "use_paint_weight", 3, 0, 0, 0, "Use Weight",
...
BoolPropertyRNA rna_Brush_use_paint_image = {
	...
	-1, "use_paint_image", 3, 0, 0, 0, "Use Texture",
...
PointerPropertyRNA rna_Brush_texture_slot = {
	...
	-1, "texture_slot", 8388608, 0, 0, 0, "Texture Slot",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Brush_mask_texture_slot = {
	...
	-1, "mask_texture_slot", 8388608, 0, 0, 0, "Mask Texture Slot",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Brush_mask_texture = {
	...
	-1, "mask_texture", 8388673, 0, 0, 0, "Mask Texture",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
IntPropertyRNA rna_Brush_texture_overlay_alpha = {
	...
	-1, "texture_overlay_alpha", 3, 0, 4, 0, "Texture Overlay Alpha",
	"",
	0, "*",
	PROP_INT, PROP_PERCENTAGE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Brush_update, 0, NULL, NULL,
...
IntPropertyRNA rna_Brush_mask_overlay_alpha = {
	...
	-1, "mask_overlay_alpha", 3, 0, 4, 0, "Mask Texture Overlay Alpha",
	"",
	0, "*",
	PROP_INT, PROP_PERCENTAGE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Brush_update, 0, NULL, NULL,
...
IntPropertyRNA rna_Brush_cursor_overlay_alpha = {
	...
	-1, "cursor_overlay_alpha", 3, 0, 4, 0, "Mask Texture Overlay Alpha",
	"",
	0, "*",
	PROP_INT, PROP_PERCENTAGE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Brush_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_Brush_cursor_color_add = {
	...
	-1, "cursor_color_add", 3, 0, 4, 0, "Add Color",
...
FloatPropertyRNA rna_Brush_cursor_color_subtract = {
	...
	-1, "cursor_color_subtract", 3, 0, 4, 0, "Subtract Color",
...
BoolPropertyRNA rna_Brush_use_custom_icon = {
	...
	-1, "use_custom_icon", 3, 0, 0, 0, "Custom Icon",
...
StringPropertyRNA rna_Brush_icon_filepath = {
	...
	-1, "icon_filepath", 262145, 0, 0, 0, "Brush Icon Filepath",
...
PointerPropertyRNA rna_Brush_clone_image = {
	...
	-1, "clone_image", 8388673, 0, 0, 0, "Clone Image",
...
FloatPropertyRNA rna_Brush_clone_alpha = {
	...
	-1, "clone_alpha", 3, 0, 4, 0, "Clone Alpha",
...
FloatPropertyRNA rna_Brush_clone_offset = {
	...
	-1, "clone_offset", 3, 0, 4, 0, "Clone Offset",
	"",
	0, "*",
	PROP_FLOAT, PROP_XYZ | PROP_UNIT_NONE, NULL, 1, {2, 0, 0}, 2,
	rna_Brush_update, 251920384, NULL, NULL,
...
PointerPropertyRNA rna_Brush_brush_capabilities = {
	...
	-1, "brush_capabilities", 8650752, 0, 0, 0, "Brush Capabilities",
...
PointerPropertyRNA rna_Brush_sculpt_capabilities = {
	...
	-1, "sculpt_capabilities", 8650752, 0, 0, 0, "Sculpt Capabilities",
...
PointerPropertyRNA rna_Brush_image_paint_capabilities = {
	...
	-1, "image_paint_capabilities", 8650752, 0, 0, 0, "Image Painting Capabilities",
...
BoolPropertyRNA rna_BrushCapabilities_has_overlay = {
	...
	-1, "has_overlay", 2, 0, 0, 0, "Has Overlay",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_BrushCapabilities_has_random_texture_angle = {
	...
	-1, "has_random_texture_angle", 2, 0, 0, 0, "Has Random Texture Angle",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_BrushCapabilities_has_spacing = {
	...
	-1, "has_spacing", 2, 0, 0, 0, "Has Spacing",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_BrushCapabilities_has_smooth_stroke = {
	...
	-1, "has_smooth_stroke", 2, 0, 0, 0, "Has Smooth Stroke",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_SculptToolCapabilities_has_accumulate = {
	...
	-1, "has_accumulate", 2, 0, 0, 0, "Has Accumulate",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_SculptToolCapabilities_has_auto_smooth = {
	...
	-1, "has_auto_smooth", 2, 0, 0, 0, "Has Auto Smooth",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_SculptToolCapabilities_has_height = {
	...
	-1, "has_height", 2, 0, 0, 0, "Has Height",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_SculptToolCapabilities_has_jitter = {
	...
	-1, "has_jitter", 2, 0, 0, 0, "Has Jitter",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_SculptToolCapabilities_has_normal_weight = {
	...
	-1, "has_normal_weight", 2, 0, 0, 0, "Has Crease/Pinch Factor",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_SculptToolCapabilities_has_rake_factor = {
	...
	-1, "has_rake_factor", 2, 0, 0, 0, "Has Rake Factor",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_SculptToolCapabilities_has_persistence = {
	...
	-1, "has_persistence", 2, 0, 0, 0, "Has Persistence",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_SculptToolCapabilities_has_pinch_factor = {
	...
	-1, "has_pinch_factor", 2, 0, 0, 0, "Has Pinch Factor",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_SculptToolCapabilities_has_plane_offset = {
	...
	-1, "has_plane_offset", 2, 0, 0, 0, "Has Plane Offset",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_SculptToolCapabilities_has_sculpt_plane = {
	...
	-1, "has_sculpt_plane", 2, 0, 0, 0, "Has Sculpt Plane",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_SculptToolCapabilities_has_secondary_color = {
	...
	-1, "has_secondary_color", 2, 0, 0, 0, "Has Secondary Color",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_SculptToolCapabilities_has_space_attenuation = {
	...
	-1, "has_space_attenuation", 2, 0, 0, 0, "Has Space Attenuation",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_SculptToolCapabilities_has_strength_pressure = {
	...
	-1, "has_strength_pressure", 2, 0, 0, 0, "Has Strength Pressure",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_SculptToolCapabilities_has_gravity = {
	...
	-1, "has_gravity", 2, 0, 0, 0, "Has Gravity",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
StructRNA RNA_SculptToolCapabilities = {
	...
	"SculptToolCapabilities", NULL, NULL, 516, NULL, "Sculpt Capabilities",
...
BoolPropertyRNA rna_ImapaintToolCapabilities_has_radius = {
	...
	-1, "has_radius", 2, 0, 0, 0, "Has Radius",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
StructRNA RNA_ImapaintToolCapabilities = {
	...
	"ImapaintToolCapabilities", NULL, NULL, 516, NULL, "Image Paint Capabilities",
...
EnumPropertyRNA rna_BrushTextureSlot_tex_paint_map_mode = {
	...
	-1, "tex_paint_map_mode", 3, 0, 0, 0, "Mode",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_TextureSlot_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_BrushTextureSlot_random_angle = {
	...
	-1, "random_angle", 3, 0, 4, 0, "Random Angle",
...
BoolPropertyRNA rna_BrushTextureSlot_has_texture_angle_source = {
	...
	-1, "has_texture_angle_source", 2, 0, 0, 0, "Has Texture Angle Source",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_BrushTextureSlot_has_texture_angle = {
	...
	-1, "has_texture_angle", 2, 0, 0, 0, "Has Texture Angle Source",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
FloatPropertyRNA rna_OperatorStrokeElement_location = {
	...
	-1, "location", 1027, 0, 0, 0, "Location",
	"",
	0, "*",
...
FloatPropertyRNA rna_OperatorStrokeElement_pressure = {
	...
	-1, "pressure", 1027, 0, 0, 0, "Pressure",
	"Tablet pressure",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_OperatorStrokeElement_is_start = {
	...
	-1, "is_start", 1027, 0, 0, 0, "Is Stroke Start",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
