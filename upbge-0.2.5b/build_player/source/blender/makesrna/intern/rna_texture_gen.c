...
EnumPropertyRNA rna_PointDensity_particle_color_source;
EnumPropertyRNA rna_PointDensity_vertex_color_source;
StringPropertyRNA rna_PointDensity_vertex_attribute_name;
...
FloatPropertyRNA rna_TextureSlot_rotation;
...
BoolPropertyRNA rna_EnvironmentMap_auto_update;
EnumPropertyRNA rna_EnvironmentMap_mode;
FloatPropertyRNA rna_EnvironmentMap_lod_factor;
EnumPropertyRNA rna_EnvironmentMap_filtering;
...
bool ImageTexture_use_derivative_map_get(PointerRNA *ptr)
{
	Tex *data = (Tex *)(ptr->data);
	return (((data->imaflag) & 16384) != 0);
}

void ImageTexture_use_derivative_map_set(PointerRNA *ptr, bool value)
{
	Tex *data = (Tex *)(ptr->data);
...
bool EnvironmentMapTexture_use_mipmap_get(PointerRNA *ptr)
{
	Tex *data = (Tex *)(ptr->data);
	return (((data->imaflag) & 4) != 0);
}

void EnvironmentMapTexture_use_mipmap_set(PointerRNA *ptr, bool value)
{
	rna_ImageTexture_mipmap_set(ptr, value);
}

bool EnvironmentMapTexture_use_mipmap_gauss_get(PointerRNA *ptr)
{
	Tex *data = (Tex *)(ptr->data);
	return (((data->imaflag) & 4096) != 0);
}

void EnvironmentMapTexture_use_mipmap_gauss_set(PointerRNA *ptr, bool value)
{
	Tex *data = (Tex *)(ptr->data);
	if (value) data->imaflag |= 4096;
	else data->imaflag &= ~4096;
...
bool EnvironmentMapTexture_use_filter_size_min_get(PointerRNA *ptr)
{
	Tex *data = (Tex *)(ptr->data);
	return (((data->imaflag) & 8192) != 0);
}

void EnvironmentMapTexture_use_filter_size_min_set(PointerRNA *ptr, bool value)
{
	Tex *data = (Tex *)(ptr->data);
	if (value) data->imaflag |= 8192;
	else data->imaflag &= ~8192;
...
int PointDensity_particle_color_source_get(PointerRNA *ptr)
{
	PointDensity *data = (PointDensity *)(ptr->data);
	return (int)(data->color_source);
}

void PointDensity_particle_color_source_set(PointerRNA *ptr, int value)
{
	PointDensity *data = (PointDensity *)(ptr->data);
	data->color_source = value;
}

int PointDensity_vertex_color_source_get(PointerRNA *ptr)
{
	PointDensity *data = (PointDensity *)(ptr->data);
	return (int)(data->ob_color_source);
}

void PointDensity_vertex_color_source_set(PointerRNA *ptr, int value)
{
	PointDensity *data = (PointDensity *)(ptr->data);
	data->ob_color_source = value;
}

void PointDensity_vertex_attribute_name_get(PointerRNA *ptr, char *value)
{
	PointDensity *data = (PointDensity *)(ptr->data);
	BLI_strncpy_utf8(value, data->vertex_attribute_name, 64);
}

int PointDensity_vertex_attribute_name_length(PointerRNA *ptr)
{
	PointDensity *data = (PointDensity *)(ptr->data);
	return strlen(data->vertex_attribute_name);
}

void PointDensity_vertex_attribute_name_set(PointerRNA *ptr, const char *value)
{
	PointDensity *data = (PointDensity *)(ptr->data);
	BLI_strncpy_utf8(data->vertex_attribute_name, value, 64);
}
...
bool PointDensity_use_falloff_curve_get(PointerRNA *ptr)
{
	PointDensity *data = (PointDensity *)(ptr->data);
	return (((data->flag) & 2) != 0);
}

void PointDensity_use_falloff_curve_set(PointerRNA *ptr, bool value)
{
	PointDensity *data = (PointDensity *)(ptr->data);
...
bool PointDensity_use_turbulence_get(PointerRNA *ptr)
{
	PointDensity *data = (PointDensity *)(ptr->data);
	return (((data->flag) & 1) != 0);
}

void PointDensity_use_turbulence_set(PointerRNA *ptr, bool value)
{
	PointDensity *data = (PointDensity *)(ptr->data);
...
bool VoxelData_use_still_frame_get(PointerRNA *ptr)
{
	VoxelData *data = (VoxelData *)(ptr->data);
	return (((data->flag) & 1) != 0);
}

void VoxelData_use_still_frame_set(PointerRNA *ptr, bool value)
{
	VoxelData *data = (VoxelData *)(ptr->data);
	if (value) data->flag |= 1;
	else data->flag &= ~1;
...
{
	VoxelData *data = (VoxelData *)(ptr->data);
	data->still_frame = CLAMPIS(value, -1048574, 1048574);
}
...
float TextureSlot_rotation_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (float)(data->rot);
}

void TextureSlot_rotation_set(PointerRNA *ptr, float value)
{
	MTex *data = (MTex *)(ptr->data);
	data->rot = value;
}
...
bool TextureSlot_use_stencil_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->texflag) & 2) != 0);
}

void TextureSlot_use_stencil_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool TextureSlot_invert_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->texflag) & 4) != 0);
}

void TextureSlot_invert_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool TextureSlot_use_rgb_to_intensity_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->texflag) & 1) != 0);
}

void TextureSlot_use_rgb_to_intensity_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
void EnvironmentMap_layers_ignore_get(PointerRNA *ptr, bool values[20])
{
	EnvMap *data = (EnvMap *)(ptr->data);
	unsigned int i;
...
void EnvironmentMap_layers_ignore_set(PointerRNA *ptr, const bool values[20])
{
	EnvMap *data = (EnvMap *)(ptr->data);
	unsigned int i;
...
bool EnvironmentMap_is_valid_get(PointerRNA *ptr)
{
	EnvMap *data = (EnvMap *)(ptr->data);
	return (((data->ok) & 2) != 0);
}

bool EnvironmentMap_auto_update_get(PointerRNA *ptr)
{
	EnvMap *data = (EnvMap *)(ptr->data);
	return (((data->flag) & 1) != 0);
}

void EnvironmentMap_auto_update_set(PointerRNA *ptr, bool value)
{
	EnvMap *data = (EnvMap *)(ptr->data);
	if (value) data->flag |= 1;
	else data->flag &= ~1;
...
int EnvironmentMap_mode_get(PointerRNA *ptr)
{
	EnvMap *data = (EnvMap *)(ptr->data);
	return (int)(data->mode);
}

void EnvironmentMap_mode_set(PointerRNA *ptr, int value)
{
	EnvMap *data = (EnvMap *)(ptr->data);
	data->mode = value;
}

float EnvironmentMap_lod_factor_get(PointerRNA *ptr)
{
	EnvMap *data = (EnvMap *)(ptr->data);
	return (float)(data->lodfactor);
}

void EnvironmentMap_lod_factor_set(PointerRNA *ptr, float value)
{
	EnvMap *data = (EnvMap *)(ptr->data);
	data->lodfactor = CLAMPIS(value, 0.0f, FLT_MAX);
}

int EnvironmentMap_filtering_get(PointerRNA *ptr)
{
	EnvMap *data = (EnvMap *)(ptr->data);
	return (int)(data->filtering);
}

void EnvironmentMap_filtering_set(PointerRNA *ptr, int value)
{
	EnvMap *data = (EnvMap *)(ptr->data);
...
/* Texture */
static const EnumPropertyItem rna_Texture_type_items[17] = {
	{0, "NONE", 0, "None", ""},
...
BoolPropertyRNA rna_Texture_use_color_ramp = {
	...
	-1, "use_color_ramp", 3, 0, 0, 0, "Use Color Ramp",
...
PointerPropertyRNA rna_Texture_color_ramp = {
	...
	-1, "color_ramp", 8388608, 0, 0, 0, "Color Ramp",
	"",
	0, "*",
...
FloatPropertyRNA rna_Texture_intensity = {
	...
	-1, "intensity", 3, 0, 4, 0, "Brightness",
...
FloatPropertyRNA rna_Texture_saturation = {
	...
	-1, "saturation", 3, 0, 4, 0, "Saturation",
...
FloatPropertyRNA rna_Texture_factor_red = {
	...
	-1, "factor_red", 3, 0, 4, 0, "Factor Red",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_Texture_factor_green = {
	...
	-1, "factor_green", 3, 0, 4, 0, "Factor Green",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_Texture_factor_blue = {
	...
	-1, "factor_blue", 3, 0, 4, 0, "Factor Blue",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_Texture_use_preview_alpha = {
	...
	-1, "use_preview_alpha", 3, 0, 0, 0, "Show Alpha",
...
FloatPropertyRNA rna_CloudsTexture_noise_scale = {
	...
	-1, "noise_scale", 3, 0, 4, 0, "Noise Size",
...
IntPropertyRNA rna_CloudsTexture_noise_depth = {
	...
	-1, "noise_depth", 3, 0, 4, 0, "Noise Depth",
...
EnumPropertyRNA rna_CloudsTexture_noise_basis = {
	...
	-1, "noise_basis", 3, 0, 0, 0, "Noise Basis",
...
EnumPropertyRNA rna_CloudsTexture_noise_type = {
	...
	-1, "noise_type", 3, 0, 0, 0, "Noise Type",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_nodes_update, 0, NULL, NULL,
...
EnumPropertyRNA rna_WoodTexture_noise_basis_2 = {
	...
	-1, "noise_basis_2", 3, 0, 0, 0, "Noise Basis 2",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_nodes_update, 0, NULL, NULL,
...
EnumPropertyRNA rna_BlendTexture_progression = {
	...
	-1, "progression", 3, 0, 0, 0, "Progression",
...
EnumPropertyRNA rna_BlendTexture_use_flip_axis = {
	...
	-1, "use_flip_axis", 3, 0, 0, 0, "Flip Axis",
...
BoolPropertyRNA rna_ImageTexture_use_interpolation = {
	...
	-1, "use_interpolation", 3, 0, 0, 0, "Interpolation",
...
BoolPropertyRNA rna_ImageTexture_use_calculate_alpha = {
	...
	-1, "use_calculate_alpha", 3, 0, 0, 0, "Calculate Alpha",
...
BoolPropertyRNA rna_ImageTexture_invert_alpha = {
	...
	-1, "invert_alpha", 3, 0, 0, 0, "Invert Alpha",
...
BoolPropertyRNA rna_ImageTexture_use_mipmap_gauss = {
	...
	-1, "use_mipmap_gauss", 3, 0, 0, 0, "MIP Map Gaussian filter",
...
IntPropertyRNA rna_ImageTexture_filter_probes = {
	...
	-1, "filter_probes", 3, 0, 4, 0, "Filter Probes",
...
IntPropertyRNA rna_ImageTexture_filter_eccentricity = {
	...
	-1, "filter_eccentricity", 3, 0, 4, 0, "Filter Eccentricity",
...
BoolPropertyRNA rna_ImageTexture_use_filter_size_min = {
	...
	-1, "use_filter_size_min", 3, 0, 0, 0, "Minimum Filter Size",
...
BoolPropertyRNA rna_ImageTexture_use_mirror_x = {
	...
	-1, "use_mirror_x", 3, 0, 0, 0, "Mirror X",
...
BoolPropertyRNA rna_ImageTexture_use_mirror_y = {
	...
	-1, "use_mirror_y", 3, 0, 0, 0, "Mirror Y",
...
BoolPropertyRNA rna_ImageTexture_use_checker_odd = {
	...
	-1, "use_checker_odd", 3, 0, 0, 0, "Checker Odd",
	"Odd checker tiles",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_ImageTexture_use_checker_even = {
	...
	-1, "use_checker_even", 3, 0, 0, 0, "Checker Even",
	"Even checker tiles",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ImageTexture_checker_distance = {
	...
	-1, "checker_distance", 3, 0, 4, 0, "Checker Distance",
...
FloatPropertyRNA rna_ImageTexture_crop_min_x = {
	...
	-1, "crop_min_x", 3, 0, 4, 0, "Crop Minimum X",
...
FloatPropertyRNA rna_ImageTexture_crop_min_y = {
	...
	-1, "crop_min_y", 3, 0, 4, 0, "Crop Minimum Y",
...
FloatPropertyRNA rna_ImageTexture_crop_max_x = {
	...
	-1, "crop_max_x", 3, 0, 4, 0, "Crop Maximum X",
...
FloatPropertyRNA rna_ImageTexture_crop_max_y = {
	...
	-1, "crop_max_y", 3, 0, 4, 0, "Crop Maximum Y",
...
PointerPropertyRNA rna_ImageTexture_image_user = {
	...
	-1, "image_user", 8388608, 0, 0, 0, "Image User",
...
BoolPropertyRNA rna_ImageTexture_use_normal_map = {
	...
	-1, "use_normal_map", 3, 0, 0, 0, "Normal Map",
...
BoolPropertyRNA rna_ImageTexture_use_derivative_map = {
	...
	-1, "use_derivative_map", 3, 0, 0, 0, "Derivative Map",
...
static const EnumPropertyItem rna_EnvironmentMapTexture_filter_type_items[5] = {
	{0, "BOX", 0, "Box", ""},
	{1, "EWA", 0, "EWA", ""},
	{2, "FELINE", 0, "FELINE", ""},
	{3, "AREA", 0, "Area", ""},
...
PointerPropertyRNA rna_EnvironmentMapTexture_environment_map = {
	...
	-1, "environment_map", 8388608, 0, 0, 0, "Environment Map",
...
StructRNA RNA_EnvironmentMapTexture = {
	...
	"EnvironmentMapTexture", NULL, NULL, 519, NULL, "Environment Map",
...
FloatPropertyRNA rna_MusgraveTexture_dimension_max = {
	...
	-1, "dimension_max", 3, 0, 4, 0, "Highest Dimension",
...
FloatPropertyRNA rna_MusgraveTexture_lacunarity = {
	...
	-1, "lacunarity", 3, 0, 4, 0, "Lacunarity",
...
FloatPropertyRNA rna_MusgraveTexture_noise_intensity = {
	...
	-1, "noise_intensity", 3, 0, 4, 0, "Noise Intensity",
...
FloatPropertyRNA rna_VoronoiTexture_minkovsky_exponent = {
	...
	-1, "minkovsky_exponent", 3, 0, 4, 0, "Minkowski Exponent",
	"Minkowski exponent",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
...
EnumPropertyRNA rna_VoronoiTexture_distance_metric = {
	...
	-1, "distance_metric", 3, 0, 0, 0, "Distance Metric",
...
FloatPropertyRNA rna_DistortedNoiseTexture_distortion = {
	...
	-1, "distortion", 3, 0, 4, 0, "Distortion Amount",
...
EnumPropertyRNA rna_DistortedNoiseTexture_noise_distortion = {
	...
	-1, "noise_distortion", 3, 0, 0, 0, "Noise Distortion",
...
static const EnumPropertyItem rna_PointDensity_point_source_items[3] = {
...
EnumPropertyRNA rna_PointDensity_point_source = {
	...
	-1, "point_source", 3, 0, 0, 0, "Point Source",
...
static const EnumPropertyItem rna_PointDensity_particle_cache_space_items[4] = {
...
EnumPropertyRNA rna_PointDensity_particle_cache_space = {
	...
	-1, "particle_cache_space", 3, 0, 0, 0, "Particle Cache",
...
static const EnumPropertyItem rna_PointDensity_vertex_cache_space_items[4] = {
...
EnumPropertyRNA rna_PointDensity_vertex_cache_space = {
	...
	-1, "vertex_cache_space", 3, 0, 0, 0, "Vertices Cache",
...
FloatPropertyRNA rna_PointDensity_radius = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
	offsetof(PointDensity, radius), 5, NULL},
...
static const EnumPropertyItem rna_PointDensity_falloff_items[8] = {
...
FloatPropertyRNA rna_PointDensity_falloff_soft = {
	{(PropertyRNA *)&rna_PointDensity_particle_color_source, (PropertyRNA *)&rna_PointDensity_falloff,
	-1, "falloff_soft", 3, 0, 4, 0, "Softness",
	"Softness of the \'soft\' falloff option",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
	offsetof(PointDensity, falloff_softness), 5, NULL},
...
static const EnumPropertyItem rna_PointDensity_particle_color_source_items[5] = {
...
EnumPropertyRNA rna_PointDensity_particle_color_source = {
	{(PropertyRNA *)&rna_PointDensity_vertex_color_source, (PropertyRNA *)&rna_PointDensity_falloff_soft,
	-1, "particle_color_source", 3, 0, 0, 0, "Color Source",
	"Data to derive color results from",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
	0, -1, NULL},
	PointDensity_particle_color_source_get, PointDensity_particle_color_source_set, NULL, NULL, NULL, NULL, rna_PointDensity_particle_color_source_items, 4, 0
};

static const EnumPropertyItem rna_PointDensity_vertex_color_source_items[5] = {
	{0, "CONSTANT", 0, "Constant", ""},
	{1, "VERTEX_COLOR", 0, "Vertex Color", "Vertex color layer"},
	{2, "VERTEX_WEIGHT", 0, "Vertex Weight", "Vertex group weight"},
	{3, "VERTEX_NORMAL", 0, "Vertex Normal", "XYZ normal vector mapped to RGB colors"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_PointDensity_vertex_color_source = {
	{(PropertyRNA *)&rna_PointDensity_vertex_attribute_name, (PropertyRNA *)&rna_PointDensity_particle_color_source,
	-1, "vertex_color_source", 3, 0, 0, 0, "Color Source",
	"Data to derive color results from",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
	0, -1, NULL},
	PointDensity_vertex_color_source_get, PointDensity_vertex_color_source_set, NULL, NULL, NULL, NULL, rna_PointDensity_vertex_color_source_items, 4, 0
};

StringPropertyRNA rna_PointDensity_vertex_attribute_name = {
	{(PropertyRNA *)&rna_PointDensity_speed_scale, (PropertyRNA *)&rna_PointDensity_vertex_color_source,
	-1, "vertex_attribute_name", 262145, 0, 0, 0, "Vertex Attribute Name",
	"Vertex attribute to use for color",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {64, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
	0, -1, NULL},
	PointDensity_vertex_attribute_name_get, PointDensity_vertex_attribute_name_length, PointDensity_vertex_attribute_name_set, NULL, NULL, NULL, 64, ""
};

FloatPropertyRNA rna_PointDensity_speed_scale = {
	{(PropertyRNA *)&rna_PointDensity_falloff_speed_scale, (PropertyRNA *)&rna_PointDensity_vertex_attribute_name,
	-1, "speed_scale", 3, 0, 4, 0, "Scale",
	"Multiplier to bring particle speed within an acceptable range",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
	offsetof(PointDensity, speed_scale), 5, NULL},
...
FloatPropertyRNA rna_PointDensity_falloff_speed_scale = {
	...
	-1, "falloff_speed_scale", 3, 0, 4, 0, "Velocity Scale",
	"Multiplier to bring particle speed within an acceptable range",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
	offsetof(PointDensity, falloff_speed_scale), 5, NULL},
...
BoolPropertyRNA rna_PointDensity_use_falloff_curve = {
	...
	-1, "use_falloff_curve", 3, 0, 0, 0, "Falloff Curve",
...
BoolPropertyRNA rna_PointDensity_use_turbulence = {
	...
	-1, "use_turbulence", 3, 0, 0, 0, "Turbulence",
...
FloatPropertyRNA rna_PointDensity_turbulence_scale = {
	...
	-1, "turbulence_scale", 3, 0, 4, 0, "Size",
	"Scale of the added turbulent noise",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
	offsetof(PointDensity, noise_size), 5, NULL},
...
FloatPropertyRNA rna_PointDensity_turbulence_strength = {
	...
	-1, "turbulence_strength", 3, 0, 4, 0, "Turbulence Strength",
	"Strength of the added turbulent noise",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
	offsetof(PointDensity, noise_fac), 5, NULL},
...
IntPropertyRNA rna_PointDensity_turbulence_depth = {
	...
	-1, "turbulence_depth", 3, 0, 4, 0, "Depth",
...
static const EnumPropertyItem rna_PointDensity_turbulence_influence_items[5] = {
...
EnumPropertyRNA rna_PointDensity_turbulence_influence = {
	...
	-1, "turbulence_influence", 3, 0, 0, 0, "Turbulence Influence",
...
static const EnumPropertyItem rna_PointDensity_noise_basis_items[11] = {
	{0, "BLENDER_ORIGINAL", 0, "Blender Original", "Noise algorithm - Blender original: Smooth interpolated noise"},
	{1, "ORIGINAL_PERLIN", 0, "Original Perlin", "Noise algorithm - Original Perlin: Smooth interpolated noise"},
	{2, "IMPROVED_PERLIN", 0, "Improved Perlin", "Noise algorithm - Improved Perlin: Smooth interpolated noise"},
	{3, "VORONOI_F1", 0, "Voronoi F1", "Noise algorithm - Voronoi F1: Returns distance to the closest feature point"},
...
StructRNA RNA_PointDensity = {
	...
	"PointDensity", NULL, NULL, 516, NULL, "PointDensity",
...
PointerPropertyRNA rna_PointDensityTexture_point_density = {
	{NULL, NULL,
	-1, "point_density", 8388608, 0, 0, 0, "Point Density",
...
StructRNA RNA_PointDensityTexture = {
	...
	"PointDensityTexture", NULL, NULL, 519, NULL, "Point Density",
...
static const EnumPropertyItem rna_VoxelData_interpolation_items[6] = {
...
static const EnumPropertyItem rna_VoxelData_smoke_data_type_items[5] = {
...
EnumPropertyRNA rna_VoxelData_smoke_data_type = {
	...
	-1, "smoke_data_type", 3, 0, 0, 0, "Source",
...
static const EnumPropertyItem rna_VoxelData_hair_data_type_items[5] = {
...
EnumPropertyRNA rna_VoxelData_hair_data_type = {
	...
	-1, "hair_data_type", 3, 0, 0, 0, "Source",
	"Simulation value to be used as a texture",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_voxeldata_update, 0, NULL, NULL,
...
static const EnumPropertyItem rna_VoxelData_extension_items[4] = {
	{1, "EXTEND", 0, "Extend", "Extend by repeating edge pixels of the image"},
	{2, "CLIP", 0, "Clip", "Clip to image size and set exterior pixels as transparent"},
	{3, "REPEAT", 0, "Repeat", "Cause the image to repeat horizontally and vertically"},
	{0, NULL, 0, NULL, NULL}
...
FloatPropertyRNA rna_VoxelData_intensity = {
	...
	-1, "intensity", 3, 0, 4, 0, "Intensity",
	"Multiplier for intensity values",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
	offsetof(VoxelData, int_multiplier), 5, NULL},
...
static const EnumPropertyItem rna_VoxelData_file_format_items[6] = {
...
EnumPropertyRNA rna_VoxelData_file_format = {
	...
	-1, "file_format", 3, 0, 0, 0, "File Format",
...
StringPropertyRNA rna_VoxelData_filepath = {
	...
	-1, "filepath", 262145, 0, 0, 0, "Source Path",
...
IntPropertyRNA rna_VoxelData_resolution = {
	...
	-1, "resolution", 3, 0, 4, 0, "Resolution",
...
BoolPropertyRNA rna_VoxelData_use_still_frame = {
	...
	-1, "use_still_frame", 3, 0, 0, 0, "Still Frame Only",
...
IntPropertyRNA rna_VoxelData_still_frame = {
	...
	-1, "still_frame", 3, 0, 4, 0, "Still Frame Number",
...
PointerPropertyRNA rna_VoxelData_domain_object = {
	...
	-1, "domain_object", 8388609, 0, 0, 0, "Domain Object",
...
StructRNA RNA_VoxelData = {
	...
	"VoxelData", NULL, NULL, 516, NULL, "VoxelData",
	"Voxel data settings",
	"*", 17,
...
PointerPropertyRNA rna_VoxelDataTexture_voxel_data = {
	...
	-1, "voxel_data", 8388608, 0, 0, 0, "Voxel Data",
...
StructRNA RNA_VoxelDataTexture = {
	...
	"VoxelDataTexture", NULL, NULL, 519, NULL, "Voxel Data",
...
static const EnumPropertyItem rna_OceanTexData_output_items[6] = {
...
PointerPropertyRNA rna_OceanTexData_ocean_object = {
	...
	-1, "ocean_object", 8388609, 0, 0, 0, "Modifier Object",
...
StructRNA RNA_OceanTexData = {
	...
	"OceanTexData", NULL, NULL, 516, NULL, "Ocean",
...
StructRNA RNA_OceanTexture = {
	...
	"OceanTexture", NULL, NULL, 519, NULL, "Ocean",
...
FloatPropertyRNA rna_TextureSlot_scale = {
	{(PropertyRNA *)&rna_TextureSlot_rotation, (PropertyRNA *)&rna_TextureSlot_offset,
	-1, "scale", 67108867, 0, 4, 0, "Size",
...
FloatPropertyRNA rna_TextureSlot_rotation = {
	{(PropertyRNA *)&rna_TextureSlot_color, (PropertyRNA *)&rna_TextureSlot_scale,
	...
	TextureSlot_rotation_get, TextureSlot_rotation_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_TextureSlot_color = {
	{(PropertyRNA *)&rna_TextureSlot_blend_type, (PropertyRNA *)&rna_TextureSlot_rotation,
...
static const EnumPropertyItem rna_TextureSlot_blend_type_items[17] = {
	{0, "MIX", 0, "Mix", ""},
	{2, "ADD", 0, "Add", ""},
...
EnumPropertyRNA rna_TextureSlot_blend_type = {
	...
	-1, "blend_type", 3, 0, 0, 0, "Blend Type",
...
BoolPropertyRNA rna_TextureSlot_use_rgb_to_intensity = {
	...
	-1, "use_rgb_to_intensity", 3, 0, 0, 0, "RGB to Intensity",
...
FloatPropertyRNA rna_TextureSlot_default_value = {
	...
	-1, "default_value", 3, 0, 4, 0, "Default Value",
...
EnumPropertyRNA rna_TextureSlot_output_node = {
	...
	-1, "output_node", 3, 0, 0, 0, "Output Node",
...
static const EnumPropertyItem rna_EnvironmentMap_source_items[5] = {
	...
	{3, "REALTIME", 0, "Realtime", "Image generated for realtime reflections in the game engine"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_EnvironmentMap_source = {
	{(PropertyRNA *)&rna_EnvironmentMap_viewpoint_object, (PropertyRNA *)&rna_EnvironmentMap_rna_type,
	-1, "source", 3, 0, 0, 0, "Source",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Envmap_update_generic, 0, NULL, NULL,
	0, -1, NULL},
	EnvironmentMap_source_get, EnvironmentMap_source_set, NULL, NULL, NULL, NULL, rna_EnvironmentMap_source_items, 4, 0
};

PointerPropertyRNA rna_EnvironmentMap_viewpoint_object = {
	{(PropertyRNA *)&rna_EnvironmentMap_mapping, (PropertyRNA *)&rna_EnvironmentMap_source,
	-1, "viewpoint_object", 8388609, 0, 0, 0, "Viewpoint Object",
...
static const EnumPropertyItem rna_EnvironmentMap_mapping_items[3] = {
...
FloatPropertyRNA rna_EnvironmentMap_clip_start = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
	offsetof(EnvMap, clipsta), 5, NULL},
...
FloatPropertyRNA rna_EnvironmentMap_clip_end = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
	offsetof(EnvMap, clipend), 5, NULL},
...
FloatPropertyRNA rna_EnvironmentMap_zoom = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_update, 0, NULL, NULL,
	offsetof(EnvMap, viewscale), 5, NULL},
...
static bool rna_EnvironmentMap_layers_ignore_default[20] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_EnvironmentMap_layers_ignore = {
	...
	-1, "layers_ignore", 3, 0, 0, 0, "Ignore Layers",
...
BoolPropertyRNA rna_EnvironmentMap_is_valid = {
	{(PropertyRNA *)&rna_EnvironmentMap_auto_update, (PropertyRNA *)&rna_EnvironmentMap_depth,
	-1, "is_valid", 2, 0, 0, 0, "Validity",
...
BoolPropertyRNA rna_EnvironmentMap_auto_update = {
	{(PropertyRNA *)&rna_EnvironmentMap_mode, (PropertyRNA *)&rna_EnvironmentMap_is_valid,
	-1, "auto_update", 3, 0, 0, 0, "Auto Update",
	"True if the cube map is updated every frame",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	EnvironmentMap_auto_update_get, EnvironmentMap_auto_update_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

static const EnumPropertyItem rna_EnvironmentMap_mode_items[3] = {
	{0, "REFLECTION", 0, "Reflection", "Reflection rendering"},
	{1, "REFRACTION", 0, "Refraction", "Refraction rendering"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_EnvironmentMap_mode = {
	{(PropertyRNA *)&rna_EnvironmentMap_lod_factor, (PropertyRNA *)&rna_EnvironmentMap_auto_update,
	-1, "mode", 3, 0, 0, 0, "Rendering Mode",
	"Texture rendering method",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	EnvironmentMap_mode_get, EnvironmentMap_mode_set, NULL, NULL, NULL, NULL, rna_EnvironmentMap_mode_items, 2, 0
};

FloatPropertyRNA rna_EnvironmentMap_lod_factor = {
	{(PropertyRNA *)&rna_EnvironmentMap_filtering, (PropertyRNA *)&rna_EnvironmentMap_mode,
	-1, "lod_factor", 3, 0, 4, 0, "Level of Detail Distance Factor",
	"The factor applied to distance computed in Lod",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(EnvMap, lodfactor), 5, NULL},
	EnvironmentMap_lod_factor_get, EnvironmentMap_lod_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 1.0f, NULL
};

static const EnumPropertyItem rna_EnvironmentMap_filtering_items[4] = {
	{0, "NONE", 0, "None", "None texture filtering"},
	{1, "LINEAR", 0, "Linear Filtering", "Linear texture filtering"},
	{2, "MIPMAP", 0, "Mipmap Filtering", "Mipmap texture filtering"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_EnvironmentMap_filtering = {
	{NULL, (PropertyRNA *)&rna_EnvironmentMap_lod_factor,
	-1, "filtering", 3, 0, 0, 0, "Filtering",
	"Texture filtering method",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	EnvironmentMap_filtering_get, EnvironmentMap_filtering_set, NULL, NULL, NULL, NULL, rna_EnvironmentMap_filtering_items, 3, 0
};
...
StringPropertyRNA rna_EnvironmentMap_save_filepath = {
	...
	-1, "filepath", 262145, 1, 0, 0, "File path",
...
StructRNA RNA_EnvironmentMap = {
	...
	NULL,
	{(PropertyRNA *)&rna_EnvironmentMap_rna_properties, (PropertyRNA *)&rna_EnvironmentMap_filtering}},
	"EnvironmentMap", NULL, NULL, 516, NULL, "EnvironmentMap",
...
FloatPropertyRNA rna_TexMapping_translation = {
	...
	-1, "translation", 3, 0, 4, 0, "Location",
	"",
	0, "*",
	PROP_FLOAT, PROP_TRANSLATION | PROP_UNIT_LENGTH, NULL, 1, {3, 0, 0}, 3,
	rna_Texture_mapping_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ColorMapping_brightness = {
	...
	-1, "brightness", 3, 0, 4, 0, "Brightness",
	"Adjust the brightness of the texture",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Color_mapping_update, 0, NULL, NULL,
...
static const EnumPropertyItem rna_ColorMapping_blend_type_items[17] = {
	{0, "MIX", 0, "Mix", ""},
	{2, "ADD", 0, "Add", ""},
	{3, "SUBTRACT", 0, "Subtract", ""},
	{1, "MULTIPLY", 0, "Multiply", ""},
...
FloatPropertyRNA rna_ColorMapping_blend_factor = {
	...
	-1, "blend_factor", 3, 0, 4, 0, "Blend Factor",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Color_mapping_update, 0, NULL, NULL,
