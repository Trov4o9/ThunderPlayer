...
extern BoolPropertyRNA rna_UILayout_template_image_cubemap;
...
struct uiLayout *UILayout_split(struct uiLayout *_self, float percentage, bool align)
{
...
void UILayout_template_ID(struct uiLayout *_self, bContext *C, struct PointerRNA *data, const char * property, const char * create, const char * open, const char * unlink, int filter)
{
	uiTemplateID(_self, C, data, property, create, open, unlink, filter);
}
...
void UILayout_template_ID_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	uiTemplateID(_self, C, data, property, new, open, unlink, filter);
}

void UILayout_template_ID_preview(struct uiLayout *_self, bContext *C, struct PointerRNA *data, const char * property, const char * create, const char * open, const char * unlink, int rows, int cols, int filter)
{
	uiTemplateIDPreview(_self, C, data, property, create, open, unlink, rows, cols, filter);
}
...
void UILayout_template_ID_preview_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	uiTemplateIDPreview(_self, C, data, property, new, open, unlink, rows, cols, filter);
}
...
void UILayout_template_curve_mapping(struct uiLayout *_self, struct PointerRNA *data, const char * property, int type, bool levels, bool brush, bool use_negative_slope)
{
...
void UILayout_template_icon_view(struct uiLayout *_self, struct PointerRNA *data, const char * property, bool show_labels, float scale)
{
...
void UILayout_template_image(struct uiLayout *_self, bContext *C, struct PointerRNA *data, const char * property, struct PointerRNA *image_user, bool compact, bool multiview, bool cubemap)
{
	uiTemplateImage(_self, C, data, property, image_user, compact, multiview, cubemap);
}
...
struct uiLayout *uiLayoutSplit(struct uiLayout *_self, float percentage, bool align);
...
void uiTemplateID(struct uiLayout *_self, bContext *C, struct PointerRNA *data, const char * property, const char * create, const char * open, const char * unlink, int filter);
void uiTemplateIDPreview(struct uiLayout *_self, bContext *C, struct PointerRNA *data, const char * property, const char * create, const char * open, const char * unlink, int rows, int cols, int filter);
...
void uiTemplateCurveMapping(struct uiLayout *_self, struct PointerRNA *data, const char * property, int type, bool levels, bool brush, bool use_negative_slope);
void uiTemplateColorRamp(struct uiLayout *_self, struct PointerRNA *data, const char * property, bool expand);
void uiTemplateIconView(struct uiLayout *_self, struct PointerRNA *data, const char * property, bool show_labels, float scale);
...
void uiTemplateImage(struct uiLayout *_self, bContext *C, struct PointerRNA *data, const char * property, struct PointerRNA *image_user, bool compact, bool multiview, bool cubemap);
...
EnumPropertyRNA rna_UILayout_operator_context = {
	...
	-1, "operator_context", 3, 0, 0, 0, "operator_context",
	"",
	0, "*",
...
FloatPropertyRNA rna_UILayout_split_percentage = {
	...
	-1, "percentage", 3, 0, 0, 0, "Percentage",
...
static const EnumPropertyItem rna_UILayout_prop_icon_items[572] = {
	{0, "NONE", 0, "NONE", ""},
...
EnumPropertyRNA rna_UILayout_prop_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_UILayout_prop_icon_items, 571, 0
};
...
IntPropertyRNA rna_UILayout_prop_icon_value = {
	...
	-1, "icon_value", 3, 0, 0, 0, "Icon Value",
	"Override automatic icon of the item",
	0, "*",
...
static const EnumPropertyItem rna_UILayout_prop_menu_enum_icon_items[572] = {
	{0, "NONE", 0, "NONE", ""},
	{1, "QUESTION", 0, "QUESTION", ""},
	{2, "ERROR", 0, "ERROR", ""},
	{3, "CANCEL", 0, "CANCEL", ""},
...
EnumPropertyRNA rna_UILayout_prop_menu_enum_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_UILayout_prop_menu_enum_icon_items, 571, 0
};
...
static const EnumPropertyItem rna_UILayout_prop_enum_icon_items[572] = {
	{0, "NONE", 0, "NONE", ""},
	{1, "QUESTION", 0, "QUESTION", ""},
	{2, "ERROR", 0, "ERROR", ""},
	{3, "CANCEL", 0, "CANCEL", ""},
...
EnumPropertyRNA rna_UILayout_prop_enum_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_UILayout_prop_enum_icon_items, 571, 0
};
...
StringPropertyRNA rna_UILayout_prop_search_search_property = {
	...
	-1, "search_property", 262145, 1, 0, 0, "",
...
static const EnumPropertyItem rna_UILayout_prop_search_icon_items[572] = {
	{0, "NONE", 0, "NONE", ""},
	{1, "QUESTION", 0, "QUESTION", ""},
	{2, "ERROR", 0, "ERROR", ""},
	{3, "CANCEL", 0, "CANCEL", ""},
...
EnumPropertyRNA rna_UILayout_prop_search_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_UILayout_prop_search_icon_items, 571, 0
};
...
static const EnumPropertyItem rna_UILayout_operator_icon_items[572] = {
	{0, "NONE", 0, "NONE", ""},
	{1, "QUESTION", 0, "QUESTION", ""},
	{2, "ERROR", 0, "ERROR", ""},
	{3, "CANCEL", 0, "CANCEL", ""},
...
EnumPropertyRNA rna_UILayout_operator_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_UILayout_operator_icon_items, 571, 0
};
...
static const EnumPropertyItem rna_UILayout_operator_menu_hold_icon_items[572] = {
	{0, "NONE", 0, "NONE", ""},
	{1, "QUESTION", 0, "QUESTION", ""},
	{2, "ERROR", 0, "ERROR", ""},
	{3, "CANCEL", 0, "CANCEL", ""},
...
EnumPropertyRNA rna_UILayout_operator_menu_hold_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_UILayout_operator_menu_hold_icon_items, 571, 0
};
...
static const EnumPropertyItem rna_UILayout_operator_menu_enum_icon_items[572] = {
	{0, "NONE", 0, "NONE", ""},
	{1, "QUESTION", 0, "QUESTION", ""},
	{2, "ERROR", 0, "ERROR", ""},
	{3, "CANCEL", 0, "CANCEL", ""},
...
EnumPropertyRNA rna_UILayout_operator_menu_enum_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_UILayout_operator_menu_enum_icon_items, 571, 0
};
...
static const EnumPropertyItem rna_UILayout_label_icon_items[572] = {
	{0, "NONE", 0, "NONE", ""},
	{1, "QUESTION", 0, "QUESTION", ""},
	{2, "ERROR", 0, "ERROR", ""},
	{3, "CANCEL", 0, "CANCEL", ""},
...
EnumPropertyRNA rna_UILayout_label_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_UILayout_label_icon_items, 571, 0
};
...
static const EnumPropertyItem rna_UILayout_menu_icon_items[572] = {
	{0, "NONE", 0, "NONE", ""},
	{1, "QUESTION", 0, "QUESTION", ""},
	{2, "ERROR", 0, "ERROR", ""},
	{3, "CANCEL", 0, "CANCEL", ""},
...
EnumPropertyRNA rna_UILayout_menu_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_UILayout_menu_icon_items, 571, 0
};
...
EnumPropertyRNA rna_UILayout_template_ID_filter = {
	{NULL, (PropertyRNA *)&rna_UILayout_template_ID_unlink,
	-1, "filter", 3, 0, 0, 0, "",
...
FunctionRNA rna_UILayout_template_ID_func = {
	...
	NULL,
	{(PropertyRNA *)&rna_UILayout_template_ID_data, (PropertyRNA *)&rna_UILayout_template_ID_filter}},
...
IntPropertyRNA rna_UILayout_template_ID_preview_rows = {
	...
	-1, "rows", 3, 0, 0, 0, "Number of thumbnail preview rows to display",
	"",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_UILayout_template_ID_preview_cols = {
	...
	-1, "cols", 3, 0, 0, 0, "Number of thumbnail preview columns to display",
	"",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
EnumPropertyRNA rna_UILayout_template_ID_preview_filter = {
	{NULL, (PropertyRNA *)&rna_UILayout_template_ID_preview_cols,
	-1, "filter", 3, 0, 0, 0, "",
	"Optionally limit the items which can be selected",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FunctionRNA rna_UILayout_template_ID_preview_func = {
	...
	NULL,
	{(PropertyRNA *)&rna_UILayout_template_ID_preview_data, (PropertyRNA *)&rna_UILayout_template_ID_preview_filter}},
...
PointerPropertyRNA rna_UILayout_template_layers_used_layers_data = {
	...
	-1, "used_layers_data", 8388608, 5, 0, 0, "",
	"Data from which to take property",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
StringPropertyRNA rna_UILayout_template_layers_used_layers_property = {
	...
	-1, "used_layers_property", 262145, 1, 0, 0, "",
	"Identifier of property in data",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_UILayout_template_layers_active_layer = {
	...
	-1, "active_layer", 3, 1, 0, 0, "Active Layer",
	"",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_UILayout_template_image_multiview = {
	{(PropertyRNA *)&rna_UILayout_template_image_cubemap, (PropertyRNA *)&rna_UILayout_template_image_compact,
	-1, "multiview", 3, 0, 0, 0, "",
...
BoolPropertyRNA rna_UILayout_template_image_cubemap = {
	{NULL, (PropertyRNA *)&rna_UILayout_template_image_multiview,
	-1, "cubemap", 3, 0, 0, 0, "",
...
FunctionRNA rna_UILayout_template_image_func = {
	...
	NULL,
	{(PropertyRNA *)&rna_UILayout_template_image_data, (PropertyRNA *)&rna_UILayout_template_image_cubemap}},
...
PointerPropertyRNA rna_UILayout_template_image_settings_image_settings = {
	...
	-1, "image_settings", 8650752, 5, 0, 0, "",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_UILayout_template_image_stereo_3d_stereo_3d_format = {
	{NULL, NULL,
	-1, "stereo_3d_format", 8650752, 5, 0, 0, "",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_UILayout_template_list_active_dataptr = {
	...
	-1, "active_dataptr", 8650752, 5, 0, 0, "",
...
StringPropertyRNA rna_UILayout_template_list_active_propname = {
	...
	-1, "active_propname", 262145, 1, 0, 0, "",
...
StringPropertyRNA rna_UILayout_template_list_item_dyntip_propname = {
	...
	-1, "item_dyntip_propname", 262145, 0, 0, 0, "",
...
FunctionRNA rna_UILayout_template_header_3D_func = {
	...
	NULL,
	{NULL, NULL}},
	"template_header_3D", 8, "Inserts common 3DView header UI (selectors for context mode, shading, etc.)",
...
FunctionRNA rna_UILayout_template_cache_file_func = {
	{NULL, (FunctionRNA *)&rna_UILayout_template_node_socket_func,
	NULL,
...
StructRNA RNA_UILayout = {
	...
	NULL,
	NULL,
	{(FunctionRNA *)&rna_UILayout_row_func, (FunctionRNA *)&rna_UILayout_template_cache_file_func}
};
...
StringPropertyRNA rna_Panel_bl_idname = {
	...
	-1, "bl_idname", 262161, 0, 0, 0, "ID Name",
...
StringPropertyRNA rna_Panel_bl_translation_context = {
	...
	-1, "bl_translation_context", 262193, 0, 0, 0, "bl_translation_context",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
StringPropertyRNA rna_Panel_bl_category = {
	...
	-1, "bl_category", 262193, 0, 0, 0, "bl_category",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
EnumPropertyRNA rna_Panel_bl_space_type = {
	...
	-1, "bl_space_type", 19, 0, 0, 0, "Space type",
...
static const EnumPropertyItem rna_Panel_bl_region_type_items[9] = {
	{0, "WINDOW", 0, "Window", ""},
	{1, "HEADER", 0, "Header", ""},
...
EnumPropertyRNA rna_Panel_bl_region_type = {
	...
	-1, "bl_region_type", 19, 0, 0, 0, "Region Type",
...
StringPropertyRNA rna_Panel_bl_context = {
	...
	-1, "bl_context", 262193, 0, 0, 0, "Context",
...
EnumPropertyRNA rna_UIList_layout_type = {
	...
	-1, "layout_type", 2, 0, 0, 0, "layout_type",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_UIList_use_filter_show = {
	...
	-1, "use_filter_show", 3, 0, 0, 0, "Show Filter",
...
StringPropertyRNA rna_UIList_filter_name = {
	...
	-1, "filter_name", -2147221503, 0, 0, 0, "Filter by Name",
...
BoolPropertyRNA rna_UIList_use_filter_invert = {
	...
	-1, "use_filter_invert", 3, 0, 0, 0, "Invert",
...
BoolPropertyRNA rna_UIList_use_filter_sort_alpha = {
	...
	-1, "use_filter_sort_alpha", 3, 0, 0, 0, "Sort by Name",
...
BoolPropertyRNA rna_UIList_use_filter_sort_reverse = {
	...
	-1, "use_filter_sort_reverse", 3, 0, 0, 0, "Invert",
...
IntPropertyRNA rna_UIList_bitflag_filter_item = {
	...
	-1, "bitflag_filter_item", 2, 0, 0, 0, "FILTER_ITEM",
...
StringPropertyRNA rna_UIList_draw_item_active_property = {
	...
	-1, "active_property", 262145, 9, 0, 0, "",
...
IntPropertyRNA rna_UIList_filter_items_filter_neworder = {
	...
	-1, "filter_neworder", 131075, 2, 0, 0, "",
