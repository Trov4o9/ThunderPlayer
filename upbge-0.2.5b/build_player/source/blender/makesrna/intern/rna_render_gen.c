...
extern PointerPropertyRNA rna_RenderEngine_register_pass_srl;
...
void RenderLayer_layers_get(PointerRNA *ptr, bool values[20])
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
	unsigned int i;
...
void RenderLayer_layers_zmask_get(PointerRNA *ptr, bool values[20])
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
	unsigned int i;
...
void RenderLayer_layers_exclude_get(PointerRNA *ptr, bool values[20])
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
	unsigned int i;
...
bool RenderLayer_use_get(PointerRNA *ptr)
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
...
bool RenderLayer_use_freestyle_get(PointerRNA *ptr)
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
...
bool RenderLayer_use_pass_color_get(PointerRNA *ptr)
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
	return (((data->passflag) & 4) != 0);
}

bool RenderLayer_use_pass_diffuse_get(PointerRNA *ptr)
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
	return (((data->passflag) & 8) != 0);
}

bool RenderLayer_use_pass_specular_get(PointerRNA *ptr)
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
...
bool RenderLayer_use_pass_reflection_get(PointerRNA *ptr)
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
	return (((data->passflag) & 128) != 0);
}

bool RenderLayer_use_pass_refraction_get(PointerRNA *ptr)
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
...
bool RenderLayer_use_pass_indirect_get(PointerRNA *ptr)
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
	return (((data->passflag) & 8192) != 0);
}

bool RenderLayer_exclude_specular_get(PointerRNA *ptr)
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
	return (((data->pass_xor) & 16) != 0);
}

bool RenderLayer_exclude_shadow_get(PointerRNA *ptr)
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
	return (((data->pass_xor) & 32) != 0);
}

bool RenderLayer_exclude_ambient_occlusion_get(PointerRNA *ptr)
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
	return (((data->pass_xor) & 64) != 0);
}

bool RenderLayer_exclude_reflection_get(PointerRNA *ptr)
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
	return (((data->pass_xor) & 128) != 0);
}

bool RenderLayer_exclude_refraction_get(PointerRNA *ptr)
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
	return (((data->pass_xor) & 1024) != 0);
}

bool RenderLayer_exclude_emit_get(PointerRNA *ptr)
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
	return (((data->pass_xor) & 65536) != 0);
}

bool RenderLayer_exclude_environment_get(PointerRNA *ptr)
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
	return (((data->pass_xor) & 131072) != 0);
}

bool RenderLayer_exclude_indirect_get(PointerRNA *ptr)
{
	RenderLayer *data = (RenderLayer *)(ptr->data);
...
void RenderEngine_register_pass(struct RenderEngine *_self, struct Scene *scene, struct SceneRenderLayer *srl, const char * name, int channels, const char * chanid, int type)
{
	RE_engine_register_pass(_self, scene, srl, name, channels, chanid, type);
}
...
void RenderEngine_register_pass_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	scene = *((struct Scene **)_data);
	_data += 8;
	srl = *((struct SceneRenderLayer **)_data);
	_data += 8;
	name = *((const char * *)_data);
	_data += 8;
	channels = *((int *)_data);
...
void RE_engine_register_pass(struct RenderEngine *_self, struct Scene *scene, struct SceneRenderLayer *srl, const char * name, int channels, const char * chanid, int type);
...
BoolPropertyRNA rna_RenderEngine_is_animation = {
	...
	-1, "is_animation", 3, 0, 0, 0, "is_animation",
	"",
	0, "*",
...
BoolPropertyRNA rna_RenderEngine_is_preview = {
	...
	-1, "is_preview", 3, 0, 0, 0, "is_preview",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_RenderEngine_camera_override = {
	...
	-1, "camera_override", 8388608, 0, 0, 0, "camera_override",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_RenderEngine_layer_override = {
	...
	-1, "layer_override", 3, 0, 0, 0, "layer_override",
	"",
	0, "*",
...
IntPropertyRNA rna_RenderEngine_resolution_x = {
	...
	-1, "resolution_x", 2, 0, 0, 0, "resolution_x",
	"",
	0, "*",
...
IntPropertyRNA rna_RenderEngine_resolution_y = {
	...
	-1, "resolution_y", 2, 0, 0, 0, "resolution_y",
	"",
	0, "*",
	PROP_INT, PROP_PIXEL | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_RenderEngine_render = {
	...
	-1, "render", 8388608, 0, 0, 0, "Render Data",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_RenderEngine_use_highlight_tiles = {
	...
	-1, "use_highlight_tiles", 3, 0, 0, 0, "use_highlight_tiles",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_RenderEngine_bl_use_preview = {
	...
	-1, "bl_use_preview", 51, 0, 0, 0, "bl_use_preview",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_RenderEngine_bl_use_texture_preview = {
	...
	-1, "bl_use_texture_preview", 51, 0, 0, 0, "bl_use_texture_preview",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_RenderEngine_bl_use_postprocess = {
	...
	-1, "bl_use_postprocess", 51, 0, 0, 0, "bl_use_postprocess",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_RenderEngine_bl_use_shading_nodes = {
	...
	-1, "bl_use_shading_nodes", 51, 0, 0, 0, "bl_use_shading_nodes",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_RenderEngine_bl_use_shading_nodes_custom = {
	...
	-1, "bl_use_shading_nodes_custom", 51, 0, 0, 0, "bl_use_shading_nodes_custom",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_RenderEngine_bl_use_exclude_layers = {
	...
	-1, "bl_use_exclude_layers", 51, 0, 0, 0, "bl_use_exclude_layers",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_RenderEngine_bl_use_save_buffers = {
	...
	-1, "bl_use_save_buffers", 51, 0, 0, 0, "bl_use_save_buffers",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_RenderEngine_bl_use_spherical_stereo = {
	...
	-1, "bl_use_spherical_stereo", 51, 0, 0, 0, "bl_use_spherical_stereo",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_RenderEngine_bake_pass_filter = {
	...
	-1, "pass_filter", 3, 1, 0, 0, "Pass Filter",
...
IntPropertyRNA rna_RenderEngine_bake_num_pixels = {
	...
	-1, "num_pixels", 3, 1, 0, 0, "Number of Pixels",
...
FunctionRNA rna_RenderEngine_tag_update_func = {
	{(FunctionRNA *)&rna_RenderEngine_update_render_passes_func, (FunctionRNA *)&rna_RenderEngine_tag_redraw_func,
	NULL,
	{NULL, NULL}},
...
FunctionRNA rna_RenderEngine_update_render_passes_func = {
	{(FunctionRNA *)&rna_RenderEngine_begin_result_func, (FunctionRNA *)&rna_RenderEngine_tag_update_func,
	NULL,
...
FunctionRNA rna_RenderEngine_begin_result_func = {
	{(FunctionRNA *)&rna_RenderEngine_update_result_func, (FunctionRNA *)&rna_RenderEngine_update_render_passes_func,
	NULL,
...
BoolPropertyRNA rna_RenderEngine_end_result_do_merge_results = {
	...
	-1, "do_merge_results", 3, 0, 0, 0, "Merge Results",
...
StringPropertyRNA rna_RenderEngine_add_pass_chan_id = {
	...
	-1, "chan_id", 262145, 1, 0, 0, "Channel IDs",
...
FloatPropertyRNA rna_RenderEngine_camera_model_matrix_r_model_matrix = {
	...
	-1, "r_model_matrix", 3, 3, 0, 0, "Model Matrix",
...
BoolPropertyRNA rna_RenderEngine_use_spherical_stereo_use_spherical_stereo = {
	...
	-1, "use_spherical_stereo", 3, 2, 0, 0, "Spherical Stereo",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_RenderEngine_get_preview_pixel_size_pixel_size = {
	...
	-1, "pixel_size", 3, 3, 0, 0, "Pixel Size",
	"",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
FunctionRNA rna_RenderEngine_get_preview_pixel_size_func = {
	{(FunctionRNA *)&rna_RenderEngine_register_pass_func, (FunctionRNA *)&rna_RenderEngine_support_display_space_shader_func,
	NULL,
...
PointerPropertyRNA rna_RenderEngine_register_pass_scene = {
	{(PropertyRNA *)&rna_RenderEngine_register_pass_srl, NULL,
	-1, "scene", 8388608, 0, 0, 0, "",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
PointerPropertyRNA rna_RenderEngine_register_pass_srl = {
...
StringPropertyRNA rna_RenderEngine_register_pass_name = {
	{(PropertyRNA *)&rna_RenderEngine_register_pass_channels, (PropertyRNA *)&rna_RenderEngine_register_pass_srl,
...
StringPropertyRNA rna_RenderEngine_register_pass_chanid = {
	...
	-1, "chanid", 262145, 0, 0, 0, "Channel IDs",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
FunctionRNA rna_RenderEngine_register_pass_func = {
	{NULL, (FunctionRNA *)&rna_RenderEngine_get_preview_pixel_size_func,
	NULL,
...
PointerPropertyRNA rna_RenderLayer_material_override = {
	...
	-1, "material_override", 8388608, 0, 0, 0, "Material Override",
...
PointerPropertyRNA rna_RenderLayer_light_override = {
	...
	-1, "light_override", 8388608, 0, 0, 0, "Light Override",
...
static bool rna_RenderLayer_layers_default[20] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_RenderLayer_layers = {
	...
	-1, "layers", 0, 0, 0, 0, "Visible Layers",
...
static bool rna_RenderLayer_layers_zmask_default[20] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_RenderLayer_layers_zmask = {
	...
	-1, "layers_zmask", 2, 0, 0, 0, "Zmask Layers",
...
static bool rna_RenderLayer_layers_exclude_default[20] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_RenderLayer_layers_exclude = {
	...
	-1, "layers_exclude", 2, 0, 0, 0, "Exclude Layers",
...
BoolPropertyRNA rna_RenderLayer_invert_zmask = {
	...
	-1, "invert_zmask", 2, 0, 0, 0, "Zmask Negate",
...
BoolPropertyRNA rna_RenderLayer_use_edge_enhance = {
	...
	-1, "use_edge_enhance", 2, 0, 0, 0, "Edge",
...
BoolPropertyRNA rna_RenderLayer_use_freestyle = {
	...
	-1, "use_freestyle", 2, 0, 0, 0, "Freestyle",
...
BoolPropertyRNA rna_RenderLayer_use_pass_combined = {
	...
	-1, "use_pass_combined", 2, 0, 0, 0, "Combined",
...
BoolPropertyRNA rna_RenderLayer_use_pass_vector = {
	...
	-1, "use_pass_vector", 2, 0, 0, 0, "Vector",
...
BoolPropertyRNA rna_RenderLayer_use_pass_normal = {
	...
	-1, "use_pass_normal", 2, 0, 0, 0, "Normal",
	"Deliver normal pass",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_RenderLayer_use_pass_object_index = {
	...
	-1, "use_pass_object_index", 2, 0, 0, 0, "Object Index",
...
BoolPropertyRNA rna_RenderLayer_use_pass_material_index = {
	...
	-1, "use_pass_material_index", 2, 0, 0, 0, "Material Index",
...
BoolPropertyRNA rna_RenderLayer_use_pass_color = {
	...
	-1, "use_pass_color", 2, 0, 0, 0, "Color",
...
BoolPropertyRNA rna_RenderLayer_use_pass_diffuse = {
	...
	-1, "use_pass_diffuse", 2, 0, 0, 0, "Diffuse",
...
BoolPropertyRNA rna_RenderLayer_use_pass_specular = {
	...
	-1, "use_pass_specular", 2, 0, 0, 0, "Specular",
...
BoolPropertyRNA rna_RenderLayer_use_pass_shadow = {
	...
	-1, "use_pass_shadow", 2, 0, 0, 0, "Shadow",
	"Deliver shadow pass",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_RenderLayer_use_pass_ambient_occlusion = {
	...
	-1, "use_pass_ambient_occlusion", 2, 0, 0, 0, "AO",
	"Deliver AO pass",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_RenderLayer_use_pass_reflection = {
	...
	-1, "use_pass_reflection", 2, 0, 0, 0, "Reflection",
...
BoolPropertyRNA rna_RenderLayer_use_pass_refraction = {
	...
	-1, "use_pass_refraction", 2, 0, 0, 0, "Refraction",
...
BoolPropertyRNA rna_RenderLayer_use_pass_environment = {
	...
	-1, "use_pass_environment", 2, 0, 0, 0, "Environment",
...
BoolPropertyRNA rna_RenderLayer_use_pass_indirect = {
	...
	-1, "use_pass_indirect", 2, 0, 0, 0, "Indirect",
...
BoolPropertyRNA rna_RenderLayer_exclude_specular = {
	...
	-1, "exclude_specular", 4098, 0, 0, 0, "Specular Exclude",
...
BoolPropertyRNA rna_RenderLayer_exclude_shadow = {
	...
	-1, "exclude_shadow", 4098, 0, 0, 0, "Shadow Exclude",
...
BoolPropertyRNA rna_RenderLayer_exclude_ambient_occlusion = {
	...
	-1, "exclude_ambient_occlusion", 4098, 0, 0, 0, "AO Exclude",
...
BoolPropertyRNA rna_RenderLayer_exclude_reflection = {
	...
	-1, "exclude_reflection", 4098, 0, 0, 0, "Reflection Exclude",
...
BoolPropertyRNA rna_RenderLayer_exclude_refraction = {
	...
	-1, "exclude_refraction", 4098, 0, 0, 0, "Refraction Exclude",
...
BoolPropertyRNA rna_RenderLayer_exclude_emit = {
	...
	-1, "exclude_emit", 4098, 0, 0, 0, "Emit Exclude",
...
BoolPropertyRNA rna_RenderLayer_exclude_environment = {
	...
	-1, "exclude_environment", 4098, 0, 0, 0, "Environment Exclude",
...
BoolPropertyRNA rna_RenderLayer_exclude_indirect = {
	...
	-1, "exclude_indirect", 4098, 0, 0, 0, "Indirect Exclude",
...
BoolPropertyRNA rna_RenderLayer_use_pass_diffuse_direct = {
	...
	-1, "use_pass_diffuse_direct", 2, 0, 0, 0, "Diffuse Direct",
...
BoolPropertyRNA rna_RenderLayer_use_pass_diffuse_indirect = {
	...
	-1, "use_pass_diffuse_indirect", 2, 0, 0, 0, "Diffuse Indirect",
...
BoolPropertyRNA rna_RenderLayer_use_pass_diffuse_color = {
	...
	-1, "use_pass_diffuse_color", 2, 0, 0, 0, "Diffuse Color",
...
BoolPropertyRNA rna_RenderLayer_use_pass_glossy_direct = {
	...
	-1, "use_pass_glossy_direct", 2, 0, 0, 0, "Glossy Direct",
...
BoolPropertyRNA rna_RenderLayer_use_pass_glossy_indirect = {
	...
	-1, "use_pass_glossy_indirect", 2, 0, 0, 0, "Glossy Indirect",
...
BoolPropertyRNA rna_RenderLayer_use_pass_glossy_color = {
	...
	-1, "use_pass_glossy_color", 2, 0, 0, 0, "Glossy Color",
...
BoolPropertyRNA rna_RenderLayer_use_pass_transmission_direct = {
	...
	-1, "use_pass_transmission_direct", 2, 0, 0, 0, "Transmission Direct",
...
BoolPropertyRNA rna_RenderLayer_use_pass_transmission_indirect = {
	...
	-1, "use_pass_transmission_indirect", 2, 0, 0, 0, "Transmission Indirect",
...
BoolPropertyRNA rna_RenderLayer_use_pass_transmission_color = {
	...
	-1, "use_pass_transmission_color", 2, 0, 0, 0, "Transmission Color",
...
BoolPropertyRNA rna_RenderLayer_use_pass_subsurface_direct = {
	...
	-1, "use_pass_subsurface_direct", 2, 0, 0, 0, "Subsurface Direct",
...
BoolPropertyRNA rna_RenderLayer_use_pass_subsurface_indirect = {
	...
	-1, "use_pass_subsurface_indirect", 2, 0, 0, 0, "Subsurface Indirect",
...
BoolPropertyRNA rna_RenderLayer_use_pass_subsurface_color = {
	...
	-1, "use_pass_subsurface_color", 2, 0, 0, 0, "Subsurface Color",
...
StringPropertyRNA rna_RenderLayer_load_from_file_filename = {
	...
	-1, "filename", 262145, 1, 0, 0, "Filename",
...
static const EnumPropertyItem rna_RenderPasses_find_by_type_pass_type_items[30] = {
	{1, "COMBINED", 0, "Combined", ""},
	{2, "Z", 0, "Z", ""},
	{4, "COLOR", 0, "Color", ""},
	{8, "DIFFUSE", 0, "Diffuse", ""},
...
StringPropertyRNA rna_RenderPass_fullname = {
	...
	-1, "fullname", 262144, 0, 0, 0, "fullname",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
StringPropertyRNA rna_RenderPass_channel_id = {
	...
	-1, "channel_id", 262144, 0, 0, 0, "channel_id",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_BakePixel_primitive_id = {
	...
	-1, "primitive_id", 2, 0, 0, 0, "primitive_id",
	"",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
