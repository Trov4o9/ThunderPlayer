...
bool Controller_show_expanded_get(PointerRNA *ptr)
{
	bController *data = (bController *)(ptr->data);
	return (((data->flag) & 1) != 0);
}

void Controller_show_expanded_set(PointerRNA *ptr, bool value)
{
	bController *data = (bController *)(ptr->data);
...
bool Controller_active_get(PointerRNA *ptr)
{
	bController *data = (bController *)(ptr->data);
	return !(((data->flag) & 32) != 0);
}

void Controller_active_set(PointerRNA *ptr, bool value)
{
	bController *data = (bController *)(ptr->data);
...
bool Controller_use_priority_get(PointerRNA *ptr)
{
	bController *data = (bController *)(ptr->data);
	return (((data->flag) & 16) != 0);
}

void Controller_use_priority_set(PointerRNA *ptr, bool value)
{
	bController *data = (bController *)(ptr->data);
...
{
	return rna_Controller_actuators_length(ptr);
}
...
bool PythonController_use_debug_get(PointerRNA *ptr)
{
	bPythonCont *data = (bPythonCont *)(((bController *)ptr->data)->data);
	return (((data->flag) & 1) != 0);
}

void PythonController_use_debug_set(PointerRNA *ptr, bool value)
{
	bPythonCont *data = (bPythonCont *)(((bController *)ptr->data)->data);
	if (value) data->flag |= 1;
	else data->flag &= ~1;
...
static const EnumPropertyItem rna_Controller_type_items[9] = {
...
BoolPropertyRNA rna_Controller_use_priority = {
	...
	-1, "use_priority", 4099, 0, 0, 0, "Priority",
...
CollectionPropertyRNA rna_Controller_actuators = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Controller_actuators_begin, Controller_actuators_next, Controller_actuators_end, Controller_actuators_get, Controller_actuators_length, Controller_actuators_lookup_int, Controller_actuators_lookup_string, NULL, &RNA_Actuator
};
...
StructRNA RNA_Controller = {
	...
	"Controller", NULL, NULL, 516, NULL, "Controller",
...
StructRNA RNA_ExpressionController = {
	...
	"ExpressionController", NULL, NULL, 516, NULL, "Expression Controller",
...
/* Python Controller */
static const EnumPropertyItem rna_PythonController_mode_items[3] = {
	{0, "SCRIPT", 0, "Script", ""},
	{1, "MODULE", 0, "Module", ""},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_PythonController_mode = {
	...
	-1, "mode", 3, 0, 0, 0, "Execution Method",
...
StructRNA RNA_PythonController = {
	...
	"PythonController", NULL, NULL, 516, NULL, "Python Controller",
...
StructRNA RNA_AndController = {
	...
	NULL,
	{NULL, NULL}},
	"AndController", NULL, NULL, 516, NULL, "And Controller",
...
StructRNA RNA_OrController = {
	...
	NULL,
	{NULL, NULL}},
	"OrController", NULL, NULL, 516, NULL, "Or Controller",
...
StructRNA RNA_NorController = {
	...
	NULL,
	{NULL, NULL}},
	"NorController", NULL, NULL, 516, NULL, "Nor Controller",
...
StructRNA RNA_NandController = {
	...
	NULL,
	{NULL, NULL}},
	"NandController", NULL, NULL, 516, NULL, "Nand Controller",
...
StructRNA RNA_XorController = {
	...
	NULL,
	{NULL, NULL}},
	"XorController", NULL, NULL, 516, NULL, "Xor Controller",
...
StructRNA RNA_XnorController = {
	...
	NULL,
	{NULL, NULL}},
	"XnorController", NULL, NULL, 516, NULL, "Xnor Controller",
