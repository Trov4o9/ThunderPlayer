...
extern BoolPropertyRNA rna_BlendDataLamps_remove_do_unlink;
extern BoolPropertyRNA rna_BlendDataLamps_remove_do_id_user;
extern BoolPropertyRNA rna_BlendDataLamps_remove_do_ui_user;
...
extern BoolPropertyRNA rna_BlendDataGroups_remove_do_unlink;
extern BoolPropertyRNA rna_BlendDataGroups_remove_do_id_user;
extern BoolPropertyRNA rna_BlendDataGroups_remove_do_ui_user;
...
BoolPropertyRNA rna_BlendDataCacheFiles_is_updated;
...
BoolPropertyRNA rna_BlendDataPaintCurves_is_updated;
...
bool BlendDataCameras_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataScenes_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataObjects_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataMaterials_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataNodeTrees_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataMeshes_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataLamps_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataLibraries_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataScreens_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataWindowManagers_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataImages_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataLattices_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataCurves_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataMetaBalls_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataFonts_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataTextures_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataBrushes_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataWorlds_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataGroups_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataTexts_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataSpeakers_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataSounds_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataArmatures_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataActions_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataParticles_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataPalettes_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataGreasePencils_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataMovieClips_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataMasks_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataLineStyles_is_updated_get(PointerRNA *ptr)
{
...
bool BlendDataCacheFiles_is_updated_get(PointerRNA *ptr)
{
	return rna_Main_cachefiles_is_updated_get(ptr);
}
...
bool BlendDataPaintCurves_is_updated_get(PointerRNA *ptr)
{
	return rna_Main_paintcurves_is_updated_get(ptr);
}
...
struct Mesh *BlendDataMeshes_new_from_object(struct Main *_self, ReportList *reports, struct Scene *scene, struct Object *object, bool apply_modifiers, int settings, bool calc_tessface, bool calc_undeformed)
{
...
struct Mesh *rna_Main_meshes_new_from_object(struct Main *_self, ReportList *reports, struct Scene *scene, struct Object *object, bool apply_modifiers, int settings, bool calc_tessface, bool calc_undeformed);
...
void BlendDataLamps_remove(struct Main *_self, ReportList *reports, struct PointerRNA *lamp, bool do_unlink, bool do_id_user, bool do_ui_user)
{
	rna_Main_ID_remove(_self, reports, lamp, do_unlink, do_id_user, do_ui_user);
}
...
void BlendDataLamps_tag(struct Main *_self, bool value)
{
...
void rna_Main_ID_remove(struct Main *_self, ReportList *reports, struct PointerRNA *lamp, bool do_unlink, bool do_id_user, bool do_ui_user);
void rna_Main_lamps_tag(struct Main *_self, bool value);
...
void BlendDataGroups_remove(struct Main *_self, ReportList *reports, struct PointerRNA *group, bool do_unlink, bool do_id_user, bool do_ui_user)
{
	rna_Main_ID_remove(_self, reports, group, do_unlink, do_id_user, do_ui_user);
}
...
void BlendDataGroups_tag(struct Main *_self, bool value)
{
...
void rna_Main_ID_remove(struct Main *_self, ReportList *reports, struct PointerRNA *group, bool do_unlink, bool do_id_user, bool do_ui_user);
void rna_Main_groups_tag(struct Main *_self, bool value);
...
void rna_Main_gpencil_tag(struct Main *_self, bool value);
...
StringPropertyRNA rna_BlendData_filepath = {
	...
	-1, "filepath", 262144, 0, 0, 0, "Filename",
...
BoolPropertyRNA rna_BlendData_is_dirty = {
	...
	-1, "is_dirty", 2, 0, 0, 0, "File Has Unsaved Changes",
...
BoolPropertyRNA rna_BlendData_is_saved = {
	...
	-1, "is_saved", 2, 0, 0, 0, "File is Saved",
...
BoolPropertyRNA rna_BlendData_use_autopack = {
	...
	-1, "use_autopack", 3, 0, 0, 0, "Use Autopack",
...
CollectionPropertyRNA rna_BlendData_node_groups = {
	...
	-1, "node_groups", 0, 0, 0, 0, "Node Groups",
...
CollectionPropertyRNA rna_BlendData_window_managers = {
	...
	-1, "window_managers", 0, 0, 0, 0, "Window Managers",
...
CollectionPropertyRNA rna_BlendData_shape_keys = {
	...
	-1, "shape_keys", 0, 0, 0, 0, "Shape Keys",
...
CollectionPropertyRNA rna_BlendData_grease_pencil = {
	...
	-1, "grease_pencil", 0, 0, 0, 0, "Grease Pencil",
...
CollectionPropertyRNA rna_BlendData_movieclips = {
	...
	-1, "movieclips", 0, 0, 0, 0, "Movie Clips",
...
CollectionPropertyRNA rna_BlendData_linestyles = {
	...
	-1, "linestyles", 0, 0, 0, 0, "Line Styles",
...
CollectionPropertyRNA rna_BlendData_cache_files = {
	...
	-1, "cache_files", 0, 0, 0, 0, "Cache Files",
...
CollectionPropertyRNA rna_BlendData_paint_curves = {
	{NULL, (PropertyRNA *)&rna_BlendData_cache_files,
	-1, "paint_curves", 0, 0, 0, 0, "Paint Curves",
...
StructRNA RNA_BlendData = {
	...
	NULL,
	{(PropertyRNA *)&rna_BlendData_rna_properties, (PropertyRNA *)&rna_BlendData_paint_curves}},
...
BoolPropertyRNA rna_BlendDataCameras_is_updated = {
	...
	-1, "is_updated", 2, 0, 0, 0, "is_updated",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
static const EnumPropertyItem rna_BlendDataMeshes_new_from_object_settings_items[3] = {
...
static const EnumPropertyItem rna_BlendDataLamps_new_type_items[6] = {
...
PointerPropertyRNA rna_BlendDataLamps_remove_lamp = {
	{(PropertyRNA *)&rna_BlendDataLamps_remove_do_unlink, NULL,
	-1, "lamp", 262144, 5, 0, 0, "",
	"Lamp to remove",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
BoolPropertyRNA rna_BlendDataLamps_remove_do_unlink = {
	{(PropertyRNA *)&rna_BlendDataLamps_remove_do_id_user, (PropertyRNA *)&rna_BlendDataLamps_remove_lamp,
	-1, "do_unlink", 3, 0, 0, 0, "",
...
BoolPropertyRNA rna_BlendDataLamps_remove_do_id_user = {
	{(PropertyRNA *)&rna_BlendDataLamps_remove_do_ui_user, (PropertyRNA *)&rna_BlendDataLamps_remove_do_unlink,
	-1, "do_id_user", 3, 0, 0, 0, "",
...
BoolPropertyRNA rna_BlendDataLamps_remove_do_ui_user = {
	{NULL, (PropertyRNA *)&rna_BlendDataLamps_remove_do_id_user,
	-1, "do_ui_user", 3, 0, 0, 0, "",
...
FunctionRNA rna_BlendDataLamps_remove_func = {
	...
	NULL,
	{(PropertyRNA *)&rna_BlendDataLamps_remove_lamp, (PropertyRNA *)&rna_BlendDataLamps_remove_do_ui_user}},
...
StructRNA RNA_BlendDataLamps = {
	...
	"BlendDataLamps", NULL, NULL, 516, NULL, "Main Lamps",
	"Collection of lamps",
	"*", 17,
...
BoolPropertyRNA rna_BlendDataImages_new_float_buffer = {
	...
	-1, "float_buffer", 3, 0, 0, 0, "Float Buffer",
...
static const EnumPropertyItem rna_BlendDataTextures_new_type_items[17] = {
	{0, "NONE", 0, "None", ""},
...
static const EnumPropertyItem rna_BlendDataBrushes_new_mode_items[10] = {
...
PointerPropertyRNA rna_BlendDataGroups_remove_group = {
	{(PropertyRNA *)&rna_BlendDataGroups_remove_do_unlink, NULL,
...
BoolPropertyRNA rna_BlendDataGroups_remove_do_unlink = {
	{(PropertyRNA *)&rna_BlendDataGroups_remove_do_id_user, (PropertyRNA *)&rna_BlendDataGroups_remove_group,
	-1, "do_unlink", 3, 0, 0, 0, "",
...
BoolPropertyRNA rna_BlendDataGroups_remove_do_id_user = {
	{(PropertyRNA *)&rna_BlendDataGroups_remove_do_ui_user, (PropertyRNA *)&rna_BlendDataGroups_remove_do_unlink,
	-1, "do_id_user", 3, 0, 0, 0, "",
...
BoolPropertyRNA rna_BlendDataGroups_remove_do_ui_user = {
	{NULL, (PropertyRNA *)&rna_BlendDataGroups_remove_do_id_user,
	-1, "do_ui_user", 3, 0, 0, 0, "",
...
FunctionRNA rna_BlendDataGroups_remove_func = {
	...
	NULL,
	{(PropertyRNA *)&rna_BlendDataGroups_remove_group, (PropertyRNA *)&rna_BlendDataGroups_remove_do_ui_user}},
	"remove", 16, "Remove a group from the current blendfile",
...
StructRNA RNA_BlendDataGroups = {
	...
	"BlendDataGroups", NULL, NULL, 516, NULL, "Main Groups",
	"Collection of groups",
	"*", 17,
...
BoolPropertyRNA rna_BlendDataTexts_load_internal = {
	...
	-1, "internal", 3, 0, 0, 0, "Make internal",
...
PointerPropertyRNA rna_BlendDataCacheFiles_rna_type = {
	{(PropertyRNA *)&rna_BlendDataCacheFiles_is_updated, (PropertyRNA *)&rna_BlendDataCacheFiles_rna_properties,
	-1, "rna_type", 8912896, 0, 0, 0, "RNA",
	"RNA type definition",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
BoolPropertyRNA rna_BlendDataCacheFiles_is_updated = {
	{NULL, (PropertyRNA *)&rna_BlendDataCacheFiles_rna_type,
	-1, "is_updated", 2, 0, 0, 0, "is_updated",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	BlendDataCacheFiles_is_updated_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
StructRNA RNA_BlendDataCacheFiles = {
	...
	NULL,
	{(PropertyRNA *)&rna_BlendDataCacheFiles_rna_properties, (PropertyRNA *)&rna_BlendDataCacheFiles_is_updated}},
...
PointerPropertyRNA rna_BlendDataPaintCurves_rna_type = {
	{(PropertyRNA *)&rna_BlendDataPaintCurves_is_updated, (PropertyRNA *)&rna_BlendDataPaintCurves_rna_properties,
	-1, "rna_type", 8912896, 0, 0, 0, "RNA",
	"RNA type definition",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
BoolPropertyRNA rna_BlendDataPaintCurves_is_updated = {
	{NULL, (PropertyRNA *)&rna_BlendDataPaintCurves_rna_type,
	-1, "is_updated", 2, 0, 0, 0, "is_updated",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	BlendDataPaintCurves_is_updated_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
StructRNA RNA_BlendDataPaintCurves = {
	{(ContainerRNA *)&RNA_Material, (ContainerRNA *)&RNA_BlendDataCacheFiles,
	NULL,
	{(PropertyRNA *)&rna_BlendDataPaintCurves_rna_properties, (PropertyRNA *)&rna_BlendDataPaintCurves_is_updated}},
