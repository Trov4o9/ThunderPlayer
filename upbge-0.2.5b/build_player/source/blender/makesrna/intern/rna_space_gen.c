...
EnumPropertyRNA rna_SpaceUVEditor_other_uv_filter;
...
BoolPropertyRNA rna_SpaceView3D_show_mist;
...
IntPropertyRNA rna_SpaceView3D_active_layer;
...
StringPropertyRNA rna_SpaceLogicEditor_import_string;
...
bool SpaceImageEditor_show_grease_pencil_get(PointerRNA *ptr)
{
	SpaceImage *data = (SpaceImage *)(ptr->data);
	return (((data->flag) & 4194304) != 0);
}

void SpaceImageEditor_show_grease_pencil_set(PointerRNA *ptr, bool value)
{
	SpaceImage *data = (SpaceImage *)(ptr->data);
...
bool SpaceUVEditor_show_other_objects_get(PointerRNA *ptr)
{
	SpaceImage *data = (SpaceImage *)(ptr->data);
	return (((data->flag) & 8388608) != 0);
}

void SpaceUVEditor_show_other_objects_set(PointerRNA *ptr, bool value)
{
	SpaceImage *data = (SpaceImage *)(ptr->data);
...
bool SpaceUVEditor_show_normalized_coords_get(PointerRNA *ptr)
{
	SpaceImage *data = (SpaceImage *)(ptr->data);
	return (((data->flag) & 512) != 0);
}

void SpaceUVEditor_show_normalized_coords_set(PointerRNA *ptr, bool value)
{
	SpaceImage *data = (SpaceImage *)(ptr->data);
...
bool SpaceUVEditor_use_snap_to_pixels_get(PointerRNA *ptr)
{
	SpaceImage *data = (SpaceImage *)(ptr->data);
	return (((data->flag) & 1024) != 0);
}

void SpaceUVEditor_use_snap_to_pixels_set(PointerRNA *ptr, bool value)
{
	SpaceImage *data = (SpaceImage *)(ptr->data);
...
int SpaceUVEditor_other_uv_filter_get(PointerRNA *ptr)
{
	SpaceImage *data = (SpaceImage *)(ptr->data);
	return (int)(data->other_uv_filter);
}

void SpaceUVEditor_other_uv_filter_set(PointerRNA *ptr, int value)
{
	SpaceImage *data = (SpaceImage *)(ptr->data);
	data->other_uv_filter = value;
}
...
bool SpaceSequenceEditor_show_grease_pencil_get(PointerRNA *ptr)
{
	SpaceSeq *data = (SpaceSeq *)(ptr->data);
	return (((data->flag) & 16) != 0);
}

void SpaceSequenceEditor_show_grease_pencil_set(PointerRNA *ptr, bool value)
{
	SpaceSeq *data = (SpaceSeq *)(ptr->data);
	if (value) data->flag |= 16;
	else data->flag &= ~16;
...
bool BackgroundImage_use_flip_x_get(PointerRNA *ptr)
{
	BGpic *data = (BGpic *)(ptr->data);
	return (((data->flag) & 128) != 0);
}

void BackgroundImage_use_flip_x_set(PointerRNA *ptr, bool value)
{
	BGpic *data = (BGpic *)(ptr->data);
...
bool BackgroundImage_use_flip_y_get(PointerRNA *ptr)
{
	BGpic *data = (BGpic *)(ptr->data);
	return (((data->flag) & 256) != 0);
}

void BackgroundImage_use_flip_y_set(PointerRNA *ptr, bool value)
{
	BGpic *data = (BGpic *)(ptr->data);
	if (value) data->flag |= 256;
	else data->flag &= ~256;
...
bool BackgroundImage_show_expanded_get(PointerRNA *ptr)
{
	BGpic *data = (BGpic *)(ptr->data);
	return (((data->flag) & 6) != 0);
}

void BackgroundImage_show_expanded_set(PointerRNA *ptr, bool value)
{
	BGpic *data = (BGpic *)(ptr->data);
...
bool BackgroundImage_use_camera_clip_get(PointerRNA *ptr)
{
	BGpic *data = (BGpic *)(ptr->data);
	return (((data->flag) & 4) != 0);
}

void BackgroundImage_use_camera_clip_set(PointerRNA *ptr, bool value)
{
	BGpic *data = (BGpic *)(ptr->data);
	if (value) data->flag |= 4;
	else data->flag &= ~4;
...
bool BackgroundImage_show_background_image_get(PointerRNA *ptr)
{
	BGpic *data = (BGpic *)(ptr->data);
	return !(((data->flag) & 8) != 0);
}

void BackgroundImage_show_background_image_set(PointerRNA *ptr, bool value)
{
	BGpic *data = (BGpic *)(ptr->data);
	if (!value) data->flag |= 8;
	else data->flag &= ~8;
...
bool BackgroundImage_show_on_foreground_get(PointerRNA *ptr)
{
	BGpic *data = (BGpic *)(ptr->data);
	return (((data->flag) & 16) != 0);
}

void BackgroundImage_show_on_foreground_set(PointerRNA *ptr, bool value)
{
	BGpic *data = (BGpic *)(ptr->data);
	if (value) data->flag |= 16;
	else data->flag &= ~16;
...
{
	rna_SpaceView3D_viewport_shade_set(ptr, value);
}
...
{
	View3D *data = (View3D *)(ptr->data);
	data->near = CLAMPIS(value, 0.0000010000f, FLT_MAX);
}
...
{
	View3D *data = (View3D *)(ptr->data);
	data->far = CLAMPIS(value, 0.0000010000f, FLT_MAX);
}
...
bool SpaceView3D_show_floor_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->gridflag) & 1) != 0);
}

void SpaceView3D_show_floor_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
...
bool SpaceView3D_show_axis_x_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->gridflag) & 2) != 0);
}

void SpaceView3D_show_axis_x_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
...
bool SpaceView3D_show_axis_y_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->gridflag) & 4) != 0);
}

void SpaceView3D_show_axis_y_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
...
bool SpaceView3D_show_axis_z_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->gridflag) & 8) != 0);
}

void SpaceView3D_show_axis_z_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
...
bool SpaceView3D_show_outline_selected_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->flag) & 2048) != 0);
}

void SpaceView3D_show_outline_selected_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
	if (value) data->flag |= 2048;
	else data->flag &= ~2048;
...
bool SpaceView3D_show_all_objects_origin_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->flag) & 32768) != 0);
}

void SpaceView3D_show_all_objects_origin_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
...
bool SpaceView3D_show_relationship_lines_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return !(((data->flag) & 4) != 0);
}

void SpaceView3D_show_relationship_lines_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
	if (!value) data->flag |= 4;
	else data->flag &= ~4;
...
bool SpaceView3D_show_grease_pencil_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->flag2) & 16) != 0);
}

void SpaceView3D_show_grease_pencil_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
...
bool SpaceView3D_show_textured_solid_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->flag2) & 8) != 0);
}

void SpaceView3D_show_textured_solid_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
...
bool SpaceView3D_show_backface_culling_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->flag2) & 1024) != 0);
}

void SpaceView3D_show_backface_culling_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
...
bool SpaceView3D_show_textured_shadeless_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->flag2) & 32768) != 0);
}

void SpaceView3D_show_textured_shadeless_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
...
bool SpaceView3D_show_occlude_wire_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->flag2) & 16384) != 0);
}

void SpaceView3D_show_occlude_wire_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
...
bool SpaceView3D_show_only_render_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->flag2) & 4) != 0);
}

void SpaceView3D_show_only_render_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
...
bool SpaceView3D_show_world_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->flag2) & 65536) != 0);
}

void SpaceView3D_show_world_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
	if (value) data->flag2 |= 65536;
	else data->flag2 &= ~65536;
}

bool SpaceView3D_show_mist_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->flag2) & 131072) != 0);
}

void SpaceView3D_show_mist_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
	if (value) data->flag2 |= 131072;
	else data->flag2 &= ~131072;
}

bool SpaceView3D_use_occlude_geometry_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->flag) & 4096) != 0);
}

void SpaceView3D_use_occlude_geometry_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
...
bool SpaceView3D_show_background_images_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->flag) & 2) != 0);
}

void SpaceView3D_show_background_images_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
	if (value) data->flag |= 2;
	else data->flag &= ~2;
...
bool SpaceView3D_use_pivot_point_align_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->flag) & 1024) != 0);
}

void SpaceView3D_use_pivot_point_align_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
	if (value) data->flag |= 1024;
	else data->flag &= ~1024;
...
bool SpaceView3D_show_manipulator_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->twflag) & 1) != 0);
}

void SpaceView3D_show_manipulator_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
...
bool SpaceView3D_lock_camera_and_layers_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->scenelock) & 1) != 0);
}

void SpaceView3D_lock_camera_and_layers_set(PointerRNA *ptr, bool value)
{
	rna_SpaceView3D_lock_camera_and_layers_set(ptr, value);
}

void SpaceView3D_layers_get(PointerRNA *ptr, bool values[20])
{
	View3D *data = (View3D *)(ptr->data);
	unsigned int i;
...
void SpaceView3D_layers_set(PointerRNA *ptr, const bool values[20])
{
	rna_SpaceView3D_layer_set(ptr, values);
}

int SpaceView3D_active_layer_get(PointerRNA *ptr)
{
	return rna_SpaceView3D_active_layer_get(ptr);
}

void SpaceView3D_layers_local_view_get(PointerRNA *ptr, bool values[8])
{
	View3D *data = (View3D *)(ptr->data);
	unsigned int i;
...
void SpaceView3D_layers_used_get(PointerRNA *ptr, bool values[20])
{
	View3D *data = (View3D *)(ptr->data);
	unsigned int i;
...
bool SpaceView3D_use_matcap_get(PointerRNA *ptr)
{
	View3D *data = (View3D *)(ptr->data);
	return (((data->flag2) & 4096) != 0);
}

void SpaceView3D_use_matcap_set(PointerRNA *ptr, bool value)
{
	View3D *data = (View3D *)(ptr->data);
...
bool SpaceProperties_use_limited_texture_context_get(PointerRNA *ptr)
{
	SpaceButs *data = (SpaceButs *)(ptr->data);
	return (((data->flag) & 8) != 0);
}

void SpaceProperties_use_limited_texture_context_set(PointerRNA *ptr, bool value)
{
	SpaceButs *data = (SpaceButs *)(ptr->data);
	if (value) data->flag |= 8;
	else data->flag &= ~8;
...
bool SpaceTimeline_show_frame_indicator_get(PointerRNA *ptr)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
	return (((data->flag) & 2) != 0);
}

void SpaceTimeline_show_frame_indicator_set(PointerRNA *ptr, bool value)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
	if (value) data->flag |= 2;
	else data->flag &= ~2;
...
bool SpaceTimeline_show_seconds_get(PointerRNA *ptr)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
	return !(((data->flag) & 1) != 0);
}

void SpaceTimeline_show_seconds_set(PointerRNA *ptr, bool value)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
	if (!value) data->flag |= 1;
	else data->flag &= ~1;
...
bool SpaceTimeline_show_cache_get(PointerRNA *ptr)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
	return (((data->cache_display) & 1) != 0);
}

void SpaceTimeline_show_cache_set(PointerRNA *ptr, bool value)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
...
bool SpaceTimeline_cache_softbody_get(PointerRNA *ptr)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
	return (((data->cache_display) & 2) != 0);
}

void SpaceTimeline_cache_softbody_set(PointerRNA *ptr, bool value)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
...
bool SpaceTimeline_cache_particles_get(PointerRNA *ptr)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
	return (((data->cache_display) & 4) != 0);
}

void SpaceTimeline_cache_particles_set(PointerRNA *ptr, bool value)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
...
bool SpaceTimeline_cache_cloth_get(PointerRNA *ptr)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
	return (((data->cache_display) & 8) != 0);
}

void SpaceTimeline_cache_cloth_set(PointerRNA *ptr, bool value)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
...
bool SpaceTimeline_cache_smoke_get(PointerRNA *ptr)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
	return (((data->cache_display) & 16) != 0);
}

void SpaceTimeline_cache_smoke_set(PointerRNA *ptr, bool value)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
...
bool SpaceTimeline_cache_dynamicpaint_get(PointerRNA *ptr)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
	return (((data->cache_display) & 32) != 0);
}

void SpaceTimeline_cache_dynamicpaint_set(PointerRNA *ptr, bool value)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
...
bool SpaceTimeline_cache_rigidbody_get(PointerRNA *ptr)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
	return (((data->cache_display) & 64) != 0);
}

void SpaceTimeline_cache_rigidbody_set(PointerRNA *ptr, bool value)
{
	SpaceTime *data = (SpaceTime *)(ptr->data);
...
bool SpaceNodeEditor_show_grease_pencil_get(PointerRNA *ptr)
{
	SpaceNode *data = (SpaceNode *)(ptr->data);
	return (((data->flag) & 4) != 0);
}

void SpaceNodeEditor_show_grease_pencil_set(PointerRNA *ptr, bool value)
{
	SpaceNode *data = (SpaceNode *)(ptr->data);
	if (value) data->flag |= 4;
	else data->flag &= ~4;
...
void SpaceLogicEditor_import_string_get(PointerRNA *ptr, char *value)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
	BLI_strncpy_utf8(value, data->import_string, 64);
}

int SpaceLogicEditor_import_string_length(PointerRNA *ptr)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
	return strlen(data->import_string);
}

void SpaceLogicEditor_import_string_set(PointerRNA *ptr, const char *value)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
	BLI_strncpy_utf8(data->import_string, value, 64);
}

bool SpaceLogicEditor_show_sensors_selected_objects_get(PointerRNA *ptr)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
	return (((data->scaflag) & 1) != 0);
}

void SpaceLogicEditor_show_sensors_selected_objects_set(PointerRNA *ptr, bool value)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
...
bool SpaceLogicEditor_show_sensors_active_object_get(PointerRNA *ptr)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
	return (((data->scaflag) & 2) != 0);
}

void SpaceLogicEditor_show_sensors_active_object_set(PointerRNA *ptr, bool value)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
...
bool SpaceLogicEditor_show_sensors_linked_controller_get(PointerRNA *ptr)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
	return (((data->scaflag) & 4) != 0);
}

void SpaceLogicEditor_show_sensors_linked_controller_set(PointerRNA *ptr, bool value)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
...
bool SpaceLogicEditor_show_sensors_active_states_get(PointerRNA *ptr)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
	return (((data->scaflag) & 512) != 0);
}

void SpaceLogicEditor_show_sensors_active_states_set(PointerRNA *ptr, bool value)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
...
bool SpaceLogicEditor_show_controllers_selected_objects_get(PointerRNA *ptr)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
	return (((data->scaflag) & 8) != 0);
}

void SpaceLogicEditor_show_controllers_selected_objects_set(PointerRNA *ptr, bool value)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
...
bool SpaceLogicEditor_show_controllers_active_object_get(PointerRNA *ptr)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
	return (((data->scaflag) & 16) != 0);
}

void SpaceLogicEditor_show_controllers_active_object_set(PointerRNA *ptr, bool value)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
...
bool SpaceLogicEditor_show_controllers_linked_controller_get(PointerRNA *ptr)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
	return (((data->scaflag) & 32) != 0);
}

void SpaceLogicEditor_show_controllers_linked_controller_set(PointerRNA *ptr, bool value)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
...
bool SpaceLogicEditor_show_actuators_selected_objects_get(PointerRNA *ptr)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
	return (((data->scaflag) & 64) != 0);
}

void SpaceLogicEditor_show_actuators_selected_objects_set(PointerRNA *ptr, bool value)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
...
bool SpaceLogicEditor_show_actuators_active_object_get(PointerRNA *ptr)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
	return (((data->scaflag) & 128) != 0);
}

void SpaceLogicEditor_show_actuators_active_object_set(PointerRNA *ptr, bool value)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
...
bool SpaceLogicEditor_show_actuators_linked_controller_get(PointerRNA *ptr)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
	return (((data->scaflag) & 256) != 0);
}

void SpaceLogicEditor_show_actuators_linked_controller_set(PointerRNA *ptr, bool value)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
...
bool SpaceLogicEditor_show_actuators_active_states_get(PointerRNA *ptr)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
	return (((data->scaflag) & 1024) != 0);
}

void SpaceLogicEditor_show_actuators_active_states_set(PointerRNA *ptr, bool value)
{
	SpaceLogic *data = (SpaceLogic *)(ptr->data);
...
bool SpaceClipEditor_show_grease_pencil_get(PointerRNA *ptr)
{
	SpaceClip *data = (SpaceClip *)(ptr->data);
	return (((data->flag) & 4096) != 0);
}

void SpaceClipEditor_show_grease_pencil_set(PointerRNA *ptr, bool value)
{
	SpaceClip *data = (SpaceClip *)(ptr->data);
	if (value) data->flag |= 4096;
	else data->flag &= ~4096;
...
BoolPropertyRNA rna_Space_show_locked_time = {
	...
	-1, "show_locked_time", 3, 0, 0, 0, "Lock Time to Other Windows",
	"",
	0, "*",
...
PointerPropertyRNA rna_SpaceImageEditor_scopes = {
	...
	-1, "scopes", 12582912, 0, 0, 0, "Scopes",
...
BoolPropertyRNA rna_SpaceImageEditor_use_image_pin = {
	...
	-1, "use_image_pin", 4099, 0, 4, 0, "Image Pin",
...
PointerPropertyRNA rna_SpaceImageEditor_sample_histogram = {
	...
	-1, "sample_histogram", 8388608, 0, 0, 0, "Line sample",
...
BoolPropertyRNA rna_SpaceImageEditor_show_repeat = {
	...
	-1, "show_repeat", 3, 0, 0, 0, "Draw Repeated",
...
BoolPropertyRNA rna_SpaceImageEditor_show_grease_pencil = {
	...
	-1, "show_grease_pencil", 3, 0, 0, 0, "Show Grease Pencil",
...
static const EnumPropertyItem rna_SpaceImageEditor_draw_channels_items[8] = {
...
EnumPropertyRNA rna_SpaceImageEditor_draw_channels = {
	...
	-1, "draw_channels", 3, 0, 0, 0, "Draw Channels",
...
BoolPropertyRNA rna_SpaceImageEditor_show_stereo_3d = {
	...
	-1, "show_stereo_3d", 3, 0, 0, 0, "Show Stereo",
...
PointerPropertyRNA rna_SpaceImageEditor_uv_editor = {
	...
	-1, "uv_editor", 8650752, 0, 0, 0, "UV Editor",
	"UV editor settings",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
static const EnumPropertyItem rna_SpaceImageEditor_mode_items[4] = {
...
FloatPropertyRNA rna_SpaceImageEditor_cursor_location = {
	...
	-1, "cursor_location", 3, 0, 0, 0, "2D Cursor Location",
...
PointerPropertyRNA rna_SpaceImageEditor_grease_pencil = {
	...
	-1, "grease_pencil", 8388673, 0, 0, 0, "Grease Pencil",
...
BoolPropertyRNA rna_SpaceImageEditor_use_realtime_update = {
	...
	-1, "use_realtime_update", 3, 0, 4, 0, "Update Automatically",
...
BoolPropertyRNA rna_SpaceImageEditor_show_render = {
	...
	-1, "show_render", 2, 0, 0, 0, "Show Render",
...
BoolPropertyRNA rna_SpaceImageEditor_show_paint = {
	...
	-1, "show_paint", 2, 0, 0, 0, "Show Paint",
...
BoolPropertyRNA rna_SpaceImageEditor_show_uvedit = {
	...
	-1, "show_uvedit", 2, 0, 0, 0, "Show UV Editor",
...
BoolPropertyRNA rna_SpaceImageEditor_show_maskedit = {
	...
	-1, "show_maskedit", 2, 0, 0, 0, "Show Mask Editor",
...
static const EnumPropertyItem rna_SpaceImageEditor_mask_draw_type_items[5] = {
...
EnumPropertyRNA rna_SpaceImageEditor_mask_draw_type = {
	...
	-1, "mask_draw_type", 3, 0, 0, 0, "Edge Draw Type",
...
BoolPropertyRNA rna_SpaceImageEditor_show_mask_smooth = {
	...
	-1, "show_mask_smooth", 3, 0, 0, 0, "Draw Smooth Splines",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 251920384, NULL, NULL,
...
BoolPropertyRNA rna_SpaceImageEditor_show_mask_overlay = {
	...
	-1, "show_mask_overlay", 3, 0, 0, 0, "Show Mask Overlay",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 251920384, NULL, NULL,
...
EnumPropertyRNA rna_SpaceImageEditor_mask_overlay_mode = {
	...
	-1, "mask_overlay_mode", 3, 0, 0, 0, "Overlay Mode",
...
EnumPropertyRNA rna_SpaceUVEditor_sticky_select_mode = {
	...
	-1, "sticky_select_mode", 3, 0, 0, 0, "Sticky Selection Mode",
...
static const EnumPropertyItem rna_SpaceUVEditor_edge_draw_type_items[5] = {
	{0, "OUTLINE", 0, "Outline", "Draw white edges with black outline"},
	{1, "DASH", 0, "Dash", "Draw dashed black-white edges"},
	{2, "BLACK", 0, "Black", "Draw black edges"},
	{3, "WHITE", 0, "White", "Draw white edges"},
...
EnumPropertyRNA rna_SpaceUVEditor_edge_draw_type = {
	...
	-1, "edge_draw_type", 3, 0, 0, 0, "Edge Draw Type",
...
BoolPropertyRNA rna_SpaceUVEditor_show_smooth_edges = {
	...
	-1, "show_smooth_edges", 3, 0, 0, 0, "Draw Smooth Edges",
...
BoolPropertyRNA rna_SpaceUVEditor_show_stretch = {
	...
	-1, "show_stretch", 3, 0, 0, 0, "Draw Stretch",
...
static const EnumPropertyItem rna_SpaceUVEditor_draw_stretch_type_items[3] = {
...
EnumPropertyRNA rna_SpaceUVEditor_draw_stretch_type = {
	...
	-1, "draw_stretch_type", 3, 0, 0, 0, "Draw Stretch Type",
...
BoolPropertyRNA rna_SpaceUVEditor_show_modified_edges = {
	...
	-1, "show_modified_edges", 3, 0, 0, 0, "Draw Modified Edges",
...
BoolPropertyRNA rna_SpaceUVEditor_show_other_objects = {
	...
	-1, "show_other_objects", 3, 0, 0, 0, "Draw Other Objects",
...
BoolPropertyRNA rna_SpaceUVEditor_show_metadata = {
	...
	-1, "show_metadata", 3, 0, 0, 0, "Show Metadata",
...
BoolPropertyRNA rna_SpaceUVEditor_show_texpaint = {
	...
	-1, "show_texpaint", 3, 0, 0, 0, "Draw Texture Paint UVs",
...
BoolPropertyRNA rna_SpaceUVEditor_show_normalized_coords = {
	...
	-1, "show_normalized_coords", 3, 0, 0, 0, "Normalized Coordinates",
...
BoolPropertyRNA rna_SpaceUVEditor_show_faces = {
	...
	-1, "show_faces", 3, 0, 0, 0, "Draw Faces",
...
BoolPropertyRNA rna_SpaceUVEditor_use_snap_to_pixels = {
	...
	-1, "use_snap_to_pixels", 3, 0, 0, 0, "Snap to Pixels",
...
BoolPropertyRNA rna_SpaceUVEditor_lock_bounds = {
	...
	-1, "lock_bounds", 3, 0, 0, 0, "Constrain to Image Bounds",
...
BoolPropertyRNA rna_SpaceUVEditor_use_live_unwrap = {
	{(PropertyRNA *)&rna_SpaceUVEditor_other_uv_filter, (PropertyRNA *)&rna_SpaceUVEditor_lock_bounds,
	-1, "use_live_unwrap", 3, 0, 0, 0, "Live Unwrap",
...
static const EnumPropertyItem rna_SpaceUVEditor_other_uv_filter_items[3] = {
	{1, "ALL", 0, "All", "No filter, show all islands from other objects"},
	{0, "SAME_IMAGE", 183, "Same Image", "Only show others\' UV islands whose active image matches image of the active face"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_SpaceUVEditor_other_uv_filter = {
	{NULL, (PropertyRNA *)&rna_SpaceUVEditor_use_live_unwrap,
	-1, "other_uv_filter", 3, 0, 0, 0, "Other UV filter",
	"Filter applied on the other object\'s UV to limit displayed",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 251920384, NULL, NULL,
	0, -1, NULL},
	SpaceUVEditor_other_uv_filter_get, SpaceUVEditor_other_uv_filter_set, NULL, NULL, NULL, NULL, rna_SpaceUVEditor_other_uv_filter_items, 2, 0
};

StructRNA RNA_SpaceUVEditor = {
	{(ContainerRNA *)&RNA_SpaceSequenceEditor, (ContainerRNA *)&RNA_SpaceImageEditor,
	NULL,
	{(PropertyRNA *)&rna_SpaceUVEditor_rna_properties, (PropertyRNA *)&rna_SpaceUVEditor_other_uv_filter}},
...
EnumPropertyRNA rna_SpaceSequenceEditor_display_mode = {
	...
	-1, "display_mode", 3, 0, 0, 0, "Display Mode",
...
BoolPropertyRNA rna_SpaceSequenceEditor_show_frame_indicator = {
	...
	-1, "show_frame_indicator", 3, 0, 0, 0, "Show Frame Number Indicator",
...
BoolPropertyRNA rna_SpaceSequenceEditor_show_frames = {
	...
	-1, "show_frames", 3, 0, 0, 0, "Draw Frames",
...
BoolPropertyRNA rna_SpaceSequenceEditor_use_marker_sync = {
	...
	-1, "use_marker_sync", 3, 0, 0, 0, "Sync Markers",
...
BoolPropertyRNA rna_SpaceSequenceEditor_show_separate_color = {
	...
	-1, "show_separate_color", 3, 0, 0, 0, "Separate Colors",
...
BoolPropertyRNA rna_SpaceSequenceEditor_show_safe_areas = {
	...
	-1, "show_safe_areas", 3, 0, 0, 0, "Safe Areas",
...
BoolPropertyRNA rna_SpaceSequenceEditor_show_safe_center = {
	...
	-1, "show_safe_center", 3, 0, 0, 0, "Center-Cut Safe Areas",
...
BoolPropertyRNA rna_SpaceSequenceEditor_show_seconds = {
	...
	-1, "show_seconds", 3, 0, 0, 0, "Show Seconds",
...
IntPropertyRNA rna_SpaceSequenceEditor_display_channel = {
	...
	-1, "display_channel", 3, 0, 4, 0, "Display Channel",
...
EnumPropertyRNA rna_SpaceSequenceEditor_preview_channels = {
	...
	-1, "preview_channels", 3, 0, 0, 0, "Draw Channels",
...
static const EnumPropertyItem rna_SpaceSequenceEditor_waveform_draw_type_items[4] = {
...
EnumPropertyRNA rna_SpaceSequenceEditor_waveform_draw_type = {
	...
	-1, "waveform_draw_type", 3, 0, 0, 0, "Waveform Drawing",
...
IntPropertyRNA rna_SpaceSequenceEditor_draw_overexposed = {
	...
	-1, "draw_overexposed", 3, 0, 4, 0, "Show Overexposed",
...
EnumPropertyRNA rna_SpaceSequenceEditor_proxy_render_size = {
	...
	-1, "proxy_render_size", 3, 0, 0, 0, "Proxy render size",
...
EnumPropertyRNA rna_SpaceSequenceEditor_overlay_type = {
	...
	-1, "overlay_type", 3, 0, 0, 0, "Overlay Type",
	"Overlay draw type",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252706816, NULL, NULL,
...
BoolPropertyRNA rna_SpaceSequenceEditor_show_backdrop = {
	...
	-1, "show_backdrop", 3, 0, 0, 0, "Use Backdrop",
...
BoolPropertyRNA rna_SpaceSequenceEditor_show_strip_offset = {
	...
	-1, "show_strip_offset", 3, 0, 0, 0, "Show Offsets",
...
BoolPropertyRNA rna_SpaceTextEditor_show_word_wrap = {
	...
	-1, "show_word_wrap", 4099, 0, 0, 0, "Word Wrap",
...
BoolPropertyRNA rna_SpaceTextEditor_show_line_numbers = {
	...
	-1, "show_line_numbers", 4099, 0, 4, 0, "Line Numbers",
...
BoolPropertyRNA rna_SpaceTextEditor_show_syntax_highlight = {
	...
	-1, "show_syntax_highlight", 4099, 0, 4, 0, "Syntax Highlight",
...
BoolPropertyRNA rna_SpaceTextEditor_show_line_highlight = {
	...
	-1, "show_line_highlight", 3, 0, 4, 0, "Highlight Line",
...
BoolPropertyRNA rna_SpaceTextEditor_show_margin = {
	...
	-1, "show_margin", 3, 0, 0, 0, "Show Margin",
	"Show right margin",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252379136, NULL, NULL,
...
IntPropertyRNA rna_SpaceTextEditor_margin_column = {
	...
	-1, "margin_column", 3, 0, 4, 0, "Margin Column",
...
IntPropertyRNA rna_SpaceTextEditor_visible_lines = {
	...
	-1, "visible_lines", 2, 0, 4, 0, "Visible Lines",
...
BoolPropertyRNA rna_SpaceTextEditor_use_overwrite = {
	...
	-1, "use_overwrite", 3, 0, 0, 0, "Overwrite",
...
BoolPropertyRNA rna_SpaceTextEditor_use_live_edit = {
	...
	-1, "use_live_edit", 3, 0, 0, 0, "Live Edit",
...
BoolPropertyRNA rna_SpaceTextEditor_use_find_all = {
	...
	-1, "use_find_all", 3, 0, 0, 0, "Find All",
...
BoolPropertyRNA rna_SpaceTextEditor_use_find_wrap = {
	...
	-1, "use_find_wrap", 3, 0, 0, 0, "Find Wrap",
...
BoolPropertyRNA rna_SpaceTextEditor_use_match_case = {
	...
	-1, "use_match_case", 3, 0, 0, 0, "Match case",
...
StringPropertyRNA rna_SpaceTextEditor_find_text = {
	...
	-1, "find_text", 262145, 0, 0, 0, "Find Text",
...
StringPropertyRNA rna_SpaceTextEditor_replace_text = {
	...
	-1, "replace_text", 262145, 0, 0, 0, "Replace Text",
...
StringPropertyRNA rna_FileSelectParams_directory = {
	...
	-1, "directory", 262145, 0, 0, 0, "Directory",
...
StringPropertyRNA rna_FileSelectParams_filename = {
	...
	-1, "filename", 262145, 0, 0, 0, "File Name",
...
BoolPropertyRNA rna_FileSelectParams_use_library_browsing = {
	...
	-1, "use_library_browsing", 2, 0, 0, 0, "Library Browser",
...
EnumPropertyRNA rna_FileSelectParams_display_type = {
	...
	-1, "display_type", 3, 0, 0, 0, "Display Mode",
...
EnumPropertyRNA rna_FileSelectParams_recursion_level = {
	...
	-1, "recursion_level", 3, 0, 0, 0, "Recursion",
...
BoolPropertyRNA rna_FileSelectParams_use_filter = {
	...
	-1, "use_filter", 3, 0, 0, 0, "Filter Files",
...
BoolPropertyRNA rna_FileSelectParams_show_hidden = {
	...
	-1, "show_hidden", 3, 0, 0, 0, "Show Hidden",
...
BoolPropertyRNA rna_FileSelectParams_use_filter_image = {
	...
	-1, "use_filter_image", 3, 0, 0, 0, "Filter Images",
	"Show image files",
	696, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 251985920, NULL, NULL,
...
BoolPropertyRNA rna_FileSelectParams_use_filter_blender = {
	...
	-1, "use_filter_blender", 3, 0, 0, 0, "Filter Blender",
	"Show .blend files",
	695, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 251985920, NULL, NULL,
...
BoolPropertyRNA rna_FileSelectParams_use_filter_backup = {
	...
	-1, "use_filter_backup", 3, 0, 0, 0, "Filter BlenderBackup files",
...
BoolPropertyRNA rna_FileSelectParams_use_filter_movie = {
	...
	-1, "use_filter_movie", 3, 0, 0, 0, "Filter Movies",
	"Show movie files",
	697, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 251985920, NULL, NULL,
...
BoolPropertyRNA rna_FileSelectParams_use_filter_script = {
	...
	-1, "use_filter_script", 3, 0, 0, 0, "Filter Script",
	"Show script files",
	698, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 251985920, NULL, NULL,
...
BoolPropertyRNA rna_FileSelectParams_use_filter_font = {
	...
	-1, "use_filter_font", 3, 0, 0, 0, "Filter Fonts",
	"Show font files",
	700, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 251985920, NULL, NULL,
...
BoolPropertyRNA rna_FileSelectParams_use_filter_sound = {
	...
	-1, "use_filter_sound", 3, 0, 0, 0, "Filter Sound",
	"Show sound files",
	699, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 251985920, NULL, NULL,
...
BoolPropertyRNA rna_FileSelectParams_use_filter_text = {
	...
	-1, "use_filter_text", 3, 0, 0, 0, "Filter Text",
	"Show text files",
	701, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 251985920, NULL, NULL,
...
BoolPropertyRNA rna_FileSelectParams_use_filter_folder = {
	...
	-1, "use_filter_folder", 3, 0, 0, 0, "Filter Folder",
	"Show folders",
	693, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 251985920, NULL, NULL,
...
BoolPropertyRNA rna_FileSelectParams_use_filter_blendid = {
	...
	-1, "use_filter_blendid", 3, 0, 0, 0, "Filter Blender IDs",
...
static const EnumPropertyItem rna_FileSelectParams_filter_id_items[30] = {
...
EnumPropertyRNA rna_FileSelectParams_filter_id = {
	...
	-1, "filter_id", 2097155, 0, 0, 0, "Filter ID types",
	"Which ID types to show/hide, when browsing a library",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 251985920, NULL, NULL,
	0, -1, NULL},
	FileSelectParams_filter_id_get, FileSelectParams_filter_id_set, NULL, NULL, NULL, NULL, rna_FileSelectParams_filter_id_items, 29, 1
};
...
EnumPropertyRNA rna_FileSelectParams_filter_id_category = {
	...
	-1, "filter_id_category", 2097155, 0, 0, 0, "Filter ID categories",
...
StringPropertyRNA rna_FileSelectParams_filter_glob = {
	...
	-1, "filter_glob", 262145, 0, 0, 0, "Extension Filter",
...
StringPropertyRNA rna_FileSelectParams_filter_search = {
	...
	-1, "filter_search", -2147221503, 0, 0, 0, "Name Filter",
...
EnumPropertyRNA rna_FileSelectParams_display_size = {
	...
	-1, "display_size", 3, 0, 0, 0, "Display Size",
...
PointerPropertyRNA rna_SpaceFileBrowser_params = {
	...
	-1, "params", 8388608, 0, 0, 0, "Filebrowser Parameter",
...
PointerPropertyRNA rna_SpaceFileBrowser_active_operator = {
	...
	-1, "active_operator", 8388608, 0, 0, 0, "Active Operator",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_SpaceFileBrowser_operator = {
	...
	-1, "operator", 8388608, 0, 0, 0, "Active Operator",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
CollectionPropertyRNA rna_SpaceFileBrowser_system_folders = {
	...
	-1, "system_folders", 0, 0, 0, 0, "System Folders",
...
IntPropertyRNA rna_SpaceFileBrowser_system_folders_active = {
	...
	-1, "system_folders_active", 4194307, 0, 0, 0, "Active System Folder",
...
CollectionPropertyRNA rna_SpaceFileBrowser_system_bookmarks = {
	...
	-1, "system_bookmarks", 0, 0, 0, 0, "System Bookmarks",
	"System\'s bookmarks",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_SpaceFileBrowser_system_bookmarks_active = {
	...
	-1, "system_bookmarks_active", 4194307, 0, 0, 0, "Active System Bookmark",
...
IntPropertyRNA rna_SpaceFileBrowser_bookmarks_active = {
	...
	-1, "bookmarks_active", 4194307, 0, 0, 0, "Active Bookmark",
...
CollectionPropertyRNA rna_SpaceFileBrowser_recent_folders = {
	...
	-1, "recent_folders", 0, 0, 0, 0, "Recent Folders",
	"",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_SpaceFileBrowser_recent_folders_active = {
	...
	-1, "recent_folders_active", 4194307, 0, 0, 0, "Active Recent Folder",
...
/* Space Outliner */
static const EnumPropertyItem rna_SpaceOutliner_display_mode_items[13] = {
...
StringPropertyRNA rna_SpaceOutliner_filter_text = {
	...
	-1, "filter_text", -2147221503, 0, 0, 0, "Display Filter",
...
BoolPropertyRNA rna_SpaceOutliner_use_filter_case_sensitive = {
	...
	-1, "use_filter_case_sensitive", 3, 0, 0, 0, "Case Sensitive Matches Only",
...
BoolPropertyRNA rna_SpaceOutliner_use_filter_complete = {
	...
	-1, "use_filter_complete", 3, 0, 0, 0, "Complete Matches Only",
...
BoolPropertyRNA rna_SpaceOutliner_use_sort_alpha = {
	...
	-1, "use_sort_alpha", 3, 0, 0, 0, "Sort Alphabetically",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252182528, NULL, NULL,
...
BoolPropertyRNA rna_SpaceOutliner_show_restrict_columns = {
	...
	-1, "show_restrict_columns", 3, 0, 0, 0, "Show Restriction Columns",
	"Show column",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252182528, NULL, NULL,
...
static const EnumPropertyItem rna_BackgroundImage_source_items[3] = {
	{0, "IMAGE", 0, "Image", ""},
...
EnumPropertyRNA rna_BackgroundImage_source = {
	...
	-1, "source", 3, 0, 0, 0, "Background Source",
...
PointerPropertyRNA rna_BackgroundImage_clip = {
	...
	-1, "clip", 8388673, 0, 0, 0, "MovieClip",
...
PointerPropertyRNA rna_BackgroundImage_clip_user = {
	...
	-1, "clip_user", 8650752, 0, 0, 0, "Clip User",
...
FloatPropertyRNA rna_BackgroundImage_offset_y = {
	...
	-1, "offset_y", 3, 0, 4, 0, "Y Offset",
	"Offset image vertically from the world origin",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252248064, NULL, NULL,
	offsetof(BGpic, yof), 5, NULL},
...
BoolPropertyRNA rna_BackgroundImage_use_flip_x = {
	...
	-1, "use_flip_x", 3, 0, 0, 0, "Flip Horizontally",
...
BoolPropertyRNA rna_BackgroundImage_use_flip_y = {
	...
	-1, "use_flip_y", 3, 0, 0, 0, "Flip Vertically",
...
static const EnumPropertyItem rna_BackgroundImage_view_axis_items[13] = {
	{0, "", 0, "X Axis", ""},
...
EnumPropertyRNA rna_BackgroundImage_view_axis = {
	...
	-1, "view_axis", 3, 0, 0, 0, "Image Axis",
...
BoolPropertyRNA rna_BackgroundImage_show_expanded = {
	...
	-1, "show_expanded", 4099, 0, 0, 0, "Show Expanded",
...
BoolPropertyRNA rna_BackgroundImage_use_camera_clip = {
	...
	-1, "use_camera_clip", 3, 0, 0, 0, "Camera Clip",
...
BoolPropertyRNA rna_BackgroundImage_show_background_image = {
	...
	-1, "show_background_image", 3, 0, 0, 0, "Show Background Image",
...
BoolPropertyRNA rna_BackgroundImage_show_on_foreground = {
	...
	-1, "show_on_foreground", 3, 0, 0, 0, "Show On Foreground",
...
static const EnumPropertyItem rna_BackgroundImage_draw_depth_items[3] = {
	{0, "BACK", 0, "Back", ""},
	{16, "FRONT", 0, "Front", ""},
	{0, NULL, 0, NULL, NULL}
};
...
static const EnumPropertyItem rna_BackgroundImage_frame_method_items[4] = {
	{0, "STRETCH", 0, "Stretch", ""},
	{32, "FIT", 0, "Fit", ""},
	{96, "CROP", 0, "Crop", ""},
	{0, NULL, 0, NULL, NULL}
...
EnumPropertyRNA rna_BackgroundImage_frame_method = {
	...
	-1, "frame_method", 3, 0, 0, 0, "Frame Method",
...
StructRNA RNA_BackgroundImage = {
	...
	"BackgroundImage", NULL, NULL, 516, NULL, "Background Image",
...
PointerPropertyRNA rna_SpaceView3D_camera = {
	...
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_SpaceView3D_camera_update, 252248064, NULL, NULL,
	0, -1, NULL},
...
BoolPropertyRNA rna_SpaceView3D_use_render_border = {
	...
	-1, "use_render_border", 1, 0, 0, 0, "Render Border",
...
FloatPropertyRNA rna_SpaceView3D_render_border_min_x = {
	...
	-1, "render_border_min_x", 3, 0, 4, 0, "Border Minimum X",
...
FloatPropertyRNA rna_SpaceView3D_render_border_min_y = {
	...
	-1, "render_border_min_y", 3, 0, 4, 0, "Border Minimum Y",
...
FloatPropertyRNA rna_SpaceView3D_render_border_max_x = {
	...
	-1, "render_border_max_x", 3, 0, 4, 0, "Border Maximum X",
...
FloatPropertyRNA rna_SpaceView3D_render_border_max_y = {
	...
	-1, "render_border_max_y", 3, 0, 4, 0, "Border Maximum Y",
...
PointerPropertyRNA rna_SpaceView3D_lock_object = {
	...
	-1, "lock_object", 8388609, 0, 0, 0, "Lock to Object",
...
StringPropertyRNA rna_SpaceView3D_lock_bone = {
	...
	-1, "lock_bone", 262145, 0, 0, 0, "Lock to Bone",
...
BoolPropertyRNA rna_SpaceView3D_lock_cursor = {
	...
	-1, "lock_cursor", 3, 0, 0, 0, "Lock to Cursor",
...
static const EnumPropertyItem rna_SpaceView3D_viewport_shade_items[7] = {
...
EnumPropertyRNA rna_SpaceView3D_viewport_shade = {
	...
	-1, "viewport_shade", 3, 0, 0, 0, "Viewport Shading",
...
PointerPropertyRNA rna_SpaceView3D_local_view = {
	...
	-1, "local_view", 8388608, 0, 0, 0, "Local View",
...
FloatPropertyRNA rna_SpaceView3D_cursor_location = {
	...
	-1, "cursor_location", 3, 0, 0, 0, "3D Cursor Location",
...
FloatPropertyRNA rna_SpaceView3D_grid_scale = {
	...
	-1, "grid_scale", 3, 0, 4, 0, "Grid Scale",
...
IntPropertyRNA rna_SpaceView3D_grid_lines = {
	...
	-1, "grid_lines", 3, 0, 4, 0, "Grid Lines",
...
IntPropertyRNA rna_SpaceView3D_grid_subdivisions = {
	...
	-1, "grid_subdivisions", 3, 0, 4, 0, "Grid Subdivisions",
...
FloatPropertyRNA rna_SpaceView3D_grid_scale_unit = {
	...
	-1, "grid_scale_unit", 2, 0, 0, 0, "Grid Scale Unit",
...
BoolPropertyRNA rna_SpaceView3D_show_floor = {
	...
	-1, "show_floor", 3, 0, 0, 0, "Display Grid Floor",
...
BoolPropertyRNA rna_SpaceView3D_show_axis_x = {
	...
	-1, "show_axis_x", 3, 0, 0, 0, "Display X Axis",
...
BoolPropertyRNA rna_SpaceView3D_show_axis_y = {
	...
	-1, "show_axis_y", 3, 0, 0, 0, "Display Y Axis",
...
BoolPropertyRNA rna_SpaceView3D_show_axis_z = {
	...
	-1, "show_axis_z", 3, 0, 0, 0, "Display Z Axis",
...
BoolPropertyRNA rna_SpaceView3D_show_outline_selected = {
	...
	-1, "show_outline_selected", 3, 0, 0, 0, "Outline Selected",
...
BoolPropertyRNA rna_SpaceView3D_show_all_objects_origin = {
	...
	-1, "show_all_objects_origin", 3, 0, 0, 0, "All Object Origins",
...
BoolPropertyRNA rna_SpaceView3D_show_relationship_lines = {
	...
	-1, "show_relationship_lines", 3, 0, 0, 0, "Relationship Lines",
...
BoolPropertyRNA rna_SpaceView3D_show_textured_solid = {
	...
	-1, "show_textured_solid", 3, 0, 0, 0, "Textured Solid",
...
BoolPropertyRNA rna_SpaceView3D_show_backface_culling = {
	...
	-1, "show_backface_culling", 3, 0, 0, 0, "Backface Culling",
...
BoolPropertyRNA rna_SpaceView3D_show_textured_shadeless = {
	...
	-1, "show_textured_shadeless", 3, 0, 0, 0, "Shadeless",
...
BoolPropertyRNA rna_SpaceView3D_show_occlude_wire = {
	...
	-1, "show_occlude_wire", 3, 0, 0, 0, "Hidden Wire",
...
BoolPropertyRNA rna_SpaceView3D_lock_camera = {
	...
	-1, "lock_camera", 3, 0, 0, 0, "Lock Camera to View",
...
BoolPropertyRNA rna_SpaceView3D_show_only_render = {
	...
	-1, "show_only_render", 3, 0, 0, 0, "Only Render",
...
BoolPropertyRNA rna_SpaceView3D_show_world = {
	{(PropertyRNA *)&rna_SpaceView3D_show_mist, (PropertyRNA *)&rna_SpaceView3D_show_only_render,
	-1, "show_world", 3, 0, 0, 0, "World Background",
...
BoolPropertyRNA rna_SpaceView3D_show_mist = {
	{(PropertyRNA *)&rna_SpaceView3D_use_occlude_geometry, (PropertyRNA *)&rna_SpaceView3D_show_world,
	-1, "show_mist", 3, 0, 0, 0, "World Mist",
	"Display world mist",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_SpaceView3D_material_update, 252248064, NULL, NULL,
	0, -1, NULL},
	SpaceView3D_show_mist_get, SpaceView3D_show_mist_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_SpaceView3D_use_occlude_geometry = {
	{(PropertyRNA *)&rna_SpaceView3D_background_images, (PropertyRNA *)&rna_SpaceView3D_show_mist,
	-1, "use_occlude_geometry", 3, 0, 0, 0, "Occlude Geometry",
...
CollectionPropertyRNA rna_SpaceView3D_background_images = {
	...
	-1, "background_images", 0, 0, 0, 0, "Background Images",
...
BoolPropertyRNA rna_SpaceView3D_show_background_images = {
	...
	-1, "show_background_images", 3, 0, 0, 0, "Display Background Images",
...
static const EnumPropertyItem rna_SpaceView3D_pivot_point_items[6] = {
	{0, "BOUNDING_BOX_CENTER", 551, "Bounding Box Center", "Pivot around bounding box center of selected object(s)"},
	{1, "CURSOR", 552, "3D Cursor", "Pivot around the 3D cursor"},
	{2, "INDIVIDUAL_ORIGINS", 553, "Individual Origins", "Pivot around each object\'s own origin"},
	{3, "MEDIAN_POINT", 554, "Median Point", "Pivot around the median point of selected objects"},
...
EnumPropertyRNA rna_SpaceView3D_pivot_point = {
	...
	-1, "pivot_point", 3, 0, 0, 0, "Pivot Point",
...
BoolPropertyRNA rna_SpaceView3D_use_pivot_point_align = {
	...
	-1, "use_pivot_point_align", 3, 0, 0, 0, "Align",
...
static const EnumPropertyItem rna_SpaceView3D_transform_manipulators_items[4] = {
...
EnumPropertyRNA rna_SpaceView3D_transform_manipulators = {
	...
	-1, "transform_manipulators", 2097155, 0, 0, 0, "Transform Manipulators",
...
static const EnumPropertyItem rna_SpaceView3D_transform_orientation_items[6] = {
...
EnumPropertyRNA rna_SpaceView3D_transform_orientation = {
	...
	-1, "transform_orientation", 3, 0, 0, 0, "Transform Orientation",
...
PointerPropertyRNA rna_SpaceView3D_current_orientation = {
	...
	-1, "current_orientation", 8388608, 0, 0, 0, "Current Transform Orientation",
...
BoolPropertyRNA rna_SpaceView3D_lock_camera_and_layers = {
	...
	-1, "lock_camera_and_layers", 4099, 0, 0, 0, "Lock Camera and Layers",
...
static bool rna_SpaceView3D_layers_default[20] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_SpaceView3D_layers = {
	{(PropertyRNA *)&rna_SpaceView3D_active_layer, (PropertyRNA *)&rna_SpaceView3D_lock_camera_and_layers,
	-1, "layers", 3, 0, 0, 0, "Visible Layers",
...
IntPropertyRNA rna_SpaceView3D_active_layer = {
	{(PropertyRNA *)&rna_SpaceView3D_layers_local_view, (PropertyRNA *)&rna_SpaceView3D_layers,
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	SpaceView3D_active_layer_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	-10000, 10000, INT_MIN, INT_MAX, 1, 0, NULL
};

static bool rna_SpaceView3D_layers_local_view_default[8] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_SpaceView3D_layers_local_view = {
	{(PropertyRNA *)&rna_SpaceView3D_layers_used, (PropertyRNA *)&rna_SpaceView3D_active_layer,
...
static bool rna_SpaceView3D_layers_used_default[20] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_SpaceView3D_layers_used = {
	...
	-1, "layers_used", 2, 0, 0, 0, "Used Layers",
...
PointerPropertyRNA rna_SpaceView3D_region_3d = {
	...
	-1, "region_3d", 8388608, 0, 0, 0, "3D Region",
...
CollectionPropertyRNA rna_SpaceView3D_region_quadviews = {
	...
	-1, "region_quadviews", 0, 0, 0, 0, "Quad View Regions",
...
BoolPropertyRNA rna_SpaceView3D_show_reconstruction = {
	...
	-1, "show_reconstruction", 3, 0, 0, 0, "Show Reconstruction",
...
FloatPropertyRNA rna_SpaceView3D_tracks_draw_size = {
	...
	-1, "tracks_draw_size", 3, 0, 4, 0, "Tracks Size",
...
static const EnumPropertyItem rna_SpaceView3D_tracks_draw_type_items[8] = {
...
EnumPropertyRNA rna_SpaceView3D_tracks_draw_type = {
	...
	-1, "tracks_draw_type", 3, 0, 0, 0, "Tracks Display Type",
...
BoolPropertyRNA rna_SpaceView3D_show_camera_path = {
	...
	-1, "show_camera_path", 3, 0, 0, 0, "Show Camera Path",
...
BoolPropertyRNA rna_SpaceView3D_show_bundle_names = {
	...
	-1, "show_bundle_names", 3, 0, 0, 0, "Show 3D Marker Names",
...
static const EnumPropertyItem rna_SpaceView3D_matcap_icon_items[25] = {
	{812, "01", 812, "", ""},
	{813, "02", 813, "", ""},
	{814, "03", 814, "", ""},
	{815, "04", 815, "", ""},
...
PointerPropertyRNA rna_SpaceView3D_fx_settings = {
	...
	-1, "fx_settings", 8388608, 0, 0, 0, "FX Options",
...
EnumPropertyRNA rna_SpaceView3D_stereo_3d_eye = {
	...
	-1, "stereo_3d_eye", 2, 0, 0, 0, "Stereo Eye",
...
EnumPropertyRNA rna_SpaceView3D_stereo_3d_camera = {
	...
	-1, "stereo_3d_camera", 3, 0, 0, 0, "Camera",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252248064, NULL, NULL,
...
BoolPropertyRNA rna_SpaceView3D_show_stereo_3d_cameras = {
	...
	-1, "show_stereo_3d_cameras", 3, 0, 0, 0, "Cameras",
...
BoolPropertyRNA rna_SpaceView3D_show_stereo_3d_convergence_plane = {
	...
	-1, "show_stereo_3d_convergence_plane", 3, 0, 0, 0, "Plane",
...
FloatPropertyRNA rna_SpaceView3D_stereo_3d_convergence_plane_alpha = {
	...
	-1, "stereo_3d_convergence_plane_alpha", 3, 0, 4, 0, "Plane Alpha",
...
BoolPropertyRNA rna_SpaceView3D_show_stereo_3d_volume = {
	...
	-1, "show_stereo_3d_volume", 3, 0, 0, 0, "Volume",
...
FloatPropertyRNA rna_SpaceView3D_stereo_3d_volume_alpha = {
	...
	-1, "stereo_3d_volume_alpha", 3, 0, 4, 0, "Volume Alpha",
...
StructRNA RNA_BackgroundImages = {
	...
	"BackgroundImages", NULL, NULL, 516, NULL, "Background Images",
...
FloatPropertyRNA rna_RegionView3D_perspective_matrix = {
	...
	-1, "perspective_matrix", 2, 0, 4, 0, "Perspective Matrix",
...
FloatPropertyRNA rna_RegionView3D_window_matrix = {
	...
	-1, "window_matrix", 2, 0, 4, 0, "Window Matrix",
...
FloatPropertyRNA rna_RegionView3D_view_matrix = {
	...
	-1, "view_matrix", 3, 0, 0, 0, "View Matrix",
	"Current view matrix",
	0, "*",
	PROP_FLOAT, PROP_MATRIX | PROP_UNIT_NONE, NULL, 2, {4, 4, 0}, 16,
	NULL, 252248064, NULL, NULL,
...
EnumPropertyRNA rna_RegionView3D_view_perspective = {
	...
	-1, "view_perspective", 3, 0, 0, 0, "Perspective",
	"View Perspective",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252248064, NULL, NULL,
...
BoolPropertyRNA rna_RegionView3D_is_perspective = {
	...
	-1, "is_perspective", 3, 0, 0, 0, "Is Perspective",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_RegionView3D_use_clip_planes = {
	...
	-1, "use_clip_planes", 3, 0, 0, 0, "Use Clip Planes",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
FloatPropertyRNA rna_RegionView3D_clip_planes = {
	...
	-1, "clip_planes", 3, 0, 4, 0, "Clip Planes",
	"",
	0, "*",
...
FloatPropertyRNA rna_RegionView3D_view_location = {
	...
	-1, "view_location", 3, 0, 0, 0, "View Location",
	"View pivot location",
	0, "*",
...
FloatPropertyRNA rna_RegionView3D_view_rotation = {
	...
	-1, "view_rotation", 3, 0, 0, 0, "View Rotation",
...
FloatPropertyRNA rna_RegionView3D_view_distance = {
	...
	-1, "view_distance", 3, 0, 4, 0, "Distance",
...
FloatPropertyRNA rna_RegionView3D_view_camera_zoom = {
	...
	-1, "view_camera_zoom", 3, 0, 4, 0, "Camera Zoom",
...
FloatPropertyRNA rna_RegionView3D_view_camera_offset = {
	...
	-1, "view_camera_offset", 3, 0, 4, 0, "Camera Offset",
...
/* Properties Space */
static const EnumPropertyItem rna_SpaceProperties_context_items[15] = {
...
static const EnumPropertyItem rna_SpaceProperties_align_items[3] = {
...
static const EnumPropertyItem rna_SpaceProperties_texture_context_items[7] = {
...
EnumPropertyRNA rna_SpaceProperties_texture_context = {
	...
	-1, "texture_context", 3, 0, 0, 0, "Texture Context",
...
BoolPropertyRNA rna_SpaceProperties_use_limited_texture_context = {
	...
	-1, "use_limited_texture_context", 3, 0, 0, 0, "Limited Texture Context",
...
PointerPropertyRNA rna_SpaceProperties_pin_id = {
	...
	-1, "pin_id", 41943105, 0, 0, 0, "pin_id",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static const EnumPropertyItem rna_SpaceDopeSheetEditor_mode_items[7] = {
...
EnumPropertyRNA rna_SpaceDopeSheetEditor_mode = {
	...
	0, -1, NULL},
	SpaceDopeSheetEditor_mode_get, SpaceDopeSheetEditor_mode_set, NULL, NULL, NULL, NULL, rna_SpaceDopeSheetEditor_mode_items, 6, 0
};
...
BoolPropertyRNA rna_SpaceDopeSheetEditor_show_sliders = {
	...
	-1, "show_sliders", 3, 0, 0, 0, "Show Sliders",
...
BoolPropertyRNA rna_SpaceDopeSheetEditor_show_pose_markers = {
	...
	-1, "show_pose_markers", 3, 0, 0, 0, "Show Pose Markers",
...
BoolPropertyRNA rna_SpaceDopeSheetEditor_show_group_colors = {
	...
	-1, "show_group_colors", 3, 0, 0, 0, "Show Group Colors",
...
BoolPropertyRNA rna_SpaceDopeSheetEditor_use_auto_merge_keyframes = {
	...
	-1, "use_auto_merge_keyframes", 3, 0, 0, 0, "AutoMerge Keyframes",
...
BoolPropertyRNA rna_SpaceDopeSheetEditor_use_realtime_update = {
	...
	-1, "use_realtime_update", 3, 0, 0, 0, "Realtime Updates",
...
PointerPropertyRNA rna_SpaceDopeSheetEditor_dopesheet = {
	...
	-1, "dopesheet", 8388608, 0, 0, 0, "Dope Sheet",
...
BoolPropertyRNA rna_SpaceGraphEditor_show_handles = {
	...
	-1, "show_handles", 3, 0, 0, 0, "Show Handles",
...
BoolPropertyRNA rna_SpaceGraphEditor_use_only_selected_curves_handles = {
	...
	-1, "use_only_selected_curves_handles", 3, 0, 0, 0, "Only Selected Curve Keyframes",
...
BoolPropertyRNA rna_SpaceGraphEditor_use_only_selected_keyframe_handles = {
	...
	-1, "use_only_selected_keyframe_handles", 3, 0, 0, 0, "Only Selected Keyframes Handles",
...
BoolPropertyRNA rna_SpaceGraphEditor_use_beauty_drawing = {
	...
	-1, "use_beauty_drawing", 3, 0, 0, 0, "Use High Quality Drawing",
...
BoolPropertyRNA rna_SpaceGraphEditor_show_cursor = {
	...
	-1, "show_cursor", 3, 0, 0, 0, "Show Cursor",
	"Show 2D cursor",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252510208, NULL, NULL,
...
FloatPropertyRNA rna_SpaceGraphEditor_cursor_position_x = {
	...
	-1, "cursor_position_x", 3, 0, 4, 0, "Cursor X-Value",
	"Graph Editor 2D-Value cursor - X-Value component",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252510208, NULL, NULL,
	offsetof(SpaceIpo, cursorTime), 5, NULL},
...
FloatPropertyRNA rna_SpaceGraphEditor_cursor_position_y = {
	...
	-1, "cursor_position_y", 3, 0, 4, 0, "Cursor Y-Value",
	"Graph Editor 2D-Value cursor - Y-Value component",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252510208, NULL, NULL,
	offsetof(SpaceIpo, cursorVal), 5, NULL},
...
BoolPropertyRNA rna_SpaceGraphEditor_has_ghost_curves = {
	...
	-1, "has_ghost_curves", 2, 0, 0, 0, "Has Ghost Curves",
...
BoolPropertyRNA rna_SpaceGraphEditor_use_normalization = {
	...
	-1, "use_normalization", 3, 0, 0, 0, "Use Normalization",
...
BoolPropertyRNA rna_SpaceGraphEditor_use_auto_normalization = {
	...
	-1, "use_auto_normalization", 3, 0, 0, 0, "Auto Normalization",
...
BoolPropertyRNA rna_SpaceNLA_show_strip_curves = {
	...
	-1, "show_strip_curves", 3, 0, 0, 0, "Show Control F-Curves",
...
BoolPropertyRNA rna_SpaceNLA_show_local_markers = {
	{(PropertyRNA *)&rna_SpaceNLA_use_realtime_update, (PropertyRNA *)&rna_SpaceNLA_show_strip_curves,
	-1, "show_local_markers", 3, 0, 0, 0, "Show Local Markers",
...
BoolPropertyRNA rna_SpaceNLA_use_realtime_update = {
	{(PropertyRNA *)&rna_SpaceNLA_dopesheet, (PropertyRNA *)&rna_SpaceNLA_show_local_markers,
	-1, "use_realtime_update", 3, 0, 0, 0, "Realtime Updates",
...
BoolPropertyRNA rna_SpaceTimeline_show_cache = {
	...
	-1, "show_cache", 3, 0, 0, 0, "Show Cache",
...
BoolPropertyRNA rna_SpaceTimeline_cache_softbody = {
	...
	-1, "cache_softbody", 3, 0, 0, 0, "Softbody",
...
BoolPropertyRNA rna_SpaceTimeline_cache_particles = {
	...
	-1, "cache_particles", 3, 0, 0, 0, "Particles",
...
BoolPropertyRNA rna_SpaceTimeline_cache_dynamicpaint = {
	...
	-1, "cache_dynamicpaint", 3, 0, 0, 0, "Dynamic Paint",
...
BoolPropertyRNA rna_SpaceTimeline_cache_rigidbody = {
	...
	-1, "cache_rigidbody", 3, 0, 0, 0, "Rigid Body",
...
StructRNA RNA_SpaceTimeline = {
	...
	"SpaceTimeline", NULL, NULL, 516, NULL, "Space Timeline Editor",
...
IntPropertyRNA rna_SpaceConsole_select_start = {
	...
	-1, "select_start", 3, 0, 4, 0, "select_start",
	"",
	0, "*",
...
IntPropertyRNA rna_SpaceConsole_select_end = {
	...
	-1, "select_end", 3, 0, 4, 0, "select_end",
	"",
	0, "*",
	PROP_INT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 251723776, NULL, NULL,
...
StringPropertyRNA rna_SpaceConsole_language = {
	...
	-1, "language", 262145, 0, 0, 0, "Language",
...
IntPropertyRNA rna_ConsoleLine_current_character = {
	...
	-1, "current_character", 3, 0, 4, 0, "current_character",
	"",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 251723776, NULL, NULL,
...
BoolPropertyRNA rna_SpaceInfo_show_report_debug = {
	...
	-1, "show_report_debug", 3, 0, 0, 0, "Show Debug",
...
BoolPropertyRNA rna_SpaceInfo_show_report_info = {
	...
	-1, "show_report_info", 3, 0, 0, 0, "Show Info",
...
BoolPropertyRNA rna_SpaceInfo_show_report_operator = {
	...
	-1, "show_report_operator", 3, 0, 0, 0, "Show Operator",
...
BoolPropertyRNA rna_SpaceInfo_show_report_warning = {
	...
	-1, "show_report_warning", 3, 0, 0, 0, "Show Warn",
	"Display warnings",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 251789312, NULL, NULL,
...
BoolPropertyRNA rna_SpaceInfo_show_report_error = {
	...
	-1, "show_report_error", 3, 0, 0, 0, "Show Error",
	"Display error text",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 251789312, NULL, NULL,
...
static const EnumPropertyItem rna_SpaceUserPreferences_filter_type_items[3] = {
...
EnumPropertyRNA rna_SpaceUserPreferences_filter_type = {
	...
	-1, "filter_type", 3, 0, 0, 0, "Filter Type",
	"Filter method",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
StringPropertyRNA rna_SpaceUserPreferences_filter_text = {
	...
	-1, "filter_text", -2147221503, 0, 0, 0, "Filter",
...
StructRNA RNA_SpaceUserPreferences = {
	...
	"SpaceUserPreferences", NULL, NULL, 516, NULL, "Space User Preferences",
...
static const EnumPropertyItem rna_SpaceNodeEditor_texture_type_items[5] = {
...
EnumPropertyRNA rna_SpaceNodeEditor_texture_type = {
	...
	-1, "texture_type", 3, 0, 0, 0, "Texture Type",
...
EnumPropertyRNA rna_SpaceNodeEditor_shader_type = {
	...
	-1, "shader_type", 3, 0, 0, 0, "Shader Type",
...
PointerPropertyRNA rna_SpaceNodeEditor_id_from = {
	...
	-1, "id_from", 8388672, 0, 0, 0, "ID From",
...
PointerPropertyRNA rna_SpaceNodeEditor_node_tree = {
	...
	-1, "node_tree", 12582977, 0, 0, 0, "Node Tree",
	"Base node tree from context",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
PointerPropertyRNA rna_SpaceNodeEditor_edit_tree = {
	...
	-1, "edit_tree", 8388672, 0, 0, 0, "Edit Tree",
...
BoolPropertyRNA rna_SpaceNodeEditor_show_backdrop = {
	...
	-1, "show_backdrop", 3, 0, 0, 0, "Backdrop",
...
BoolPropertyRNA rna_SpaceNodeEditor_use_auto_render = {
	...
	-1, "use_auto_render", 3, 0, 0, 0, "Auto Render",
...
FloatPropertyRNA rna_SpaceNodeEditor_backdrop_zoom = {
	...
	-1, "backdrop_zoom", 3, 0, 4, 0, "Backdrop Zoom",
...
FloatPropertyRNA rna_SpaceNodeEditor_backdrop_x = {
	...
	-1, "backdrop_x", 3, 0, 4, 0, "Backdrop X",
	"Backdrop X offset",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252772352, NULL, NULL,
...
FloatPropertyRNA rna_SpaceNodeEditor_backdrop_y = {
	...
	-1, "backdrop_y", 3, 0, 4, 0, "Backdrop Y",
	"Backdrop Y offset",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252772352, NULL, NULL,
	offsetof(SpaceNode, yof), 5, NULL},
...
EnumPropertyRNA rna_SpaceNodeEditor_backdrop_channels = {
	{(PropertyRNA *)&rna_SpaceNodeEditor_cursor_location, (PropertyRNA *)&rna_SpaceNodeEditor_backdrop_y,
	-1, "backdrop_channels", 3, 0, 0, 0, "Draw Channels",
	"Channels of the image to draw",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252772352, NULL, NULL,
...
BoolPropertyRNA rna_SpaceNodeEditor_use_insert_offset = {
	...
	-1, "use_insert_offset", 4099, 0, 0, 0, "Auto-offset",
...
EnumPropertyRNA rna_SpaceNodeEditor_insert_offset_direction = {
	...
	-1, "insert_offset_direction", 3, 0, 0, 0, "Auto-offset Direction",
...
StringPropertyRNA rna_SpaceNodeEditorPath_to_string = {
	...
	-1, "to_string", 262144, 0, 0, 0, "to_string",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_SpaceNodeEditorPath_start_node_tree = {
	{NULL, NULL,
	-1, "node_tree", 8388608, 5, 0, 0, "Node Tree",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
/* Space Logic Editor */
StringPropertyRNA rna_SpaceLogicEditor_import_string = {
	{(PropertyRNA *)&rna_SpaceLogicEditor_show_sensors_selected_objects, NULL,
	-1, "import_string", 262145, 0, 0, 0, "Import String",
	"Import string used to find the component when adding a new component",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {64, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	SpaceLogicEditor_import_string_get, SpaceLogicEditor_import_string_length, SpaceLogicEditor_import_string_set, NULL, NULL, NULL, 64, ""
};

BoolPropertyRNA rna_SpaceLogicEditor_show_sensors_selected_objects = {
	{(PropertyRNA *)&rna_SpaceLogicEditor_show_sensors_active_object, (PropertyRNA *)&rna_SpaceLogicEditor_import_string,
	-1, "show_sensors_selected_objects", 3, 0, 0, 0, "Show Selected Object",
...
BoolPropertyRNA rna_SpaceLogicEditor_show_sensors_active_object = {
	...
	-1, "show_sensors_active_object", 3, 0, 0, 0, "Show Active Object",
...
BoolPropertyRNA rna_SpaceLogicEditor_show_sensors_linked_controller = {
	...
	-1, "show_sensors_linked_controller", 3, 0, 0, 0, "Show Linked to Controller",
...
BoolPropertyRNA rna_SpaceLogicEditor_show_sensors_active_states = {
	...
	-1, "show_sensors_active_states", 3, 0, 0, 0, "Show Active States",
...
BoolPropertyRNA rna_SpaceLogicEditor_show_controllers_selected_objects = {
	...
	-1, "show_controllers_selected_objects", 3, 0, 0, 0, "Show Selected Object",
...
BoolPropertyRNA rna_SpaceLogicEditor_show_controllers_active_object = {
	...
	-1, "show_controllers_active_object", 3, 0, 0, 0, "Show Active Object",
...
BoolPropertyRNA rna_SpaceLogicEditor_show_controllers_linked_controller = {
	...
	-1, "show_controllers_linked_controller", 3, 0, 0, 0, "Show Linked to Controller",
...
BoolPropertyRNA rna_SpaceLogicEditor_show_actuators_selected_objects = {
	...
	-1, "show_actuators_selected_objects", 3, 0, 0, 0, "Show Selected Object",
...
BoolPropertyRNA rna_SpaceLogicEditor_show_actuators_active_object = {
	...
	-1, "show_actuators_active_object", 3, 0, 0, 0, "Show Active Object",
...
BoolPropertyRNA rna_SpaceLogicEditor_show_actuators_linked_controller = {
	...
	-1, "show_actuators_linked_controller", 3, 0, 0, 0, "Show Linked to Actuator",
...
BoolPropertyRNA rna_SpaceLogicEditor_show_actuators_active_states = {
	...
	-1, "show_actuators_active_states", 3, 0, 0, 0, "Show Active States",
...
StructRNA RNA_SpaceLogicEditor = {
	...
	NULL,
	{(PropertyRNA *)&rna_SpaceLogicEditor_import_string, (PropertyRNA *)&rna_SpaceLogicEditor_show_actuators_active_states}},
	"SpaceLogicEditor", NULL, NULL, 516, NULL, "Space Logic Editor",
...
PointerPropertyRNA rna_SpaceClipEditor_clip = {
	...
	-1, "clip", 8388673, 0, 0, 0, "Movie Clip",
	"Movie clip displayed and edited in this space",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
PointerPropertyRNA rna_SpaceClipEditor_clip_user = {
	...
	-1, "clip_user", 8650752, 0, 0, 0, "Movie Clip User",
	"Parameters defining which frame of the movie clip is displayed",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252903424, NULL, NULL,
...
static const EnumPropertyItem rna_SpaceClipEditor_mask_draw_type_items[5] = {
	{0, "OUTLINE", 0, "Outline", "Draw white edges with black outline"},
	{1, "DASH", 0, "Dash", "Draw dashed black-white edges"},
	{2, "BLACK", 0, "Black", "Draw black edges"},
	{3, "WHITE", 0, "White", "Draw white edges"},
...
BoolPropertyRNA rna_SpaceClipEditor_show_marker_pattern = {
	...
	-1, "show_marker_pattern", 3, 0, 0, 0, "Show Marker Pattern",
...
BoolPropertyRNA rna_SpaceClipEditor_show_marker_search = {
	...
	-1, "show_marker_search", 3, 0, 0, 0, "Show Marker Search",
...
BoolPropertyRNA rna_SpaceClipEditor_lock_selection = {
	...
	-1, "lock_selection", 3, 0, 0, 0, "Lock to Selection",
...
BoolPropertyRNA rna_SpaceClipEditor_lock_time_cursor = {
	...
	-1, "lock_time_cursor", 3, 0, 0, 0, "Lock to Time Cursor",
...
BoolPropertyRNA rna_SpaceClipEditor_show_track_path = {
	...
	-1, "show_track_path", 3, 0, 0, 0, "Show Track Path",
...
IntPropertyRNA rna_SpaceClipEditor_path_length = {
	...
	-1, "path_length", 3, 0, 4, 0, "Path Length",
...
BoolPropertyRNA rna_SpaceClipEditor_show_tiny_markers = {
	...
	-1, "show_tiny_markers", 3, 0, 0, 0, "Show Tiny Markers",
...
BoolPropertyRNA rna_SpaceClipEditor_show_bundles = {
	...
	-1, "show_bundles", 3, 0, 0, 0, "Show Bundles",
...
BoolPropertyRNA rna_SpaceClipEditor_use_mute_footage = {
	...
	-1, "use_mute_footage", 3, 0, 0, 0, "Mute Footage",
...
BoolPropertyRNA rna_SpaceClipEditor_show_disabled = {
	...
	-1, "show_disabled", 3, 0, 0, 0, "Show Disabled",
...
BoolPropertyRNA rna_SpaceClipEditor_show_names = {
	...
	-1, "show_names", 3, 0, 0, 0, "Show Names",
...
BoolPropertyRNA rna_SpaceClipEditor_show_stable = {
	...
	-1, "show_stable", 3, 0, 0, 0, "Show Stable",
...
BoolPropertyRNA rna_SpaceClipEditor_use_manual_calibration = {
	...
	-1, "use_manual_calibration", 3, 0, 0, 0, "Manual Calibration",
...
BoolPropertyRNA rna_SpaceClipEditor_show_filters = {
	...
	-1, "show_filters", 3, 0, 0, 0, "Show Filters",
...
BoolPropertyRNA rna_SpaceClipEditor_show_graph_frames = {
	...
	-1, "show_graph_frames", 3, 0, 0, 0, "Show Frames",
...
BoolPropertyRNA rna_SpaceClipEditor_show_graph_tracks_motion = {
	...
	-1, "show_graph_tracks_motion", 3, 0, 0, 0, "Show Tracks Motion",
...
BoolPropertyRNA rna_SpaceClipEditor_show_graph_tracks_error = {
	...
	-1, "show_graph_tracks_error", 3, 0, 0, 0, "Show Tracks Error",
...
BoolPropertyRNA rna_SpaceClipEditor_show_graph_only_selected = {
	...
	-1, "show_graph_only_selected", 3, 0, 0, 0, "Only Selected",
...
BoolPropertyRNA rna_SpaceClipEditor_show_graph_hidden = {
	...
	-1, "show_graph_hidden", 3, 0, 0, 0, "Display Hidden",
...
BoolPropertyRNA rna_SpaceClipEditor_show_red_channel = {
	...
	-1, "show_red_channel", 3, 0, 0, 0, "Show Red Channel",
...
BoolPropertyRNA rna_SpaceClipEditor_show_green_channel = {
	...
	-1, "show_green_channel", 3, 0, 0, 0, "Show Green Channel",
...
BoolPropertyRNA rna_SpaceClipEditor_show_blue_channel = {
	...
	-1, "show_blue_channel", 3, 0, 0, 0, "Show Blue Channel",
...
BoolPropertyRNA rna_SpaceClipEditor_use_grayscale_preview = {
	...
	-1, "use_grayscale_preview", 3, 0, 0, 0, "Grayscale",
...
EnumPropertyRNA rna_SpaceClipEditor_grease_pencil_source = {
	...
	-1, "grease_pencil_source", 3, 0, 0, 0, "Grease Pencil Source",
