...
bool Curve_show_handles_get(PointerRNA *ptr)
{
	Curve *data = (Curve *)(ptr->data);
	return !(((data->drawflag) & 1) != 0);
}

void Curve_show_handles_set(PointerRNA *ptr, bool value)
{
	Curve *data = (Curve *)(ptr->data);
...
bool Curve_show_normal_face_get(PointerRNA *ptr)
{
	Curve *data = (Curve *)(ptr->data);
	return !(((data->drawflag) & 2) != 0);
}

void Curve_show_normal_face_set(PointerRNA *ptr, bool value)
{
	Curve *data = (Curve *)(ptr->data);
...
BoolPropertyRNA rna_Curve_show_handles = {
	...
	-1, "show_handles", 3, 0, 0, 0, "Draw Handles",
...
IntPropertyRNA rna_Curve_path_duration = {
	...
	-1, "path_duration", 3, 0, 4, 0, "Path Length",
...
BoolPropertyRNA rna_Curve_use_path_follow = {
	...
	-1, "use_path_follow", 3, 0, 0, 0, "Follow",
...
BoolPropertyRNA rna_Curve_use_deform_bounds = {
	...
	-1, "use_deform_bounds", 3, 0, 0, 0, "Bounds Clamp",
...
IntPropertyRNA rna_Curve_bevel_resolution = {
	...
	-1, "bevel_resolution", 3, 0, 4, 0, "Bevel Resolution",
...
FloatPropertyRNA rna_Curve_bevel_depth = {
	...
	-1, "bevel_depth", 3, 0, 4, 0, "Bevel Depth",
...
IntPropertyRNA rna_Curve_resolution_u = {
	...
	-1, "resolution_u", 3, 0, 4, 0, "Resolution U",
...
IntPropertyRNA rna_Curve_resolution_v = {
	...
	-1, "resolution_v", 3, 0, 4, 0, "Resolution V",
...
IntPropertyRNA rna_Curve_render_resolution_u = {
	...
	-1, "render_resolution_u", 3, 0, 4, 0, "Render Resolution U",
...
IntPropertyRNA rna_Curve_render_resolution_v = {
	...
	-1, "render_resolution_v", 3, 0, 4, 0, "Render Resolution V",
...
PointerPropertyRNA rna_Curve_bevel_object = {
	...
	-1, "bevel_object", 8388609, 0, 0, 0, "Bevel Object",
...
PointerPropertyRNA rna_Curve_taper_object = {
	...
	-1, "taper_object", 8388609, 0, 0, 0, "Taper Object",
...
EnumPropertyRNA rna_Curve_dimensions = {
	...
	-1, "dimensions", 3, 0, 0, 0, "Dimensions",
...
EnumPropertyRNA rna_Curve_twist_mode = {
	...
	-1, "twist_mode", 3, 0, 0, 0, "Twist Method",
...
EnumPropertyRNA rna_Curve_bevel_factor_mapping_start = {
	...
	-1, "bevel_factor_mapping_start", 3, 0, 0, 0, "Start Mapping Type",
...
EnumPropertyRNA rna_Curve_bevel_factor_mapping_end = {
	...
	-1, "bevel_factor_mapping_end", 3, 0, 0, 0, "End Mapping Type",
...
FloatPropertyRNA rna_Curve_twist_smooth = {
	...
	-1, "twist_smooth", 3, 0, 4, 0, "Twist Smooth",
...
BoolPropertyRNA rna_Curve_use_fill_deform = {
	...
	-1, "use_fill_deform", 3, 0, 0, 0, "Fill Deformed",
...
BoolPropertyRNA rna_Curve_use_fill_caps = {
	...
	-1, "use_fill_caps", 3, 0, 0, 0, "Fill Caps",
...
BoolPropertyRNA rna_Curve_use_map_taper = {
	...
	-1, "use_map_taper", 3, 0, 0, 0, "Map Taper",
...
BoolPropertyRNA rna_Curve_use_uv_as_generated = {
	...
	-1, "use_uv_as_generated", 3, 0, 0, 0, "Use UV for mapping",
...
FloatPropertyRNA rna_Curve_bevel_factor_start = {
	...
	-1, "bevel_factor_start", 3, 0, 4, 0, "Start Bevel Factor",
...
FloatPropertyRNA rna_Curve_bevel_factor_end = {
	...
	-1, "bevel_factor_end", 3, 0, 4, 0, "End Bevel Factor",
...
PointerPropertyRNA rna_CurveSplines_active = {
	...
	-1, "active", 8388609, 0, 0, 0, "Active Spline",
	"Active curve spline",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
EnumPropertyRNA rna_TextCurve_align_x = {
	...
	-1, "align_x", 3, 0, 0, 0, "Text Horizontal Align",
...
static const EnumPropertyItem rna_TextCurve_align_y_items[5] = {
	{0, "TOP_BASELINE", 0, "Top Base-Line", "Align to top but use the base-line of the text"},
	{1, "TOP", 0, "Top", "Align text to the top"},
	{2, "CENTER", 0, "Center", "Align text to the middle"},
	{3, "BOTTOM", 0, "Bottom", "Align text to the bottom"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_TextCurve_align_y = {
	{(PropertyRNA *)&rna_TextCurve_size, (PropertyRNA *)&rna_TextCurve_align_x,
	-1, "align_y", 3, 0, 0, 0, "Text Vertical Align",
	"Text vertical align from the object center",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Curve_update_data, 0, NULL, NULL,
	0, -1, NULL},
	TextCurve_align_y_get, TextCurve_align_y_set, NULL, NULL, NULL, NULL, rna_TextCurve_align_y_items, 4, 0
};

FloatPropertyRNA rna_TextCurve_size = {
	{(PropertyRNA *)&rna_TextCurve_small_caps_scale, (PropertyRNA *)&rna_TextCurve_align_y,
	-1, "size", 3, 0, 4, 0, "Font size",
	"",
	0, "*",
...
FloatPropertyRNA rna_TextCurve_small_caps_scale = {
	...
	-1, "small_caps_scale", 3, 0, 4, 0, "Small Caps",
...
FloatPropertyRNA rna_TextCurve_space_line = {
	...
	-1, "space_line", 3, 0, 4, 0, "Distance between lines of text",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Curve_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_TextCurve_space_word = {
	...
	-1, "space_word", 3, 0, 4, 0, "Spacing between words",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Curve_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_TextCurve_space_character = {
	...
	-1, "space_character", 3, 0, 4, 0, "Global spacing between characters",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Curve_update_data, 0, NULL, NULL,
...
FloatPropertyRNA rna_TextCurve_underline_position = {
	...
	-1, "underline_position", 3, 0, 4, 0, "Underline Position",
...
FloatPropertyRNA rna_TextCurve_underline_height = {
	...
	-1, "underline_height", 3, 0, 4, 0, "Underline Thickness",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Curve_update_data, 0, NULL, NULL,
...
CollectionPropertyRNA rna_TextCurve_text_boxes = {
	...
	-1, "text_boxes", 0, 0, 8, 0, "Textboxes",
	"",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_TextCurve_active_textbox = {
	...
	-1, "active_textbox", 3, 0, 4, 0, "The active text box",
	"",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
StringPropertyRNA rna_TextCurve_family = {
	...
	-1, "family", 262145, 0, 0, 0, "Object Font",
...
CollectionPropertyRNA rna_TextCurve_body_format = {
	...
	-1, "body_format", 0, 0, 8, 0, "Character Info",
...
PointerPropertyRNA rna_TextCurve_follow_curve = {
	...
	-1, "follow_curve", 8388609, 0, 0, 0, "Text on Curve",
...
PointerPropertyRNA rna_TextCurve_font_bold = {
	...
	-1, "font_bold", 8388673, 0, 0, 0, "Font Bold",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Curve_update_data, 0, NULL, NULL,
...
PointerPropertyRNA rna_TextCurve_font_italic = {
	...
	-1, "font_italic", 8388673, 0, 0, 0, "Font Italic",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Curve_update_data, 0, NULL, NULL,
...
PointerPropertyRNA rna_TextCurve_font_bold_italic = {
	...
	-1, "font_bold_italic", 8388673, 0, 0, 0, "Font Bold Italic",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Curve_update_data, 0, NULL, NULL,
...
PointerPropertyRNA rna_TextCurve_edit_format = {
	...
	-1, "edit_format", 8388608, 0, 0, 0, "Edit Format",
...
BoolPropertyRNA rna_TextCurve_use_fast_edit = {
	...
	-1, "use_fast_edit", 3, 0, 0, 0, "Fast Editing",
...
FloatPropertyRNA rna_TextBox_height = {
	...
	-1, "height", 3, 0, 4, 0, "Textbox Height",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Curve_update_data, 0, NULL, NULL,
...
BoolPropertyRNA rna_TextCharacterFormat_use_underline = {
	...
	-1, "use_underline", 3, 0, 0, 0, "Underline",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Curve_update_data, 0, NULL, NULL,
...
BoolPropertyRNA rna_TextCharacterFormat_use_small_caps = {
	...
	-1, "use_small_caps", 3, 0, 0, 0, "Small Caps",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Curve_update_data, 0, NULL, NULL,
...
IntPropertyRNA rna_TextCharacterFormat_material_index = {
	...
	-1, "material_index", 3, 0, 0, 0, "Material Index",
	"",
	0, "*",
...
FloatPropertyRNA rna_SplinePoint_weight_softbody = {
	...
	-1, "weight_softbody", 3, 0, 4, 0, "Weight",
...
BoolPropertyRNA rna_BezierSplinePoint_select_left_handle = {
	...
	-1, "select_left_handle", 3, 0, 4, 0, "Handle 1 selected",
...
BoolPropertyRNA rna_BezierSplinePoint_select_right_handle = {
	...
	-1, "select_right_handle", 3, 0, 4, 0, "Handle 2 selected",
...
BoolPropertyRNA rna_BezierSplinePoint_select_control_point = {
	...
	-1, "select_control_point", 3, 0, 4, 0, "Control Point selected",
...
EnumPropertyRNA rna_BezierSplinePoint_handle_left_type = {
	...
	-1, "handle_left_type", 3, 0, 0, 0, "Handle 1 Type",
	"Handle types",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
EnumPropertyRNA rna_BezierSplinePoint_handle_right_type = {
	...
	-1, "handle_right_type", 3, 0, 0, 0, "Handle 2 Type",
	"Handle types",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Curve_update_points, 0, NULL, NULL,
...
FloatPropertyRNA rna_BezierSplinePoint_handle_left = {
	...
	-1, "handle_left", 3, 0, 0, 0, "Handle 1",
...
FloatPropertyRNA rna_BezierSplinePoint_handle_right = {
	...
	-1, "handle_right", 3, 0, 0, 0, "Handle 2",
...
FloatPropertyRNA rna_BezierSplinePoint_tilt = {
	...
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Curve_update_data, 0, NULL, NULL,
	offsetof(BezTriple, alfa), 5, NULL},
...
CollectionPropertyRNA rna_Spline_bezier_points = {
	...
	-1, "bezier_points", 0, 0, 8, 0, "Bezier Points",
...
EnumPropertyRNA rna_Spline_tilt_interpolation = {
	...
	-1, "tilt_interpolation", 3, 0, 0, 0, "Tilt Interpolation",
...
EnumPropertyRNA rna_Spline_radius_interpolation = {
	...
	-1, "radius_interpolation", 3, 0, 0, 0, "Radius Interpolation",
...
IntPropertyRNA rna_Spline_point_count_u = {
	...
	-1, "point_count_u", 2, 0, 4, 0, "Points U",
...
IntPropertyRNA rna_Spline_point_count_v = {
	...
	-1, "point_count_v", 2, 0, 4, 0, "Points V",
...
BoolPropertyRNA rna_Spline_use_cyclic_u = {
	...
	-1, "use_cyclic_u", 3, 0, 0, 0, "Cyclic U",
...
BoolPropertyRNA rna_Spline_use_cyclic_v = {
	...
	-1, "use_cyclic_v", 3, 0, 0, 0, "Cyclic V",
...
BoolPropertyRNA rna_Spline_use_endpoint_u = {
	...
	-1, "use_endpoint_u", 3, 0, 0, 0, "Endpoint U",
...
BoolPropertyRNA rna_Spline_use_endpoint_v = {
	...
	-1, "use_endpoint_v", 3, 0, 0, 0, "Endpoint V",
...
BoolPropertyRNA rna_Spline_use_bezier_u = {
	...
	-1, "use_bezier_u", 3, 0, 0, 0, "Bezier U",
...
BoolPropertyRNA rna_Spline_use_bezier_v = {
	...
	-1, "use_bezier_v", 3, 0, 0, 0, "Bezier V",
...
IntPropertyRNA rna_Spline_character_index = {
	...
	-1, "character_index", 2, 0, 4, 0, "Character Index",
...
IntPropertyRNA rna_Spline_calc_length_resolution = {
	...
	-1, "resolution", 3, 0, 0, 0, "Resolution",
