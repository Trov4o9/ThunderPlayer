...
BoolPropertyRNA rna_RigidBodyJointConstraint_use_breaking;
FloatPropertyRNA rna_RigidBodyJointConstraint_breaking_threshold;
...
bool RigidBodyJointConstraint_use_linked_collision_get(PointerRNA *ptr)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	return (((data->flag) & 128) != 0);
}

void RigidBodyJointConstraint_use_linked_collision_set(PointerRNA *ptr, bool value)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	if (value) data->flag |= 128;
	else data->flag &= ~128;
...
bool RigidBodyJointConstraint_show_pivot_get(PointerRNA *ptr)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	return (((data->flag) & 64) != 0);
}

void RigidBodyJointConstraint_show_pivot_set(PointerRNA *ptr, bool value)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	if (value) data->flag |= 64;
	else data->flag &= ~64;
...
bool RigidBodyJointConstraint_use_limit_x_get(PointerRNA *ptr)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	return (((data->flag) & 1) != 0);
}

void RigidBodyJointConstraint_use_limit_x_set(PointerRNA *ptr, bool value)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	if (value) data->flag |= 1;
	else data->flag &= ~1;
...
bool RigidBodyJointConstraint_use_limit_y_get(PointerRNA *ptr)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	return (((data->flag) & 2) != 0);
}

void RigidBodyJointConstraint_use_limit_y_set(PointerRNA *ptr, bool value)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	if (value) data->flag |= 2;
	else data->flag &= ~2;
...
bool RigidBodyJointConstraint_use_limit_z_get(PointerRNA *ptr)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	return (((data->flag) & 4) != 0);
}

void RigidBodyJointConstraint_use_limit_z_set(PointerRNA *ptr, bool value)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	if (value) data->flag |= 4;
	else data->flag &= ~4;
...
bool RigidBodyJointConstraint_use_angular_limit_x_get(PointerRNA *ptr)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	return (((data->flag) & 8) != 0);
}

void RigidBodyJointConstraint_use_angular_limit_x_set(PointerRNA *ptr, bool value)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	if (value) data->flag |= 8;
	else data->flag &= ~8;
...
bool RigidBodyJointConstraint_use_angular_limit_y_get(PointerRNA *ptr)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	return (((data->flag) & 16) != 0);
}

void RigidBodyJointConstraint_use_angular_limit_y_set(PointerRNA *ptr, bool value)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	if (value) data->flag |= 16;
	else data->flag &= ~16;
...
bool RigidBodyJointConstraint_use_angular_limit_z_get(PointerRNA *ptr)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	return (((data->flag) & 32) != 0);
}

void RigidBodyJointConstraint_use_angular_limit_z_set(PointerRNA *ptr, bool value)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	if (value) data->flag |= 32;
	else data->flag &= ~32;
...
bool RigidBodyJointConstraint_use_breaking_get(PointerRNA *ptr)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	return (((data->flag) & 256) != 0);
}

void RigidBodyJointConstraint_use_breaking_set(PointerRNA *ptr, bool value)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	if (value) data->flag |= 256;
	else data->flag &= ~256;
...
float RigidBodyJointConstraint_breaking_threshold_get(PointerRNA *ptr)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	return (float)(data->breaking);
}

void RigidBodyJointConstraint_breaking_threshold_set(PointerRNA *ptr, float value)
{
	bRigidBodyJointConstraint *data = (bRigidBodyJointConstraint *)(((bConstraint *)ptr->data)->data);
	data->breaking = CLAMPIS(value, 0.0f, FLT_MAX);
}
...
EnumPropertyRNA rna_Constraint_owner_space = {
	...
	-1, "owner_space", 3, 0, 0, 0, "Owner Space",
...
EnumPropertyRNA rna_Constraint_target_space = {
	...
	-1, "target_space", 3, 0, 0, 0, "Target Space",
...
BoolPropertyRNA rna_Constraint_is_proxy_local = {
	...
	-1, "is_proxy_local", 2, 0, 0, 0, "Proxy Local",
...
FloatPropertyRNA rna_Constraint_error_location = {
	...
	-1, "error_location", 2, 0, 4, 0, "Lin error",
...
FloatPropertyRNA rna_Constraint_error_rotation = {
	...
	-1, "error_rotation", 2, 0, 4, 0, "Rot error",
...
BoolPropertyRNA rna_ChildOfConstraint_use_location_x = {
	...
	-1, "use_location_x", 3, 0, 0, 0, "Location X",
...
BoolPropertyRNA rna_ChildOfConstraint_use_location_y = {
	...
	-1, "use_location_y", 3, 0, 0, 0, "Location Y",
...
BoolPropertyRNA rna_ChildOfConstraint_use_location_z = {
	...
	-1, "use_location_z", 3, 0, 0, 0, "Location Z",
...
BoolPropertyRNA rna_ChildOfConstraint_use_rotation_x = {
	...
	-1, "use_rotation_x", 3, 0, 0, 0, "Rotation X",
...
BoolPropertyRNA rna_ChildOfConstraint_use_rotation_y = {
	...
	-1, "use_rotation_y", 3, 0, 0, 0, "Rotation Y",
...
BoolPropertyRNA rna_ChildOfConstraint_use_rotation_z = {
	...
	-1, "use_rotation_z", 3, 0, 0, 0, "Rotation Z",
...
FloatPropertyRNA rna_ChildOfConstraint_inverse_matrix = {
	...
	-1, "inverse_matrix", 1, 0, 4, 0, "Inverse Matrix",
...
IntPropertyRNA rna_PythonConstraint_target_count = {
	...
	-1, "target_count", 3, 0, 4, 0, "Number of Targets",
...
BoolPropertyRNA rna_PythonConstraint_use_targets = {
	...
	-1, "use_targets", 3, 0, 0, 0, "Use Targets",
...
BoolPropertyRNA rna_PythonConstraint_has_script_error = {
	...
	-1, "has_script_error", 2, 0, 0, 0, "Script Error",
...
BoolPropertyRNA rna_StretchToConstraint_use_bbone_shape = {
	...
	-1, "use_bbone_shape", 3, 0, 0, 0, "Follow B-Bone",
...
EnumPropertyRNA rna_StretchToConstraint_volume = {
	...
	-1, "volume", 3, 0, 0, 0, "Maintain Volume",
...
FloatPropertyRNA rna_StretchToConstraint_rest_length = {
	...
	-1, "rest_length", 3, 0, 4, 0, "Original Length",
...
FloatPropertyRNA rna_StretchToConstraint_bulge = {
	...
	-1, "bulge", 3, 0, 4, 0, "Volume Variation",
...
BoolPropertyRNA rna_StretchToConstraint_use_bulge_min = {
	...
	-1, "use_bulge_min", 3, 0, 0, 0, "Use Volume Variation Minimum",
...
BoolPropertyRNA rna_StretchToConstraint_use_bulge_max = {
	...
	-1, "use_bulge_max", 3, 0, 0, 0, "Use Volume Variation Maximum",
...
FloatPropertyRNA rna_StretchToConstraint_bulge_min = {
	...
	-1, "bulge_min", 3, 0, 4, 0, "Volume Variation Minimum",
...
FloatPropertyRNA rna_StretchToConstraint_bulge_max = {
	...
	-1, "bulge_max", 3, 0, 4, 0, "Volume Variation Maximum",
...
FloatPropertyRNA rna_StretchToConstraint_bulge_smooth = {
	...
	-1, "bulge_smooth", 3, 0, 4, 0, "Volume Variation Smoothness",
...
FloatPropertyRNA rna_FollowPathConstraint_offset_factor = {
	...
	-1, "offset_factor", 3, 0, 4, 0, "Offset Factor",
...
EnumPropertyRNA rna_FollowPathConstraint_forward_axis = {
	...
	-1, "forward_axis", 3, 0, 0, 0, "Forward Axis",
...
BoolPropertyRNA rna_FollowPathConstraint_use_curve_follow = {
	...
	-1, "use_curve_follow", 3, 0, 0, 0, "Follow Curve",
...
BoolPropertyRNA rna_FollowPathConstraint_use_fixed_location = {
	...
	-1, "use_fixed_location", 3, 0, 0, 0, "Fixed Position",
...
BoolPropertyRNA rna_FollowPathConstraint_use_curve_radius = {
	...
	-1, "use_curve_radius", 3, 0, 0, 0, "Curve Radius",
...
EnumPropertyRNA rna_LockedTrackConstraint_lock_axis = {
	...
	-1, "lock_axis", 3, 0, 0, 0, "Locked Axis",
	"Axis that points upward",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
EnumPropertyRNA rna_ActionConstraint_transform_channel = {
	...
	-1, "transform_channel", 3, 0, 0, 0, "Transform Channel",
...
BoolPropertyRNA rna_ActionConstraint_use_bone_object_action = {
	...
	-1, "use_bone_object_action", 3, 0, 0, 0, "Object Action",
...
EnumPropertyRNA rna_FloorConstraint_floor_location = {
	...
	-1, "floor_location", 3, 0, 0, 0, "Floor Location",
...
BoolPropertyRNA rna_FloorConstraint_use_rotation = {
	...
	-1, "use_rotation", 3, 0, 0, 0, "Use Rotation",
...
BoolPropertyRNA rna_TrackToConstraint_use_target_z = {
	...
	-1, "use_target_z", 3, 0, 0, 0, "Target Z",
...
PointerPropertyRNA rna_KinematicConstraint_pole_target = {
	...
	-1, "pole_target", 8388609, 0, 0, 0, "Pole Target",
...
StringPropertyRNA rna_KinematicConstraint_pole_subtarget = {
	...
	-1, "pole_subtarget", 262145, 0, 0, 0, "Pole Sub-Target",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {64, 0, 0}, 0,
	rna_Constraint_dependency_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_KinematicConstraint_pole_angle = {
	...
	-1, "pole_angle", 3, 0, 4, 0, "Pole Angle",
...
FloatPropertyRNA rna_KinematicConstraint_orient_weight = {
	...
	-1, "orient_weight", 3, 0, 4, 0, "Orientation Weight",
...
IntPropertyRNA rna_KinematicConstraint_chain_count = {
	...
	-1, "chain_count", 3, 0, 4, 0, "Chain Length",
...
EnumPropertyRNA rna_KinematicConstraint_reference_axis = {
	...
	-1, "reference_axis", 3, 0, 0, 0, "Axis Reference",
...
BoolPropertyRNA rna_KinematicConstraint_use_location = {
	...
	-1, "use_location", 3, 0, 0, 0, "Position",
...
BoolPropertyRNA rna_KinematicConstraint_lock_location_x = {
	...
	-1, "lock_location_x", 3, 0, 0, 0, "Lock X Pos",
...
BoolPropertyRNA rna_KinematicConstraint_lock_location_y = {
	...
	-1, "lock_location_y", 3, 0, 0, 0, "Lock Y Pos",
...
BoolPropertyRNA rna_KinematicConstraint_lock_location_z = {
	...
	-1, "lock_location_z", 3, 0, 0, 0, "Lock Z Pos",
...
BoolPropertyRNA rna_KinematicConstraint_use_rotation = {
	...
	-1, "use_rotation", 3, 0, 0, 0, "Rotation",
...
BoolPropertyRNA rna_KinematicConstraint_lock_rotation_x = {
	...
	-1, "lock_rotation_x", 3, 0, 0, 0, "Lock X Rot",
...
BoolPropertyRNA rna_KinematicConstraint_lock_rotation_y = {
	...
	-1, "lock_rotation_y", 3, 0, 0, 0, "Lock Y Rot",
...
BoolPropertyRNA rna_KinematicConstraint_lock_rotation_z = {
	...
	-1, "lock_rotation_z", 3, 0, 0, 0, "Lock Z Rot",
...
EnumPropertyRNA rna_KinematicConstraint_limit_mode = {
	...
	-1, "limit_mode", 3, 0, 0, 0, "Limit Mode",
...
PointerPropertyRNA rna_RigidBodyJointConstraint_child = {
	...
	-1, "child", 8388609, 0, 0, 0, "Child Object",
	"Child object",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_dependency_update, 85590016, NULL, NULL,
...
static const EnumPropertyItem rna_RigidBodyJointConstraint_pivot_type_items[5] = {
...
EnumPropertyRNA rna_RigidBodyJointConstraint_pivot_type = {
	...
	-1, "pivot_type", 3, 0, 0, 0, "Pivot Type",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_RigidBodyJointConstraint_pivot_x = {
	...
	-1, "pivot_x", 3, 0, 4, 0, "Pivot X",
	"Offset pivot on X",
	0, "*",
	PROP_FLOAT, PROP_DISTANCE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, pivX), 5, NULL},
...
FloatPropertyRNA rna_RigidBodyJointConstraint_pivot_y = {
	...
	-1, "pivot_y", 3, 0, 4, 0, "Pivot Y",
	"Offset pivot on Y",
	0, "*",
	PROP_FLOAT, PROP_DISTANCE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, pivY), 5, NULL},
...
FloatPropertyRNA rna_RigidBodyJointConstraint_pivot_z = {
	...
	-1, "pivot_z", 3, 0, 4, 0, "Pivot Z",
	"Offset pivot on Z",
	0, "*",
	PROP_FLOAT, PROP_DISTANCE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, pivZ), 5, NULL},
...
FloatPropertyRNA rna_RigidBodyJointConstraint_axis_x = {
	...
	-1, "axis_x", 3, 0, 4, 0, "Axis X",
	"Rotate pivot on X axis",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, axX), 5, NULL},
...
FloatPropertyRNA rna_RigidBodyJointConstraint_axis_y = {
	...
	-1, "axis_y", 3, 0, 4, 0, "Axis Y",
	"Rotate pivot on Y axis",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, axY), 5, NULL},
...
FloatPropertyRNA rna_RigidBodyJointConstraint_axis_z = {
	...
	-1, "axis_z", 3, 0, 4, 0, "Axis Z",
	"Rotate pivot on Z axis",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, axZ), 5, NULL},
...
BoolPropertyRNA rna_RigidBodyJointConstraint_use_linked_collision = {
	...
	-1, "use_linked_collision", 3, 0, 0, 0, "Disable Linked Collision",
...
BoolPropertyRNA rna_RigidBodyJointConstraint_show_pivot = {
	...
	-1, "show_pivot", 3, 0, 0, 0, "Draw Pivot",
...
FloatPropertyRNA rna_RigidBodyJointConstraint_limit_min_x = {
	...
	-1, "limit_min_x", 3, 0, 4, 0, "Minimum Limit X",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, minLimit[0]), 5, NULL},
...
FloatPropertyRNA rna_RigidBodyJointConstraint_limit_min_y = {
	...
	-1, "limit_min_y", 3, 0, 4, 0, "Minimum Limit Y",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, minLimit[1]), 5, NULL},
...
FloatPropertyRNA rna_RigidBodyJointConstraint_limit_min_z = {
	...
	-1, "limit_min_z", 3, 0, 4, 0, "Minimum Limit Z",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, minLimit[2]), 5, NULL},
...
FloatPropertyRNA rna_RigidBodyJointConstraint_limit_max_x = {
	...
	-1, "limit_max_x", 3, 0, 4, 0, "Maximum Limit X",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, maxLimit[0]), 5, NULL},
...
FloatPropertyRNA rna_RigidBodyJointConstraint_limit_max_y = {
	...
	-1, "limit_max_y", 3, 0, 4, 0, "Maximum Limit Y",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, maxLimit[1]), 5, NULL},
...
FloatPropertyRNA rna_RigidBodyJointConstraint_limit_max_z = {
	...
	-1, "limit_max_z", 3, 0, 4, 0, "Maximum Limit Z",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, maxLimit[2]), 5, NULL},
...
FloatPropertyRNA rna_RigidBodyJointConstraint_limit_angle_min_x = {
	...
	-1, "limit_angle_min_x", 3, 0, 4, 0, "Minimum Angular Limit X",
	"",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, minLimit[3]), 5, NULL},
...
FloatPropertyRNA rna_RigidBodyJointConstraint_limit_angle_min_y = {
	...
	-1, "limit_angle_min_y", 3, 0, 4, 0, "Minimum Angular Limit Y",
	"",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, minLimit[4]), 5, NULL},
...
FloatPropertyRNA rna_RigidBodyJointConstraint_limit_angle_min_z = {
	...
	-1, "limit_angle_min_z", 3, 0, 4, 0, "Minimum Angular Limit Z",
	"",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, minLimit[5]), 5, NULL},
...
FloatPropertyRNA rna_RigidBodyJointConstraint_limit_angle_max_x = {
	...
	-1, "limit_angle_max_x", 3, 0, 4, 0, "Maximum Angular Limit X",
	"",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, maxLimit[3]), 5, NULL},
...
FloatPropertyRNA rna_RigidBodyJointConstraint_limit_angle_max_y = {
	...
	-1, "limit_angle_max_y", 3, 0, 4, 0, "Maximum Angular Limit Y",
	"",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, maxLimit[4]), 5, NULL},
...
FloatPropertyRNA rna_RigidBodyJointConstraint_limit_angle_max_z = {
	...
	-1, "limit_angle_max_z", 3, 0, 4, 0, "Maximum Angular Limit Z",
	"",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, maxLimit[5]), 5, NULL},
...
BoolPropertyRNA rna_RigidBodyJointConstraint_use_angular_limit_x = {
	...
	-1, "use_angular_limit_x", 3, 0, 0, 0, "Angular X Limit",
...
BoolPropertyRNA rna_RigidBodyJointConstraint_use_angular_limit_y = {
	...
	-1, "use_angular_limit_y", 3, 0, 0, 0, "Angular Y Limit",
...
BoolPropertyRNA rna_RigidBodyJointConstraint_use_angular_limit_z = {
	{(PropertyRNA *)&rna_RigidBodyJointConstraint_use_breaking, (PropertyRNA *)&rna_RigidBodyJointConstraint_use_angular_limit_y,
	-1, "use_angular_limit_z", 3, 0, 0, 0, "Angular Z Limit",
...
BoolPropertyRNA rna_RigidBodyJointConstraint_use_breaking = {
	{(PropertyRNA *)&rna_RigidBodyJointConstraint_breaking_threshold, (PropertyRNA *)&rna_RigidBodyJointConstraint_use_angular_limit_z,
	-1, "use_breaking", 3, 0, 0, 0, "Use Breaking",
	"Allow breaking on high impulse",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	RigidBodyJointConstraint_use_breaking_get, RigidBodyJointConstraint_use_breaking_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

FloatPropertyRNA rna_RigidBodyJointConstraint_breaking_threshold = {
	{NULL, (PropertyRNA *)&rna_RigidBodyJointConstraint_use_breaking,
	-1, "breaking_threshold", 3, 0, 4, 0, "Breaking Impulse Threshold",
	"Break on impulse greater than threshold",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(bRigidBodyJointConstraint, breaking), 5, NULL},
	RigidBodyJointConstraint_breaking_threshold_get, RigidBodyJointConstraint_breaking_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

StructRNA RNA_RigidBodyJointConstraint = {
	{(ContainerRNA *)&RNA_ClampToConstraint, (ContainerRNA *)&RNA_KinematicConstraint,
	NULL,
	{(PropertyRNA *)&rna_RigidBodyJointConstraint_target, (PropertyRNA *)&rna_RigidBodyJointConstraint_breaking_threshold}},
	"RigidBodyJointConstraint", NULL, NULL, 516, NULL, "Rigid Body Joint Constraint",
...
BoolPropertyRNA rna_LimitDistanceConstraint_use_transform_limit = {
	...
	-1, "use_transform_limit", 3, 0, 0, 0, "For Transform",
...
EnumPropertyRNA rna_TransformConstraint_map_to_x_from = {
	...
	-1, "map_to_x_from", 3, 0, 0, 0, "Map To X From",
...
EnumPropertyRNA rna_TransformConstraint_map_to_y_from = {
	...
	-1, "map_to_y_from", 3, 0, 0, 0, "Map To Y From",
...
EnumPropertyRNA rna_TransformConstraint_map_to_z_from = {
	...
	-1, "map_to_z_from", 3, 0, 0, 0, "Map To Z From",
...
BoolPropertyRNA rna_TransformConstraint_use_motion_extrapolate = {
	...
	-1, "use_motion_extrapolate", 3, 0, 0, 0, "Extrapolate Motion",
	"Extrapolate ranges",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_from_min_x = {
	...
	-1, "from_min_x", 3, 0, 4, 0, "From Minimum X",
...
FloatPropertyRNA rna_TransformConstraint_from_min_y = {
	...
	-1, "from_min_y", 3, 0, 4, 0, "From Minimum Y",
...
FloatPropertyRNA rna_TransformConstraint_from_min_z = {
	...
	-1, "from_min_z", 3, 0, 4, 0, "From Minimum Z",
...
FloatPropertyRNA rna_TransformConstraint_from_max_x = {
	...
	-1, "from_max_x", 3, 0, 4, 0, "From Maximum X",
...
FloatPropertyRNA rna_TransformConstraint_from_max_y = {
	...
	-1, "from_max_y", 3, 0, 4, 0, "From Maximum Y",
...
FloatPropertyRNA rna_TransformConstraint_from_max_z = {
	...
	-1, "from_max_z", 3, 0, 4, 0, "From Maximum Z",
...
FloatPropertyRNA rna_TransformConstraint_to_min_x = {
	...
	-1, "to_min_x", 3, 0, 4, 0, "To Minimum X",
...
FloatPropertyRNA rna_TransformConstraint_to_min_y = {
	...
	-1, "to_min_y", 3, 0, 4, 0, "To Minimum Y",
...
FloatPropertyRNA rna_TransformConstraint_to_min_z = {
	...
	-1, "to_min_z", 3, 0, 4, 0, "To Minimum Z",
...
FloatPropertyRNA rna_TransformConstraint_to_max_x = {
	...
	-1, "to_max_x", 3, 0, 4, 0, "To Maximum X",
...
FloatPropertyRNA rna_TransformConstraint_to_max_y = {
	...
	-1, "to_max_y", 3, 0, 4, 0, "To Maximum Y",
...
FloatPropertyRNA rna_TransformConstraint_to_max_z = {
	...
	-1, "to_max_z", 3, 0, 4, 0, "To Maximum Z",
...
FloatPropertyRNA rna_TransformConstraint_from_min_x_rot = {
	...
	-1, "from_min_x_rot", 3, 0, 4, 0, "From Minimum X",
	"Bottom range of X axis source motion",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_from_min_y_rot = {
	...
	-1, "from_min_y_rot", 3, 0, 4, 0, "From Minimum Y",
	"Bottom range of Y axis source motion",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_from_min_z_rot = {
	...
	-1, "from_min_z_rot", 3, 0, 4, 0, "From Minimum Z",
	"Bottom range of Z axis source motion",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_from_max_x_rot = {
	...
	-1, "from_max_x_rot", 3, 0, 4, 0, "From Maximum X",
	"Top range of X axis source motion",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_from_max_y_rot = {
	...
	-1, "from_max_y_rot", 3, 0, 4, 0, "From Maximum Y",
	"Top range of Y axis source motion",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_from_max_z_rot = {
	...
	-1, "from_max_z_rot", 3, 0, 4, 0, "From Maximum Z",
	"Top range of Z axis source motion",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_to_min_x_rot = {
	...
	-1, "to_min_x_rot", 3, 0, 4, 0, "To Minimum X",
	"Bottom range of X axis destination motion",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_to_min_y_rot = {
	...
	-1, "to_min_y_rot", 3, 0, 4, 0, "To Minimum Y",
	"Bottom range of Y axis destination motion",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_to_min_z_rot = {
	...
	-1, "to_min_z_rot", 3, 0, 4, 0, "To Minimum Z",
	"Bottom range of Z axis destination motion",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_to_max_x_rot = {
	...
	-1, "to_max_x_rot", 3, 0, 4, 0, "To Maximum X",
	"Top range of X axis destination motion",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_to_max_y_rot = {
	...
	-1, "to_max_y_rot", 3, 0, 4, 0, "To Maximum Y",
	"Top range of Y axis destination motion",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_to_max_z_rot = {
	...
	-1, "to_max_z_rot", 3, 0, 4, 0, "To Maximum Z",
	"Top range of Z axis destination motion",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_from_min_x_scale = {
	...
	-1, "from_min_x_scale", 3, 0, 4, 0, "From Minimum X",
	"Bottom range of X axis source motion",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_from_min_y_scale = {
	...
	-1, "from_min_y_scale", 3, 0, 4, 0, "From Minimum Y",
	"Bottom range of Y axis source motion",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_from_min_z_scale = {
	...
	-1, "from_min_z_scale", 3, 0, 4, 0, "From Minimum Z",
	"Bottom range of Z axis source motion",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_from_max_x_scale = {
	...
	-1, "from_max_x_scale", 3, 0, 4, 0, "From Maximum X",
	"Top range of X axis source motion",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_from_max_y_scale = {
	...
	-1, "from_max_y_scale", 3, 0, 4, 0, "From Maximum Y",
	"Top range of Y axis source motion",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_from_max_z_scale = {
	...
	-1, "from_max_z_scale", 3, 0, 4, 0, "From Maximum Z",
	"Top range of Z axis source motion",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_to_min_x_scale = {
	...
	-1, "to_min_x_scale", 3, 0, 4, 0, "To Minimum X",
	"Bottom range of X axis destination motion",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_to_min_y_scale = {
	...
	-1, "to_min_y_scale", 3, 0, 4, 0, "To Minimum Y",
	"Bottom range of Y axis destination motion",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_to_min_z_scale = {
	...
	-1, "to_min_z_scale", 3, 0, 4, 0, "To Minimum Z",
	"Bottom range of Z axis destination motion",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_to_max_x_scale = {
	...
	-1, "to_max_x_scale", 3, 0, 4, 0, "To Maximum X",
	"Top range of X axis destination motion",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_to_max_y_scale = {
	...
	-1, "to_max_y_scale", 3, 0, 4, 0, "To Maximum Y",
	"Top range of Y axis destination motion",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
FloatPropertyRNA rna_TransformConstraint_to_max_z_scale = {
	...
	-1, "to_max_z_scale", 3, 0, 4, 0, "To Maximum Z",
	"Top range of Z axis destination motion",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
static const EnumPropertyItem rna_ShrinkwrapConstraint_shrinkwrap_type_items[4] = {
...
EnumPropertyRNA rna_ShrinkwrapConstraint_shrinkwrap_type = {
	...
	-1, "shrinkwrap_type", 3, 0, 0, 0, "Shrinkwrap Type",
...
EnumPropertyRNA rna_ShrinkwrapConstraint_project_axis = {
	...
	-1, "project_axis", 3, 0, 0, 0, "Project Axis",
	"Axis constrain to",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
...
EnumPropertyRNA rna_ShrinkwrapConstraint_project_axis_space = {
	...
	-1, "project_axis_space", 3, 0, 0, 0, "Axis Space",
...
FloatPropertyRNA rna_ShrinkwrapConstraint_project_limit = {
	...
	-1, "project_limit", 3, 0, 4, 0, "Project Distance",
...
FloatPropertyRNA rna_SplineIKConstraint_joint_bindings = {
	...
	-1, "joint_bindings", 131075, 0, 0, 0, "Joint Bindings",
...
BoolPropertyRNA rna_SplineIKConstraint_use_chain_offset = {
	...
	-1, "use_chain_offset", 3, 0, 0, 0, "Chain Offset",
...
BoolPropertyRNA rna_SplineIKConstraint_use_even_divisions = {
	...
	-1, "use_even_divisions", 3, 0, 0, 0, "Even Divisions",
...
BoolPropertyRNA rna_SplineIKConstraint_use_y_stretch = {
	...
	-1, "use_y_stretch", 3, 0, 0, 0, "Y Stretch",
...
BoolPropertyRNA rna_SplineIKConstraint_use_curve_radius = {
	...
	-1, "use_curve_radius", 3, 0, 0, 0, "Use Curve Radius",
...
EnumPropertyRNA rna_SplineIKConstraint_xz_scale_mode = {
	...
	-1, "xz_scale_mode", 3, 0, 0, 0, "XZ Scale Mode",
...
BoolPropertyRNA rna_PivotConstraint_use_relative_location = {
	...
	-1, "use_relative_location", 3, 0, 0, 0, "Use Relative Offset",
...
EnumPropertyRNA rna_PivotConstraint_rotation_range = {
	...
	-1, "rotation_range", 3, 0, 0, 0, "Enabled Rotation Range",
...
BoolPropertyRNA rna_FollowTrackConstraint_use_active_clip = {
	...
	-1, "use_active_clip", 3, 0, 0, 0, "Active Clip",
...
BoolPropertyRNA rna_FollowTrackConstraint_use_3d_position = {
	...
	-1, "use_3d_position", 3, 0, 0, 0, "3D Position",
...
PointerPropertyRNA rna_FollowTrackConstraint_depth_object = {
	...
	-1, "depth_object", 8388609, 0, 0, 0, "Depth Object",
...
BoolPropertyRNA rna_FollowTrackConstraint_use_undistorted_position = {
	...
	-1, "use_undistorted_position", 3, 0, 0, 0, "Undistort",
...
PointerPropertyRNA rna_TransformCacheConstraint_cache_file = {
	...
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_dependency_update, 0, NULL, NULL,
	0, -1, NULL},
...
StringPropertyRNA rna_TransformCacheConstraint_object_path = {
	...
	rna_Constraint_transformCache_object_path_update, 0, NULL, NULL,
	0, -1, NULL},
