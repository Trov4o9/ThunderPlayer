...
bool DopeSheet_show_only_group_objects_get(PointerRNA *ptr)
{
	bDopeSheet *data = (bDopeSheet *)(ptr->data);
	return (((data->filterflag) & 32) != 0);
}

void DopeSheet_show_only_group_objects_set(PointerRNA *ptr, bool value)
{
	bDopeSheet *data = (bDopeSheet *)(ptr->data);
...
bool DopeSheet_show_only_matching_fcurves_get(PointerRNA *ptr)
{
	bDopeSheet *data = (bDopeSheet *)(ptr->data);
	return (((data->filterflag) & 134217728) != 0);
}

void DopeSheet_show_only_matching_fcurves_set(PointerRNA *ptr, bool value)
{
	bDopeSheet *data = (bDopeSheet *)(ptr->data);
...
bool DopeSheet_use_filter_text_get(PointerRNA *ptr)
{
	bDopeSheet *data = (bDopeSheet *)(ptr->data);
	return (((data->filterflag) & 134217728) != 0);
}

void DopeSheet_use_filter_text_set(PointerRNA *ptr, bool value)
{
	bDopeSheet *data = (bDopeSheet *)(ptr->data);
	if (value) data->filterflag |= 134217728;
	else data->filterflag &= ~134217728;
...
bool DopeSheet_show_lamps_get(PointerRNA *ptr)
{
	bDopeSheet *data = (bDopeSheet *)(ptr->data);
	return !(((data->filterflag) & 4096) != 0);
}

void DopeSheet_show_lamps_set(PointerRNA *ptr, bool value)
{
	bDopeSheet *data = (bDopeSheet *)(ptr->data);
...
CollectionPropertyRNA rna_Action_pose_markers = {
	...
	-1, "pose_markers", 65536, 0, 0, 0, "Pose Markers",
...
FloatPropertyRNA rna_Action_frame_range = {
	...
	-1, "frame_range", 2, 0, 0, 0, "Frame Range",
...
static const EnumPropertyItem rna_Action_id_root_items[34] = {
...
EnumPropertyRNA rna_Action_id_root = {
	...
	-1, "id_root", 3, 0, 0, 0, "ID Root Type",
	"Type of ID block that action can be used on - DO NOT CHANGE UNLESS YOU KNOW WHAT YOU ARE DOING",
	0, "ID",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Action_id_root_get, Action_id_root_set, NULL, NULL, NULL, NULL, rna_Action_id_root_items, 33, 17217
};
...
StringPropertyRNA rna_ActionFCurves_new_data_path = {
	...
	-1, "data_path", 262145, 1, 0, 0, "Data Path",
...
StringPropertyRNA rna_ActionFCurves_new_action_group = {
	...
	-1, "action_group", 262145, 0, 0, 0, "Action Group",
...
PointerPropertyRNA rna_ActionPoseMarkers_active = {
	...
	-1, "active", 8454145, 0, 0, 0, "Active Pose Marker",
...
IntPropertyRNA rna_ActionPoseMarkers_active_index = {
	...
	-1, "active_index", 65539, 0, 0, 0, "Active Pose Marker Index",
...
BoolPropertyRNA rna_ActionGroup_show_expanded = {
	...
	-1, "show_expanded", 3, 0, 0, 0, "Expanded",
...
BoolPropertyRNA rna_DopeSheet_show_datablock_filters = {
	...
	-1, "show_datablock_filters", 4099, 0, 0, 0, "Show Datablock Filters",
...
BoolPropertyRNA rna_DopeSheet_use_datablock_sort = {
	...
	-1, "use_datablock_sort", 3, 0, 0, 0, "Sort Data-Blocks",
...
BoolPropertyRNA rna_DopeSheet_show_only_errors = {
	{(PropertyRNA *)&rna_DopeSheet_show_only_group_objects, (PropertyRNA *)&rna_DopeSheet_use_datablock_sort,
	-1, "show_only_errors", 3, 0, 0, 0, "Show Errors",
...
BoolPropertyRNA rna_DopeSheet_show_only_group_objects = {
	...
	-1, "show_only_group_objects", 3, 0, 0, 0, "Only Objects in Group",
...
PointerPropertyRNA rna_DopeSheet_filter_group = {
	...
	-1, "filter_group", 8388609, 0, 0, 0, "Filtering Group",
...
BoolPropertyRNA rna_DopeSheet_show_only_matching_fcurves = {
	...
	-1, "show_only_matching_fcurves", 3, 0, 0, 0, "Only Matching F-Curves",
...
StringPropertyRNA rna_DopeSheet_filter_fcurve_name = {
	...
	-1, "filter_fcurve_name", -2147221503, 0, 0, 0, "F-Curve Name Filter",
...
BoolPropertyRNA rna_DopeSheet_use_filter_text = {
	...
	-1, "use_filter_text", 3, 0, 0, 0, "Only Matching Channels",
...
StringPropertyRNA rna_DopeSheet_filter_text = {
	{(PropertyRNA *)&rna_DopeSheet_use_multi_word_filter, (PropertyRNA *)&rna_DopeSheet_use_filter_text,
	-1, "filter_text", -2147221503, 0, 0, 0, "Name Filter",
...
BoolPropertyRNA rna_DopeSheet_use_multi_word_filter = {
	...
	-1, "use_multi_word_filter", 3, 0, 0, 0, "Multi-Word Fuzzy Filter",
...
BoolPropertyRNA rna_DopeSheet_show_missing_nla = {
	...
	-1, "show_missing_nla", 3, 0, 0, 0, "Include Missing NLA",
...
BoolPropertyRNA rna_DopeSheet_show_summary = {
	...
	-1, "show_summary", 3, 0, 0, 0, "Display Summary",
...
BoolPropertyRNA rna_DopeSheet_show_expanded_summary = {
	...
	-1, "show_expanded_summary", 3, 0, 0, 0, "Collapse Summary",
...
BoolPropertyRNA rna_DopeSheet_show_transforms = {
	...
	-1, "show_transforms", 3, 0, 0, 0, "Display Transforms",
...
BoolPropertyRNA rna_DopeSheet_show_shapekeys = {
	...
	-1, "show_shapekeys", 3, 0, 0, 0, "Display Shapekeys",
...
BoolPropertyRNA rna_DopeSheet_show_modifiers = {
	...
	-1, "show_modifiers", 3, 0, 0, 0, "Display Modifier Data",
...
BoolPropertyRNA rna_DopeSheet_show_meshes = {
	...
	-1, "show_meshes", 3, 0, 0, 0, "Display Meshes",
...
BoolPropertyRNA rna_DopeSheet_show_lattices = {
	...
	-1, "show_lattices", 3, 0, 0, 0, "Display Lattices",
...
BoolPropertyRNA rna_DopeSheet_show_cameras = {
	...
	-1, "show_cameras", 3, 0, 0, 0, "Display Camera",
...
BoolPropertyRNA rna_DopeSheet_show_materials = {
	...
	-1, "show_materials", 3, 0, 0, 0, "Display Material",
...
BoolPropertyRNA rna_DopeSheet_show_lamps = {
	...
	-1, "show_lamps", 3, 0, 0, 0, "Display Lamp",
...
BoolPropertyRNA rna_DopeSheet_show_linestyles = {
	...
	-1, "show_linestyles", 3, 0, 0, 0, "Display Line Style",
...
BoolPropertyRNA rna_DopeSheet_show_textures = {
	...
	-1, "show_textures", 3, 0, 0, 0, "Display Texture",
...
BoolPropertyRNA rna_DopeSheet_show_curves = {
	...
	-1, "show_curves", 3, 0, 0, 0, "Display Curve",
...
BoolPropertyRNA rna_DopeSheet_show_worlds = {
	...
	-1, "show_worlds", 3, 0, 0, 0, "Display World",
...
BoolPropertyRNA rna_DopeSheet_show_scenes = {
	...
	-1, "show_scenes", 3, 0, 0, 0, "Display Scene",
...
BoolPropertyRNA rna_DopeSheet_show_particles = {
	...
	-1, "show_particles", 3, 0, 0, 0, "Display Particle",
...
BoolPropertyRNA rna_DopeSheet_show_metaballs = {
	...
	-1, "show_metaballs", 3, 0, 0, 0, "Display Metaball",
...
BoolPropertyRNA rna_DopeSheet_show_armatures = {
	...
	-1, "show_armatures", 3, 0, 0, 0, "Display Armature",
...
BoolPropertyRNA rna_DopeSheet_show_nodes = {
	...
	-1, "show_nodes", 3, 0, 0, 0, "Display Node",
...
BoolPropertyRNA rna_DopeSheet_show_speakers = {
	...
	-1, "show_speakers", 3, 0, 0, 0, "Display Speaker",
...
BoolPropertyRNA rna_DopeSheet_show_gpencil = {
	...
	-1, "show_gpencil", 3, 0, 0, 0, "Display Grease Pencil",
...
BoolPropertyRNA rna_DopeSheet_show_gpencil_3d_only = {
	...
	-1, "show_gpencil_3d_only", 3, 0, 0, 0, "Active Scene Only",
