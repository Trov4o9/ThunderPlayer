...
StringPropertyRNA rna_UserPreferences_app_template;
...
IntPropertyRNA rna_UserPreferences_version;
...
FloatPropertyRNA rna_UserPreferencesView_ui_scale;
EnumPropertyRNA rna_UserPreferencesView_ui_line_width;
BoolPropertyRNA rna_UserPreferencesView_show_tooltips;
BoolPropertyRNA rna_UserPreferencesView_show_tooltips_python;
BoolPropertyRNA rna_UserPreferencesView_show_developer_ui;
...
BoolPropertyRNA rna_UserPreferencesView_show_layout_ui;
BoolPropertyRNA rna_UserPreferencesView_show_view3d_cursor;
...
BoolPropertyRNA rna_UserPreferencesView_use_cursor_lock_adjust;
...
BoolPropertyRNA rna_UserPreferencesInput_use_ndof;
...
EnumPropertyRNA rna_UserPreferencesSystem_text_hinting;
EnumPropertyRNA rna_UserPreferencesSystem_select_method;
BoolPropertyRNA rna_UserPreferencesSystem_use_select_pick_depth;
EnumPropertyRNA rna_UserPreferencesSystem_multi_sample;
BoolPropertyRNA rna_UserPreferencesSystem_use_region_overlap;
EnumPropertyRNA rna_UserPreferencesSystem_opensubdiv_compute_type;
IntPropertyRNA rna_UserPreferencesSystem_legacy_compute_device_type;
...
bool ThemePanelColors_show_header_get(PointerRNA *ptr)
{
	uiPanelColors *data = (uiPanelColors *)(ptr->data);
	return (bool)(data->show_header);
}

void ThemePanelColors_show_header_set(PointerRNA *ptr, bool value)
{
	uiPanelColors *data = (uiPanelColors *)(ptr->data);
	data->show_header = value;
}

bool ThemePanelColors_show_back_get(PointerRNA *ptr)
{
	uiPanelColors *data = (uiPanelColors *)(ptr->data);
	return (bool)(data->show_back);
}

void ThemePanelColors_show_back_set(PointerRNA *ptr, bool value)
{
	uiPanelColors *data = (uiPanelColors *)(ptr->data);
...
void ThemeGradientColors_gradient_set(PointerRNA *ptr, const float values[3])
{
	...
	for (i = 0; i < 3; i++) {
		data->gradient[i] = unit_float_to_uchar_clamp(values[i]);
	}
}
...
void ThemeGradientColors_high_gradient_set(PointerRNA *ptr, const float values[3])
{
	...
	for (i = 0; i < 3; i++) {
		data->high_gradient[i] = unit_float_to_uchar_clamp(values[i]);
	}
}
...
void UserPreferences_app_template_get(PointerRNA *ptr, char *value)
{
	UserDef *data = (UserDef *)(ptr->data);
	BLI_strncpy_utf8(value, data->app_template, 64);
}

int UserPreferences_app_template_length(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return strlen(data->app_template);
}

void UserPreferences_app_template_set(PointerRNA *ptr, const char *value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
void UserPreferences_version_get(PointerRNA *ptr, int values[3])
{
...
float UserPreferencesView_ui_scale_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (float)(data->ui_scale);
}

void UserPreferencesView_ui_scale_set(PointerRNA *ptr, float value)
{
	UserDef *data = (UserDef *)(ptr->data);
	data->ui_scale = CLAMPIS(value, 0.2500000000f, 4.0f);
}

int UserPreferencesView_ui_line_width_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (int)(data->ui_line_width);
}

void UserPreferencesView_ui_line_width_set(PointerRNA *ptr, int value)
{
	UserDef *data = (UserDef *)(ptr->data);
	data->ui_line_width = value;
}

bool UserPreferencesView_show_tooltips_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->flag) & 2048) != 0);
}

void UserPreferencesView_show_tooltips_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_show_tooltips_python_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return !(((data->flag) & 67108864) != 0);
}

void UserPreferencesView_show_tooltips_python_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_show_developer_ui_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->flag) & 1024) != 0);
}

void UserPreferencesView_show_developer_ui_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_show_object_info_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 16) != 0);
}

void UserPreferencesView_show_object_info_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_use_global_scene_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->flag) & 16) != 0);
}

void UserPreferencesView_use_global_scene_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_show_large_cursors_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (bool)(data->curssize);
}

void UserPreferencesView_show_large_cursors_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
	data->curssize = value;
}

bool UserPreferencesView_show_view_name_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 262144) != 0);
}

void UserPreferencesView_show_view_name_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_show_splash_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return !(((data->uiflag) & 134217728) != 0);
}

void UserPreferencesView_show_splash_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_show_playback_fps_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 2097152) != 0);
}

void UserPreferencesView_show_playback_fps_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_show_layout_ui_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return !(((data->app_flag) & 1) != 0);
}

void UserPreferencesView_show_layout_ui_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_show_view3d_cursor_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return !(((data->app_flag) & 2) != 0);
}

void UserPreferencesView_show_view3d_cursor_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
	if (!value) data->app_flag |= 2;
	else data->app_flag &= ~2;
}

bool UserPreferencesView_use_mouse_over_open_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 512) != 0);
}

void UserPreferencesView_use_mouse_over_open_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_use_quit_dialog_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 1073741824) != 0);
}

void UserPreferencesView_use_quit_dialog_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_show_column_layout_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 32) != 0);
}

void UserPreferencesView_show_column_layout_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_use_directional_menus_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return !(((data->uiflag) & 8388608) != 0);
}

void UserPreferencesView_use_directional_menus_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_use_global_pivot_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 4096) != 0);
}

void UserPreferencesView_use_global_pivot_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_use_mouse_depth_navigate_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 32768) != 0);
}

void UserPreferencesView_use_mouse_depth_navigate_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_use_mouse_depth_cursor_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 1024) != 0);
}

void UserPreferencesView_use_mouse_depth_cursor_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_use_cursor_lock_adjust_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 64) != 0);
}

void UserPreferencesView_use_cursor_lock_adjust_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_use_camera_lock_parent_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return !(((data->uiflag) & 524288) != 0);
}

void UserPreferencesView_use_camera_lock_parent_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_use_zoom_to_mouse_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 1048576) != 0);
}

void UserPreferencesView_use_zoom_to_mouse_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_use_auto_perspective_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 2048) != 0);
}

void UserPreferencesView_use_auto_perspective_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_use_rotate_around_active_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 16384) != 0);
}

void UserPreferencesView_use_rotate_around_active_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_show_mini_axis_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 131072) != 0);
}

void UserPreferencesView_show_mini_axis_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesView_show_manipulator_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->tw_flag) & 1) != 0);
}

void UserPreferencesView_show_manipulator_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_enter_edit_mode_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->flag) & 262144) != 0);
}

void UserPreferencesEdit_use_enter_edit_mode_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_drag_immediately_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->flag) & 2097152) != 0);
}

void UserPreferencesEdit_use_drag_immediately_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_global_undo_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 8192) != 0);
}

void UserPreferencesEdit_use_global_undo_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_auto_keying_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->autokey_mode) & 1) != 0);
}

void UserPreferencesEdit_use_auto_keying_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_keyframe_insert_available_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->autokey_flag) & 1) != 0);
}

void UserPreferencesEdit_use_keyframe_insert_available_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_auto_keying_warning_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return !(((data->autokey_flag) & 128) != 0);
}

void UserPreferencesEdit_use_auto_keying_warning_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_keyframe_insert_needed_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->autokey_flag) & 2) != 0);
}

void UserPreferencesEdit_use_keyframe_insert_needed_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_visual_keying_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->autokey_flag) & 4) != 0);
}

void UserPreferencesEdit_use_visual_keying_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_insertkey_xyz_to_rgb_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->autokey_flag) & 8) != 0);
}

void UserPreferencesEdit_use_insertkey_xyz_to_rgb_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_negative_frames_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return !(((data->flag) & 16777216) != 0);
}

void UserPreferencesEdit_use_negative_frames_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_grease_pencil_simplify_stroke_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->gp_settings) & 2) != 0);
}

void UserPreferencesEdit_use_grease_pencil_simplify_stroke_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_duplicate_mesh_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->dupflag) & 1) != 0);
}

void UserPreferencesEdit_use_duplicate_mesh_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_duplicate_surface_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->dupflag) & 4) != 0);
}

void UserPreferencesEdit_use_duplicate_surface_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_duplicate_curve_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->dupflag) & 2) != 0);
}

void UserPreferencesEdit_use_duplicate_curve_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_duplicate_text_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->dupflag) & 8) != 0);
}

void UserPreferencesEdit_use_duplicate_text_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_duplicate_metaball_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->dupflag) & 16) != 0);
}

void UserPreferencesEdit_use_duplicate_metaball_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_duplicate_armature_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->dupflag) & 512) != 0);
}

void UserPreferencesEdit_use_duplicate_armature_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_duplicate_lamp_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->dupflag) & 32) != 0);
}

void UserPreferencesEdit_use_duplicate_lamp_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_duplicate_material_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->dupflag) & 128) != 0);
}

void UserPreferencesEdit_use_duplicate_material_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_duplicate_texture_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->dupflag) & 256) != 0);
}

void UserPreferencesEdit_use_duplicate_texture_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_duplicate_fcurve_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->dupflag) & 64) != 0);
}

void UserPreferencesEdit_use_duplicate_fcurve_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_duplicate_action_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->dupflag) & 1024) != 0);
}

void UserPreferencesEdit_use_duplicate_action_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesEdit_use_duplicate_particle_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->dupflag) & 2048) != 0);
}

void UserPreferencesEdit_use_duplicate_particle_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_invert_mouse_zoom_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 33554432) != 0);
}

void UserPreferencesInput_invert_mouse_zoom_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_use_mouse_continuous_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 16777216) != 0);
}

void UserPreferencesInput_use_mouse_continuous_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_ndof_pan_yz_swap_axis_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->ndof_flag) & 128) != 0);
}

void UserPreferencesInput_ndof_pan_yz_swap_axis_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_ndof_zoom_invert_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->ndof_flag) & 256) != 0);
}

void UserPreferencesInput_ndof_zoom_invert_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_ndof_show_guide_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->ndof_flag) & 1) != 0);
}

void UserPreferencesInput_ndof_show_guide_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_ndof_rotx_invert_axis_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->ndof_flag) & 512) != 0);
}

void UserPreferencesInput_ndof_rotx_invert_axis_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_ndof_roty_invert_axis_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->ndof_flag) & 1024) != 0);
}

void UserPreferencesInput_ndof_roty_invert_axis_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_ndof_rotz_invert_axis_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->ndof_flag) & 2048) != 0);
}

void UserPreferencesInput_ndof_rotz_invert_axis_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_ndof_panx_invert_axis_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->ndof_flag) & 4096) != 0);
}

void UserPreferencesInput_ndof_panx_invert_axis_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_ndof_pany_invert_axis_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->ndof_flag) & 8192) != 0);
}

void UserPreferencesInput_ndof_pany_invert_axis_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_ndof_panz_invert_axis_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->ndof_flag) & 16384) != 0);
}

void UserPreferencesInput_ndof_panz_invert_axis_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_ndof_lock_horizon_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->ndof_flag) & 4) != 0);
}

void UserPreferencesInput_ndof_lock_horizon_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_ndof_fly_helicopter_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->ndof_flag) & 2) != 0);
}

void UserPreferencesInput_ndof_fly_helicopter_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_use_mouse_emulate_3_button_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->flag) & 4096) != 0);
}

void UserPreferencesInput_use_mouse_emulate_3_button_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_use_emulate_numpad_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->flag) & 8192) != 0);
}

void UserPreferencesInput_use_emulate_numpad_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_use_mouse_mmb_paste_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 4194304) != 0);
}

void UserPreferencesInput_use_mouse_mmb_paste_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_invert_zoom_wheel_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 4) != 0);
}

void UserPreferencesInput_invert_zoom_wheel_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesInput_use_trackpad_natural_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag2) & 4) != 0);
}

void UserPreferencesInput_use_trackpad_natural_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesFilePaths_show_hidden_files_datablocks_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 65536) != 0);
}

void UserPreferencesFilePaths_show_hidden_files_datablocks_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesFilePaths_use_filter_files_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 8) != 0);
}

void UserPreferencesFilePaths_use_filter_files_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesFilePaths_hide_recent_locations_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 268435456) != 0);
}

void UserPreferencesFilePaths_hide_recent_locations_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesFilePaths_hide_system_bookmarks_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & INT_MIN) != 0);
}

void UserPreferencesFilePaths_hide_system_bookmarks_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesFilePaths_show_thumbnails_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 536870912) != 0);
}

void UserPreferencesFilePaths_show_thumbnails_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesFilePaths_use_relative_paths_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->flag) & 1048576) != 0);
}

void UserPreferencesFilePaths_use_relative_paths_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesFilePaths_use_file_compression_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->flag) & 32768) != 0);
}

void UserPreferencesFilePaths_use_file_compression_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesFilePaths_use_load_ui_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return !(((data->flag) & 8388608) != 0);
}

void UserPreferencesFilePaths_use_load_ui_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesFilePaths_use_auto_save_temporary_files_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->flag) & 1) != 0);
}

void UserPreferencesFilePaths_use_auto_save_temporary_files_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
	if (value) data->flag |= 1;
	else data->flag &= ~1;
...
bool UserPreferencesFilePaths_use_keep_session_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag2) & 1) != 0);
}

void UserPreferencesFilePaths_use_keep_session_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesFilePaths_use_save_preview_images_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->flag) & 65536) != 0);
}

void UserPreferencesFilePaths_use_save_preview_images_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesSystem_use_international_fonts_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->transopts) & 32) != 0);
}

void UserPreferencesSystem_use_international_fonts_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesSystem_use_translate_tooltips_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->transopts) & 1) != 0);
}

void UserPreferencesSystem_use_translate_tooltips_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesSystem_use_translate_interface_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->transopts) & 2) != 0);
}

void UserPreferencesSystem_use_translate_interface_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesSystem_use_translate_new_dataname_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->transopts) & 256) != 0);
}

void UserPreferencesSystem_use_translate_new_dataname_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesSystem_use_weight_color_range_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->flag) & 131072) != 0);
}

void UserPreferencesSystem_use_weight_color_range_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesSystem_use_preview_images_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 256) != 0);
}

void UserPreferencesSystem_use_preview_images_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesSystem_use_scripts_auto_execute_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return !(((data->flag) & 4194304) != 0);
}

void UserPreferencesSystem_use_scripts_auto_execute_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesSystem_use_tabs_as_spaces_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return !(((data->flag) & 33554432) != 0);
}

void UserPreferencesSystem_use_tabs_as_spaces_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesSystem_use_mipmaps_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return !(((data->gameflags) & 4) != 0);
}

void UserPreferencesSystem_use_mipmaps_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesSystem_use_16bit_textures_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->use_16bit_textures) & 1) != 0);
}

void UserPreferencesSystem_use_16bit_textures_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesSystem_use_gpu_mipmap_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->use_gpu_mipmap) & 1) != 0);
}

void UserPreferencesSystem_use_gpu_mipmap_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool UserPreferencesSystem_use_text_antialiasing_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return !(((data->text_render) & 1) != 0);
}

void UserPreferencesSystem_use_text_antialiasing_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
int UserPreferencesSystem_text_hinting_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return ((data->text_render) & 14);
}

void UserPreferencesSystem_text_hinting_set(PointerRNA *ptr, int value)
{
	UserDef *data = (UserDef *)(ptr->data);
	data->text_render &= ~14;
...
bool UserPreferencesSystem_use_select_pick_depth_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->gpu_select_pick_deph) & 1) != 0);
}

void UserPreferencesSystem_use_select_pick_depth_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
	if (value) data->gpu_select_pick_deph |= 1;
	else data->gpu_select_pick_deph &= ~1;
}
...
bool UserPreferencesSystem_use_region_overlap_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag2) & 2) != 0);
}

void UserPreferencesSystem_use_region_overlap_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
int UserPreferencesSystem_opensubdiv_compute_type_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (int)(data->opensubdiv_compute_type);
}

void UserPreferencesSystem_opensubdiv_compute_type_set(PointerRNA *ptr, int value)
{
	UserDef *data = (UserDef *)(ptr->data);
	data->opensubdiv_compute_type = value;
}

int UserPreferencesSystem_legacy_compute_device_type_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
...
EnumPropertyRNA rna_ThemeFontStyle_font_kerning_style = {
	...
	-1, "font_kerning_style", 3, 0, 0, 0, "Kerning Style",
...
IntPropertyRNA rna_ThemeFontStyle_shadow_offset_x = {
	...
	-1, "shadow_offset_x", 3, 0, 4, 0, "Shadow X Offset",
...
IntPropertyRNA rna_ThemeFontStyle_shadow_offset_y = {
	...
	-1, "shadow_offset_y", 3, 0, 4, 0, "Shadow Y Offset",
	"Shadow offset in pixels",
	0, "*",
	PROP_INT, PROP_PIXEL | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeFontStyle_shadow_alpha = {
	...
	-1, "shadow_alpha", 3, 0, 4, 0, "Shadow Alpha",
	"",
	0, "*",
...
FloatPropertyRNA rna_ThemeFontStyle_shadow_value = {
	...
	-1, "shadow_value", 3, 0, 4, 0, "Shadow Brightness",
...
PointerPropertyRNA rna_ThemeStyle_panel_title = {
	...
	-1, "panel_title", 8650752, 0, 0, 0, "Panel Title Font",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeStyle_widget_label = {
	...
	-1, "widget_label", 8650752, 0, 0, 0, "Widget Label Style",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeStyle_widget = {
	...
	-1, "widget", 8650752, 0, 0, 0, "Widget Style",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeWidgetColors_inner_sel = {
	...
	-1, "inner_sel", 3, 0, 4, 0, "Inner Selected",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeWidgetColors_text_sel = {
	...
	-1, "text_sel", 3, 0, 4, 0, "Text Selected",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
IntPropertyRNA rna_ThemeWidgetColors_shadedown = {
	...
	-1, "shadedown", 3, 0, 4, 0, "Shade Down",
	"",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeWidgetStateColors_inner_anim_sel = {
	...
	-1, "inner_anim_sel", 3, 0, 4, 0, "Animated Selected",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeWidgetStateColors_inner_key_sel = {
	...
	-1, "inner_key_sel", 3, 0, 4, 0, "Keyframe Selected",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeWidgetStateColors_inner_driven_sel = {
	...
	-1, "inner_driven_sel", 3, 0, 4, 0, "Driven Selected",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_ThemePanelColors_show_header = {
	...
	-1, "show_header", 3, 0, 4, 0, "Show Header",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_ThemePanelColors_show_back = {
	...
	-1, "show_back", 3, 0, 4, 0, "Show Background",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_ThemeGradientColors_show_grad = {
	...
	-1, "show_grad", 3, 0, 4, 0, "Use Gradient",
...
FloatPropertyRNA rna_ThemeGradientColors_gradient = {
	...
	-1, "gradient", 3, 0, 4, 0, "Gradient Low",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeGradientColors_high_gradient = {
	...
	-1, "high_gradient", 3, 0, 4, 0, "Gradient High/Off",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_regular = {
	...
	-1, "wcol_regular", 8650752, 0, 0, 0, "Regular Widget Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_tool = {
	...
	-1, "wcol_tool", 8650752, 0, 0, 0, "Tool Widget Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_radio = {
	...
	-1, "wcol_radio", 8650752, 0, 0, 0, "Radio Widget Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_text = {
	...
	-1, "wcol_text", 8650752, 0, 0, 0, "Text Widget Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_option = {
	...
	-1, "wcol_option", 8650752, 0, 0, 0, "Option Widget Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_toggle = {
	...
	-1, "wcol_toggle", 8650752, 0, 0, 0, "Toggle Widget Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_num = {
	...
	-1, "wcol_num", 8650752, 0, 0, 0, "Number Widget Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_numslider = {
	...
	-1, "wcol_numslider", 8650752, 0, 0, 0, "Slider Widget Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_box = {
	...
	-1, "wcol_box", 8650752, 0, 0, 0, "Box Backdrop Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_menu = {
	...
	-1, "wcol_menu", 8650752, 0, 0, 0, "Menu Widget Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_pulldown = {
	...
	-1, "wcol_pulldown", 8650752, 0, 0, 0, "Pulldown Widget Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_menu_back = {
	...
	-1, "wcol_menu_back", 8650752, 0, 0, 0, "Menu Backdrop Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_pie_menu = {
	...
	-1, "wcol_pie_menu", 8650752, 0, 0, 0, "Pie Menu Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_tooltip = {
	...
	-1, "wcol_tooltip", 8650752, 0, 0, 0, "Tooltip Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_menu_item = {
	...
	-1, "wcol_menu_item", 8650752, 0, 0, 0, "Menu Item Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_scroll = {
	...
	-1, "wcol_scroll", 8650752, 0, 0, 0, "Scroll Widget Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_progress = {
	...
	-1, "wcol_progress", 8650752, 0, 0, 0, "Progress Bar Widget Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_list_item = {
	...
	-1, "wcol_list_item", 8650752, 0, 0, 0, "List Item Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeUserInterface_wcol_state = {
	...
	-1, "wcol_state", 8650752, 0, 0, 0, "State Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeUserInterface_menu_shadow_fac = {
	...
	-1, "menu_shadow_fac", 3, 0, 4, 0, "Menu Shadow Strength",
...
IntPropertyRNA rna_ThemeUserInterface_menu_shadow_width = {
	...
	-1, "menu_shadow_width", 3, 0, 4, 0, "Menu Shadow Width",
...
StringPropertyRNA rna_ThemeUserInterface_icon_file = {
	...
	-1, "icon_file", 262145, 0, 0, 0, "Icon File",
	"",
	0, "*",
...
FloatPropertyRNA rna_ThemeUserInterface_icon_alpha = {
	...
	-1, "icon_alpha", 3, 0, 4, 0, "Icon Alpha",
...
FloatPropertyRNA rna_ThemeUserInterface_widget_emboss = {
	...
	-1, "widget_emboss", 3, 0, 4, 0, "Widget Emboss",
...
FloatPropertyRNA rna_ThemeSpaceGeneric_back = {
	...
	-1, "back", 3, 0, 4, 0, "Window Background",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSpaceGeneric_text_hi = {
	...
	-1, "text_hi", 3, 0, 4, 0, "Text Highlight",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSpaceGeneric_header_text = {
	...
	-1, "header_text", 3, 0, 4, 0, "Header Text",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSpaceGeneric_header_text_hi = {
	...
	-1, "header_text_hi", 3, 0, 4, 0, "Header Text Highlight",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeSpaceGeneric_panelcolors = {
	...
	-1, "panelcolors", 8650752, 0, 0, 0, "Panel Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSpaceGeneric_button = {
	...
	-1, "button", 3, 0, 4, 0, "Region Background",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSpaceGeneric_button_title = {
	...
	-1, "button_title", 3, 0, 4, 0, "Region Text Titles",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSpaceGeneric_button_text = {
	...
	-1, "button_text", 3, 0, 4, 0, "Region Text",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSpaceGeneric_button_text_hi = {
	...
	-1, "button_text_hi", 3, 0, 4, 0, "Region Text Highlight",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSpaceGeneric_tab_active = {
	...
	-1, "tab_active", 3, 0, 4, 0, "Tab Active",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSpaceGeneric_tab_inactive = {
	...
	-1, "tab_inactive", 3, 0, 4, 0, "Tab Inactive",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSpaceGeneric_tab_back = {
	...
	-1, "tab_back", 3, 0, 4, 0, "Tab Background",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSpaceGeneric_tab_outline = {
	...
	-1, "tab_outline", 3, 0, 4, 0, "Tab Outline",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeSpaceGradient_gradients = {
	...
	-1, "gradients", 8650752, 0, 0, 0, "Gradient Colors",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSpaceListGeneric_list_title = {
	...
	-1, "list_title", 3, 0, 4, 0, "Source List Title",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSpaceListGeneric_list_text = {
	...
	-1, "list_text", 3, 0, 4, 0, "Source List Text",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSpaceListGeneric_list_text_hi = {
	...
	-1, "list_text_hi", 3, 0, 4, 0, "Source List Text Highlight",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeView3D_space = {
	...
	-1, "space", 8650752, 0, 0, 0, "Theme Space",
	"Settings for space",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_clipping_border_3d = {
	...
	-1, "clipping_border_3d", 3, 0, 4, 0, "Clipping Border",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_gp_vertex = {
	...
	-1, "gp_vertex", 3, 0, 4, 0, "Grease Pencil Vertex",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_gp_vertex_select = {
	...
	-1, "gp_vertex_select", 3, 0, 4, 0, "Grease Pencil Vertex Select",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
IntPropertyRNA rna_ThemeView3D_gp_vertex_size = {
	...
	-1, "gp_vertex_size", 3, 0, 4, 0, "Grease Pencil Vertex Size",
	"",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_text_grease_pencil = {
	...
	-1, "text_grease_pencil", 3, 0, 4, 0, "Grease Pencil Keyframe",
...
FloatPropertyRNA rna_ThemeView3D_object_selected = {
	...
	-1, "object_selected", 3, 0, 4, 0, "Object Selected",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_object_active = {
	...
	-1, "object_active", 3, 0, 4, 0, "Active Object",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_object_grouped = {
	...
	-1, "object_grouped", 3, 0, 4, 0, "Object Grouped",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_object_grouped_active = {
	...
	-1, "object_grouped_active", 3, 0, 4, 0, "Object Grouped Active",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_text_keyframe = {
	...
	-1, "text_keyframe", 3, 0, 4, 0, "Object Keyframe",
...
FloatPropertyRNA rna_ThemeView3D_vertex_select = {
	...
	-1, "vertex_select", 3, 0, 4, 0, "Vertex Select",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
IntPropertyRNA rna_ThemeView3D_vertex_size = {
	...
	-1, "vertex_size", 3, 0, 4, 0, "Vertex Size",
	"",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_vertex_bevel = {
	...
	-1, "vertex_bevel", 3, 0, 4, 0, "Vertex Bevel",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_vertex_unreferenced = {
	...
	-1, "vertex_unreferenced", 3, 0, 4, 0, "Vertex Group Unreferenced",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_edge_select = {
	...
	-1, "edge_select", 3, 0, 4, 0, "Edge Select",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_edge_sharp = {
	...
	-1, "edge_sharp", 3, 0, 4, 0, "Edge Sharp",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_edge_crease = {
	...
	-1, "edge_crease", 3, 0, 4, 0, "Edge Crease",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_edge_bevel = {
	...
	-1, "edge_bevel", 3, 0, 4, 0, "Edge Bevel",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_edge_facesel = {
	...
	-1, "edge_facesel", 3, 0, 4, 0, "Edge UV Face Select",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_freestyle_edge_mark = {
	...
	-1, "freestyle_edge_mark", 3, 0, 4, 0, "Freestyle Edge Mark",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_face_select = {
	...
	-1, "face_select", 3, 0, 4, 0, "Face Selected",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_face_dot = {
	...
	-1, "face_dot", 3, 0, 4, 0, "Face Dot Selected",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
IntPropertyRNA rna_ThemeView3D_facedot_size = {
	...
	-1, "facedot_size", 3, 0, 4, 0, "Face Dot Size",
	"",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_freestyle_face_mark = {
	...
	-1, "freestyle_face_mark", 3, 0, 4, 0, "Freestyle Face Mark",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_nurb_uline = {
	...
	-1, "nurb_uline", 3, 0, 4, 0, "NURBS U-lines",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_nurb_vline = {
	...
	-1, "nurb_vline", 3, 0, 4, 0, "NURBS V-lines",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_nurb_sel_uline = {
	...
	-1, "nurb_sel_uline", 3, 0, 4, 0, "NURBS active U-lines",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_nurb_sel_vline = {
	...
	-1, "nurb_sel_vline", 3, 0, 4, 0, "NURBS active V-lines",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_act_spline = {
	...
	-1, "act_spline", 3, 0, 4, 0, "Active spline",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_handle_free = {
	...
	-1, "handle_free", 3, 0, 4, 0, "Free handle color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_handle_auto = {
	...
	-1, "handle_auto", 3, 0, 4, 0, "Auto handle color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_handle_vect = {
	...
	-1, "handle_vect", 3, 0, 4, 0, "Vector handle color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_handle_sel_vect = {
	...
	-1, "handle_sel_vect", 3, 0, 4, 0, "Vector handle selected color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_handle_align = {
	...
	-1, "handle_align", 3, 0, 4, 0, "Align handle color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_handle_sel_free = {
	...
	-1, "handle_sel_free", 3, 0, 4, 0, "Free handle selected color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_handle_sel_auto = {
	...
	-1, "handle_sel_auto", 3, 0, 4, 0, "Auto handle selected color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_handle_sel_align = {
	...
	-1, "handle_sel_align", 3, 0, 4, 0, "Align handle selected color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_lastsel_point = {
	...
	-1, "lastsel_point", 3, 0, 4, 0, "Last selected point",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_extra_edge_len = {
	...
	-1, "extra_edge_len", 3, 0, 4, 0, "Edge Length Text",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_extra_edge_angle = {
	...
	-1, "extra_edge_angle", 3, 0, 4, 0, "Edge Angle Text",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_extra_face_angle = {
	...
	-1, "extra_face_angle", 3, 0, 4, 0, "Face Angle Text",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_extra_face_area = {
	...
	-1, "extra_face_area", 3, 0, 4, 0, "Face Area Text",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_editmesh_active = {
	...
	-1, "editmesh_active", 3, 0, 4, 0, "Active Vert/Edge/Face",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_vertex_normal = {
	...
	-1, "vertex_normal", 3, 0, 4, 0, "Vertex Normal",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_split_normal = {
	...
	-1, "split_normal", 3, 0, 4, 0, "Split Normal",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_bone_pose_active = {
	...
	-1, "bone_pose_active", 3, 0, 4, 0, "Bone Pose Active",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_bone_solid = {
	...
	-1, "bone_solid", 3, 0, 4, 0, "Bone Solid",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_bundle_solid = {
	...
	-1, "bundle_solid", 3, 0, 4, 0, "Bundle Solid",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_camera_path = {
	...
	-1, "camera_path", 3, 0, 4, 0, "Camera Path",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_view_overlay = {
	...
	-1, "view_overlay", 3, 0, 4, 0, "View Overlay",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_frame_current = {
	...
	-1, "frame_current", 3, 0, 4, 0, "Current Frame",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_paint_curve_handle = {
	...
	-1, "paint_curve_handle", 3, 0, 4, 0, "Paint Curve Handle",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_paint_curve_pivot = {
	...
	-1, "paint_curve_pivot", 3, 0, 4, 0, "Paint Curve Pivot",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
IntPropertyRNA rna_ThemeView3D_outline_width = {
	...
	-1, "outline_width", 3, 0, 4, 0, "Outline Width",
	"",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
PointerPropertyRNA rna_ThemeGraphEditor_space_list = {
	...
	-1, "space_list", 8650752, 0, 0, 0, "Theme Space List",
...
FloatPropertyRNA rna_ThemeGraphEditor_window_sliders = {
	...
	-1, "window_sliders", 3, 0, 4, 0, "Window Sliders",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeGraphEditor_channels_region = {
	...
	-1, "channels_region", 3, 0, 4, 0, "Channels Region",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeGraphEditor_dopesheet_channel = {
	...
	-1, "dopesheet_channel", 3, 0, 4, 0, "Dope Sheet Channel",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeGraphEditor_dopesheet_subchannel = {
	...
	-1, "dopesheet_subchannel", 3, 0, 4, 0, "Dope Sheet Sub-Channel",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeGraphEditor_channel_group = {
	...
	-1, "channel_group", 3, 0, 4, 0, "Channel Group",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeGraphEditor_active_channels_group = {
	...
	-1, "active_channels_group", 3, 0, 4, 0, "Active Channel Group",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeGraphEditor_handle_auto_clamped = {
	...
	-1, "handle_auto_clamped", 3, 0, 4, 0, "Auto-Clamped handle color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeGraphEditor_handle_sel_auto_clamped = {
	...
	-1, "handle_sel_auto_clamped", 3, 0, 4, 0, "Auto-Clamped handle selected color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeGraphEditor_handle_vertex = {
	...
	-1, "handle_vertex", 3, 0, 4, 0, "Handle Vertex",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeGraphEditor_handle_vertex_select = {
	...
	-1, "handle_vertex_select", 3, 0, 4, 0, "Handle Vertex Select",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
IntPropertyRNA rna_ThemeGraphEditor_handle_vertex_size = {
	...
	-1, "handle_vertex_size", 3, 0, 4, 0, "Handle Vertex Size",
	"",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeFileBrowser_selected_file = {
	...
	-1, "selected_file", 3, 0, 4, 0, "Selected File",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNLAEditor_view_sliders = {
	...
	-1, "view_sliders", 3, 0, 4, 0, "View Sliders",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNLAEditor_active_action = {
	...
	-1, "active_action", 3, 0, 4, 0, "Active Action",
...
FloatPropertyRNA rna_ThemeNLAEditor_active_action_unset = {
	...
	-1, "active_action_unset", 3, 0, 4, 0, "No Active Action",
...
FloatPropertyRNA rna_ThemeNLAEditor_strips_selected = {
	...
	-1, "strips_selected", 3, 0, 4, 0, "Strips Selected",
...
FloatPropertyRNA rna_ThemeNLAEditor_transition_strips = {
	...
	-1, "transition_strips", 3, 0, 4, 0, "Transitions",
...
FloatPropertyRNA rna_ThemeNLAEditor_transition_strips_selected = {
	...
	-1, "transition_strips_selected", 3, 0, 4, 0, "Transitions Selected",
...
FloatPropertyRNA rna_ThemeNLAEditor_meta_strips = {
	...
	-1, "meta_strips", 3, 0, 4, 0, "Meta Strips",
...
FloatPropertyRNA rna_ThemeNLAEditor_meta_strips_selected = {
	...
	-1, "meta_strips_selected", 3, 0, 4, 0, "Meta Strips Selected",
...
FloatPropertyRNA rna_ThemeNLAEditor_sound_strips = {
	...
	-1, "sound_strips", 3, 0, 4, 0, "Sound Strips",
...
FloatPropertyRNA rna_ThemeNLAEditor_sound_strips_selected = {
	...
	-1, "sound_strips_selected", 3, 0, 4, 0, "Sound Strips Selected",
...
FloatPropertyRNA rna_ThemeNLAEditor_tweak_duplicate = {
	...
	-1, "tweak_duplicate", 3, 0, 4, 0, "Tweak Duplicate Flag",
...
FloatPropertyRNA rna_ThemeNLAEditor_keyframe_border = {
	...
	-1, "keyframe_border", 3, 0, 4, 0, "Keyframe Border",
...
FloatPropertyRNA rna_ThemeNLAEditor_keyframe_border_selected = {
	...
	-1, "keyframe_border_selected", 3, 0, 4, 0, "Keyframe Border Selected",
...
StructRNA RNA_ThemeNLAEditor = {
	...
	"ThemeNLAEditor", NULL, NULL, 512, NULL, "Theme NLA Editor",
...
FloatPropertyRNA rna_ThemeDopeSheet_value_sliders = {
	...
	-1, "value_sliders", 3, 0, 4, 0, "Value Sliders",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeDopeSheet_channels_selected = {
	...
	-1, "channels_selected", 3, 0, 4, 0, "Channels Selected",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeDopeSheet_long_key_selected = {
	...
	-1, "long_key_selected", 3, 0, 4, 0, "Long Key Selected",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeDopeSheet_keyframe_selected = {
	...
	-1, "keyframe_selected", 3, 0, 4, 0, "Keyframe Selected",
...
FloatPropertyRNA rna_ThemeDopeSheet_keyframe_extreme = {
	...
	-1, "keyframe_extreme", 3, 0, 4, 0, "Extreme Keyframe",
...
FloatPropertyRNA rna_ThemeDopeSheet_keyframe_extreme_selected = {
	...
	-1, "keyframe_extreme_selected", 3, 0, 4, 0, "Extreme Keyframe Selected",
...
FloatPropertyRNA rna_ThemeDopeSheet_keyframe_breakdown = {
	...
	-1, "keyframe_breakdown", 3, 0, 4, 0, "Breakdown Keyframe",
...
FloatPropertyRNA rna_ThemeDopeSheet_keyframe_breakdown_selected = {
	...
	-1, "keyframe_breakdown_selected", 3, 0, 4, 0, "Breakdown Keyframe Selected",
...
FloatPropertyRNA rna_ThemeDopeSheet_keyframe_jitter = {
	...
	-1, "keyframe_jitter", 3, 0, 4, 0, "Jitter Keyframe",
...
FloatPropertyRNA rna_ThemeDopeSheet_keyframe_jitter_selected = {
	...
	-1, "keyframe_jitter_selected", 3, 0, 4, 0, "Jitter Keyframe Selected",
...
FloatPropertyRNA rna_ThemeDopeSheet_keyframe_scale_factor = {
	...
	-1, "keyframe_scale_factor", 3, 0, 4, 0, "Keyframe Scale Factor",
	"Scale factor for adjusting the height of keyframes",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 252575744, NULL, NULL,
...
FloatPropertyRNA rna_ThemeDopeSheet_summary = {
	{NULL, (PropertyRNA *)&rna_ThemeDopeSheet_keyframe_scale_factor,
	-1, "summary", 3, 0, 4, 0, "Summary",
...
FloatPropertyRNA rna_ThemeImageEditor_scope_back = {
	...
	-1, "scope_back", 3, 0, 4, 0, "Scope region background color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeImageEditor_preview_stitch_face = {
	...
	-1, "preview_stitch_face", 3, 0, 4, 0, "Stitch preview face color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeImageEditor_preview_stitch_edge = {
	...
	-1, "preview_stitch_edge", 3, 0, 4, 0, "Stitch preview edge color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeImageEditor_preview_stitch_vert = {
	...
	-1, "preview_stitch_vert", 3, 0, 4, 0, "Stitch preview vertex color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeImageEditor_preview_stitch_stitchable = {
	...
	-1, "preview_stitch_stitchable", 3, 0, 4, 0, "Stitch preview stitchable color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeImageEditor_preview_stitch_unstitchable = {
	...
	-1, "preview_stitch_unstitchable", 3, 0, 4, 0, "Stitch preview unstitchable color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeImageEditor_preview_stitch_active = {
	...
	-1, "preview_stitch_active", 3, 0, 4, 0, "Stitch preview active island",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeImageEditor_uv_shadow = {
	...
	-1, "uv_shadow", 3, 0, 4, 0, "Texture paint/Modifier UVs",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeImageEditor_uv_others = {
	...
	-1, "uv_others", 3, 0, 4, 0, "Other Object UVs",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeImageEditor_metadatabg = {
	...
	-1, "metadatabg", 3, 0, 4, 0, "Metadata Background",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeImageEditor_metadatatext = {
	...
	-1, "metadatatext", 3, 0, 4, 0, "Metadata Text",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSequenceEditor_movie_strip = {
	...
	-1, "movie_strip", 3, 0, 4, 0, "Movie Strip",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSequenceEditor_movieclip_strip = {
	...
	-1, "movieclip_strip", 3, 0, 4, 0, "Clip Strip",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSequenceEditor_image_strip = {
	...
	-1, "image_strip", 3, 0, 4, 0, "Image Strip",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSequenceEditor_scene_strip = {
	...
	-1, "scene_strip", 3, 0, 4, 0, "Scene Strip",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSequenceEditor_audio_strip = {
	...
	-1, "audio_strip", 3, 0, 4, 0, "Audio Strip",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSequenceEditor_effect_strip = {
	...
	-1, "effect_strip", 3, 0, 4, 0, "Effect Strip",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSequenceEditor_transition_strip = {
	...
	-1, "transition_strip", 3, 0, 4, 0, "Transition Strip",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSequenceEditor_meta_strip = {
	...
	-1, "meta_strip", 3, 0, 4, 0, "Meta Strip",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSequenceEditor_text_strip = {
	...
	-1, "text_strip", 3, 0, 4, 0, "Text Strip",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSequenceEditor_draw_action = {
	...
	-1, "draw_action", 3, 0, 4, 0, "Draw Action",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeSequenceEditor_preview_back = {
	...
	-1, "preview_back", 3, 0, 4, 0, "Preview Background",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeTextEditor_line_numbers_background = {
	...
	-1, "line_numbers_background", 3, 0, 4, 0, "Line Numbers Background",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeTextEditor_selected_text = {
	...
	-1, "selected_text", 3, 0, 4, 0, "Selected Text",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeTextEditor_syntax_builtin = {
	...
	-1, "syntax_builtin", 3, 0, 4, 0, "Syntax Built-in",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeTextEditor_syntax_symbols = {
	...
	-1, "syntax_symbols", 3, 0, 4, 0, "Syntax Symbols",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeTextEditor_syntax_special = {
	...
	-1, "syntax_special", 3, 0, 4, 0, "Syntax Special",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeTextEditor_syntax_preprocessor = {
	...
	-1, "syntax_preprocessor", 3, 0, 4, 0, "Syntax PreProcessor",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeTextEditor_syntax_reserved = {
	...
	-1, "syntax_reserved", 3, 0, 4, 0, "Syntax Reserved",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeTextEditor_syntax_comment = {
	...
	-1, "syntax_comment", 3, 0, 4, 0, "Syntax Comment",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeTextEditor_syntax_string = {
	...
	-1, "syntax_string", 3, 0, 4, 0, "Syntax String",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeTextEditor_syntax_numbers = {
	...
	-1, "syntax_numbers", 3, 0, 4, 0, "Syntax Numbers",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeTimeline_time_keyframe = {
	...
	-1, "time_keyframe", 3, 0, 4, 0, "Keyframe",
...
FloatPropertyRNA rna_ThemeTimeline_time_grease_pencil = {
	...
	-1, "time_grease_pencil", 3, 0, 4, 0, "Grease Pencil",
...
StructRNA RNA_ThemeTimeline = {
	...
	"ThemeTimeline", NULL, NULL, 512, NULL, "Theme Timeline",
...
FloatPropertyRNA rna_ThemeNodeEditor_node_selected = {
	...
	-1, "node_selected", 3, 0, 4, 0, "Node Selected",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_node_active = {
	...
	-1, "node_active", 3, 0, 4, 0, "Active Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_wire_inner = {
	...
	-1, "wire_inner", 3, 0, 4, 0, "Wire Color",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_wire_select = {
	...
	-1, "wire_select", 3, 0, 4, 0, "Wire Select",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_node_backdrop = {
	...
	-1, "node_backdrop", 3, 0, 4, 0, "Node Backdrop",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_converter_node = {
	...
	-1, "converter_node", 3, 0, 4, 0, "Converter Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_color_node = {
	...
	-1, "color_node", 3, 0, 4, 0, "Color Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_group_node = {
	...
	-1, "group_node", 3, 0, 4, 0, "Group Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_group_socket_node = {
	...
	-1, "group_socket_node", 3, 0, 4, 0, "Group Socket Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_frame_node = {
	...
	-1, "frame_node", 3, 0, 4, 0, "Frame Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_matte_node = {
	...
	-1, "matte_node", 3, 0, 4, 0, "Matte Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_distor_node = {
	...
	-1, "distor_node", 3, 0, 4, 0, "Distort Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
IntPropertyRNA rna_ThemeNodeEditor_noodle_curving = {
	...
	-1, "noodle_curving", 3, 0, 4, 0, "Noodle curving",
...
FloatPropertyRNA rna_ThemeNodeEditor_input_node = {
	...
	-1, "input_node", 3, 0, 4, 0, "Input Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_output_node = {
	...
	-1, "output_node", 3, 0, 4, 0, "Output Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_filter_node = {
	...
	-1, "filter_node", 3, 0, 4, 0, "Filter Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_vector_node = {
	...
	-1, "vector_node", 3, 0, 4, 0, "Vector Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_texture_node = {
	...
	-1, "texture_node", 3, 0, 4, 0, "Texture Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_shader_node = {
	...
	-1, "shader_node", 3, 0, 4, 0, "Shader Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_script_node = {
	...
	-1, "script_node", 3, 0, 4, 0, "Script Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_pattern_node = {
	...
	-1, "pattern_node", 3, 0, 4, 0, "Pattern Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeNodeEditor_layout_node = {
	...
	-1, "layout_node", 3, 0, 4, 0, "Layout Node",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeOutliner_selected_highlight = {
	...
	-1, "selected_highlight", 3, 0, 4, 0, "Selected Highlight",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeInfo_info_selected = {
	...
	-1, "info_selected", 3, 0, 4, 0, "Selected Line Background",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeInfo_info_selected_text = {
	...
	-1, "info_selected_text", 3, 0, 4, 0, "Selected Line Text",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeInfo_info_error = {
	...
	-1, "info_error", 3, 0, 4, 0, "Error Background",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeInfo_info_error_text = {
	...
	-1, "info_error_text", 3, 0, 4, 0, "Error Text",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeInfo_info_warning = {
	...
	-1, "info_warning", 3, 0, 4, 0, "Warning Background",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeInfo_info_warning_text = {
	...
	-1, "info_warning_text", 3, 0, 4, 0, "Warning Text",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeInfo_info_info = {
	...
	-1, "info_info", 3, 0, 4, 0, "Info Background",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeInfo_info_info_text = {
	...
	-1, "info_info_text", 3, 0, 4, 0, "Info Text",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeInfo_info_debug = {
	...
	-1, "info_debug", 3, 0, 4, 0, "Debug Background",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeInfo_info_debug_text = {
	...
	-1, "info_debug_text", 3, 0, 4, 0, "Debug Text",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
StructRNA RNA_ThemeUserPreferences = {
	...
	"ThemeUserPreferences", NULL, NULL, 512, NULL, "Theme User Preferences",
...
FloatPropertyRNA rna_ThemeConsole_line_output = {
	...
	-1, "line_output", 3, 0, 4, 0, "Line Output",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeConsole_line_input = {
	...
	-1, "line_input", 3, 0, 4, 0, "Line Input",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeConsole_line_error = {
	...
	-1, "line_error", 3, 0, 4, 0, "Line Error",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
StructRNA RNA_ThemeLogicEditor = {
	...
	"ThemeLogicEditor", NULL, NULL, 512, NULL, "Theme Logic Editor",
...
FloatPropertyRNA rna_ThemeClipEditor_marker_outline = {
	...
	-1, "marker_outline", 3, 0, 4, 0, "Marker Outline Color",
...
FloatPropertyRNA rna_ThemeClipEditor_active_marker = {
	...
	-1, "active_marker", 3, 0, 4, 0, "Active Marker",
...
FloatPropertyRNA rna_ThemeClipEditor_selected_marker = {
	...
	-1, "selected_marker", 3, 0, 4, 0, "Selected Marker",
...
FloatPropertyRNA rna_ThemeClipEditor_disabled_marker = {
	...
	-1, "disabled_marker", 3, 0, 4, 0, "Disabled Marker",
...
FloatPropertyRNA rna_ThemeClipEditor_locked_marker = {
	...
	-1, "locked_marker", 3, 0, 4, 0, "Locked Marker",
...
FloatPropertyRNA rna_ThemeClipEditor_path_before = {
	...
	-1, "path_before", 3, 0, 4, 0, "Path Before",
...
FloatPropertyRNA rna_ThemeClipEditor_path_after = {
	...
	-1, "path_after", 3, 0, 4, 0, "Path After",
...
BoolPropertyRNA rna_ThemeBoneColorSet_show_colored_constraints = {
	...
	-1, "show_colored_constraints", 3, 0, 0, 0, "Colored Constraints",
...
EnumPropertyRNA rna_Theme_theme_area = {
	...
	-1, "theme_area", 268435459, 0, 0, 0, "Active Theme Area",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Theme_user_interface = {
	...
	-1, "user_interface", 8650752, 0, 0, 0, "User Interface",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Theme_view_3d = {
	...
	-1, "view_3d", 8650752, 0, 0, 0, "3D View",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Theme_graph_editor = {
	...
	-1, "graph_editor", 8650752, 0, 0, 0, "Graph Editor",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Theme_file_browser = {
	...
	-1, "file_browser", 8650752, 0, 0, 0, "File Browser",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Theme_nla_editor = {
	...
	-1, "nla_editor", 8650752, 0, 0, 0, "NLA Editor",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Theme_dopesheet_editor = {
	...
	-1, "dopesheet_editor", 8650752, 0, 0, 0, "Dope Sheet",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Theme_image_editor = {
	...
	-1, "image_editor", 8650752, 0, 0, 0, "Image Editor",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Theme_sequence_editor = {
	...
	-1, "sequence_editor", 8650752, 0, 0, 0, "Sequence Editor",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Theme_properties = {
	...
	-1, "properties", 8650752, 0, 0, 0, "Properties",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Theme_text_editor = {
	...
	-1, "text_editor", 8650752, 0, 0, 0, "Text Editor",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Theme_timeline = {
	...
	-1, "timeline", 8650752, 0, 0, 0, "Timeline",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Theme_node_editor = {
	...
	-1, "node_editor", 8650752, 0, 0, 0, "Node Editor",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Theme_logic_editor = {
	...
	-1, "logic_editor", 8650752, 0, 0, 0, "Logic Editor",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Theme_outliner = {
	...
	-1, "outliner", 8650752, 0, 0, 0, "Outliner",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Theme_user_preferences = {
	...
	-1, "user_preferences", 8650752, 0, 0, 0, "User Preferences",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_Theme_console = {
	...
	-1, "console", 8650752, 0, 0, 0, "Console",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
CollectionPropertyRNA rna_Theme_bone_color_sets = {
	...
	-1, "bone_color_sets", 262144, 0, 8, 0, "Bone Color Sets",
	"",
	0, "*",
...
PointerPropertyRNA rna_Theme_clip_editor = {
	...
	-1, "clip_editor", 8650752, 0, 0, 0, "Clip Editor",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
FloatPropertyRNA rna_UserSolidLight_diffuse_color = {
	...
	-1, "diffuse_color", 3, 0, 4, 0, "Diffuse Color",
...
FloatPropertyRNA rna_UserSolidLight_specular_color = {
	...
	-1, "specular_color", 3, 0, 4, 0, "Specular Color",
...
FloatPropertyRNA rna_WalkNavigation_mouse_speed = {
	...
	-1, "mouse_speed", 3, 0, 4, 0, "Mouse Sensitivity",
...
FloatPropertyRNA rna_WalkNavigation_walk_speed = {
	...
	-1, "walk_speed", 3, 0, 4, 0, "Walk Speed",
...
FloatPropertyRNA rna_WalkNavigation_walk_speed_factor = {
	...
	-1, "walk_speed_factor", 3, 0, 4, 0, "Speed Factor",
...
FloatPropertyRNA rna_WalkNavigation_view_height = {
	...
	-1, "view_height", 3, 0, 4, 0, "View Height",
...
FloatPropertyRNA rna_WalkNavigation_jump_height = {
	...
	-1, "jump_height", 3, 0, 4, 0, "Jump Height",
...
FloatPropertyRNA rna_WalkNavigation_teleport_time = {
	...
	-1, "teleport_time", 3, 0, 4, 0, "Teleport Duration",
...
BoolPropertyRNA rna_WalkNavigation_use_mouse_reverse = {
	...
	-1, "use_mouse_reverse", 3, 0, 0, 0, "Reverse Mouse",
...
static const EnumPropertyItem rna_UserPreferences_active_section_items[8] = {
...
EnumPropertyRNA rna_UserPreferences_active_section = {
	{(PropertyRNA *)&rna_UserPreferences_app_template, (PropertyRNA *)&rna_UserPreferences_rna_type,
	-1, "active_section", 3, 0, 0, 0, "Active Section",
...
StringPropertyRNA rna_UserPreferences_app_template = {
	{(PropertyRNA *)&rna_UserPreferences_themes, (PropertyRNA *)&rna_UserPreferences_active_section,
	-1, "app_template", 262145, 0, 0, 0, "Application Template",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {64, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	UserPreferences_app_template_get, UserPreferences_app_template_length, UserPreferences_app_template_set, NULL, NULL, NULL, 64, ""
};

CollectionPropertyRNA rna_UserPreferences_themes = {
	{(PropertyRNA *)&rna_UserPreferences_ui_styles, (PropertyRNA *)&rna_UserPreferences_app_template,
	-1, "themes", 0, 0, 0, 0, "Themes",
	"",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
CollectionPropertyRNA rna_UserPreferences_autoexec_paths = {
	...
	-1, "autoexec_paths", 0, 0, 0, 0, "Autoexec Paths",
	"",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
PointerPropertyRNA rna_UserPreferences_view = {
	...
	-1, "view", 8650752, 0, 0, 0, "View & Controls",
...
PointerPropertyRNA rna_UserPreferences_edit = {
	...
	-1, "edit", 8650752, 0, 0, 0, "Edit Methods",
...
PointerPropertyRNA rna_UserPreferences_filepaths = {
	...
	-1, "filepaths", 8650752, 0, 0, 0, "File Paths",
...
PointerPropertyRNA rna_UserPreferences_system = {
	{(PropertyRNA *)&rna_UserPreferences_version, (PropertyRNA *)&rna_UserPreferences_filepaths,
	-1, "system", 8650752, 0, 0, 0, "System & OpenGL",
...
static int rna_UserPreferences_version_default[3] = {
	0,
	0,
	0
};
...
IntPropertyRNA rna_UserPreferences_version = {
	{NULL, (PropertyRNA *)&rna_UserPreferences_system,
	-1, "version", 8388610, 0, 0, 0, "Version",
	"Version of Blender the userpref.blend was saved with",
	0, "*",
	PROP_INT, PROP_XYZ | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, UserPreferences_version_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	0, INT_MAX, 0, INT_MAX, 1, 0, rna_UserPreferences_version_default
};

StructRNA RNA_UserPreferences = {
	{(ContainerRNA *)&RNA_Addons, (ContainerRNA *)&RNA_WalkNavigation,
	NULL,
	{(PropertyRNA *)&rna_UserPreferences_rna_properties, (PropertyRNA *)&rna_UserPreferences_version}},
	"UserPreferences", NULL, NULL, 512, NULL, "User Preferences",
...
PointerPropertyRNA rna_UserPreferencesView_rna_type = {
	{(PropertyRNA *)&rna_UserPreferencesView_ui_scale, (PropertyRNA *)&rna_UserPreferencesView_rna_properties,
	-1, "rna_type", 8912896, 0, 0, 0, "RNA",
	"RNA type definition",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_UserPreferencesView_ui_scale = {
	{(PropertyRNA *)&rna_UserPreferencesView_ui_line_width, (PropertyRNA *)&rna_UserPreferencesView_rna_type,
	-1, "ui_scale", 3, 0, 4, 0, "UI Scale",
	...
	UserPreferencesView_ui_scale_get, UserPreferencesView_ui_scale_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5000000000f, 2.0f, 0.2500000000f, 4.0f, 1.0f, 2, 1.0f, NULL
};

static const EnumPropertyItem rna_UserPreferencesView_ui_line_width_items[4] = {
...
EnumPropertyRNA rna_UserPreferencesView_ui_line_width = {
	{(PropertyRNA *)&rna_UserPreferencesView_show_tooltips, (PropertyRNA *)&rna_UserPreferencesView_ui_scale,
	-1, "ui_line_width", 3, 0, 0, 0, "UI Line Width",
	"Changes the thickness of lines and points in the interface",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_dpi_update, 0, NULL, NULL,
	0, -1, NULL},
	UserPreferencesView_ui_line_width_get, UserPreferencesView_ui_line_width_set, NULL, NULL, NULL, NULL, rna_UserPreferencesView_ui_line_width_items, 3, 0
};

BoolPropertyRNA rna_UserPreferencesView_show_tooltips = {
	{(PropertyRNA *)&rna_UserPreferencesView_show_tooltips_python, (PropertyRNA *)&rna_UserPreferencesView_ui_line_width,
	-1, "show_tooltips", 3, 0, 0, 0, "Tooltips",
...
BoolPropertyRNA rna_UserPreferencesView_show_tooltips_python = {
	{(PropertyRNA *)&rna_UserPreferencesView_show_developer_ui, (PropertyRNA *)&rna_UserPreferencesView_show_tooltips,
	-1, "show_tooltips_python", 3, 0, 0, 0, "Python Tooltips",
...
BoolPropertyRNA rna_UserPreferencesView_show_developer_ui = {
	{(PropertyRNA *)&rna_UserPreferencesView_show_object_info, (PropertyRNA *)&rna_UserPreferencesView_show_tooltips_python,
	-1, "show_developer_ui", 3, 0, 0, 0, "Developer Extras",
	"Show options for developers (edit source in context menu, geometry indices)",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	UserPreferencesView_show_developer_ui_get, UserPreferencesView_show_developer_ui_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_UserPreferencesView_show_object_info = {
	{(PropertyRNA *)&rna_UserPreferencesView_use_global_scene, (PropertyRNA *)&rna_UserPreferencesView_show_developer_ui,
	-1, "show_object_info", 3, 0, 0, 0, "Display Object Info",
...
BoolPropertyRNA rna_UserPreferencesView_use_global_scene = {
	...
	-1, "use_global_scene", 3, 0, 0, 0, "Global Scene",
...
BoolPropertyRNA rna_UserPreferencesView_show_large_cursors = {
	...
	-1, "show_large_cursors", 3, 0, 4, 0, "Large Cursors",
...
BoolPropertyRNA rna_UserPreferencesView_show_view_name = {
	...
	-1, "show_view_name", 3, 0, 0, 0, "Show View Name",
...
BoolPropertyRNA rna_UserPreferencesView_show_splash = {
	...
	-1, "show_splash", 3, 0, 0, 0, "Show Splash",
...
BoolPropertyRNA rna_UserPreferencesView_show_playback_fps = {
	{(PropertyRNA *)&rna_UserPreferencesView_show_layout_ui, (PropertyRNA *)&rna_UserPreferencesView_show_splash,
	-1, "show_playback_fps", 3, 0, 0, 0, "Show Playback FPS",
...
BoolPropertyRNA rna_UserPreferencesView_show_layout_ui = {
	{(PropertyRNA *)&rna_UserPreferencesView_show_view3d_cursor, (PropertyRNA *)&rna_UserPreferencesView_show_playback_fps,
	-1, "show_layout_ui", 3, 0, 0, 0, "Show Layout Widgets",
	"Show screen layout editing UI",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update_ui, 0, NULL, NULL,
	0, -1, NULL},
	UserPreferencesView_show_layout_ui_get, UserPreferencesView_show_layout_ui_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_UserPreferencesView_show_view3d_cursor = {
	{(PropertyRNA *)&rna_UserPreferencesView_use_mouse_over_open, (PropertyRNA *)&rna_UserPreferencesView_show_layout_ui,
	-1, "show_view3d_cursor", 3, 0, 0, 0, "Show 3D View Cursor",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
	0, -1, NULL},
	UserPreferencesView_show_view3d_cursor_get, UserPreferencesView_show_view3d_cursor_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_UserPreferencesView_use_mouse_over_open = {
	{(PropertyRNA *)&rna_UserPreferencesView_open_toplevel_delay, (PropertyRNA *)&rna_UserPreferencesView_show_view3d_cursor,
	-1, "use_mouse_over_open", 3, 0, 0, 0, "Open On Mouse Over",
...
IntPropertyRNA rna_UserPreferencesView_open_toplevel_delay = {
	...
	-1, "open_toplevel_delay", 3, 0, 4, 0, "Top Level Menu Open Delay",
...
IntPropertyRNA rna_UserPreferencesView_open_sublevel_delay = {
	...
	-1, "open_sublevel_delay", 3, 0, 4, 0, "Sub Level Menu Open Delay",
...
IntPropertyRNA rna_UserPreferencesView_pie_initial_timeout = {
	...
	-1, "pie_initial_timeout", 3, 0, 4, 0, "Recenter Timeout",
...
IntPropertyRNA rna_UserPreferencesView_pie_animation_timeout = {
	...
	-1, "pie_animation_timeout", 3, 0, 4, 0, "Animation Timeout",
...
IntPropertyRNA rna_UserPreferencesView_pie_menu_radius = {
	...
	-1, "pie_menu_radius", 3, 0, 4, 0, "Radius",
...
IntPropertyRNA rna_UserPreferencesView_pie_menu_threshold = {
	...
	-1, "pie_menu_threshold", 3, 0, 4, 0, "Threshold",
...
IntPropertyRNA rna_UserPreferencesView_pie_menu_confirm = {
	...
	-1, "pie_menu_confirm", 3, 0, 4, 0, "Confirm Threshold",
...
BoolPropertyRNA rna_UserPreferencesView_use_quit_dialog = {
	...
	-1, "use_quit_dialog", 3, 0, 0, 0, "Prompt Quit",
...
IntPropertyRNA rna_UserPreferencesView_open_left_mouse_delay = {
	...
	-1, "open_left_mouse_delay", 3, 0, 4, 0, "Hold LMB Open Toolbox Delay",
...
IntPropertyRNA rna_UserPreferencesView_open_right_mouse_delay = {
	...
	-1, "open_right_mouse_delay", 3, 0, 4, 0, "Hold RMB Open Toolbox Delay",
...
BoolPropertyRNA rna_UserPreferencesView_show_column_layout = {
	...
	-1, "show_column_layout", 3, 0, 0, 0, "Toolbox Column Layout",
...
BoolPropertyRNA rna_UserPreferencesView_use_directional_menus = {
	...
	-1, "use_directional_menus", 3, 0, 0, 0, "Contents Follow Opening Direction",
...
BoolPropertyRNA rna_UserPreferencesView_use_global_pivot = {
	...
	-1, "use_global_pivot", 3, 0, 0, 0, "Global Pivot",
...
BoolPropertyRNA rna_UserPreferencesView_use_mouse_depth_navigate = {
	...
	-1, "use_mouse_depth_navigate", 3, 0, 0, 0, "Auto Depth",
...
BoolPropertyRNA rna_UserPreferencesView_use_mouse_depth_cursor = {
	{(PropertyRNA *)&rna_UserPreferencesView_use_cursor_lock_adjust, (PropertyRNA *)&rna_UserPreferencesView_use_mouse_depth_navigate,
	-1, "use_mouse_depth_cursor", 3, 0, 0, 0, "Cursor Depth",
...
BoolPropertyRNA rna_UserPreferencesView_use_cursor_lock_adjust = {
	{(PropertyRNA *)&rna_UserPreferencesView_use_camera_lock_parent, (PropertyRNA *)&rna_UserPreferencesView_use_mouse_depth_cursor,
	-1, "use_cursor_lock_adjust", 3, 0, 0, 0, "Cursor Lock Adjust",
	"Place the cursor without \'jumping\' to the new location (when lock-to-cursor is used)",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	UserPreferencesView_use_cursor_lock_adjust_get, UserPreferencesView_use_cursor_lock_adjust_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_UserPreferencesView_use_camera_lock_parent = {
	{(PropertyRNA *)&rna_UserPreferencesView_use_zoom_to_mouse, (PropertyRNA *)&rna_UserPreferencesView_use_cursor_lock_adjust,
	-1, "use_camera_lock_parent", 3, 0, 0, 0, "Camera Parent Lock",
...
BoolPropertyRNA rna_UserPreferencesView_use_zoom_to_mouse = {
	...
	-1, "use_zoom_to_mouse", 3, 0, 0, 0, "Zoom To Mouse Position",
...
BoolPropertyRNA rna_UserPreferencesView_use_auto_perspective = {
	...
	-1, "use_auto_perspective", 3, 0, 0, 0, "Auto Perspective",
...
BoolPropertyRNA rna_UserPreferencesView_use_rotate_around_active = {
	...
	-1, "use_rotate_around_active", 3, 0, 0, 0, "Rotate Around Selection",
...
BoolPropertyRNA rna_UserPreferencesView_show_mini_axis = {
	...
	-1, "show_mini_axis", 3, 0, 0, 0, "Show Mini Axes",
...
IntPropertyRNA rna_UserPreferencesView_mini_axis_size = {
	...
	-1, "mini_axis_size", 3, 0, 4, 0, "Mini Axes Size",
...
IntPropertyRNA rna_UserPreferencesView_mini_axis_brightness = {
	...
	-1, "mini_axis_brightness", 3, 0, 4, 0, "Mini Axes Brightness",
...
IntPropertyRNA rna_UserPreferencesView_smooth_view = {
	...
	-1, "smooth_view", 3, 0, 4, 0, "Smooth View",
...
FloatPropertyRNA rna_UserPreferencesView_rotation_angle = {
	...
	-1, "rotation_angle", 3, 0, 4, 0, "Rotation Angle",
...
BoolPropertyRNA rna_UserPreferencesView_show_manipulator = {
	...
	-1, "show_manipulator", 3, 0, 0, 0, "Manipulator",
...
IntPropertyRNA rna_UserPreferencesView_manipulator_size = {
	...
	-1, "manipulator_size", 3, 0, 4, 0, "Manipulator Size",
...
IntPropertyRNA rna_UserPreferencesView_manipulator_handle_size = {
	...
	-1, "manipulator_handle_size", 3, 0, 4, 0, "Manipulator Handle Size",
...
IntPropertyRNA rna_UserPreferencesView_manipulator_hotspot = {
	...
	-1, "manipulator_hotspot", 3, 0, 4, 0, "Manipulator Hotspot",
...
IntPropertyRNA rna_UserPreferencesView_object_origin_size = {
	...
	-1, "object_origin_size", 3, 0, 4, 0, "Object Origin Size",
...
IntPropertyRNA rna_UserPreferencesView_view2d_grid_spacing_min = {
	...
	-1, "view2d_grid_spacing_min", 3, 0, 4, 0, "2D View Minimum Grid Spacing",
...
static const EnumPropertyItem rna_UserPreferencesView_timecode_style_items[6] = {
...
EnumPropertyRNA rna_UserPreferencesView_timecode_style = {
	...
	-1, "timecode_style", 3, 0, 0, 0, "TimeCode Style",
...
static const EnumPropertyItem rna_UserPreferencesView_view_frame_type_items[4] = {
...
EnumPropertyRNA rna_UserPreferencesView_view_frame_type = {
	...
	-1, "view_frame_type", 3, 0, 0, 0, "Zoom To Frame Type",
...
IntPropertyRNA rna_UserPreferencesView_view_frame_keyframes = {
	...
	-1, "view_frame_keyframes", 3, 0, 4, 0, "Zoom Keyframes",
...
FloatPropertyRNA rna_UserPreferencesView_view_frame_seconds = {
	...
	-1, "view_frame_seconds", 3, 0, 4, 0, "Zoom Seconds",
...
StructRNA RNA_UserPreferencesView = {
	...
	"UserPreferencesView", NULL, NULL, 512, NULL, "View & Controls",
	"Preferences related to viewing data",
	"*", 17,
...
static const EnumPropertyItem rna_UserPreferencesEdit_material_link_items[3] = {
...
EnumPropertyRNA rna_UserPreferencesEdit_material_link = {
	...
	-1, "material_link", 3, 0, 0, 0, "Material Link To",
...
static const EnumPropertyItem rna_UserPreferencesEdit_object_align_items[3] = {
...
EnumPropertyRNA rna_UserPreferencesEdit_object_align = {
	...
	-1, "object_align", 3, 0, 0, 0, "Align Object To",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_enter_edit_mode = {
	...
	-1, "use_enter_edit_mode", 3, 0, 0, 0, "Enter Edit Mode",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_drag_immediately = {
	...
	-1, "use_drag_immediately", 3, 0, 0, 0, "Release confirms",
...
IntPropertyRNA rna_UserPreferencesEdit_undo_steps = {
	...
	-1, "undo_steps", 3, 0, 0, 0, "Undo Steps",
...
IntPropertyRNA rna_UserPreferencesEdit_undo_memory_limit = {
	...
	-1, "undo_memory_limit", 3, 0, 4, 0, "Undo Memory Size",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_global_undo = {
	...
	-1, "use_global_undo", 3, 0, 0, 0, "Global Undo",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_auto_keying = {
	...
	-1, "use_auto_keying", 3, 0, 0, 0, "Auto Keying Enable",
...
static const EnumPropertyItem rna_UserPreferencesEdit_auto_keying_mode_items[3] = {
...
EnumPropertyRNA rna_UserPreferencesEdit_auto_keying_mode = {
	...
	-1, "auto_keying_mode", 3, 0, 0, 0, "Auto Keying Mode",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_keyframe_insert_available = {
	...
	-1, "use_keyframe_insert_available", 3, 0, 0, 0, "Auto Keyframe Insert Available",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_auto_keying_warning = {
	...
	-1, "use_auto_keying_warning", 3, 0, 0, 0, "Show Auto Keying Warning",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_keyframe_insert_needed = {
	...
	-1, "use_keyframe_insert_needed", 3, 0, 0, 0, "Keyframe Insert Needed",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_visual_keying = {
	...
	-1, "use_visual_keying", 3, 0, 0, 0, "Visual Keying",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_insertkey_xyz_to_rgb = {
	...
	-1, "use_insertkey_xyz_to_rgb", 3, 0, 0, 0, "New F-Curve Colors - XYZ to RGB",
...
static const EnumPropertyItem rna_UserPreferencesEdit_keyframe_new_interpolation_type_items[17] = {
...
EnumPropertyRNA rna_UserPreferencesEdit_keyframe_new_interpolation_type = {
	...
	-1, "keyframe_new_interpolation_type", 3, 0, 0, 0, "New Interpolation Type",
...
static const EnumPropertyItem rna_UserPreferencesEdit_keyframe_new_handle_type_items[6] = {
	{0, "FREE", 0, "Free", ""},
	{2, "VECTOR", 0, "Vector", ""},
	{3, "ALIGNED", 0, "Aligned", ""},
	{1, "AUTO", 0, "Automatic", ""},
...
EnumPropertyRNA rna_UserPreferencesEdit_keyframe_new_handle_type = {
	...
	-1, "keyframe_new_handle_type", 3, 0, 0, 0, "New Handles Type",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_negative_frames = {
	...
	-1, "use_negative_frames", 3, 0, 0, 0, "Allow Negative Frames",
...
FloatPropertyRNA rna_UserPreferencesEdit_fcurve_unselected_alpha = {
	...
	-1, "fcurve_unselected_alpha", 3, 0, 4, 0, "Unselected F-Curve Visibility",
...
IntPropertyRNA rna_UserPreferencesEdit_grease_pencil_manhattan_distance = {
	...
	-1, "grease_pencil_manhattan_distance", 3, 0, 4, 0, "Grease Pencil Manhattan Distance",
...
IntPropertyRNA rna_UserPreferencesEdit_grease_pencil_euclidean_distance = {
	{(PropertyRNA *)&rna_UserPreferencesEdit_use_grease_pencil_simplify_stroke, (PropertyRNA *)&rna_UserPreferencesEdit_grease_pencil_manhattan_distance,
	-1, "grease_pencil_euclidean_distance", 3, 0, 4, 0, "Grease Pencil Euclidean Distance",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_grease_pencil_simplify_stroke = {
	{(PropertyRNA *)&rna_UserPreferencesEdit_grease_pencil_eraser_radius, (PropertyRNA *)&rna_UserPreferencesEdit_grease_pencil_euclidean_distance,
	-1, "use_grease_pencil_simplify_stroke", 3, 0, 0, 0, "Grease Pencil Simplify Stroke",
...
IntPropertyRNA rna_UserPreferencesEdit_grease_pencil_eraser_radius = {
	...
	-1, "grease_pencil_eraser_radius", 3, 0, 4, 0, "Grease Pencil Eraser Radius",
...
FloatPropertyRNA rna_UserPreferencesEdit_grease_pencil_default_color = {
	...
	-1, "grease_pencil_default_color", 3, 0, 4, 0, "Grease Pencil Default Color",
...
FloatPropertyRNA rna_UserPreferencesEdit_sculpt_paint_overlay_color = {
	...
	-1, "sculpt_paint_overlay_color", 3, 0, 4, 0, "Sculpt/Paint Overlay Color",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_duplicate_mesh = {
	...
	-1, "use_duplicate_mesh", 3, 0, 0, 0, "Duplicate Mesh",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_duplicate_surface = {
	...
	-1, "use_duplicate_surface", 3, 0, 0, 0, "Duplicate Surface",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_duplicate_curve = {
	...
	-1, "use_duplicate_curve", 3, 0, 0, 0, "Duplicate Curve",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_duplicate_text = {
	...
	-1, "use_duplicate_text", 3, 0, 0, 0, "Duplicate Text",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_duplicate_metaball = {
	...
	-1, "use_duplicate_metaball", 3, 0, 0, 0, "Duplicate Metaball",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_duplicate_armature = {
	...
	-1, "use_duplicate_armature", 3, 0, 0, 0, "Duplicate Armature",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_duplicate_lamp = {
	...
	-1, "use_duplicate_lamp", 3, 0, 0, 0, "Duplicate Lamp",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_duplicate_material = {
	...
	-1, "use_duplicate_material", 3, 0, 0, 0, "Duplicate Material",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_duplicate_texture = {
	...
	-1, "use_duplicate_texture", 3, 0, 0, 0, "Duplicate Texture",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_duplicate_fcurve = {
	...
	-1, "use_duplicate_fcurve", 3, 0, 0, 0, "Duplicate F-Curve",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_duplicate_action = {
	...
	-1, "use_duplicate_action", 3, 0, 0, 0, "Duplicate Action",
...
BoolPropertyRNA rna_UserPreferencesEdit_use_duplicate_particle = {
	...
	-1, "use_duplicate_particle", 3, 0, 0, 0, "Duplicate Particle",
...
IntPropertyRNA rna_UserPreferencesEdit_node_margin = {
	...
	-1, "node_margin", 3, 0, 4, 0, "Auto-offset Margin",
...
StructRNA RNA_UserPreferencesEdit = {
	...
	"UserPreferencesEdit", NULL, NULL, 512, NULL, "Edit Methods",
	"Settings for interacting with Blender data",
	"*", 17,
...
static const EnumPropertyItem rna_UserPreferencesInput_select_mouse_items[3] = {
...
EnumPropertyRNA rna_UserPreferencesInput_select_mouse = {
	...
	-1, "select_mouse", 3, 0, 0, 0, "Select Mouse",
...
static const EnumPropertyItem rna_UserPreferencesInput_view_zoom_method_items[4] = {
...
EnumPropertyRNA rna_UserPreferencesInput_view_zoom_method = {
	...
	-1, "view_zoom_method", 3, 0, 0, 0, "Zoom Style",
...
static const EnumPropertyItem rna_UserPreferencesInput_view_zoom_axis_items[3] = {
...
EnumPropertyRNA rna_UserPreferencesInput_view_zoom_axis = {
	...
	-1, "view_zoom_axis", 3, 0, 0, 0, "Zoom Axis",
...
BoolPropertyRNA rna_UserPreferencesInput_invert_mouse_zoom = {
	...
	-1, "invert_mouse_zoom", 3, 0, 0, 0, "Invert Zoom Direction",
...
static const EnumPropertyItem rna_UserPreferencesInput_view_rotate_method_items[3] = {
...
EnumPropertyRNA rna_UserPreferencesInput_view_rotate_method = {
	...
	-1, "view_rotate_method", 3, 0, 0, 0, "View Rotation",
...
BoolPropertyRNA rna_UserPreferencesInput_use_mouse_continuous = {
	...
	-1, "use_mouse_continuous", 3, 0, 0, 0, "Continuous Grab",
...
static const EnumPropertyItem rna_UserPreferencesInput_navigation_mode_items[3] = {
...
EnumPropertyRNA rna_UserPreferencesInput_navigation_mode = {
	...
	-1, "navigation_mode", 3, 0, 0, 0, "View Navigation",
...
PointerPropertyRNA rna_UserPreferencesInput_walk_navigation = {
	...
	-1, "walk_navigation", 8650752, 0, 0, 0, "Walk Navigation",
...
IntPropertyRNA rna_UserPreferencesInput_drag_threshold = {
	...
	-1, "drag_threshold", 3, 0, 4, 0, "Drag Threshold",
...
IntPropertyRNA rna_UserPreferencesInput_tweak_threshold = {
	...
	-1, "tweak_threshold", 3, 0, 4, 0, "Tweak Threshold",
...
FloatPropertyRNA rna_UserPreferencesInput_ndof_sensitivity = {
	...
	-1, "ndof_sensitivity", 3, 0, 4, 0, "Sensitivity",
...
FloatPropertyRNA rna_UserPreferencesInput_ndof_orbit_sensitivity = {
	...
	-1, "ndof_orbit_sensitivity", 3, 0, 4, 0, "Orbit Sensitivity",
...
FloatPropertyRNA rna_UserPreferencesInput_ndof_deadzone = {
	...
	-1, "ndof_deadzone", 3, 0, 4, 0, "Deadzone",
...
BoolPropertyRNA rna_UserPreferencesInput_ndof_pan_yz_swap_axis = {
	...
	-1, "ndof_pan_yz_swap_axis", 3, 0, 0, 0, "Y/Z Swap Axis",
...
BoolPropertyRNA rna_UserPreferencesInput_ndof_zoom_invert = {
	...
	-1, "ndof_zoom_invert", 3, 0, 0, 0, "Invert Zoom",
...
BoolPropertyRNA rna_UserPreferencesInput_ndof_show_guide = {
	...
	-1, "ndof_show_guide", 3, 0, 0, 0, "Show Navigation Guide",
...
static const EnumPropertyItem rna_UserPreferencesInput_ndof_view_navigate_method_items[3] = {
...
EnumPropertyRNA rna_UserPreferencesInput_ndof_view_navigate_method = {
	...
	-1, "ndof_view_navigate_method", 3, 0, 0, 0, "NDOF View Navigate",
...
static const EnumPropertyItem rna_UserPreferencesInput_ndof_view_rotate_method_items[3] = {
...
EnumPropertyRNA rna_UserPreferencesInput_ndof_view_rotate_method = {
	...
	-1, "ndof_view_rotate_method", 3, 0, 0, 0, "NDOF View Rotation",
	"Rotation style in the viewport",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_UserPreferencesInput_ndof_rotx_invert_axis = {
	...
	-1, "ndof_rotx_invert_axis", 3, 0, 0, 0, "Invert Pitch (X) Axis",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_UserPreferencesInput_ndof_roty_invert_axis = {
	...
	-1, "ndof_roty_invert_axis", 3, 0, 0, 0, "Invert Yaw (Y) Axis",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_UserPreferencesInput_ndof_rotz_invert_axis = {
	...
	-1, "ndof_rotz_invert_axis", 3, 0, 0, 0, "Invert Roll (Z) Axis",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_UserPreferencesInput_ndof_panx_invert_axis = {
	...
	-1, "ndof_panx_invert_axis", 3, 0, 0, 0, "Invert X Axis",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_UserPreferencesInput_ndof_pany_invert_axis = {
	...
	-1, "ndof_pany_invert_axis", 3, 0, 0, 0, "Invert Y Axis",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_UserPreferencesInput_ndof_panz_invert_axis = {
	...
	-1, "ndof_panz_invert_axis", 3, 0, 0, 0, "Invert Z Axis",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_UserPreferencesInput_ndof_lock_horizon = {
	...
	-1, "ndof_lock_horizon", 3, 0, 0, 0, "Lock Horizon",
...
BoolPropertyRNA rna_UserPreferencesInput_ndof_fly_helicopter = {
	{(PropertyRNA *)&rna_UserPreferencesInput_use_ndof, (PropertyRNA *)&rna_UserPreferencesInput_ndof_lock_horizon,
	-1, "ndof_fly_helicopter", 3, 0, 0, 0, "Helicopter Mode",
...
BoolPropertyRNA rna_UserPreferencesInput_use_ndof = {
	{(PropertyRNA *)&rna_UserPreferencesInput_mouse_double_click_time, (PropertyRNA *)&rna_UserPreferencesInput_ndof_fly_helicopter,
	-1, "use_ndof", 1026, 0, 0, 0, "",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_UserPreferencesInput_mouse_double_click_time = {
	{(PropertyRNA *)&rna_UserPreferencesInput_use_mouse_emulate_3_button, (PropertyRNA *)&rna_UserPreferencesInput_use_ndof,
	-1, "mouse_double_click_time", 3, 0, 4, 0, "Double Click Timeout",
...
BoolPropertyRNA rna_UserPreferencesInput_use_mouse_emulate_3_button = {
	...
	-1, "use_mouse_emulate_3_button", 3, 0, 0, 0, "Emulate 3 Button Mouse",
...
BoolPropertyRNA rna_UserPreferencesInput_use_emulate_numpad = {
	...
	-1, "use_emulate_numpad", 3, 0, 0, 0, "Emulate Numpad",
...
BoolPropertyRNA rna_UserPreferencesInput_use_mouse_mmb_paste = {
	...
	-1, "use_mouse_mmb_paste", 3, 0, 0, 0, "Middle Mouse Paste",
...
BoolPropertyRNA rna_UserPreferencesInput_invert_zoom_wheel = {
	...
	-1, "invert_zoom_wheel", 3, 0, 0, 0, "Wheel Invert Zoom",
...
IntPropertyRNA rna_UserPreferencesInput_wheel_scroll_lines = {
	...
	-1, "wheel_scroll_lines", 3, 0, 4, 0, "Wheel Scroll Lines",
...
BoolPropertyRNA rna_UserPreferencesInput_use_trackpad_natural = {
	...
	-1, "use_trackpad_natural", 3, 0, 0, 0, "Trackpad Natural",
...
StringPropertyRNA rna_UserPreferencesInput_active_keyconfig = {
	...
	-1, "active_keyconfig", 262145, 0, 0, 0, "Key Config",
...
StructRNA RNA_UserPreferencesInput = {
	...
	"UserPreferencesInput", NULL, NULL, 512, NULL, "Input",
	"Settings for input devices",
	"*", 17,
...
BoolPropertyRNA rna_UserPreferencesFilePaths_show_hidden_files_datablocks = {
	...
	-1, "show_hidden_files_datablocks", 3, 0, 0, 0, "Hide Dot Files/Data-Blocks",
...
BoolPropertyRNA rna_UserPreferencesFilePaths_use_filter_files = {
	...
	-1, "use_filter_files", 3, 0, 0, 0, "Filter File Extensions",
...
BoolPropertyRNA rna_UserPreferencesFilePaths_hide_recent_locations = {
	...
	-1, "hide_recent_locations", 3, 0, 0, 0, "Hide Recent Locations",
...
BoolPropertyRNA rna_UserPreferencesFilePaths_hide_system_bookmarks = {
	...
	-1, "hide_system_bookmarks", 3, 0, 0, 0, "Hide System Bookmarks",
...
BoolPropertyRNA rna_UserPreferencesFilePaths_show_thumbnails = {
	...
	-1, "show_thumbnails", 3, 0, 0, 0, "Show Thumbnails",
...
BoolPropertyRNA rna_UserPreferencesFilePaths_use_relative_paths = {
	...
	-1, "use_relative_paths", 3, 0, 0, 0, "Relative Paths",
...
BoolPropertyRNA rna_UserPreferencesFilePaths_use_file_compression = {
	...
	-1, "use_file_compression", 3, 0, 0, 0, "Compress File",
...
StringPropertyRNA rna_UserPreferencesFilePaths_font_directory = {
	...
	-1, "font_directory", 262145, 0, 0, 0, "Fonts Directory",
...
StringPropertyRNA rna_UserPreferencesFilePaths_texture_directory = {
	...
	-1, "texture_directory", 262145, 0, 0, 0, "Textures Directory",
...
StringPropertyRNA rna_UserPreferencesFilePaths_render_output_directory = {
	...
	-1, "render_output_directory", 262145, 0, 0, 0, "Render Output Directory",
...
StringPropertyRNA rna_UserPreferencesFilePaths_script_directory = {
	...
	-1, "script_directory", 262145, 0, 0, 0, "Python Scripts Directory",
...
StringPropertyRNA rna_UserPreferencesFilePaths_i18n_branches_directory = {
	...
	-1, "i18n_branches_directory", 262145, 0, 0, 0, "Translation Branches Directory",
...
StringPropertyRNA rna_UserPreferencesFilePaths_sound_directory = {
	...
	-1, "sound_directory", 262145, 0, 0, 0, "Sounds Directory",
...
StringPropertyRNA rna_UserPreferencesFilePaths_temporary_directory = {
	...
	-1, "temporary_directory", 262145, 0, 0, 0, "Temporary Directory",
...
StringPropertyRNA rna_UserPreferencesFilePaths_render_cache_directory = {
	...
	-1, "render_cache_directory", 262145, 0, 0, 0, "Render Cache Path",
...
StringPropertyRNA rna_UserPreferencesFilePaths_image_editor = {
	...
	-1, "image_editor", 262145, 0, 0, 0, "Image Editor",
...
StringPropertyRNA rna_UserPreferencesFilePaths_animation_player = {
	...
	-1, "animation_player", 262145, 0, 0, 0, "Animation Player",
...
static const EnumPropertyItem rna_UserPreferencesFilePaths_animation_player_preset_items[7] = {
...
EnumPropertyRNA rna_UserPreferencesFilePaths_animation_player_preset = {
	...
	-1, "animation_player_preset", 3, 0, 0, 0, "Animation Player Preset",
...
IntPropertyRNA rna_UserPreferencesFilePaths_save_version = {
	...
	-1, "save_version", 3, 0, 4, 0, "Save Versions",
...
BoolPropertyRNA rna_UserPreferencesFilePaths_use_auto_save_temporary_files = {
	...
	-1, "use_auto_save_temporary_files", 3, 0, 0, 0, "Auto Save Temporary Files",
...
IntPropertyRNA rna_UserPreferencesFilePaths_auto_save_time = {
	...
	-1, "auto_save_time", 3, 0, 4, 0, "Auto Save Time",
...
BoolPropertyRNA rna_UserPreferencesFilePaths_use_keep_session = {
	...
	-1, "use_keep_session", 3, 0, 0, 0, "Keep Session",
...
IntPropertyRNA rna_UserPreferencesFilePaths_recent_files = {
	...
	-1, "recent_files", 3, 0, 4, 0, "Recent Files",
...
BoolPropertyRNA rna_UserPreferencesFilePaths_use_save_preview_images = {
	...
	-1, "use_save_preview_images", 3, 0, 0, 0, "Save Preview Images",
...
StructRNA RNA_UserPreferencesFilePaths = {
	...
	"UserPreferencesFilePaths", NULL, NULL, 512, NULL, "File Paths",
	"Default paths for external files",
	"*", 17,
...
BoolPropertyRNA rna_UserPreferencesSystem_use_international_fonts = {
	...
	-1, "use_international_fonts", 3, 0, 0, 0, "International Fonts",
...
IntPropertyRNA rna_UserPreferencesSystem_dpi = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_pixel_size, (PropertyRNA *)&rna_UserPreferencesSystem_use_international_fonts,
	-1, "dpi", 2, 0, 4, 0, "DPI",
	...
	UserPreferencesSystem_dpi_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
...
FloatPropertyRNA rna_UserPreferencesSystem_pixel_size = {
	...
	-1, "pixel_size", 2, 0, 4, 0, "Pixel Size",
...
StringPropertyRNA rna_UserPreferencesSystem_font_path_ui = {
	...
	-1, "font_path_ui", 262145, 0, 0, 0, "Interface Font",
...
StringPropertyRNA rna_UserPreferencesSystem_font_path_ui_mono = {
	...
	-1, "font_path_ui_mono", 262145, 0, 0, 0, "Mono-space Font",
...
IntPropertyRNA rna_UserPreferencesSystem_scrollback = {
	...
	-1, "scrollback", 3, 0, 4, 0, "Scrollback",
...
static const EnumPropertyItem rna_UserPreferencesSystem_language_items[2] = {
...
BoolPropertyRNA rna_UserPreferencesSystem_use_translate_tooltips = {
	...
	-1, "use_translate_tooltips", 3, 0, 0, 0, "Translate Tooltips",
	"Translate tooltips",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_UserPreferencesSystem_use_translate_interface = {
	...
	-1, "use_translate_interface", 3, 0, 0, 0, "Translate Interface",
	"Translate interface",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_UserPreferencesSystem_use_translate_new_dataname = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_solid_lights, (PropertyRNA *)&rna_UserPreferencesSystem_use_translate_interface,
	-1, "use_translate_new_dataname", 3, 0, 0, 0, "Translate New Names",
...
CollectionPropertyRNA rna_UserPreferencesSystem_solid_lights = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_use_weight_color_range, (PropertyRNA *)&rna_UserPreferencesSystem_use_translate_new_dataname,
	-1, "solid_lights", 0, 0, 8, 0, "Solid Lights",
...
BoolPropertyRNA rna_UserPreferencesSystem_use_weight_color_range = {
	...
	-1, "use_weight_color_range", 3, 0, 0, 0, "Use Weight Color Range",
...
PointerPropertyRNA rna_UserPreferencesSystem_weight_color_range = {
	...
	-1, "weight_color_range", 8650752, 0, 0, 0, "Weight Color Range",
...
static const EnumPropertyItem rna_UserPreferencesSystem_color_picker_type_items[6] = {
...
EnumPropertyRNA rna_UserPreferencesSystem_color_picker_type = {
	...
	-1, "color_picker_type", 3, 0, 0, 0, "Color Picker Type",
...
BoolPropertyRNA rna_UserPreferencesSystem_use_preview_images = {
	...
	-1, "use_preview_images", 3, 0, 0, 0, "Enable All Codecs",
...
BoolPropertyRNA rna_UserPreferencesSystem_use_scripts_auto_execute = {
	...
	-1, "use_scripts_auto_execute", 3, 0, 0, 0, "Auto Run Python Scripts and Components",
...
BoolPropertyRNA rna_UserPreferencesSystem_use_tabs_as_spaces = {
	...
	-1, "use_tabs_as_spaces", 3, 0, 0, 0, "Tabs as Spaces",
...
IntPropertyRNA rna_UserPreferencesSystem_prefetch_frames = {
	...
	-1, "prefetch_frames", 3, 0, 4, 0, "Prefetch Frames",
...
IntPropertyRNA rna_UserPreferencesSystem_memory_cache_limit = {
	...
	-1, "memory_cache_limit", 3, 0, 4, 0, "Memory Cache Limit",
...
IntPropertyRNA rna_UserPreferencesSystem_frame_server_port = {
	...
	-1, "frame_server_port", 3, 0, 4, 0, "Frame Server Port",
...
FloatPropertyRNA rna_UserPreferencesSystem_gl_clip_alpha = {
	...
	-1, "gl_clip_alpha", 3, 0, 4, 0, "Clip Alpha",
...
BoolPropertyRNA rna_UserPreferencesSystem_use_16bit_textures = {
	...
	-1, "use_16bit_textures", 3, 0, 0, 0, "16 Bit Float Textures",
...
BoolPropertyRNA rna_UserPreferencesSystem_use_gpu_mipmap = {
	...
	-1, "use_gpu_mipmap", 3, 0, 0, 0, "GPU Mipmap Generation",
...
static const EnumPropertyItem rna_UserPreferencesSystem_image_draw_method_items[4] = {
...
EnumPropertyRNA rna_UserPreferencesSystem_image_draw_method = {
	...
	-1, "image_draw_method", 3, 0, 0, 0, "Image Draw Method",
...
static const EnumPropertyItem rna_UserPreferencesSystem_anisotropic_filter_items[6] = {
	{1, "FILTER_0", 0, "Off", ""},
	{2, "FILTER_2", 0, "2x", ""},
	{4, "FILTER_4", 0, "4x", ""},
	{8, "FILTER_8", 0, "8x", ""},
...
EnumPropertyRNA rna_UserPreferencesSystem_anisotropic_filter = {
	...
	-1, "anisotropic_filter", 3, 0, 0, 0, "Anisotropic Filter",
...
static const EnumPropertyItem rna_UserPreferencesSystem_gl_texture_limit_items[9] = {
	{0, "CLAMP_OFF", 0, "Off", ""},
...
EnumPropertyRNA rna_UserPreferencesSystem_gl_texture_limit = {
	...
	-1, "gl_texture_limit", 3, 0, 0, 0, "GL Texture Limit",
...
IntPropertyRNA rna_UserPreferencesSystem_texture_time_out = {
	...
	-1, "texture_time_out", 3, 0, 4, 0, "Texture Time Out",
...
IntPropertyRNA rna_UserPreferencesSystem_texture_collection_rate = {
	...
	-1, "texture_collection_rate", 3, 0, 4, 0, "Texture Collection Rate",
...
static const EnumPropertyItem rna_UserPreferencesSystem_window_draw_method_items[6] = {
...
EnumPropertyRNA rna_UserPreferencesSystem_window_draw_method = {
	...
	-1, "window_draw_method", 3, 0, 0, 0, "Window Draw Method",
...
static const EnumPropertyItem rna_UserPreferencesSystem_audio_mixing_buffer_items[9] = {
...
EnumPropertyRNA rna_UserPreferencesSystem_audio_mixing_buffer = {
	...
	-1, "audio_mixing_buffer", 3, 0, 0, 0, "Audio Mixing Buffer",
...
static const EnumPropertyItem rna_UserPreferencesSystem_audio_device_items[4] = {
...
EnumPropertyRNA rna_UserPreferencesSystem_audio_device = {
	...
	-1, "audio_device", 3, 0, 0, 0, "Audio Device",
	"Audio output device",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_UserDef_audio_update, 0, NULL, NULL,
...
static const EnumPropertyItem rna_UserPreferencesSystem_audio_sample_rate_items[5] = {
...
EnumPropertyRNA rna_UserPreferencesSystem_audio_sample_rate = {
	...
	-1, "audio_sample_rate", 3, 0, 0, 0, "Audio Sample Rate",
	"Audio sample rate",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_UserDef_audio_update, 0, NULL, NULL,
...
static const EnumPropertyItem rna_UserPreferencesSystem_audio_sample_format_items[7] = {
...
EnumPropertyRNA rna_UserPreferencesSystem_audio_sample_format = {
	...
	-1, "audio_sample_format", 3, 0, 0, 0, "Audio Sample Format",
	"Audio sample format",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_UserDef_audio_update, 0, NULL, NULL,
...
static const EnumPropertyItem rna_UserPreferencesSystem_audio_channels_items[6] = {
...
EnumPropertyRNA rna_UserPreferencesSystem_audio_channels = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_use_text_antialiasing, (PropertyRNA *)&rna_UserPreferencesSystem_audio_sample_format,
	-1, "audio_channels", 3, 0, 0, 0, "Audio Channels",
	"Audio channel count",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_UserDef_audio_update, 0, NULL, NULL,
...
BoolPropertyRNA rna_UserPreferencesSystem_use_text_antialiasing = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_text_hinting, (PropertyRNA *)&rna_UserPreferencesSystem_audio_channels,
	-1, "use_text_antialiasing", 3, 0, 0, 0, "Text Anti-aliasing",
...
static const EnumPropertyItem rna_UserPreferencesSystem_text_hinting_items[5] = {
	{0, "AUTO", 0, "Auto", ""},
	{2, "NONE", 0, "None", ""},
	{4, "SLIGHT", 0, "Slight", ""},
	{8, "FULL", 0, "Full", ""},
...
EnumPropertyRNA rna_UserPreferencesSystem_text_hinting = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_select_method, (PropertyRNA *)&rna_UserPreferencesSystem_use_text_antialiasing,
	-1, "text_hinting", 3, 0, 0, 0, "Text Hinting",
	"Method for making user interface text render sharp",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_text_update, 0, NULL, NULL,
	0, -1, NULL},
	UserPreferencesSystem_text_hinting_get, UserPreferencesSystem_text_hinting_set, NULL, NULL, NULL, NULL, rna_UserPreferencesSystem_text_hinting_items, 4, 0
};

static const EnumPropertyItem rna_UserPreferencesSystem_select_method_items[4] = {
	{0, "AUTO", 0, "Automatic", ""},
...
EnumPropertyRNA rna_UserPreferencesSystem_select_method = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_use_select_pick_depth, (PropertyRNA *)&rna_UserPreferencesSystem_text_hinting,
	-1, "select_method", 3, 0, 0, 0, "Selection Method",
...
BoolPropertyRNA rna_UserPreferencesSystem_use_select_pick_depth = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_multi_sample, (PropertyRNA *)&rna_UserPreferencesSystem_select_method,
	-1, "use_select_pick_depth", 3, 0, 0, 0, "OpenGL Depth Picking",
	"Use the depth buffer for picking 3D View selection",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	UserPreferencesSystem_use_select_pick_depth_get, UserPreferencesSystem_use_select_pick_depth_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

static const EnumPropertyItem rna_UserPreferencesSystem_multi_sample_items[6] = {
...
EnumPropertyRNA rna_UserPreferencesSystem_multi_sample = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_use_region_overlap, (PropertyRNA *)&rna_UserPreferencesSystem_use_select_pick_depth,
	-1, "multi_sample", 3, 0, 0, 0, "MultiSample",
...
BoolPropertyRNA rna_UserPreferencesSystem_use_region_overlap = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_opensubdiv_compute_type, (PropertyRNA *)&rna_UserPreferencesSystem_multi_sample,
	-1, "use_region_overlap", 3, 0, 0, 0, "Region Overlap",
...
static const EnumPropertyItem rna_UserPreferencesSystem_opensubdiv_compute_type_items[8] = {
	{0, "NONE", 0, "None", ""},
	{1, "CPU", 0, "CPU", ""},
	{2, "OPENMP", 0, "OpenMP", ""},
	{3, "OPENCL", 0, "OpenCL", ""},
...
EnumPropertyRNA rna_UserPreferencesSystem_opensubdiv_compute_type = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_legacy_compute_device_type, (PropertyRNA *)&rna_UserPreferencesSystem_use_region_overlap,
	-1, "opensubdiv_compute_type", 16777219, 0, 0, 0, "OpenSubdiv Compute Type",
	"Type of computer back-end used with OpenSubdiv",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_opensubdiv_update, 252313600, NULL, NULL,
	0, -1, NULL},
	UserPreferencesSystem_opensubdiv_compute_type_get, UserPreferencesSystem_opensubdiv_compute_type_set, rna_userdef_opensubdiv_compute_type_itemf, NULL, NULL, NULL, rna_UserPreferencesSystem_opensubdiv_compute_type_items, 7, 0
};

IntPropertyRNA rna_UserPreferencesSystem_legacy_compute_device_type = {
	{NULL, (PropertyRNA *)&rna_UserPreferencesSystem_opensubdiv_compute_type,
	-1, "legacy_compute_device_type", 524290, 0, 4, 0, "Legacy Compute Device Type",
	"For backwards compatibility only",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(UserDef, compute_device_type), 0, NULL},
	UserPreferencesSystem_legacy_compute_device_type_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	-10000, 10000, INT_MIN, INT_MAX, 1, 0, NULL
};
...
StructRNA RNA_UserPreferencesSystem = {
	...
	NULL,
	{(PropertyRNA *)&rna_UserPreferencesSystem_rna_properties, (PropertyRNA *)&rna_UserPreferencesSystem_legacy_compute_device_type}},
	"UserPreferencesSystem", NULL, NULL, 512, NULL, "System & OpenGL",
	"Graphics driver and operating system settings",
	"*", 17,
...
PointerPropertyRNA rna_Addon_preferences = {
	...
	-1, "preferences", 8388608, 0, 0, 0, "preferences",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
StringPropertyRNA rna_AddonPreferences_bl_idname = {
	...
	-1, "bl_idname", 262161, 0, 0, 0, "bl_idname",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {64, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_PathCompare_use_glob = {
	...
	-1, "use_glob", 3, 0, 0, 0, "Use Wildcard",
