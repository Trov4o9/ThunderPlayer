...
FloatPropertyRNA rna_WorldTextureSlot_lod_bias;
...
bool World_use_sky_blend_get(PointerRNA *ptr)
{
	World *data = (World *)(ptr->data);
	return (((data->skytype) & 1) != 0);
}

void World_use_sky_blend_set(PointerRNA *ptr, bool value)
{
	World *data = (World *)(ptr->data);
...
bool World_use_sky_paper_get(PointerRNA *ptr)
{
	World *data = (World *)(ptr->data);
	return (((data->skytype) & 4) != 0);
}

void World_use_sky_paper_set(PointerRNA *ptr, bool value)
{
	World *data = (World *)(ptr->data);
...
bool World_use_sky_real_get(PointerRNA *ptr)
{
	World *data = (World *)(ptr->data);
	return (((data->skytype) & 2) != 0);
}

void World_use_sky_real_set(PointerRNA *ptr, bool value)
{
	World *data = (World *)(ptr->data);
...
bool WorldLighting_use_environment_light_get(PointerRNA *ptr)
{
	World *data = (World *)(ptr->data);
	return (((data->mode) & 16) != 0);
}

void WorldLighting_use_environment_light_set(PointerRNA *ptr, bool value)
{
	World *data = (World *)(ptr->data);
...
bool WorldLighting_use_indirect_light_get(PointerRNA *ptr)
{
	World *data = (World *)(ptr->data);
	return (((data->mode) & 128) != 0);
}

void WorldLighting_use_indirect_light_set(PointerRNA *ptr, bool value)
{
	World *data = (World *)(ptr->data);
...
bool WorldLighting_use_falloff_get(PointerRNA *ptr)
{
	World *data = (World *)(ptr->data);
	return (((data->aomode) & 1) != 0);
}

void WorldLighting_use_falloff_set(PointerRNA *ptr, bool value)
{
	World *data = (World *)(ptr->data);
...
bool WorldLighting_use_cache_get(PointerRNA *ptr)
{
	World *data = (World *)(ptr->data);
	return (((data->aomode) & 4) != 0);
}

void WorldLighting_use_cache_set(PointerRNA *ptr, bool value)
{
	World *data = (World *)(ptr->data);
...
bool WorldTextureSlot_use_map_blend_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 1) != 0);
}

void WorldTextureSlot_use_map_blend_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool WorldTextureSlot_use_map_horizon_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 2) != 0);
}

void WorldTextureSlot_use_map_horizon_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool WorldTextureSlot_use_map_zenith_up_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 4) != 0);
}

void WorldTextureSlot_use_map_zenith_up_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
bool WorldTextureSlot_use_map_zenith_down_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 8) != 0);
}

void WorldTextureSlot_use_map_zenith_down_set(PointerRNA *ptr, bool value)
{
	MTex *data = (MTex *)(ptr->data);
...
float WorldTextureSlot_lod_bias_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (float)(data->lodbias);
}

void WorldTextureSlot_lod_bias_set(PointerRNA *ptr, float value)
{
	MTex *data = (MTex *)(ptr->data);
	data->lodbias = value;
}
...
FloatPropertyRNA rna_World_horizon_color = {
	...
	-1, "horizon_color", 3, 0, 4, 0, "Horizon Color",
...
FloatPropertyRNA rna_World_zenith_color = {
	...
	-1, "zenith_color", 3, 0, 4, 0, "Zenith Color",
	"Color at the zenith",
	0, "*",
	PROP_FLOAT, PROP_COLOR | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_World_draw_update, 0, NULL, NULL,
	offsetof(World, zenr), 5, NULL},
...
FloatPropertyRNA rna_World_ambient_color = {
	...
	-1, "ambient_color", 3, 0, 4, 0, "Ambient Color",
	"Ambient color of the world",
	0, "*",
	PROP_FLOAT, PROP_COLOR | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_World_draw_update, 0, NULL, NULL,
	offsetof(World, ambr), 5, NULL},
...
FloatPropertyRNA rna_World_color_range = {
	...
	-1, "color_range", 3, 0, 4, 0, "Range",
	"The color range that will be mapped to 0-1",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_World_update, 0, NULL, NULL,
	offsetof(World, range), 5, NULL},
...
BoolPropertyRNA rna_World_use_sky_blend = {
	...
	-1, "use_sky_blend", 3, 0, 0, 0, "Blend Sky",
...
BoolPropertyRNA rna_World_use_sky_paper = {
	...
	-1, "use_sky_paper", 3, 0, 0, 0, "Paper Sky",
...
BoolPropertyRNA rna_World_use_sky_real = {
	...
	-1, "use_sky_real", 3, 0, 0, 0, "Real Sky",
...
PointerPropertyRNA rna_World_light_settings = {
	...
	-1, "light_settings", 8650752, 0, 0, 0, "Lighting",
...
PointerPropertyRNA rna_World_mist_settings = {
	...
	-1, "mist_settings", 8650752, 0, 0, 0, "Mist",
	"World mist settings",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
StructRNA RNA_WorldTextureSlots = {
	...
	"WorldTextureSlots", NULL, NULL, 516, NULL, "Texture Slots",
...
BoolPropertyRNA rna_WorldLighting_use_ambient_occlusion = {
	...
	-1, "use_ambient_occlusion", 3, 0, 0, 0, "Use Ambient Occlusion",
...
static const EnumPropertyItem rna_WorldLighting_ao_blend_type_items[3] = {
...
EnumPropertyRNA rna_WorldLighting_ao_blend_type = {
	...
	-1, "ao_blend_type", 3, 0, 0, 0, "Blend Mode",
...
BoolPropertyRNA rna_WorldLighting_use_environment_light = {
	...
	-1, "use_environment_light", 3, 0, 0, 0, "Use Environment Lighting",
...
FloatPropertyRNA rna_WorldLighting_environment_energy = {
	...
	-1, "environment_energy", 3, 0, 4, 0, "Environment Color",
	"Defines the strength of environment light",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_World_draw_update, 0, NULL, NULL,
	offsetof(World, ao_env_energy), 5, NULL},
...
static const EnumPropertyItem rna_WorldLighting_environment_color_items[4] = {
...
EnumPropertyRNA rna_WorldLighting_environment_color = {
	...
	-1, "environment_color", 3, 0, 0, 0, "Environment Color",
...
BoolPropertyRNA rna_WorldLighting_use_indirect_light = {
	...
	-1, "use_indirect_light", 3, 0, 0, 0, "Use Indirect Lighting",
...
FloatPropertyRNA rna_WorldLighting_indirect_factor = {
	...
	-1, "indirect_factor", 3, 0, 4, 0, "Indirect Factor",
	"Factor for how much surrounding objects contribute to light",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_World_update, 0, NULL, NULL,
	offsetof(World, ao_indirect_energy), 5, NULL},
...
IntPropertyRNA rna_WorldLighting_indirect_bounces = {
	...
	-1, "indirect_bounces", 3, 0, 4, 0, "Bounces",
...
static const EnumPropertyItem rna_WorldLighting_gather_method_items[3] = {
...
EnumPropertyRNA rna_WorldLighting_gather_method = {
	...
	-1, "gather_method", 3, 0, 0, 0, "Gather Method",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_World_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_WorldLighting_threshold = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_World_update, 0, NULL, NULL,
	offsetof(World, ao_adapt_thresh), 5, NULL},
...
FloatPropertyRNA rna_WorldLighting_adapt_to_speed = {
	...
	-1, "adapt_to_speed", 3, 0, 4, 0, "Adapt To Speed",
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_World_update, 0, NULL, NULL,
	offsetof(World, ao_adapt_speed_fac), 5, NULL},
...
FloatPropertyRNA rna_WorldLighting_error_threshold = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_World_update, 0, NULL, NULL,
	offsetof(World, ao_approx_error), 5, NULL},
...
FloatPropertyRNA rna_WorldLighting_correction = {
	...
	-1, "correction", 3, 0, 4, 0, "Correction",
	"Ad-hoc correction for over-occlusion due to the approximation",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_World_update, 0, NULL, NULL,
	offsetof(World, ao_approx_correction), 5, NULL},
...
BoolPropertyRNA rna_WorldLighting_use_cache = {
	...
	-1, "use_cache", 3, 0, 0, 0, "Pixel Cache",
...
static const EnumPropertyItem rna_WorldLighting_sample_method_items[4] = {
...
EnumPropertyRNA rna_WorldLighting_sample_method = {
	...
	-1, "sample_method", 3, 0, 0, 0, "Sample Method",
...
BoolPropertyRNA rna_WorldTextureSlot_use_map_horizon = {
	...
	-1, "use_map_horizon", 3, 0, 0, 0, "Horizon",
...
BoolPropertyRNA rna_WorldTextureSlot_use_map_zenith_up = {
	...
	-1, "use_map_zenith_up", 3, 0, 0, 0, "Zenith Up",
...
BoolPropertyRNA rna_WorldTextureSlot_use_map_zenith_down = {
	{(PropertyRNA *)&rna_WorldTextureSlot_lod_bias, (PropertyRNA *)&rna_WorldTextureSlot_use_map_zenith_up,
	-1, "use_map_zenith_down", 3, 0, 0, 0, "Zenith Down",
...
FloatPropertyRNA rna_WorldTextureSlot_lod_bias = {
	{(PropertyRNA *)&rna_WorldTextureSlot_texture_coords, (PropertyRNA *)&rna_WorldTextureSlot_use_map_zenith_down,
	...
	WorldTextureSlot_lod_bias_get, WorldTextureSlot_lod_bias_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

static const EnumPropertyItem rna_WorldTextureSlot_texture_coords_items[8] = {
...
EnumPropertyRNA rna_WorldTextureSlot_texture_coords = {
	{(PropertyRNA *)&rna_WorldTextureSlot_object, (PropertyRNA *)&rna_WorldTextureSlot_lod_bias,
...
FloatPropertyRNA rna_WorldTextureSlot_horizon_factor = {
	...
	-1, "horizon_factor", 3, 0, 4, 0, "Horizon Factor",
...
FloatPropertyRNA rna_WorldTextureSlot_zenith_up_factor = {
	...
	-1, "zenith_up_factor", 3, 0, 4, 0, "Zenith Up Factor",
	"Amount texture affects color of the zenith above",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_World_update, 0, NULL, NULL,
	offsetof(MTex, zenupfac), 5, NULL},
...
FloatPropertyRNA rna_WorldTextureSlot_zenith_down_factor = {
	...
	-1, "zenith_down_factor", 3, 0, 4, 0, "Zenith Down Factor",
	"Amount texture affects color of the zenith below",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_World_update, 0, NULL, NULL,
	offsetof(MTex, zendownfac), 5, NULL},
...
StructRNA RNA_WorldTextureSlot = {
	...
	"WorldTextureSlot", NULL, NULL, 516, NULL, "World Texture Slot",
