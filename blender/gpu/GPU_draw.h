...
typedef enum GPU_MipmapFilter {
	GPU_MIPMAP_FILTER_NEAREST_MIPMAP_NEAREST = 0,
	GPU_MIPMAP_FILTER_NEAREST_MIPMAP_LINEAR = 1,
	GPU_MIPMAP_FILTER_LINEAR_MIPMAP_NEAREST = 2,
	GPU_MIPMAP_FILTER_LINEAR_MIPMAP_LINEAR = 3
} GPU_MipmapFilter;
