...
public:
	...
	virtual void ActivateMeshUser(RAS_MeshUser *meshUser, RAS_Rasterizer *rasty, const mt::mat3x4& camtrans, bool forceUpdate = false);
	void GetMaterialData(float& r, float& g, float& b, float& a,
	...
	virtual void SetForceInstancing(bool force);
	virtual bool GetForceInstancing() const;
	...
	class BL_BlenderShader *GetBlenderShader() { return m_blenderShader; }
	...
	static PyObject *pyattr_get_forceInstancing(EXP_PyObjectPlus *self_v, const EXP_PYATTRIBUTE_DEF *attrdef);
	static int pyattr_set_forceInstancing(EXP_PyObjectPlus *self_v, const EXP_PYATTRIBUTE_DEF *attrdef, PyObject *value);
