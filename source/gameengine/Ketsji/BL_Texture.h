...
private:
	...
	MTex *m_mtex;
	GPUTexture *m_gpuTex;
	/// Ponteiro da GPU texture na última verificação — evita pointer chase por frame
	GPUTexture *m_lastCheckedGpuTex = nullptr;
...
public:
	...
	unsigned long long GetBindlessHandle() const;
