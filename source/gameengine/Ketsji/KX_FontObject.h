...
public:
	...
	virtual void UpdateBucketsNoOnlyShadow();
	virtual void UpdateShadowBuckets();
...
protected:
	...
	int m_lastDpi;
	float m_lastFSize;
	float m_lastResolution;
	float m_lastLineSpacing;
	mt::vec3 m_lastWorldScale;
	mt::mat3 m_lastWorldOrientation;
	mt::vec3 m_lastWorldPosition;
	int m_lastTextVersion;
