...
bool KX_TrackToActuator::Update(double curtime)
{
	...
	if (bNegativeEvent) {
		...
		KX_GameObject *targetobj = (KX_GameObject *)m_object;
		mt::vec3 myPos = curobj->NodeGetWorldPosition();
		mt::vec3 targetPos = targetobj->NodeGetWorldPosition();

		mt::vec3 dir = myPos - targetPos;
		mt::mat3 mat;
		mt::mat3 oldmat;
