...
private:
	...
	bool m_has_base;
	float m_pose_head_base[3];
	float m_pose_tail_base[3];
...
public:
    ...
    static PyObject *py_attr_get_pose_head_base(EXP_PyObjectPlus *self, const struct EXP_PYATTRIBUTE_DEF *attrdef);
    static PyObject *py_attr_get_pose_tail_base(EXP_PyObjectPlus *self, const struct EXP_PYATTRIBUTE_DEF *attrdef);
#endif  /* WITH_PYTHON */
};
