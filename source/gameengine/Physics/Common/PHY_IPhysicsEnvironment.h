...
public:
	...
	/// Synchronize motion states between physics and logic objects
	virtual void SyncMotionStates(float timeStep) = 0;
	virtual void SyncMotionStatesInterpolated(float timeStep, float alpha) = 0;
	virtual void CachePreviousTransforms() = 0;
