...
public:
	...
	virtual void ActivateMeshUser(RAS_MeshUser *meshUser, RAS_Rasterizer *rasty, const mt::mat3x4& camtrans, bool forceUpdate = false) = 0;
	...
	virtual bool GetForceInstancing() const { return false; }
