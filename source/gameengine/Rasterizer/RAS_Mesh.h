...
{
public:
	// Controla se esta malha pode participar de auto agrupamento/batching.
	inline bool AllowAutoBatching() const { return m_allowAutoBatch; }
	inline void SetAllowAutoBatching(bool allow) { m_allowAutoBatch = allow; }

	// Se verdadeiro, tenta forçar instancing para esta malha mesmo se o bucket não tiver instancing ativo.
	inline bool ForceInstancing() const { return m_forceInstancing; }
	inline void SetForceInstancing(bool force) { m_forceInstancing = force; }
...
protected:
	...
	Mesh *m_mesh;
	bool m_allowAutoBatch = true;
	bool m_forceInstancing = false;
