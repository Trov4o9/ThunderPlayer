...
struct GPUTexture;
extern GPUTexture *g_DebugDepthTex;
...
public:
	enum Type {
		...
		RAS_OFFSCREEN_GBUFFER,

		RAS_OFFSCREEN_CUSTOM,

		RAS_OFFSCREEN_MAX,
	};
	GPUFrameBuffer *GetFrameBuffer() const { return m_frameBuffer; }
...
private:
    ...
    static inline void FreeSlot(Slot& slot, bool multisample);
