...
public:
	...
	/// \brief Test if AABB is inside frustum using identity matrix and no final check (faster).
	TestType AabbInsideFrustumFast(const mt::vec3& min, const mt::vec3& max) const;
