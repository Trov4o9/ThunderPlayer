...
static struct uiWidgetColors wcol_pulldown = {
	{75, 75, 75, 255},
	{63, 63, 63, 255},
	{100, 100, 100, 255},  // cinza escuro no lugar do azul
	{255, 255, 255, 255},

	{255, 255, 255, 255},     // contorno escuro
	{255, 255, 255, 255},  // texto claro
...
static struct uiWidgetColors wcol_menu_item = {
	{45, 45, 45, 255},
	{45, 45, 45, 0},
	{90, 90, 90, 255},     // hover escuro neutro
	{172, 172, 172, 128},
...
static struct uiWidgetColors wcol_menu_back = {
	{5, 10, 20, 230},      // fundo preto azulado
	{10, 25, 50, 230},     // sombra sutil para fundo
	{20, 40, 80, 230},     // hover de fundo mais azul
	{50, 90, 140, 255},    // fundo ativo brilhante azul

	{80, 160, 255, 255},   // contorno azul neon claro
	{180, 230, 255, 255},  // texto branco azulado

	0,
	25, -20
};

/* pie menu totalmente escuro */
...
static struct uiWidgetColors wcol_radio = {
	...
	{0, 255, 238, 255},   // contorno
	{220, 220, 220, 255},   // texto
...
static struct uiWidgetColors wcol_regular = {
	{45, 45, 45, 45},     // fundo preto real
	{30, 30, 30, 255},     // sombra sutil
	{50, 50, 50, 255},     // hover cinza escuro
	{20, 20, 20, 255},     // ativo

	{225, 235, 255, 255},     // contorno cinza
	{220, 220, 220, 255},  // texto branco acinzentado
